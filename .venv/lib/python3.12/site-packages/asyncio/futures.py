...
class Future:
    ...
    def _format_callbacks(self):
        ...
        if size == 1:
            ...
            cb = "{}, <{} more>, {}".format(
                format_cb(cb[0]), size - 2, format_cb(cb[-1])
            )
        return "cb=[%s]" % cb
    ...
    if _PY34:
        ...
        def __del__(self):
            ...
            context = {
                "message": (
                    "%s exception was never retrieved" % self.__class__.__name__
                ),
                "exception": exc,
                "future": self,
            }
...
def wrap_future(fut, *, loop=None):
    ...
    fut.add_done_callback(
        lambda future: loop.call_soon_threadsafe(new_future._copy_state, future)
    )
    return new_future
