...
from . import events, futures, protocols, streams, tasks
    ...
    def connection_made(self, transport):
        ...
        if stdin_transport is not None:
            self.stdin = streams.StreamWriter(
                stdin_transport, protocol=self, reader=None, loop=self._loop
            )
...
class Process:
    ...
    def communicate(self, input=None):
        ...
        if self.stderr is not None:
            ...
            stderr = self._noop()
        stdin, stdout, stderr = yield from tasks.gather(
...
def create_subprocess_shell(
    ...
    **kwds
    ...
    transport, protocol = yield from loop.subprocess_shell(
        protocol_factory, cmd, stdin=stdin, stdout=stdout, stderr=stderr, **kwds
    )
