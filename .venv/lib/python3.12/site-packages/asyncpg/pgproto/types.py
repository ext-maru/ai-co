...
class BitString:
    ...
    def __init__(self, bitstring: typing.Optional[builtins.bytes] = None) -> None:
        if not bitstring:
            self._bytes = bytes()
            self._bitlength = 0
        else:
            ...
            for i, bit in enumerate(bitstring):
                ...
                bit = int(bit)
                if bit != 0 and bit != 1:
                    raise ValueError("invalid bit value at position {}".format(i))
    ...
    def to_int(self, bitorder: _BitOrderType = "big", *, signed: bool = False) -> int:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return self._bytes == other._bytes and self._bitlength == other._bitlength
...
class Point(typing.Tuple[float, float]):
    ...
    def __new__(
        ...
        return super().__new__(cls, typing.cast(typing.Any, (float(x), float(y))))
...
class LineSegment(typing.Tuple[Point, Point]):
    ...
    def __new__(
        ...
        return super().__new__(cls, typing.cast(typing.Any, (Point(*p1), Point(*p2))))
...
class Path:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return self.points == other.points and self._is_closed == other._is_closed
