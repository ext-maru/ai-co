...
class CRLDistributionPoints(ExtensionType):
    ...
    def __init__(self, distribution_points: Iterable[DistributionPoint]) -> None:
...
class Admission:
    def __init__(
        ...
        if not all(isinstance(info, ProfessionInfo) for info in profession_infos):
            raise TypeError(
                "Every item in the profession_infos list must be a " "ProfessionInfo"
            )
...
class Admissions(ExtensionType):
    ...
    def __init__(
        ...
        if not all(isinstance(admission, Admission) for admission in admissions):
            raise TypeError(
                "Every item in the contents_of_admissions list must be an " "Admission"
            )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            self.authority == other.authority and self._admissions == other._admissions
        )
