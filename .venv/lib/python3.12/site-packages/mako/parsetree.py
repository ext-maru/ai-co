...
from mako import ast, exceptions, filters, util
...
class Expression(Node):
    ...
    def undeclared_identifiers(self):
        ...
        return self.code.undeclared_identifiers.union(
            self.escapes_code.undeclared_identifiers.difference(filters.DEFAULT_ESCAPES)
    ...
    def _parse_attributes(self, expressions, nonexpressions):
        ...
        for key in self.attributes:
            if key in expressions:
                ...
                raise exceptions.CompileException(
                    "Invalid attribute for tag '%s': '%s'" % (self.keyword, key),
                    **self.exception_kwargs,
                )
...
class NamespaceTag(Tag):
    ...
    def __init__(self, keyword, attributes, **kwargs):
        ...
        if "name" not in attributes and "import" not in attributes:
            raise exceptions.CompileException(
                "'name' and/or 'import' attributes are required " "for <%namespace>",
                **self.exception_kwargs,
            )
...
class DefTag(Tag):
    ...
    def undeclared_identifiers(self):
        ...
        for c in self.function_decl.defaults:
            res += list(
                ast.PythonCode(c, **self.exception_kwargs).undeclared_identifiers
            )
        return (
            set(res)
            .union(
