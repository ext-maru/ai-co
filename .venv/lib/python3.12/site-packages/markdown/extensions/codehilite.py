...
class CodeHilite:
    ...
    * **Lexer Options**: <https://pygments.org/docs/lexers/>
    ...
    def __init__(self, src: str, **options):
        ...
        self.pygments_formatter: str | Callable = options.pop(
...
class CodeHiliteExtension(Extension):
    ...
    def __init__(self, **kwargs):
        ...
        self.config = {
            "linenums": [
                None,
                "Use lines numbers. True|table|inline=yes, False=no, None=auto. Default: `None`.",
            ],
            ...
            "use_pygments": [
                True,
                "Highlight code blocks with pygments. Disable if using a JavaScript library. Default: `True`.",
            ],
            "lang_prefix": [
                "language-",
            ...
            "pygments_formatter": [
                "html",
                "Use a specific formatter for Pygments highlighting. Default: `html`.",
            ],
        }
