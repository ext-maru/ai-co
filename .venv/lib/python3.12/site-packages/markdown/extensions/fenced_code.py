...
from .attr_list import AttrListExtension, get_attrs_and_remainder
        ...
        while 1:
            ...
            if m:
                ...
                if m.group("attrs"):
                    ...
                    if (
                        remainder
                    ):  # Does not have correctly matching curly braces, so the syntax is invalid.
                        index = m.end(
                            "attrs"
                        )  # Explicitly skip over this, to prevent an infinite loop.
                        continue
