...
from . import inlinepatterns, util
...
class InlineProcessor(Treeprocessor):
    ...
    def __init__(self, md: Markdown):
        ...
        self.__placeholder_length = (
            4 + len(self.__placeholder_prefix) + len(self.__placeholder_suffix)
        )
    ...
    def __processPlaceholders(
        self, data: str | None, parent: etree.Element, isText: bool = True
    ...
    def __applyPattern(
        ...
        if new_style:
            ...
            return (
                "{}{}{}{}".format(
                    leftData, match.group(1), placeholder, match.groups()[-1]
                ),
                True,
                0,
            )

    def __build_ancestors(
    ...
    def _prettifyETree(self, elem: etree.Element) -> None:
        ...
        if self.md.is_block_level(elem.tag) and elem.tag not in ["code", "pre"]:
            if (
                ...
                and len(elem)
                and self.md.is_block_level(elem[0].tag)
            ):
                elem.text = i
            for e in elem:
