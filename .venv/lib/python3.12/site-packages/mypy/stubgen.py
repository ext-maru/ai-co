...
class ASTStubGenerator(BaseStubGenerator, mypy.traverser.TraverserVisitor):
        ...
        for lvalue in o.lvalues:
            ...
            if (
                ...
                if is_explicit_type_alias:
                    self.process_typealias(
                        lvalue, o.rvalue, is_explicit_type_alias=True
                    )
                    continue
    ...
    def is_alias_expression(self, expr: Expression, top_level: bool = True) -> bool:
        ...
        if (
            ...
            and self.get_fullname(expr.callee) in TYPE_VAR_LIKE_NAMES
        ):
            return True
    ...
    def get_assign_initializer(self, rvalue: Expression) -> str:
        ...
        if self.processing_dataclass:
            if isinstance(rvalue, CallExpr):
                ...
                if fullname in (
                    self.dataclass_field_specifier or DATACLASS_FIELD_SPECIFIERS
                ):
                    p = AliasPrinter(self)
