...
class StubgenUtilSuite(unittest.TestCase):
    ...
    @pytest.mark.xfail(
        ...
        reason="Arg and kwarg signature validation not implemented yet",
    )
    def test_infer_sig_from_docstring_args_kwargs_errors(self) -> None:
        ...
        # args after kwargs
        assert_equal(
            infer_sig_from_docstring("func(**kwargs, *args) -> int", "func"), []
        )
    ...
    def test_infer_sig_from_docstring_pos_only_and_keyword_only_arguments_errors(
        self,
    ) -> None:
        # / as first argument
        ...
        assert_equal(
            infer_sig_from_docstring("func(*args, *, kwonly) -> str", "func"), []
        )
...
class StubgencSuite(unittest.TestCase):
    ...
    def test_generate_c_type_none_default(self) -> None:
        ...
        assert_equal(
            output,
            [
                "def test(self, arg0: int = ..., arg1: Incomplete | None = ...) -> None: ..."
            ],
        )
