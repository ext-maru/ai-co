...
class _PyCSimpleType(_CTypeBaseType):
    ...
    def from_param(
        self: type[_typeshed.Self], value: Any, /
    ) -> _typeshed.Self | _CArgObject: ...
    def in_dll(
        self: type[_typeshed.Self], dll: CDLL, name: str, /
    ) -> _typeshed.Self: ...
    if sys.version_info < (3, 13):
...
class Union(_CData, metaclass=_UnionType):
    _fields_: ClassVar[
        Sequence[tuple[str, type[_CDataType]] | tuple[str, type[_CDataType], int]]
    ]
    _pack_: ClassVar[int]
...
def alignment(
    obj_or_type: _CData | _CDataType | type[_CData | _CDataType], /
) -> int: ...
def get_errno() -> int: ...
