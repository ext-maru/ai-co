...
class Distribution:
    ...
    def __init__(
        self, attrs: MutableMapping[str, Incomplete] | None = None
    ) -> None: ...
    ...
    @overload
    def get_command_obj(
        self, command: Literal["bdist"], create: Literal[1, True] = 1
    ) -> bdist: ...
    @overload
    def get_command_obj(
    ...
    @overload
    def get_command_obj(
        self, command: Literal["build"], create: Literal[1, True] = 1
    ) -> build: ...
    @overload
    def get_command_obj(
    ...
    @overload
    def get_command_obj(
        self, command: Literal["check"], create: Literal[1, True] = 1
    ) -> check: ...
    @overload
    def get_command_obj(
        self, command: Literal["clean"], create: Literal[1, True] = 1
    ) -> clean: ...
    @overload
    def get_command_obj(
    ...
    @overload
    def get_command_obj(
        self, command: Literal["sdist"], create: Literal[1, True] = 1
    ) -> sdist: ...
    @overload
    def get_command_obj(
    ...
    @overload
    def get_command_obj(
        self, command: str, create: Literal[1, True] = 1
    ) -> Command: ...
    # Not replicating the overloads for "Command | None", user may use "isinstance"
    @overload
    def get_command_obj(
        self, command: str, create: Literal[0, False]
    ) -> Command | None: ...
    @overload
    ...
    def get_command_class(
        self, command: Literal["build_scripts"]
    ) -> type[build_scripts]: ...
    @overload
    ...
    @overload
    def get_command_class(
        self, command: Literal["install_data"]
    ) -> type[install_data]: ...
    @overload
    def get_command_class(
        self, command: Literal["install_egg_info"]
    ) -> type[install_egg_info]: ...
    @overload
    def get_command_class(
        self, command: Literal["install_headers"]
    ) -> type[install_headers]: ...
    @overload
    def get_command_class(
        self, command: Literal["install_lib"]
    ) -> type[install_lib]: ...
    @overload
    def get_command_class(
        self, command: Literal["install_scripts"]
