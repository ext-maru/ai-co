...
def dist(
    p: Iterable[_SupportsFloatOrIndex], q: Iterable[_SupportsFloatOrIndex], /
) -> float: ...
...
if sys.version_info >= (3, 12):
    def nextafter(
        ...
        y: _SupportsFloatOrIndex,
        /,
        *,
        steps: SupportsIndex | None = None,
    ) -> float: ...
...
_SupportsProdNoDefaultT = TypeVar(
    "_SupportsProdNoDefaultT", bound=_SupportsProdWithNoDefaultGiven
)
