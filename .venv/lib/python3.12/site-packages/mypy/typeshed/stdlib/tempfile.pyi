...
class _TemporaryFileWrapper(IO[AnyStr]):
    ...
    if sys.version_info >= (3, 12):
        ...
        def __init__(
            self, file: IO[AnyStr], name: str, delete: bool = True
        ) -> None: ...
    ...
    @overload
    def writelines(
        self: _TemporaryFileWrapper[bytes], lines: Iterable[ReadableBuffer]
    ) -> None: ...
    @overload
...
class SpooledTemporaryFile(IO[AnyStr], _SpooledTemporaryFileBase):
    ...
    def writelines(
        self: SpooledTemporaryFile[str], iterable: Iterable[str]
    ) -> None: ...
    @overload
    def writelines(
...
def mktemp(
    suffix: str = "", prefix: str = "tmp", dir: StrPath | None = None
) -> str: ...
