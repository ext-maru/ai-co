...
class WeakValueDictionary(MutableMapping[_KT, _VT]):
    ...
    @overload
    def update(
        self, other: SupportsKeysAndGetItem[_KT, _VT], /, **kwargs: _VT
    ) -> None: ...
    @overload
...
class WeakKeyDictionary(MutableMapping[_KT, _VT]):
    ...
    @overload
    def update(
        self, dict: SupportsKeysAndGetItem[_KT, _VT], /, **kwargs: _VT
    ) -> None: ...
    @overload
...
class finalize(Generic[_P, _T]):
    ...
    def detach(
        self,
    ) -> tuple[_T, Callable[_P, Any], tuple[Any, ...], dict[str, Any]] | None: ...
    def peek(
        self,
    ) -> tuple[_T, Callable[_P, Any], tuple[Any, ...], dict[str, Any]] | None: ...
    @property
