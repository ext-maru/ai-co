...
class Element(Generic[_Tag]):
    ...
    tail: str | None
    def __init__(
        self, tag: _Tag, attrib: dict[str, str] = {}, **extra: str
    ) -> None: ...
    ...
    def makeelement(
        self, tag: _OtherTag, attrib: dict[str, str], /
    ) -> Element[_OtherTag]: ...
    ...
    def __copy__(
        ...
        _Tag
    ]: ...  # returns the type of self in Python impl, but not in C impl
...
class ElementTree(Generic[_Root]):
    def __init__(
        self, element: Element | None = None, file: _FileRead | None = None
    ) -> None: ...
...
if sys.version_info >= (3, 9):
    def indent(
        tree: Element | ElementTree[Any], space: str = "  ", level: int = 0
    ) -> None: ...

def parse(
    source: _FileRead, parser: XMLParser[Any] | None = None
) -> ElementTree[Element]: ...
...
class XMLPullParser(Generic[_E]):
    def __init__(
        ...
        events: Sequence[str] | None = None,
        *,
        _parser: XMLParser[_E] | None = None,
    ) -> None: ...
...
class XMLParser(Generic[_E]):
    ...
    version: str
    def __init__(
        self, *, target: _Target | None = None, encoding: str | None = None
    ) -> None: ...
    def close(self) -> _E: ...
    def feed(self, data: str | ReadableBuffer, /) -> None: ...
    def flush(self) -> None: ...
