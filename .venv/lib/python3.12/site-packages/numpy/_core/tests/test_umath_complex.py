...
class TestComplexAbsoluteMixedDTypes:
    ...
    def test_array(self, stride, astype, func):
        ...
        vec = np.array([
                (0, 0., 0, -31.666483, 200, 0., 0.,  1.      ,  3.0 + 4.0.j  ,  613090),   # noqa: E203,E501
                (1, 0., 0, 260.91525 ,  42, 0., 0.,  1.      ,  5.0 + 12.0.j ,  787315),   # noqa: E203,E501
                (1, 0., 0,  52.15155 ,  42, 0., 0.,  1.      ,  8.0 + 15.0.j ,  806641),   # noqa: E203,E501
                (1, 0., 0,  52.430195,  42, 0., 0.,  1.      ,  7.0 + 24.0.j , 1363540),   # noqa: E203,E501
                (2, 0., 0, 304.43646 ,  58, 0., 0.,  1.      ,  20.0 + 21.0.j,  787323),   # noqa: E203,E501
                (3, 0., 0, 299.42108 ,  52, 0., 0.,  1.      ,  12.0 + 35.0.j,  787332),   # noqa: E203,E501
                (4, 0., 0,  39.4836  ,  28, 0., 0.,  9.182192,  9.0 + 40.0.j ,  787304),   # noqa: E203,E501
                (4, 0., 0,  76.83787 ,  28, 0., 0.,  1.      ,  28.0 + 45.0.j, 1321869),   # noqa: E203,E501
                (5, 0., 0, 143.26366 ,  24, 0., 0., 10.996129,  11.0 + 60.0.j,  787299)],  # noqa: E203,E501
            dtype=dtype)
