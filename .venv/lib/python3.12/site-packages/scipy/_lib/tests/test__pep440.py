...
def test_dev_version():
    ...
    for ver in ['1.9.0', '1.9.0.a1', '1.9.0.b2', '1.9.0.b2.dev+ffffffff', '1.9.0.dev1']:
...
def test_dev_a_b_rc_mixed():
    assert Version('1.9.0.a2.dev+f16acvda') == Version('1.9.0.a2.dev+f16acvda')
    assert Version('1.9.0.a2.dev+6acvda54') < Version('1.9.0.a2')


def test_dev0_version():
    assert Version('1.9.0.dev0+Unknown') < Version('1.9.0')
    for ver in ['1.9.0', '1.9.0.a1', '1.9.0.b2', '1.9.0.b2.dev0+ffffffff']:
...
def test_dev0_a_b_rc_mixed():
    assert Version('1.9.0.a2.dev0+f16acvda') == Version('1.9.0.a2.dev0+f16acvda')
    assert Version('1.9.0.a2.dev0+6acvda54') < Version('1.9.0.a2')
