...
class AICompanyProjectScope:
        ...
        for worker_file in workers_dir.glob("*_worker.py"):
            try:
                ...
                workers[worker_file.stem] = {
                    "type": worker_type_match.group(1) if worker_type_match else "unknown",
    ...
    def _analyze_knowledge_base(self):
        ...
        if kb_dir.exists():
            ...
            if evolution.exists():
                kb_info["evolution_snapshots"] = len(list(evolution.glob("snapshot_*.json")))
...
"""
    ...
    def run_full_analysis(self):
        ...
        print(f"Knowledge Docs: {analysis['ai_company']['knowledge_base']['total_documents']}")
