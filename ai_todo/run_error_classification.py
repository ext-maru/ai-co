...
def main():
    ...
    output_data = {
        ...
        "improvement_recommendations": [
            f"最多の{sorted_categories[0][0]}エラー対策を優先実施" if sorted_categories else "エラーパターンの詳細分析が必要",
            "エラー予防システムの実装",
            "定期的なエラー分析の自動化"
        ]
    }
    
    output_file = Path("/home/aicompany/ai_co/ai_todo/error_classification_results.json")
    ...
    # 分類器の統計エクスポート
    classifier.export_results("/home/aicompany/ai_co/ai_todo/classified_errors_export.json")
