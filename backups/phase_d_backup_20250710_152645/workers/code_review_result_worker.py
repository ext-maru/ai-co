...
class CodeReviewResultWorker(AsyncBaseWorkerV2):
    ...
    async def process_message(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.elder_integration_enabled:
            message["elder_metadata"] = {
                ...
                "elder_rank": ElderRank.ELDER_SERVANT.value if ElderRank else "elder_servant",
    ...
    async def _escalate_to_elder_council(self, issue: Dict[str, Any]):
        ...
        try:
            if self.elder_council_summoner:
                ...
                self.logger.info(f"🏛️ Issue escalated to Elder Council: {issue['issue_type']}")
        except Exception as e:
    ...
    async def _consult_four_sages(self, consultation_type: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """Four Sages への知恵の相談"""
    ...
    async def _generate_review_result(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Four Sages 知恵の相談
        sages_wisdom = await self._consult_four_sages("rag", {
