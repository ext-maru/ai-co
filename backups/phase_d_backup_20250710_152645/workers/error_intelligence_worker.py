...
class ErrorIntelligenceWorker:
    ...
    def __init__(self):
        ...
        logger.info(
            f"ErrorIntelligenceWorker initialized as Elder Tree error specialist"
        )
    ...
    def _check_error_patterns_with_rag(
    ...
    def _determine_error_severity(
        self, task: Dict[str, Any], pattern_match: Optional[List]
    ) -> str:
        ...
        if any(
            keyword in error_message or keyword in error_type
