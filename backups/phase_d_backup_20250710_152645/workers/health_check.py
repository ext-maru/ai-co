...
def test_critical_integrations():
    ...
    print(f'Critical integrations success rate: {successful_imports}/{len(critical_integrations)} ({success_rate:.1f}%)')
...
async def test_async_capabilities():
    ...
    from libs.elder_tree_hierarchy import ElderTreeHierarchy, ElderMessage, ElderRank
