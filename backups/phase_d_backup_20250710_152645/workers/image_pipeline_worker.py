...
class ImageProcessingWorker(BaseWorker, CommunicationMixin):
    ...
    def process_message(self, ch, method, properties, body):
        ...
        try:
            ...
            if self.elder_systems_initialized:
                self._report_processing_success_to_task_sage(task, output_size, operations)
    ...
    def _report_processing_success_to_task_sage(self, task: Dict[str, Any], output_size: int, operations: List[Dict]):
    ...
    def _report_processing_error_to_incident_sage(self, task: Dict[str, Any], error: Exception):
        ...
        try:
            ...
            self.logger.error(f"Failed to report processing error to Incident Sage: {e}")
    ...
    def get_elder_image_status(self) -> Dict[str, Any]:
        ...
        status = {
            ...
            'status': 'healthy' if self.elder_systems_initialized and PIL_AVAILABLE else 'degraded'
        }
