...
class AIVersionCommand(BaseCommand):
    ...
    def setup_arguments(self):
        ...
        self.parser.add_argument("--check-update", action="store_true", help="更新確認")
    ...
    def execute(self, args) -> CommandResult:
        ...
        if args.json:
            return CommandResult(
                success=True, message=json.dumps(version_info, indent=2)
            )
...
"""
        ...
        self.console.print(
            Panel(info_text.strip(), title="📦 バージョン情報", border_style="blue")
        )
