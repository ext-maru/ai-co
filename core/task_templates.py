...
class TemplateParameter:
    ...
    def __init__(self, name: str, param_type: str = None, type: str = None,
                 description: str = "", default: Any = None, 
                 required: bool = True, choices: Optional[List[Any]] = None,
...
class TaskTemplateManager:
        ...
        builtin_templates = [
            {
                ...
                'parameters': [
                    TemplateParameter('date', param_type='date', description='Report date', 
                                    default='today').to_dict()
                ]
            },
            {
                ...
                'parameters': [
                    TemplateParameter('file_path', param_type='string', description='Path to file',
            ...
            },
            {
                ...
                'parameters': [
                    TemplateParameter('language', param_type='string', description='Programming language',
                                    choices=['python', 'javascript', 'go'],
                                    default='python').to_dict(),
                    TemplateParameter('base_url', param_type='string', description='API base URL',
                                    required=True).to_dict(),
                    TemplateParameter('auth_type', param_type='string', description='Authentication type',
                                    choices=['none', 'api_key', 'oauth2'],
                                    default='api_key').to_dict(),
                    TemplateParameter('endpoints', param_type='list', description='API endpoints',
                                    default=[]).to_dict()
                ]
            },
            {
                ...
                'parameters': [
                    TemplateParameter('data_source', param_type='string', description='Data source path',
                                    required=True).to_dict(),
                    TemplateParameter('output_format', param_type='string', description='Output format',
                                    choices=['markdown', 'html', 'pdf'],
                                    default='markdown').to_dict()
                ]
            }
        ]
    ...
    def create_template(self, name: str, task_type: str, 
                       template_data: Dict[str, Any],
                       parameters: List[Dict[str, Any]],
                       description: str = "",
                       tags: Optional[List[str]] = None) -> TaskTemplate:
        """テンプレートを作成"""
        template = TaskTemplate(
