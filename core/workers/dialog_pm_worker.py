...
class DialogPMWorker:
    ...
    def process_worker_response(self, ch, method, properties, body):
        ...
        try:
            ...
            if status == "need_info":
                ...
                self.conversation_manager.request_user_input(conversation_id, question)
    ...
    def process_user_input(self, ch, method, properties, body):
        ...
        try:
            ...
            # 会話に記録
            self.conversation_manager.add_user_response(conversation_id, user_response)
    ...
    def start(self):
        ...
        self.channel.basic_consume(
            queue="user_input_queue", on_message_callback=self.process_user_input
        )
