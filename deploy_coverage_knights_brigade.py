...
'''
                    ...
                    if class_end != -1:
                        ...
                        if next_class == -1:
                            ...
                            # 次のクラスの前に挿入
                            content = content[:next_class] + method_code + content[next_class:]
                ...
                for mark in marks_to_add:
                    if f'{mark}:' not in content:
                        ...
                        if insert_pos != -1:
                            ...
                            content = content[:next_line] + marker_line + content[next_line:]
                            updated = True
...
'''
        ...
        # 報告書保存
        report_file = self.project_root / 'knowledge_base' / 'COVERAGE_KNIGHTS_WEEK2_REPORT.md'
        ...
        print(f"📊 カバレッジ: {self.battle_report['coverage_before']:.1f}% → {self.battle_report['coverage_after']:.1f}%")
