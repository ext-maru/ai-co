# 🧹 AI Company クリーンアップガイド v1.0

## 📋 概要

AI Companyプロジェクトの定期的なクリーンアップ手順と、不要ファイルの判断基準をまとめたガイドです。プロジェクトの見通しを良くし、開発効率を向上させるための重要なメンテナンス作業です。
...
**🧹 このガイドに従って、AI Companyプロジェクトを常にクリーンに保ちましょう**