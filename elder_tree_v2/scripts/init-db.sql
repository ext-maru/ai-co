...
-- Grant permissions
GRANT ALL PRIVILEGES ON SCHEMA elder_tree TO elder_tree;
GRANT ALL PRIVILEGES ON SCHEMA knowledge TO elder_tree;
GRANT ALL PRIVILEGES ON SCHEMA task TO elder_tree;
GRANT ALL PRIVILEGES ON SCHEMA incident TO elder_tree;
GRANT ALL PRIVILEGES ON SCHEMA rag TO elder_tree;
...
-- Set search path
ALTER DATABASE elder_tree_db SET search_path TO elder_tree, knowledge, task, incident, rag, public;
