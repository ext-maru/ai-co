...
**監査日時**: 2025-07-23T02:46:15.784147  
**対象ファイル数**: 1987  
**スキャン完了数**: 1987
...
| カテゴリ | 件数 | 重要度 |
|---------|------|--------|
| 品質違反 | 7698 | Critical: 103, High: 241 |
...
**syntax_error**
- ファイル: `libs/knowledge_integration_mapper.py:0`
- メッセージ: Syntax error in file
- 提案: Fix syntax errors before proceeding


**syntax_error**
- ファイル: `libs/enhanced_quality_standards.py:0`
- メッセージ: Syntax error in file
- 提案: Fix syntax errors before proceeding
...
- 🔧 241個の高複雑度関数をリファクタリングしてください
- 💳 1928時間分の技術負債があります。計画的な返済を推奨
- 📝 2070個の関数にドキュメント文字列を追加してください
...
| 違反タイプ | 件数 |
|-----------|------|
| missing_docstring | 2070 |
| line_too_long | 1932 |
| insufficient_comments | 1798 |
| deep_nesting | 907 |
| file_too_long | 543 |
| high_complexity | 241 |
