...
class PredictionIntent(Enum):
    ...
    @classmethod
    def from_string(cls, text: str) -> 'PredictionIntent':
...
class PredictionResult:
    """Result of a prediction magic operation"""
    prediction_type: str
...
class RiskAssessor:
    """Component for risk assessment and uncertainty quantification"""
...
class CapacityPlanner:
    """Component for capacity planning and resource prediction"""
    
    def plan_capacity(self, data: Dict[str, Any]) -> Dict[str, Any]:
...
class AnomalyDetector:
    """Component for anomaly and outlier detection"""
    
    def detect_anomalies(self, data: Union[List, np.ndarray], method: str = 'auto') -> Dict[str, Any]:
...
class PredictionMagic:
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        """Get the capabilities of this magic"""
        return {
            'name': self.name,
