...
**監査日時**: 2025-07-23T02:40:31.493696  
**対象ファイル数**: 1985  
**スキャン完了数**: 1985
...
| カテゴリ | 件数 | 重要度 |
|---------|------|--------|
| 品質違反 | 7936 | Critical: 89, High: 254 |
...
**syntax_error**
- ファイル: `commands/ai_commit_auto.py:0`
...
- 🔧 254個の高複雑度関数をリファクタリングしてください
- 💳 2032時間分の技術負債があります。計画的な返済を推奨
- 📝 2163個の関数にドキュメント文字列を追加してください
...
| 違反タイプ | 件数 |
|-----------|------|
| missing_docstring | 2163 |
| line_too_long | 2059 |
| insufficient_comments | 1796 |
| deep_nesting | 923 |
| file_too_long | 546 |
| high_complexity | 254 |
| too_many_parameters | 106 |
| syntax_error | 89 |
