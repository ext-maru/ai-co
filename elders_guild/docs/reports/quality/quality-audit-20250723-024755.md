...
**監査日時**: 2025-07-23T02:47:55.685661  
**対象ファイル数**: 1989  
**スキャン完了数**: 1989
...
| カテゴリ | 件数 | 重要度 |
|---------|------|--------|
| 品質違反 | 7718 | Critical: 101, High: 243 |
...
**syntax_error**
- ファイル: `commands/ai_nwo_library_update.py:0`
- メッセージ: Syntax error in file
- 提案: Fix syntax errors before proceeding


**syntax_error**
- ファイル: `libs/comprehensive_grimoire_migration.py:0`
- メッセージ: Syntax error in file
- 提案: Fix syntax errors before proceeding


**syntax_error**
- ファイル: `libs/grand_elder_process.py:0`
- メッセージ: Syntax error in file
- 提案: Fix syntax errors before proceeding


**syntax_error**
- ファイル: `libs/elder_flow_servant_executor_real.py:0`
- メッセージ: Syntax error in file
- 提案: Fix syntax errors before proceeding


**syntax_error**
- ファイル: `libs/knowledge_index_optimizer.py:0`
- メッセージ: Syntax error in file
- 提案: Fix syntax errors before proceeding
...
- 🔧 243個の高複雑度関数をリファクタリングしてください
- 💳 1944時間分の技術負債があります。計画的な返済を推奨
- 📝 2076個の関数にドキュメント文字列を追加してください
...
| 違反タイプ | 件数 |
|-----------|------|
| missing_docstring | 2076 |
| line_too_long | 1932 |
| insufficient_comments | 1800 |
| deep_nesting | 919 |
| file_too_long | 543 |
| high_complexity | 243 |
