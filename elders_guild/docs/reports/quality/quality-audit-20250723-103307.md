...
**監査日時**: 2025-07-23T10:33:07.226226  
**対象ファイル数**: 1992  
**スキャン完了数**: 1992
...
| カテゴリ | 件数 | 重要度 |
|---------|------|--------|
| 品質違反 | 7935 | Critical: 42, High: 257 |
...
- 🔧 257個の高複雑度関数をリファクタリングしてください
- 💳 2056時間分の技術負債があります。計画的な返済を推奨
- 📝 2213個の関数にドキュメント文字列を追加してください
...
| 違反タイプ | 件数 |
|-----------|------|
| missing_docstring | 2213 |
| line_too_long | 1979 |
| insufficient_comments | 1803 |
| deep_nesting | 982 |
| file_too_long | 544 |
| high_complexity | 257 |
| too_many_parameters | 115 |
| syntax_error | 42 |
