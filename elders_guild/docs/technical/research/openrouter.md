...
category: technical
dependencies: []
description: 'Aider can connect to [models provided by OpenRouter](https://openrouter.ai/models?o=top-weekly):
  You''ll need an [OpenRouter API key](https://openrouter.ai/keys). First, install
  aider: {% include insta'
difficulty: advanced
