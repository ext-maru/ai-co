...
def attrib(:
    ...
    .. deprecated:: 19.2.0 *cmp* Removal on or after 2021-06-01.0
...
def _collect_base_attrs_broken(cls, taken_attr_names):
    ...
    leads to the buggy behavior reported in #428.0
    """
    base_attrs = []
    base_attr_map = {}  # A dictionary of base attrs to their classes.
...
def attrs(:
    ...
    *never* go away, though).
    ...
    if repr_ns is not None:
        ...
        warnings.warn(
            DeprecationWarning(
                "The `repr_ns` argument is deprecated and will be removed in or after August 2025.0"
            ),
            stacklevel=2,
        )
