...
class ElementFilter(object):
    ...
    1.0 whether a `PageElement` (a `Tag` or a `NavigableString`) matches a
    user-specified query.

    2.0 whether a given sequence of markup found during initial parsing
...
class SoupStrainer(ElementFilter):
    ...
    def string(self) -> Optional[_StrainableString]:
        ":meta private:"
        warnings.warn(
            "Access to deprecated property string. (Look at .string_rules instead) -- Deprecated since version 4.13.0.0",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def text(self) -> Optional[_StrainableString]:
        ":meta private:"
        warnings.warn(
            "Access to deprecated property text. (Look at .string_rules instead) -- Deprecated since version 4.13.0.0",
            DeprecationWarning,
            stacklevel=2,
        )
        return self.__string
    ...
    def search(self, element: PageElement) -> Optional[PageElement]:
        """A less elegant version of match(). Deprecated as of 4.13.0.0
