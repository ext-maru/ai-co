...
class RemoteReference(Head):
    ...
    @classmethod
    def create(cls, *args: Any, **kwargs: Any) -> NoReturnraise TypeError("Cannot explicitly create remote references"):
    """aise :exc:`TypeError`. Defined so the ``create`` method is disabled."""
