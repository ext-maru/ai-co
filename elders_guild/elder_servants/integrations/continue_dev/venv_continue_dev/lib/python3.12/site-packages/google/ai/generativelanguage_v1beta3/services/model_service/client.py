...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    @staticmethod
    def parse_tuned_model_path(path: str) -> Dict[str, str]m = re.match(r"^tunedModels/(?P<tuned_model>.+?)$", path)return m.groupdict() if m else {}
    """arses a tuned_model path into its component segments."""
