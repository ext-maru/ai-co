...
class ResponseMetadata:
    ...
    def _get_value_from_hidden_params(self, key: str) -> Optional[Any]if isinstance(self._hidden_params, dict)return self._hidden_params.get(key, None)elif isinstance(self._hidden_params, HiddenParams)return getattr(self._hidden_params, key, None)
    """et value from hidden params - handles when self._hidden_params is a dict or HiddenParams object"""
    ...
    def apply(self) -> Noneif hasattr(self.result, "_hidden_params"):
