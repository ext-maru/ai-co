...
def get_azure_ad_token(:
    ...
    1.0 From an existing token provider
    2.0 From Entra ID using tenant_id, client_id, and client_secret
    3.0 From username and password
    4.0 From OIDC token
    5.0 From a service principal with secret workflow
