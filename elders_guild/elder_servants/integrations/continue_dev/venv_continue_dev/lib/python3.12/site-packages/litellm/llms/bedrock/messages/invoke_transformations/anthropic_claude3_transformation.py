...
class AmazonAnthropicClaude3MessagesConfig(:
    ...
    def transform_anthropic_messages_request(:
        ...
        # 1.0 anthropic_version is required for all claude models
        ...
        # 2.0 `stream` is not allowed in request body for bedrock invoke
        if "stream" in anthropic_messages_request:
            anthropic_messages_request.pop("stream", None)

        # 3.0 `model` is not allowed in request body for bedrock invoke
