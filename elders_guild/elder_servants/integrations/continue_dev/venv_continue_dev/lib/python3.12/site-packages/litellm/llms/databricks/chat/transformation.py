        ...
        try:
            ...
            for choice in chunk["choices"]:
                ...
                if tool_calls and self.json_mode:
                    # 1.0 Check if the function name is set and == RESPONSE_FORMAT_TOOL_NAME
                    # 2.0 If no function name, just args -> check last function name (saved via state variable)
                    # 3.0 Convert args to json
                    # 4.0 Convert json to message
                    # 5.0 Set content to message.content
                    # 6.0 Set tool_calls to None
                    from litellm.constants import RESPONSE_FORMAT_TOOL_NAME
