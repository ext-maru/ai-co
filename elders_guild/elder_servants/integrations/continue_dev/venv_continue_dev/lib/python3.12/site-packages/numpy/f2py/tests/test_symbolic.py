...
class TestSymbolic(util.F2PyTest):
    ...
    def test_fromstring(self):
        ...
        assert fromstring("123.0 _4") == as_number(123.0, 4)
        assert fromstring("123.0 _8") == as_number(123.0, 8)
        assert fromstring("123.0 e0") == as_number(123.0, 4)
        assert fromstring("123.0 d0") == as_number(123.0, 8)
        ...
        assert fromstring("123.0 _myrealkind") == as_number(123.0, "myrealkind")
