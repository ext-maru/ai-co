...
class TestFFT1D:
    ...
    def test_fft2(self):
        ...
        assert_allclose(np.fft.fft2(x) / (30.0 * 20.0),
    ...
    def test_ifft2(self):
        ...
        assert_allclose(np.fft.ifft2(x) * (30.0 * 20.0),
    ...
    def test_fftn(self):
        ...
        assert_allclose(np.fft.fftn(x) / (30.0 * 20.0 * 10.0),
    ...
    def test_ifftn(self):
        ...
        assert_allclose(np.fft.ifftn(x) * (30.0 * 20.0 * 10.0),
    ...
    def test_rfft2(self):
        ...
        assert_allclose(np.fft.rfft2(x) / (30.0 * 20.0),
    ...
    def test_rfftn(self):
        ...
        assert_allclose(np.fft.rfftn(x) / (30.0 * 20.0 * 10.0),
    ...
    def test_hfft(self):
        ...
        assert_allclose(np.fft.hfft(x_herm) / 30.0,
