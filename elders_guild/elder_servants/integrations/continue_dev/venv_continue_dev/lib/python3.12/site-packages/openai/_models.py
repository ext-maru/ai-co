...
class BaseModel(pydantic.BaseModel):
    ...
    def to_dict(:
        ...
        *,
        ...
        Args:
            ...
            warnings: Whether to log warnings when invalid fields are encountered. This is only supported in Pydantic v2.0
        """
    ...
    def to_json(:
        ...
        *,
        ...
        Args:
            ...
            warnings: Whether to show any warnings that occurred during serialization. This is only supported in Pydantic v2.0
        """
    ...
    # Based on https://github.com/samuelcolvin/pydantic/issues/1168#issuecomment-817742836.0
    @classmethod
    @override
...
def is_basemodel(type_: type) -> boolif is_union(type_)for variant in get_args(type_)if is_basemodel(variant):
...
def validate_type(*, type_: type[_T], value: object) -> _Tif inspect.isclass(type_) and issubclass(type_, pydantic.BaseModel)return cast(_T, parse_obj(type_, value)):
    """trict validation that the given value matches the expected type"""
...
def set_pydantic_config(typ: Any, config: pydantic.ConfigDict) -> None:
    ...
    Note: this is a no-op on Pydantic v1.0
    """
