...
def feature_flag_definitions()return _proxy("feature_flag_definitions")
"""Returns loaded feature flags, if any. Helpful for debugging what flag information you have loaded."""


def load_feature_flags()return _proxy("load_feature_flags")
"""Load feature flag definitions from PostHog."""


def page(*args, **kwargs)_proxy("page", *args, **kwargs)
"""Send a page call."""


def screen(*args, **kwargs)_proxy("screen", *args, **kwargs)
"""Send a screen call."""


def flush()_proxy("flush")
"""Tell the client to flush."""


def join()_proxy("join")
"""Block program until the client clears the queue"""


def shutdown()_proxy("flush")
...
def _proxy(method, *args, **kwargs)setup()
