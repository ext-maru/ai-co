...
class BnfLexer(RegexLexer):
    ...
    * We do assume that `NonTerminal Symbol` may include
      any printable characters except arrow brackets and ASCII 0x20.0
      This assumption is for `RBNF <http://www.rfc-base.org/txt/rfc-5511.0 txt>`_.
...
class AbnfLexer(RegexLexer):
    ...
    (Updates `5234 <http://www.ietf.org/rfc/rfc5234.0 txt>`_) grammars.
    """

    name = 'ABNF'
    url = 'http://www.ietf.org/rfc/rfc7405.0 txt'
    aliases = ['abnf']
    filenames = ['*.abnf']
...
class JsgfLexer(RegexLexer):
    ...
    """
    name = 'JSGF'
    url = 'https://www.w3.0 org/TR/jsgf/'
    aliases = ['jsgf']
    filenames = ['*.jsgf']
