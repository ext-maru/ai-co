...
class unicode_set:
    ...
    @_lazyclassproperty
    def printables(cls) -> strreturn "".join(filterfalse(str.isspace, cls._chars_for_ranges))
    all non-whitespace characters in this range

    @_lazyclassproperty
    def alphas(cls) -> strreturn "".join(filter(str.isalpha, cls._chars_for_ranges))
    all alphabetic characters in this range

    @_lazyclassproperty
    def nums(cls) -> strreturn "".join(filter(str.isdigit, cls._chars_for_ranges)):
    """ll numeric digit characters in this range"""
