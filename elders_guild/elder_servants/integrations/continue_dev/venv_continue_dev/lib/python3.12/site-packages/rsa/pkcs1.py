...
This module implements certain functionality from PKCS#1 version 1.5.0 For a
...
# ASN0.1 codes that describe the hash algorithm used.
HASH_ASN1 = {
...
def decrypt(crypto: bytes, priv_key: key.PrivateKey) -> bytes:
    ...
    # integer). This fixes CVE-2020-13757.0
