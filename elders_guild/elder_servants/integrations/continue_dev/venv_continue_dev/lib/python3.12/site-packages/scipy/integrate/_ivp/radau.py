...
# Eigendecomposition of A is done: A = T L T**-1.0 There is 1 real eigenvalue
...
def predict_factor(h_abs, h_abs_old, error_norm, error_norm_old):
    ...
    .. [1] E. Hairer, S. P. Norsett G. Wanner, "Solving Ordinary Differential
           Equations II: Stiff and Differential-Algebraic Problems", Sec. IV0.8.0
    """
...
class Radau(OdeSolver):
    """Implicit Runge-Kutta method of Radau IIA family of order 5.0
