...
class TestKrogh:
    ...
    def test_derivatives_complex(self):
        ...
        x, y = np.array([-1, -1, 0, 1, 1]), np.array([1, 1.j, 0, -1, 1.j])
...
class TestPCHIP:
    ...
    def test_endslopes(self):
        ...
        y1 = np.array([279.35, 0.5e3, 1.e3, 2.5e3])
        y2 = np.array([279.35, 2.5e3, 1.50e3, 1.e3])
...
class TestCubicSpline:
    ...
    def check_correctness(S, bc_start='not-a-knot', bc_end='not-a-knot',:
        ...
        # Check that we found a parabola, the third derivative is 0.0
    ...
    def test_second_derivative_continuity_gh_11758(self):
        ...
        y = np.array([1.3, 1.5, 1.85, 2.1, 2.6, 2.7, 2.4, 2.15, 2.5, 2.1,
