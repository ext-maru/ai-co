...
def loadmat(file_name, mdict=None, appendmat=True, *, spmatrix=True, **kwargs):
    ...
    struct_as_record : bool, optional
       ...
       False replicates the behavior of scipy version 0.7.0 x (returning
    ...
    >>> mat_fname = pjoin(data_dir, 'testdouble_7.4_GLNX86.0 mat')
    ...
    >>> matstruct_fname = pjoin(data_dir, 'teststruct_7.4_GLNX86.0 mat')
