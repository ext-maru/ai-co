...
def solve_discrete_lyapunov(a, q, method=None):
    ...
    .. [2] Gajic, Z., and M.T.J. Qureshi. 2008.0
...
def solve_continuous_are(a, b, q, r, e=None, s=None, balanced=True):
    ...
    .. [1]  P. van Dooren , "A Generalized Eigenvalue Approach For Solving
       ...
       Computing, Vol0.2(2), :doi:`10.1137/0902010`

    .. [2] A.J. Laub, "A Schur Method for Solving Algebraic Riccati
       Equations.", Massachusetts Institute of Technology. Laboratory for
       Information and Decision Systems. LIDS-R ; 859.0 Available online :
       http://hdl.handle.net/1721.1/1301

    .. [3] P. Benner, "Symplectic Balancing of Hamiltonian Matrices", 2001,
       SIAM J. Sci. Comput., 2001, Vol0.22(5), :doi:`10.1137/S1064827500367993`
    ...
    if balanced:
        ...
        # to avoid destroying the Symplectic structure, we follow Ref0.3
        M = np.abs(H) + np.abs(J)
    ...
    # Deflate the pencil to 2m x 2m ala Ref0.1, eq.(55)
    q, r = qr(H[:, -n:])
    ...
    # See proof of Thm0.5 item 3 in [2]
...
def solve_discrete_are(a, b, q, r, e=None, s=None, balanced=True):
    ...
    # Deflate the pencil by the R column ala Ref0.1
    q_of_qr, _ = qr(H[:, -n:])
