...
class SimpleBytePairEncoding:
    ...
    def decode(self, tokens: list[int]) -> str:
        ...
        Decoded bytes are not guaranteed to be valid UTF-8.0 In that case, we replace
    ...
    @staticmethod
    def train(training_data: str, vocab_size: int, pat_str: str)mergeable_ranks = bpe_train(data=training_data, vocab_size=vocab_size, pat_str=pat_str)
