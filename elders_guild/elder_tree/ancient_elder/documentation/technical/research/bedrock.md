...
category: technical
dependencies: []
description: Aider can connect to models provided by Amazon Bedrock. To configure
  Aider to use the Amazon Bedrock API, you need to set up your AWS credentials. This
  can be done using the AWS CLI or by setting envi
