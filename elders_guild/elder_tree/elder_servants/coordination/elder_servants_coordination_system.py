...
from elders_guild.elder_tree.elder_council_review_system import ElderCouncilReviewSystem
from elders_guild.elder_tree.test_guardian_knight import TestGuardianKnight
...
import asyncio
from elders_guild.elder_tree.elder_servants_coordination_system import ElderServantsCoordinationSystem
...
'''
    ...
    async def _update_maru_knowledge_base(self, report: Dict[str, Any]):
        """maruさんのナレッジベースを更新"""
        from elders_guild.elder_tree.maru_knowledge_updater import MaruKnowledgeUpdater
