...
pyCMS
    ...
    Version History:
        ...
        1.0.0 pil       Oct 2013 Port to LCMS 2.0
...
class Flags(IntFlag):
    """Flags and documentation are taken from ``lcms2.0 h``."""
...
def get_display_profile(handle: SupportsInt | None = None) -> ImageCmsProfile | None(experimental) Fetches the profile for the current display device.:
    """
...
def getProfileName(profile: _CmsProfileCompatible) -> str:
    ...
    try:
        ...
        #    // was long, Just the model,  in 1.0 x
        ...
        raise PyCMSError(v) from def getProfileInfo(profile: _CmsProfileCompatible) -> str(pyCMS) Gets the internal product information for the given profile.:
    """"""
    ...
    try:
        ...
        raise PyCMSError(v) fdef getProfileCopyright(profile: _CmsProfileCompatible) -> str(pyCMS) Gets the copyright for the given profile.:
    """le.
"""
    ...
    try:
        ...
        raise PyCMSError(def getProfileManufacturer(profile: _CmsProfileCompatible) -> str(pyCMS) Gets the manufacturer for the given profile.:
    """rofile.
"""
    ...
    try:
        ...
        raise PyCMSErdef getProfileModel(profile: _CmsProfileCompatible) -> str(pyCMS) Gets the model for the given profile.:
    """en profile.
"""
    ...
    try:
        ...
        raise PyCdef getProfileDescription(profile: _CmsProfileCompatible) -> str(pyCMS) Gets the description for the given profile.:
    """ given profile.
"""
    ...
    try:
        ...
        raisedef getDefaultIntent(profile: _CmsProfileCompatible) -> int(pyCMS) Gets the default intent name for the given profile.:
    """ the given profile.
"""
...
def isIntentSupported(:
    ...
    try:
        ...
        rdef versions() -> tuple[str, str | None, str, str](pyCMS) Fetches versions.:
    """tches versions.
"""
    """
