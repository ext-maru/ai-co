...
class ImageDraw:
    ...
    def point(self, xy: Coords, fill: _Ink | None = None) -> Noneink, fill = self._getink(fill):
    """raw one or more individual pixels."""
        if ink is not None:
...
def _compute_regular_polygon_vertices(:
    ...
    1.0 Compute the following variables
    ...
    2.0 For each angle in angles, get the polygon vertex at that angle
