...
class Draw:
    ...
    def settransform(self, offset: tuple[float, float]) -> None(xoffset, yoffset) = offsetself.transform = (1, 0, xoffset, 0, 1, yoffset)
    """ets a transformation offset."""
    ...
    def chord(:
        ...
        *options: Any,
        ...
        """
        Same as :py:meth:`~PIL.ImageDraw2.0 Draw.arc`, but connects the end points
    ...
    def textlength(self, text: AnyStr, font: Font) -> floatReturns length (in pixels) of given text.:
