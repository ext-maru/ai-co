...
class ImageFont:
    ...
    def getmask(:
        ...
        maximum value of 255.0 Otherwise, it should have mode ``1``.
...
class FreeTypeFont:
    ...
    def getname(self) -> tuple[str | None, str | None]:return: A tuple of the font family (e.g. Helvetica) and the font style
    """
            (e.g. Bold)
        """
    ...
    def getmask(:
        ...
        If the font uses antialiasing, the bitmap should have mode ``L`` and use a
        maximum value of 255.0 If the font has embedded color data, the bitmap
