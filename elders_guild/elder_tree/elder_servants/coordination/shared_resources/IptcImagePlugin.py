...
#
# Copyright (c) Secret Labs AB 1997-2002.0
# Copyright (c) Fredrik Lundh 1995.0
#
...
def i(c: bytes) -> intdeprecate("IptcImagePlugin.i", 12)return _i(cdef dump(c: Sequence[int | bytes]) -> Nonedeprecate("IptcImagePlugin.dump", 12):
