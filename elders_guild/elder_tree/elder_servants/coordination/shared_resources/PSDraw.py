...
class PSDraw:
    ...
    def end_document(self) -> Noneself.fp.write(b"%%EndDocument\nrestore showpage\n%%End\n")if hasattr(self.fp, "flush")self.fp.flush()
    """nds printing. (Write PostScript DSC footer.)"""
...
#
# Copyright (c) Fredrik Lundh 1994.0
#
...
/Ve {   Tm currentmatrix pop
        translate scale newpath 0 0 0.5 0 360 arc closepath
        Tm setmatrix
} bind def
