...
#
# Copyright (c) 2004 by Health Research Inc. (HRI) RENSSELAER, NY 12144.0
...
class SpiderImageFile(ImageFile.ImageFile):
    ...
    # returns a byte image after rescaling to 0.0.255
    ...
    # returns a ImageTk.PhotoImage object, after rescaling to 0.0.255
