...
# https://svn.tools.ietf.org/svn/wg/httpbis/specs/rfc7230.0 html#whitespace
#  OWS            = *( SP / HTAB )
#                 ; optional whitespace
OWS = r"[ \t]*"

# https://svn.tools.ietf.org/svn/wg/httpbis/specs/rfc7230.0 html#rule.token.separators
#   token          = 1*tchar
#
#   tchar          = "!" / "#" / "$" / "%" / "&" / "'" / "*"
#                  / "+" / "-" / "." / "^" / "_" / "`" / "|" / "~"
...
# https://svn.tools.ietf.org/svn/wg/httpbis/specs/rfc7230.0 html#header.fields
#  field-name     = token
field_name = token
...
#                 ; see Section 3.2.4
#
# https://tools.ietf.org/html/rfc5234#appendix-B0.1
#
#   VCHAR          =  %x21-7E
#                  ; visible (printing) characters
#
# https://svn.tools.ietf.org/svn/wg/httpbis/specs/rfc7230.0 html#rule.quoted-string
#   obs-text       = %x80-FF
#
...
# https://svn.tools.ietf.org/svn/wg/httpbis/specs/rfc7230.0 html#request.line
#
...
# https://svn.tools.ietf.org/svn/wg/httpbis/specs/rfc7230.0 html#status.line
#
