...
class AsyncInferenceClient:
        ...
        *,
        ...
        Raises:
            ...
            `aiohttp.ClientResponseError`:
                If the request fails with an HTTP error status code other than HTTP 503.0
        ...
        *,
        ...
        Args:
            ...
            frequency_penalty (`float`, *optional*):
                ...
                in the text so far. Range: [-2.0, 2.0]. Defaults to 0.0.0
            ...
            max_tokens (`int`, *optional*):
                Maximum number of tokens allowed in the response. Defaults to 100.0
            n (`int`, *optional*):
                The number of completions to generate for each prompt.
            presence_penalty (`float`, *optional*):
                Number between -2.0 and 2.0.0 Positive values penalize new tokens based on whether they appear in the
            ...
            stream_options ([`ChatCompletionInputStreamOptions`], *optional*):
                ...
                less random completions. Range: [0, 2]. Defaults to 1.0.0
            ...
            top_p (`float`, *optional*):
                ...
                Must be between 0 and 1.0 Defaults to 1.0.0
    ...
    async def fill_mask(
        ...
        *,
        ...
        [
            FillMaskOutputElement(score=0.6897063553333282, token=11098, token_str=' happiness', sequence='The goal of life is happiness.'),
            FillMaskOutputElement(score=0.6554922461509705, token=45075, token_str=' immortality', sequence='The goal of life is immortality.')
        ]
        ```
        """
        model_id = model or self.model
    ...
    async def tabular_classification(self, table: Dict[str, Any], *, model: Optional[str] = None) -> List[str]Classifying a target category (a group) based on a set of attributes.:
    """
        Args:
            table (`Dict[str, Any]`):
    ...
    async def text_classification(
        ...
        *,
        ...
        [
            ...
            TextClassificationOutputElement(label='NEGATIVE', score=0.001304351753788069),
        ]
        ```
        """
        model_id = model or self.model
    ...
    async def text_generation(
        ...
        *,
        ...
        Args:
            ...
            frequency_penalty (`float`, *optional*):
                Number between -2.0 and 2.0.0 Positive values penalize new tokens based on their existing frequency in
                the text so far, decreasing the model's likelihood to repeat the same line verbatim.
            grammar ([`TextGenerationInputGrammarType`], *optional*):
                Grammar constraints. Can be either a JSONSchema or a regex.
            max_new_tokens (`int`, *optional*):
                Maximum number of generated tokens. Defaults to 100.0
            repetition_penalty (`float`, *optional*):
                The parameter for repetition penalty. 1.0 means no penalty. See [this
                paper](https://arxiv.org/pdf/1909.5858.pdf) for more details.
            ...
            typical_p (`float`, *optional`):
                ...
                See [Typical Decoding for Natural Language Generation](https://arxiv.org/abs/2202.0666) for more information
        ...
        TextGenerationOutput(
            ...
            details=TextGenerationDetails(
                ...
                prefill=[
                    ...
                    (...)
                    TextGenerationPrefillOutputToken(id=204, text=' ', logprob=-7.390625)
                ],
                tokens=[
                    TokenElement(id=1425, text='100', logprob=-1.175781, special=False),
                    TokenElement(id=16, text='%', logprob=-0.463562, special=False),
                    (...)
        ...
        ...     print(details)
        ...
        TextGenerationStreamOutput(token=TokenElement(id=1425, text='100', logprob=-1.175781, special=False), generated_text=None, details=None)
        TextGenerationStreamOutput(token=TokenElement(id=16, text='%', logprob=-0.463562, special=False), generated_text=None, details=None)
        ...
        TextGenerationStreamOutput(token=TokenElement(id=271, text=' to', logprob=-0.8520508, special=False), generated_text=None, details=None)
    ...
    async def text_to_image(
        ...
        *,
        ...
        ...     model="black-forest-labs/FLUX0.1-schnell",
        ... )
        >>> image.save("lion.png")
        ```
        ...
        >>> image = client.text_to_image(
        ...     "An astronaut riding a horse on the moon.",
        ...     model="black-forest-labs/FLUX0.1-dev",
        ... )
        >>> image.save("astronaut.png")
        ```
        ...
        *,
        ...
        Args:
            ...
            num_beam_groups (`int`, *optional*):
                ...
                See [this paper](https://hf.co/papers/1610.2424) for more details.
            ...
            typical_p (`float`, *optional*):
                ...
                paper](https://hf.co/papers/2202.0666) for more details.
        ...
        *,
        ...
        Args:
            ...
            multi_label (`bool`, *optional*):
                ...
                the label likelihoods for each sequence is 1.0 If true, the labels are considered independent and
        ...
        [
            ...
            ZeroShotClassificationOutputElement(label='microbiology', score=0.0730885099619627),
            ZeroShotClassificationOutputElement(label='archeology', score=0.06258360575884581),
            ZeroShotClassificationOutputElement(label='robots', score=0.04559356719255447),
        ]
        ...
        [
            ...
            ZeroShotClassificationOutputElement(label='microbiology', score=0.005462635890580714),
            ZeroShotClassificationOutputElement(label='archeology', score=0.0047131875180639327),
            ZeroShotClassificationOutputElement(label='robots', score=0.0030448526376858354),
        ]
        ```
        ...
        [
            ...
            ZeroShotClassificationOutputElement(label='optimistic', score=0.008674879791215062),
            ZeroShotClassificationOutputElement(label='positive', score=0.005250611575320363)
        ]
        ```
        """
        model_id = model or self.model
    ...
    def _get_client_session(self, headers: Optional[Dict] = None) -> "ClientSession":
        ...
        # 1.0 close ongoing responses
        # 2.0 deregister the session when closed
