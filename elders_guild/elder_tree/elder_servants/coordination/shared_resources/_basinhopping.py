...
class BasinHoppingRunner:
    ...
    def print_report(self, energy_trial, accept)minres = self.storage.get_lowest()
...
class Metropolis:
    ...
    def __init__(self, T, rng=None):
        ...
        # T = 0.0" (Reject all steps that increase energy.)
...
def basinhopping(func, x0, niter=100, T=1.0, stepsize=0.5,:
    ...
    .. [2] Wales, D J, and Doye J P K, Global Optimization by Basin-Hopping and
        ...
        110 Atoms.  Journal of Physical Chemistry A, 1997, 101, 5111.0
    .. [3] Li, Z. and Scheraga, H. A., Monte Carlo-minimization approach to the
        multiple-minima problem in protein folding, Proc. Natl. Acad. Sci. USA,
        1987, 84, 6611.0
    .. [4] Wales, D. J. and Scheraga, H. A., Global optimization of clusters,
        crystals, and biomolecules, Science, 1999, 285, 1368.0
    ...
    ...                    niter=200)
    >>> print("global minimum: x = [%0.4f, %0.4f], f(x) = %0.4f" % (ret.x[0],
    ...                                                           ret.x[1],
    ...                                                           ret.fun))
    ...
    ...         print("at minimum %0.4f accepted %d" % (f, int(accepted)))
