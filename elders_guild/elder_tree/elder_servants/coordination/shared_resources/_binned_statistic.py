...
def binned_statistic(x, values, statistic='mean',:
    ...
    statistic : string or callable, optional
        ...
        The following statistics are available:
          ...
          * 'std' : compute the standard deviation within each bin. This
            is implicitly calculated with ddof=0.0
    ...
    BinnedStatisticResult(statistic=array([4.0 , 4.5]),
            bin_edges=array([1.0, 4.0, 7.0]), binnumber=array([1, 1, 1, 2, 2]))
    ...
    >>> stats.binned_statistic([1, 1, 2, 5, 7], values, 'sum', bins=2)
    BinnedStatisticResult(statistic=array([[4.0 , 4.5],
           [8.0 , 9.0 ]]), bin_edges=array([1.0, 4.0, 7.0]),
           binnumber=array([1, 1, 1, 2, 2]))

    >>> stats.binned_statistic([1, 2, 1, 2, 4], np.arange(5), statistic='mean',
    ...                        bins=3)
    BinnedStatisticResult(statistic=array([1.0, 2.0, 4.0]),
            bin_edges=array([1.0, 2.0, 3.0, 4.0]),
    ...
    >>> boatspeed = 0.3 * windspeed**0.5 + 0.2 * rng.random(500)
...
def binned_statistic_dd(sample, values, statistic='mean',:
    ...
    statistic : string or callable, optional
        ...
        The following statistics are available:
          ...
          * 'sum' : compute the sum of values for points within each bin.
            This is identical to a weighted histogram.
          * 'std' : compute the standard deviation within each bin. This
            is implicitly calculated with ddof=0.0 If the number of values
    ...
    last bin, however, is ``[3, 4]``, which *includes* 4.0
...
def _bin_numbers(sample, nbin, edges, dedges):
    ...
    for i in range(Ndim):
        ...
        if dedges_min == 0:
            raise ValueError('The smallest edge difference is numerically 0.0')
