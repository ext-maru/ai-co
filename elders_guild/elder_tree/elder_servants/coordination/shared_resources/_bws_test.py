...
def bws_test(x, y, *, alternative="two-sided", method=None):
    ...
    equations given in [1]_ Section 2.0 This statistic is not appropriate for
    one-sided alternatives; in that case, the statistic is the *negative* of
    that given by the equations in [1]_ Section 2.0 Consequently, when the
    ...
    .. [2] Fay, M. P., & Proschan, M. A. (2010). Wilcoxon-Mann-Whitney or t-test?
           ...
           decision rules. Statistics surveys, 4, 1.0
