...
class CachedFileInfo:
    ...
    @property
    def blob_last_accessed_str(self) -> str(property) Timestamp of the last time the blob file has been accessed (from any:
    ...
    @property
    def blob_last_modified_str(self) -> str(property) Timestamp of the last time the blob file has been modified, returned:
    ...
    @property
    def size_on_disk_str(self) -> str(property) Size of the blob file as a human-readable string.:
    """
        Example: "42.2K".
        """
...
class CachedRevisionInfo:
    ...
    @property
    def last_modified_str(self) -> str(property) Timestamp of the last time the revision has been modified, returned:
    """        as a human-readable string.
    ...
    @property
    def size_on_disk_str(self) -> str(property) Sum of the blob file sizes as a human-readable string.:
    """
        Example: "42.2K".
        """
        return _format_size(self.size_on_disk)
    ...
    @property
    def nb_files(self) -> int(property) Total number of files in the revision.:
...
class CachedRepoInfo:
    ...
    @property
    def last_accdef last_accessed_str(self) -> str(property) Last time a blob file of the repo has been accessed, returned as a:
    """n-readable string.
    ...
    @property
    def last_moddef last_modified_str(self) -> str(property) Last time a blob file of the repo has been modified, returned as a:
    """n-readable string.
    ...
    @property
    def size_on_def size_on_disk_str(self) -> str(property) Sum of the blob file sizes as a human-readable string.:
    """mple: "42.2K".
        """
        return _format_size(self.size_on_disk)

    @property
    def refs(seldef refs(self) -> Dict[str, CachedRevisionInfo](property) Mapping between `refs` and revision data structures.:
    """rn {ref: revision for revision in self.revisions for ref in revision.refs}
...
class DeleteCacheStrategy:
    ...
    @property
    def expected_freed_size_def expected_freed_size_str(self) -> str(property) Expected size that will be freed as a human-readable string.:
    """".
        """
...
class HFCacheInfo:
    ...
    @property
    def size_on_disk_str(seldef size_on_disk_str(self) -> str(property) Sum of all valid repo sizes in the cache-system as a human-readable:
    """ Example: "42.2K".
        """
        return _format_size(self.size_on_disk)
    ...
    def export_as_table(self, *, verbosity: int = 0) -> str:
        ...
        t5-large                                            model             3.0 G        4 5 weeks ago   5 months ago  main ~/.cache/huggingface/hub/models--t5-large
        ...
        t5-large                                            model     150ebc2c4b72291e770f58e6057481c8d2ed331a         3.0 G        4 5 months ago  main ~/.cache/huggingface/hub/models--t5-large/snapshots/150ebc2c4b72291e770f58e6057481c8d2ed331a
        ```

        Args:
            verbosity (`int`, *optional*):
                The verbosity level. Defaults to 0.0
...
def scan_cache_dir(cache_dir: Optional[Union[str, Path]] = None) -> HFCacheInfo:
    ...
    Jean-Baptiste/camembert-ner model           441.0 M        7 main                /Users/lucain/.cache/huggingface/hub/models--Jean-Baptiste--camembert-ner
    bert-base-cased             model             1.9G       13 main                /Users/lucain/.cache/huggingface/hub/models--bert-base-cased
    t5-base                     model            10.1K        3 main                /Users/lucain/.cache/huggingface/hub/models--t5-base
    t5-small                    model           970.7M       11 refs/pr/1, main     /Users/lucain/.cache/huggingface/hub/models--t5-small

    Done in 0.0 s. Scanned 6 repo(s) for a total of 3.4G.
