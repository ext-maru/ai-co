...
def _chandrupatla(func, a, b, *, args=(), xatol=None, xrtol=None,:
    ...
    root that makes the element 0.0 This function allows for `a`, `b`, and the
...
def _chandrupatla_minimize(func, x1, x2, x3, *, args=(), xatol=None,:
    ...
    q0 = xp_copy(x3)  # "At the start, q0 is set at x3.0.." ([1] after (7))
    ...
    def pre_func_eval(work):
        ...
        # [1] Section 3.0 "The quadratic minimum point Q1 is calculated using
