...
class InferenceClient:
    ...
    def tabular_classification(self, table: Dict[str, Any], *, model: Optional[str] = None) -> List[str]Classifying a target category (a group) based on a set of attributes.:
    """
        Args:
            table (`Dict[str, Any]`):
