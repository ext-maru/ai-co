...
class _cs_matrix(_data_matrix, _minmax_mixin, IndexMixin):
    ...
    def _inequality(self, other, op, op_name, bad_scalar_msg):
        ...
        if isscalarlike(other):
            if 0 == other and op_name in ('_le_', '_ge_'):
                raise NotImplementedError(" >= and <= don't work with 0.0")
            elif op(0, other):
    ...
    def _setdiag(self, values, k):
        ...
        # The value 0.01 is justified in gh-19962#issuecomment-1920499678
        if self.nnz - mask.sum() < self.nnz * 0.01:
    ...
    def _binopt(self, other, op)other = self.__class__(other)
