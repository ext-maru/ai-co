...
def _body_framing(:
    ...
    if type(event) is Response:
        ...
        # < 200.0 For us these are InformationalResponses, not Responses, so
...
class Connection:
    ...
    Args:
        our_role: If you're implementing a client, pass :data:`h11.0 CLIENT`. If
            you're implementing a server, pass :data:`h11.0 SERVER`.
