...
def chatterjeexi(x, y, *, axis=0, y_continuous=False, method='asymptotic'):
    ...
    if one of the variables is a function of the other." See [1]_ Remark 1.0:

    References
    ----------
    .. [1] Chatterjee, Sourav. "A new coefficient of correlation." Journal of
           the American Statistical Association 116.536 (2021): 2009-2022.0
