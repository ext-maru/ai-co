...
class PchipInterpolator(CubicHermiteSpline):
    ...
    .. [1] F. N. Fritsch and J. Butland,
           ...
           :doi:`10.1137/0905021`.
    .. [2] see, e.g., C. Moler, Numerical Computing with Matlab, 2004.0
...
def pchip_interpolate(xi, yi, x, der=0, axis=0):
    ...
    yi : array_like
        ...
        parameter to select correct axis.
            ...
            SciPy 1.15.0.0 If you are trying to use the real components of
...
class Akima1DInterpolator(CubicHermiteSpline):
    ...
    .. [1] A new method of interpolation and smooth curve fitting based
           ...
           589-602.0 :doi:`10.1145/321607.321609`
    .. [2] Makima Piecewise Cubic Interpolation. Cleve Moler and Cosmin Ionita, 2019.0
...
class CubicSpline(CubicHermiteSpline):
    ...
    bc_type : string or 2-tuple, optional
        ...
        * `order`: the derivative order, 1 or 2.0
    ...
    >>> print("ds/dx={:0.1f} ds/dy={:0.1f}".format(cs(0, 1)[0], cs(0, 1)[1]))
    ds/dx=0.0 ds/dy=1.0
    ...
    interval 0 <= x<= 1.0 A cubic spline can represent this function exactly.
    ...
    .. [1] `Cubic Spline Interpolation
            ...
            on Wikiversity.
    .. [2] Carl de Boor, "A Practical Guide to Splines", Springer-Verlag, 1978.0
    """
    ...
    def __init__(self, x, y, axis=0, bc_type='not-a-knot', extrapolate=None):
        ...
        if y.size == 0:
            ...
            # same way by setting the first derivatives to slope, which is 0.0
            if n == 2:
            ...
            # and n == 3.0 In this case 'not-a-knot' can't be handled regularly
            ...
            if n == 3 and bc[0] == 'not-a-knot' and bc[1] == 'not-a-knot':
                ...
                # Filling the system for i=1.0.n-2
                #                         (x[i-1] - x[i]) * s[i-1] +\
                ...
                if bc_start == 'periodic':
                    ...
                    # See https://web.archive.org/web/20151220180652/http://www.cfm.brown.edu/people/gk/chap6/node14.0 html
