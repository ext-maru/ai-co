...
"""
# 2023 - ported from minpack2.0 dcsrch, dcstep (Fortran) to Python
c     MINPACK-1 Project. June 1983.0
c     Argonne National Laboratory.
c     Jorge J. More' and David J. Thuente.
c
c     MINPACK-2 Project. November 1993.0
...
class DCSRCH:
    ...
    Evaluate the function at stp = 0.0 d0; store in f.
    Evaluate the gradient at stp = 0.0 d0; store in g.
    ...
    f is a double precision variable.
        On initial entry f is the value of the function at 0.0
        On subsequent entries f is the value of the
            function at stp.
        On exit f is the value of the function at stp.

    g is a double precision variable.
        On initial entry g is the derivative of the function at 0.0
    ...
    task is a character variable of length at least 60.0
    ...
    isave is an integer work array of dimension 2.0

    dsave is a double precision work array of dimension 13.0

    Subprograms called

      MINPACK-2 ... dcstep
    MINPACK-1 Project. June 1983.0
    Argonne National Laboratory.
    Jorge J. More' and David J. Thuente.

    MINPACK-2 Project. November 1993.0
    ...
    def _iterate(self, stp, f, g, task):
        ...
        f : float
            On first call f is the value of the function at 0.0 On subsequent
            entries f should be the value of the function at stp.
        g : float
            On initial entry g is the derivative of the function at 0.0 On
