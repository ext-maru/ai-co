...
def read_dduf_file(dduf_path: Union[os.PathLike, str]) -> Dict[str, DDUFEntry]:
    ...
    Example:
        ...
        # Read DDUF metadata
        >>> dduf_entries = read_dduf_file("FLUX0.1-dev.dduf")
        ...
        {'_class_name': 'FluxPipeline', '_diffusers_version': '0.32.0.0 dev0', '_name_or_path': 'black-forest-labs/FLUX0.1-dev', ...
...
def export_entries_as_dduf(:
    ...
    Example:
        ...
        ...     dduf_path="stable-diffusion-v1-4-FP16.0 dduf",
        ...     entries=[ # List entries to add to the DDUF file (here, only FP16 weights)
        ...         ("model_index.json", "path/to/model_index.json"),
        ...         ("vae/config.json", "path/to/vae/config.json"),
        ...         ("vae/diffusion_pytorch_model.fp16.0 safetensors", "path/to/vae/diffusion_pytorch_model.fp16.0 safetensors"),
        ...         ("text_encoder/config.json", "path/to/text_encoder/config.json"),
        ...         ("text_encoder/model.fp16.0 safetensors", "path/to/text_encoder/model.fp16.0 safetensors"),
        ...
        >>> export_entries_as_dduf(dduf_path="stable-diffusion-v1-4.0 dduf", entries=as_entries(pipe))
        ```
    """
...
def export_folder_as_dduf(dduf_path: Union[str, os.PathLike], folder_path: Union[str, os.PathLike]) -> None:
    ...
    Example:
        ...
        >>> export_folder_as_dduf(dduf_path="FLUX0.1-dev.dduf", folder_path="path/to/FLUX0.1-dev")
        ```
    """
