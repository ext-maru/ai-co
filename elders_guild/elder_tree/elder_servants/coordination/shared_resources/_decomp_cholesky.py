...
def cholesky(a, lower=False, overwrite_a=False, check_finite=True):
    ...
    >>> L
    array([[ 1.0+0.j,  0.0+0.j],
           [ 0.0+2.j,  1.0+0.j]])
    >>> L @ L.T.conj()
    array([[ 1.0+0.j,  0.0-2.j],
           [ 0.0+2.j,  5.0+0.j]])
...
def cho_factor(a, lower=False, overwrite_a=False, check_finite=True):
    ...
    >>> c, low = cho_factor(A)
    >>> c
    array([[3.0        , 1.0        , 0.33333333, 1.66666667],
           [3.0        , 2.44948974, 1.90515869, -0.27216553],
           [1.0        , 5.0        , 2.29330749, 0.8559528 ],
           [5.0        , 1.0        , 2.0        , 1.55418563]])
