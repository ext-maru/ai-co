...
class VisitingDistribution:
    ...
    visiting_param : float
        Parameter for visiting distribution. Default value is 2.62.0
    ...
    def __init__(self, lb, ub, visiting_param, rng_gen):
        ...
        if step < dim:
            ...
            x_visit[np.fabs(
                x_visit - self.lower) < self.MIN_VISIT_BOUND] += 1.0 e-10
        else:
...
def dual_annealing(func, bounds, args=(), maxiter=1000,:
    ...
    maxiter : int, optional
        The maximum number of global search iterations. Default value is 1000.0
    minimizer_kwargs : dict, optional
        ...
        local minima that it is trapped in. Default value is 5230.0 Range is
        (0.01, 5.0 e4].

        is triggered. Default value of the ratio is 2e-5.0 Range is (0, 1).
    visit : float, optional
        Parameter for visiting distribution. Default value is 2.62.0 Higher
