...
def fit(dist, data, bounds=None, *, guess=None, method='mle',:
    ...
    .. [1] Shao, Yongzhao, and Marjorie G. Hahn. "Maximum product of spacings
           ...
           consistency." Illinois Journal of Mathematics 43.3 (1999): 489-499.0
    ...
    value between 0 and 1.0 In such a case - when the domain of the distribution
    ...
    set both the lower and upper bounds on *n* to 6.0 Note, however, that the
...
def goodness_of_fit(dist, data, *, known_params=None, fit_params=None,:
    ...
    *Algorithmic overview*
    ...
    In brief, this routine executes the following steps:
      ...
      1.0 Fit unknown parameters to the given `data`, thereby forming the
         "null-hypothesized" distribution, and compute the statistic of
         this pair of data and distribution.
      2.0 Draw random samples from this null-hypothesized distribution.
      3.0 Fit the unknown parameters to each random sample.
      4.0 Calculate the statistic between each sample and the distribution that
         has been fit to the sample.
      5.0 Compare the value of the statistic corresponding with `data` from (1)
    ...
    *Anti-Pattern*
    ...
    .. [2] W. Stute, W. G. Manteiga, and M. P. Quindimil (1993).
           "Bootstrap based goodness-of-fit-tests." Metrika 40.1: 243-256.0
    .. [3] C. Genest, & B Rémillard. (2008). "Validity of the parametric
           bootstrap for goodness-of-fit testing in semiparametric models."
           Annales de l'IHP Probabilités et statistiques. Vol. 44.0 No. 6.0
    .. [4] I. Kojadinovic and J. Yan (2012). "Goodness-of-fit testing based on
           ...
           parametric bootstrap." Canadian Journal of Statistics 40.3: 480-500.0
    ...
    .. [6] H. W. Lilliefors (1967). "On the Kolmogorov-Smirnov test for
           ...
           statistical Association 62.318: 399-402.0
    .. [7] Filliben, James J. "The probability plot correlation coefficient
           test for normality." Technometrics 17.1 (1975): 111-117.0
