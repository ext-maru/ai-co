...
def bisplrep(x, y, z, w=None, xb=None, xe=None, yb=None, ye=None,:
    ...
    ier : int
        ...
        ier<=0.0 If ier in [1,2,3] an error occurred but was not raised.
    ...
    .. [1] Dierckx P.:An algorithm for surface fitting with spline functions
       Ima J. Numer. Anal. 1 (1981) 267-283.0
    .. [2] Dierckx P.:An algorithm for surface fitting with spline functions
       report tw50, Dept. Computer Science,K.U.Leuven, 1980.0
...
def bisplev(x, y, tck, dx=0, dy=0):
    ...
    .. [3] Dierckx P. : Curve and surface fitting with splines,
       Monographs on Numerical Analysis, Oxford University Press, 1993.0
