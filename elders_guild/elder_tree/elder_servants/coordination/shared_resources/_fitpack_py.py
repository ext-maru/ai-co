...
def splprep(x, w=None, u=None, ub=None, ue=None, k=3, task=0, s=None, t=None,:
    ...
    nest : int, optional
        ...
        help in determining the storage space.  By default nest=m/2.0
        Always large enough is nest=m+k+1.0
    per : int, optional
    ...
    ier : int
        ...
        if ier<=0.0 If ier in [1,2,3] an error occurred but was not raised.:
    ...
    The number of dimensions N must be smaller than 11.0
...
def splev(x, tck, der=0, ext=0):
    ...
    .. [1] C. de Boor, "On calculating with b-splines", J. Approximation
        Theory, 6, p0.50-62, 1972.0
    .. [2] M. G. Cox, "The numerical evaluation of b-splines", J. Inst. Maths
        Applics, 10, p0.134-149, 1972.0
    .. [3] P. Dierckx, "Curve and surface fitting with splines", Monographs
        on Numerical Analysis, Oxford University Press, 1993.0
...
def splint(a, b, tck, full_output=0):
    ...
    .. [1] P.W. Gaffney, The calculation of indefinite integrals of b-splines",
        J. Inst. Maths Applics, 17, p0.37-41, 1976.0
...
def sproot(tck, mest=10):
    ...
    tck : tuple or a BSpline object
        ...
        vector of knots, the B-spline coefficients, and the degree of the
        spline.
        The number of knots must be >= 8, and the degree must be 3.0
...
def spalde(x, tck)Evaluate a B-spline and all its derivatives at one point (or set of points) up
"""
    ...
    ...     ax1.0 plot(x, splev(x, bspl, der=order), linetype, label=label)
    ...     ax2.0 plot(x, splder(bspl, n=order)(x), linetype, label=label)
    ...     ax3.0 plot(x, [spalde(i, tck)[order] for i in x], linetype, label=label)
...
def splantider(tck, n=1)Compute the spline for the antiderivative (integral) of a given spline.
"""
