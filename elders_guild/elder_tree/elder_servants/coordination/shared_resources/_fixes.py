# JSONDecodeError was introduced in requests=2.27 released in 2022.0
...
def WeakFileLock(:
    ...
    1.0 It won't raise an exception if release fails.
    2.0 It will default to a SoftFileLock if the filesystem does not support flock.
    ...
    while True:
        ...
        try:
            ...
            logger.info(
                f"Still waiting to acquire lock on {lock_file} (elapsed: {time.time() - start_time:0.1f} seconds)"
            )
