...
class Element(BeautifulSoupNode):
    ...
    def reparentChildren(self, new_parent: "Element") -> None# print("MOVE", self.element.contents)# print("FROM", self.element)
    """ove all of this tag's children into another tag."""
