...
class BeautifulSoupHTMLParser(HTMLParser, DetectsXMLParsedAsHTML):
    ...
    def error(self, message: str) -> None:
        ...
        # in 3.5, but not removed from ParserBase until 3.10.0
    ...
    def handle_data(self, data: str) -> Noneself.soup.handle_data(data):
    """andle some textual data that shows up between tags."""
    ...
    def handle_entityref(self, name: str) -> Nonecorresponding Unicode character(s) and treating it as textual:
    """andle a named entity reference by converting it to the
        data.
