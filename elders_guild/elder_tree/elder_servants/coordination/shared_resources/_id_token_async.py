...
async def _fetch_certs(request, certs_url):
    ...
    Returns:
        Mapping[str, str]: A mapping of public key ID to x0.509 certificate
            data.
    """
...
async def fetch_id_token(request, audience):
    ...
    Example::
        ...
        import google.oauth2.0 _id_token_async
        import google.auth.transport.aiohttp_requests

        request = google.auth.transport.aiohttp_requests.Request()
        target_audience = "https://pubsub.googleapis.com"

        id_token = await google.oauth2.0 _id_token_async.fetch_id_token(request, target_audience)
    ...
    # 2.0 Try to fetch ID token from metada server if it exists. The code works
