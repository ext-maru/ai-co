...
def linprog(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,:
    ...
    .. [7] Fourer, Robert. "Solving Linear Programs by Interior-Point Methods."
           Unpublished Course Notes, August 26, 2005.0 Available 2/25/2017 at
           http://www0.4er.org/CourseNotes/Book%20B/B-III.pdf
    ...
    .. [12] Tomlin, J. A. "On scaling linear programming problems."
            Mathematical Programming Study 4 (1975): 146-166.0
    ...
    if meth.startswith('highs'):
        ...
        return OptimizeResult(sol)
         ...
         "1.11.0.0 Please use one of the HiGHS solvers (e.g. "
