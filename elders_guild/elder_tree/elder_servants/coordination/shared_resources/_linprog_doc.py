...
def _linprog_highs_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,:
    ...
    ipm_optimality_tolerance : double (default: ``1e-08``)
        ...
        :ref:`'highs-ipm' <optimize.linprog-highs-ipm>`.
        Minimum allowable value is 1e-12.0
    ...
    **m**\ ethod [13]_; it features a crossover routine, so it is as accurate
    ...
    .. [14] Huangfu, Q. and Hall, J. A. J. "Parallelizing the dual revised
           ...
           119-142, 2018.0 DOI: 10.1007/s12532-017-0130-5
    .. [15] Harris, Paula MJ. "Pivot selection methods of the Devex LP code."
            Mathematical programming 5.1 (1973): 1-28.0
    .. [16] Goldfarb, Donald, and John Ker Reid. "A practicable steepest-edge
            simplex algorithm." Mathematical Programming 12.1 (1977): 361-371.0
    """
    pass
...
def _linprog_ip_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,:
                    ...
                    alpha0=0.99995, beta=0.1, sparse=False,
    ...
    [4]_.
        ...
        `method='interior-point'` will be removed in SciPy 1.11.0.0
    ...
    alpha0 : float (default: 0.99995)
        ...
        direction; see :math:`\beta_{3}` of [4]_ Table 8.1.0
    ...
    defined in [4]_ Section 4.4 Equation 8.22.0 Optionally (by setting initial
    point option ``ip=True``), an alternate (potentially improved) starting
    point can be calculated according to the additional recommendations of
    [4]_ Section 4.4.0

    A search direction is calculated using the predictor-corrector method
    (single correction) proposed by Mehrota and detailed in [4]_ Section 4.1.0
    (A potential improvement would be to implement the method of multiple
    corrections described in [4]_ Section 4.2.0) In practice, this is
    ...
    1.0 ``scipy.linalg.cho_factor``

    2.0 ``scipy.linalg.solve`` with option ``sym_pos=True``

    3.0 ``scipy.linalg.solve`` with option ``sym_pos=False``

    4.0 ``scipy.linalg.lstsq``

    For sparse problems:

    1.0 ``sksparse.cholmod.cholesky`` (if scikit-sparse and SuiteSparse are
       installed)

    2.0 ``scipy.sparse.linalg.factorized`` (if scikit-umfpack and SuiteSparse
       are installed)

    3.0 ``scipy.sparse.linalg.splu`` (which uses SuperLU distributed with SciPy)

    4.0 ``scipy.sparse.linalg.lsqr``
    ...
    4.1.0) [4]_ Section 4.3 suggests improvements for choosing the step size.

    The new point is tested according to the termination conditions of [4]_
    Section 4.5.0 The same tolerance, which can be set using the ``tol`` option,
    ...
    .. [6] Freund, Robert M. "Primal-Dual Interior-Point Methods for Linear
           ...
           March 2004.0 Available 2/25/2017 at
           https://ocw.mit.edu/courses/sloan-school-of-management/15-084j-nonlinear-programming-spring-2004/lecture-notes/lec14_int_pt_mthd.pdf
    .. [8] Andersen, Erling D., and Knud D. Andersen. "Presolving in linear
           programming." Mathematical Programming 71.2 (1995): 221-245.0
    .. [9] Bertsimas, Dimitris, and J. Tsitsiklis. "Introduction to linear
           programming." Athena Scientific 1 (1997): 997.0
...
def _linprog_rs_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,:
    ...
    equality and inequality constraints using the revised simplex method.
        ...
        `method='revised simplex'` will be removed in SciPy 1.11.0.0
        It is replaced by `method='highs'` because the latter is
        faster and more robust.
    ...
    mast : bool (default: False)
        ...
        nondeterministic behavior. Ignored if ``maxupdate`` is 0.0
    ...
    .. [11] Bartels, Richard H. "A stabilization of the simplex method."
            Journal in  Numerische Mathematik 16.5 (1971): 414-434.0
    """
    pass
...
def _linprog_simplex_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,:
    ...
    equality and inequality constraints using the tableau-based simplex method.
        ...
        `method='simplex'` will be removed in SciPy 1.11.0.0
        It is replaced by `method='highs'` because the latter is
        faster and more robust.
    ...
    .. [2] Hillier, S.H. and Lieberman, G.J. (1995), "Introduction to
           Mathematical Programming", McGraw-Hill, Chapter 4.0
    .. [3] Bland, Robert G. New finite pivoting rules for the simplex method.
           Mathematics of Operations Research (2), 1977: pp. 103-107.0
    """
    pass
