...
def _has_own_attribute(cls, attrib_name)Check whether *cls* defines *attrib_name* (and doesn't just inherit it).
"""
    """
...
def _transform_attrs(:
    ...
    otherwise use the old -- incorrect -- order.  See #428.0
...
def attrs(:
    ...
    *never* go away, though).
    ...
    #  unsafe_hash takes precedence due to PEP 681.0
