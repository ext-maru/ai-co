...
class _MWU:
    ...
    def pmf(self, k):
        ...
        # In practice, `pmf` is never called with k > m*n/2.0
    ...
    def cdf(self, k):
        ...
        # In practice, `cdf` is never called with k > m*n/2.0
    ...
    def build_u_freqs_array(self, maxu):
        ...
        for u in np.arange(1, maxu + 1):
            ...
            if new_val > uint_max and configurations_is_uint:
                # OK, we got into numbers too big for uint64.0
...
def mannwhitneyu(x, y, use_continuity=True, alternative="two-sided",:
    ...
    alternative : {'two-sided', 'less', 'greater'}, optional
        ...
        * 'greater': the distribution underlying `x` is stochastically greater
        ...
        see [5]_ section 5.1.0
    axis : int, optional
        Axis along which to perform the test. Default is 0.0
    ...
    .. [1] H.B. Mann and D.R. Whitney, "On a test of whether one of two random
           ...
           Mathematical Statistics, Vol. 18, pp. 50-60, 1947.0
    ...
    .. [4] Rosie Shier, "Statistics: 2.3 The Mann-Whitney U Test", Mathematics
           Learning Support Centre, 2004.0
    .. [5] Michael P. Fay and Michael A. Proschan. "Wilcoxon-Mann-Whitney
           ...
           1-39, 2010.0 https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2857732/
