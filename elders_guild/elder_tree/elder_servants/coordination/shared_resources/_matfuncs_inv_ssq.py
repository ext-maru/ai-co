...
def _briggs_helper_function(a, k)Computes r = a^(1 / (2^k)) - 1.0
"""
    ...
    .. [1] Awad H. Al-Mohy (2012)
           ...
           Numerical Algorithms, 59 : 393--402.0
...
def _inverse_squaring_helper(T0, theta):
    ...
    .. [2] Awad H. Al-Mohy and Nicholas J. Higham (2012)
           ...
           SIAM Journal on Scientific Computing, 34 (4). C152-C169.0
           ISSN 1095-7197
    ...
    # is negative with imaginary part 0.0
...
def _remainder_matrix_power_triu(T, t):
    ...
    The fractional power is restricted to fractions -1 < t < 1.0
...
def _remainder_matrix_power(A, t):
    """
    Compute the fractional power of a matrix, for fractions -1 < t < 1.0
...
def _logm_triu(T):
    ...
    theta = (None,
            ...
            1.28e-1, 2.6e-1, 2.88e-1, 3.67e-1,
            4.39e-1, 5.3e-1, 5.60e-1, 6.9e-1,
