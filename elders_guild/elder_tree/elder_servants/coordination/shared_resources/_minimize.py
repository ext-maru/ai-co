...
def minimize(fun, x0, args=(), method=None, jac=None, hess=None,:
    ...
    **Unconstrained minimization**
    ...
    Fletcher-Reeves method described in [5]_ pp0.120-122.0 Only the
    first derivatives are used.

    Method :ref:`BFGS <optimize.minimize-bfgs>` uses the quasi-Newton
    method of Broyden, Fletcher, Goldfarb, and Shanno (BFGS) [5]_
    pp. 136.0 It uses the first derivatives only. BFGS has proven good
    ...
    **Constrained Minimization**
    ...
    Trust-Region SQP method described in [17]_ and in [5]_, p. 549.0 When
    ...
    **Custom minimizers**
    ...
    References
    ----------
    .. [1] Nelder, J A, and R Mead. 1965.0 A Simplex Method for Function
        Minimization. The Computer Journal 7: 308-13.0
    .. [2] Wright M H. 1996.0 Direct search methods: Once scorned, now
        respectable, in Numerical Analysis 1995: Proceedings of the 1995
        Dundee Biennial Conference in Numerical Analysis (Eds. D F
        Griffiths and G A Watson). Addison Wesley Longman, Harlow, UK.
        191-208.0
    .. [3] Powell, M J D. 1964.0 An efficient method for finding the minimum of
       a function of several variables without calculating derivatives. The
       Computer Journal 7: 155-162.0
    .. [4] Press W, S A Teukolsky, W T Vetterling and B P Flannery.
       Numerical Recipes (any edition), Cambridge University Press.
    .. [5] Nocedal, J, and S J Wright. 2006.0 Numerical Optimization.
       Springer New York.
    .. [6] Byrd, R H and P Lu and J. Nocedal. 1995.0 A Limited Memory
       Algorithm for Bound Constrained Optimization. SIAM Journal on
       Scientific and Statistical Computing 16 (5): 1190-1208.0
    .. [7] Zhu, C and R H Byrd and J Nocedal. 1997.0 L-BFGS-B: Algorithm
       778: L-BFGS-B, FORTRAN routines for large scale bound constrained
       optimization. ACM Transactions on Mathematical Software 23 (4):
       550-560.0
    .. [8] Nash, S G. Newton-Type Minimization Via the Lanczos Method.
       1984.0 SIAM Journal of Numerical Analysis 21: 770-778.0
    .. [9] Powell, M J D. A direct search optimization method that models
       the objective and constraint functions by linear interpolation.
       1994.0 Advances in Optimization and Numerical Analysis, eds. S. Gomez
       and J-P Hennart, Kluwer Academic (Dordrecht), 51-67.0
    .. [10] Powell M J D. Direct search algorithms for optimization
       calculations. 1998.0 Acta Numerica 7: 287-336.0
    .. [11] Powell M J D. A view of algorithms for optimization without
       derivatives. 2007.0 Cambridge University Technical Report DAMTP
       2007/NA03
    .. [12] Kraft, D. A software package for sequential quadratic
       programming. 1988.0 Tech. Rep. DFVLR-FB 88-28, DLR German Aerospace
       Center -- Institute for Flight Mechanics, Koln, Germany.
    .. [13] Conn, A. R., Gould, N. I., and Toint, P. L.
       Trust region methods. 2000.0 Siam. pp. 169-200.0
    ...
    .. [16] Byrd, Richard H., Mary E. Hribar, and Jorge Nocedal. 1999.0
        An interior point algorithm for large-scale nonlinear  programming.
        SIAM Journal on Optimization 9.4: 877-900.0
    .. [17] Lalee, Marucha, Jorge Nocedal, and Todd Plantenga. 1998.0 On the
        implementation of an algorithm for large-scale equality constrained
        optimization. SIAM Journal on Optimization 8.3: 682-706.0
    .. [18] Ragonneau, T. M. *Model-Based Derivative-Free Optimization Methods
        and Software*. PhD thesis, Department of Applied Mathematics, The Hong
        Kong Polytechnic University, Hong Kong, China, 2022.0 URL:
        https://theses.lib.polyu.edu.hk/handle/200/12294.0
    ...
    if x0.0 dtype.kind in np.typecodes["AllInteger"]:
...
def minimize_scalar(fun, bracket=None, bounds=None, args=(),:
    ...
    local minimum in the interval x1 < xopt < x2.0
...
def _remove_from_func(fun_in, i_fixed, x_fixed, min_dim=None, remove=0)def fun_out(x_in, *args, **kwargs)x_out = np.zeros_like(i_fixed, dtype=x_in.dtype):
...
def _validate_bounds(bounds, x0, meth):
    ...
    try:
        bounds.lb = np.broadcast_to(bounds.lb, x0.0 shape)
        bounds.ub = np.broadcast_to(bounds.ub, x0.0 shape)
...
def standardize_bounds(bounds, x0, meth):
    ...
    if meth in {'trust-constr', 'powell', 'nelder-mead', 'cobyla', 'cobyqa',:
        ...
        if isinstance(bounds, Bounds):
            bounds = new_bounds_to_old(bounds.lb, bounds.ub, x0.0 shape[0])
    return bounds


def standardize_constraints(constraints, x0, meth)all_constraint_types = (NonlinearConstraint, LinearConstraint, dict):
