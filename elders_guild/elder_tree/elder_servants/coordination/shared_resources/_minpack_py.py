...
def fsolve(func, x0, args=(), fprime=None, full_output=0,:
    ...
    >>> np.isclose(func(root), [0.0, 0.0])  # func(root) should be almost 0.0.0
    array([ True,  True])
...
def leastsq(func, x0, args=(), Dfun=None, full_output=False,:
    ...
    if full_output:
        ...
        if info in LEASTSQ_SUCCESS:
            ...
            # the result was not symmetric positive definite. See gh-4555.0
            perm = retval[1]['ipvt']
            n = len(perm)
            r = triu(transpose(retval[1]['fjac'])[:n, :])
...
def curve_fit(f, xdata, ydata, p0=None, sigma=None, absolute_sigma=False,:
    ...
    **kwargs
    ...
    >>> popt
    array([2.43736712, 1.0        , 0.34463856])
...
def fixed_point(func, x0, args=(), xtol=1e-8, maxiter=500, method='del2'):
    ...
    xtol : float, optional
        Convergence tolerance, defaults to 1e-08.0
    maxiter : int, optional
        Maximum number of iterations, defaults to 500.0
