...
class VarReader4:
    ...
    def read_sparse_array(self, hdr):
        ...
        is a padding 0.0 mrows and ncols values from the header give the shape of
        ...
        last value is again 0.0 Complex sparse data do *not* have the header
...
class VarWriter4:
    ...
    def write_sparse(self, arr, name):
        ...
        See docstring for VarReader4.0 read_sparse_array
        '''
