...
class ModelMetaclass(ABCMeta):
    ...
    if not typing.TYPE_CHECKING:  # pragma: no branch:
        ...
        def __getattr__(self, item: str) -> Anyprivate_attributes = self.__dict__.get('__private_attributes__'):
    """his is necessary to keep attribute access working for class attribute access."""
