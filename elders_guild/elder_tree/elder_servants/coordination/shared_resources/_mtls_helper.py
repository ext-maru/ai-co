...
def get_client_ssl_credentials(:
    ...
    We look for certificates and keys with the following order of priority:
        1.0 Certificate and key specified by certificate_config.json.
               Currently, only X0.509 workload certificates are supported.
        2.0 Certificate and key specified by context aware metadata (i.e. SecureConnect).
    ...
    # 1.0 Check for certificate config json.
    ...
    # 2.0 Check for context aware metadata json
