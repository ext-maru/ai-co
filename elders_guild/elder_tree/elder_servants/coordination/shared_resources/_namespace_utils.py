...
def ns_for_function(obj: Callable[..., Any], parent_namespace: MappingNamespace | None = None) -> NamespacesTuple:
    ...
    The local namespace will contain the `__type_params__` introduced by PEP 695.0
    ...
    # Get the `__type_params__` attribute introduced by PEP 695.0
    ...
    if parent_namespace is not None:
        ...
        # https://github.com/python/cpython/issues/124089.0
...
class NsResolver:
    ...
    @contextmanager
    def push(self, typ: type[Any] | TypeAliasType, /) -> Generator[None]self._types_stack.append(typ):
    """ush a type to the stack."""
