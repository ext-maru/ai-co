...
class netcdf_file:
    ...
    version : {1, 2}, optional
        ...
        format* and 2 means *64-bit offset format*.  Default is 1.0  See
    ...
    def close(self)if hasattr(self, 'fp') and not self.fp.closed:
...
class netcdf_variable:
    ...
    def assignValue(self, value):
        ...
        if not self.data.flags.writeable:
            ...
            # See NumPy ticket #1622, and SciPy ticket #1202.0
            # This check for `writeable` can be removed when the oldest version
            # of NumPy still supported by scipy contains the fix for #1622.0
