...
class RealData(Data):
    ...
    For example, ``wd = 1.0/np.power(`sx`, 2)``.
...
class ODR:
    ...
    taufac : float, optional
        float specifying the initial trust region. The default value is 1.0
        The initial trust region is equal to taufac times the length of the
        first computed Gauss-Newton step. taufac must be less than 1.0
    sstol : float, optional
        ...
        computation on the machine. sstol must be less than 1.0
    ...
    maxit : int, optional
        ...
        defaults to 50.0 For restarts, maxit is the number of additional
        iterations to perform and defaults to 10.0
    ...
    def restart(self, iter=None):
        ...
        ----------
        iter : int, optional
            ODRPACK's default for the number of new iterations is 10.0
