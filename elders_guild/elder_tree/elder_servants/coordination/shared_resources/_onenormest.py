...
def onenormest(A, t=2, itmax=5, compute_v=False, compute_w=False):
    ...
    bound on the norm) correct to within a factor 3.0"
    ...
    .. [1] Nicholas J. Higham and Francoise Tisseur (2000),
           ...
           SIAM J. Matrix Anal. Appl. Vol. 21, No. 4, pp. 1185-1201.0

    .. [2] Awad H. Al-Mohy and Nicholas J. Higham (2009),
           "A new scaling and squaring algorithm for the matrix exponential."
           SIAM J. Matrix Anal. Appl. Vol. 31, No. 3, pp. 970-989.0
    ...
    >>> A = csc_array([[1.0, 0.0, 0.0], [5.0, 8.0, 2.0], [0.0, -1.0, 0.0]], dtype=float)
    >>> A.toarray()
    array([[ 1.0,  0.0,  0.0],
           [ 5.0,  8.0,  2.0],
           [ 0.0, -1.0,  0.0]])
...
def _algorithm_2_2(A, AT, t):
    ...
    its usage in algorithm 2.4.0 This algorithm 2.2 may be easier to test,

    which could have propagated less noticeably to algorithm 2.4.0
