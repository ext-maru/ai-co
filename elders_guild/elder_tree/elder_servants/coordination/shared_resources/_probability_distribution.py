...
class _ProbabilityDistribution(ABC):
    ...
    def kurtosis(self, *, method):
        ...
        3.0
        >>> (X.kurtosis()
        ...  == X.kurtosis(convention='excess') + 3.0
        ...  == X.moment(order=4, kind='standardized'))
        True
    ...
    def logcdf(self, x, y, /, *, method):
        ...
        >>> X.logcdf(0.25)
        -0.287682072451781
        >>> np.allclose(X.logcdf(0.0), np.log(X.cdf(0.0)))
        True
    ...
    def logccdf(self, x, y, /, *, method):
        ...
        >>> X.logccdf(0.25)
        -1.3862943611198906
        >>> np.allclose(X.logccdf(0.0), np.log(X.ccdf(0.0)))
        True
