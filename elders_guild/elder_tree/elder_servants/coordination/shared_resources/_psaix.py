...
def swap_memory()total, free, sin, sout = cext.swap_mem()
...
def cpu_stats()ctx_switches, interrupts, soft_interrupts, syscalls = cext.cpu_stats()
...
def pid_exists(pid)return os.path.exists(os.path.join(get_procfs_path(), str(pid), "psinfo"))
