...
if OPENBSD or NETBSD:
    ...
    def cpu_count_cores():
        ...
        # http://manpages.ubuntu.com/manpages/precise/man4/smp0.4freebsd.html
...
def cpu_stats():
    ...
    if FREEBSD:
        ...
        # Note about intrs: the C extension returns 0.0 intrs
...
if FREEBSD:
    ...
    def cpu_freq():
        ...
        match the frequency of CPU 0.0
        """
        ret = []
...
def disk_partitions(all=False):
    ...
    https://github.com/giampaolo/psutil/issues/906.0
    """
    retlist = []
