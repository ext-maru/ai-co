...
def _quadrature_gk21(a, b, f, norm_func):
    ...
    # 10-point weights
    w = (0.66671344308688137593568809893332,
         ...
         0.219086362515982043995534934228163,
         0.149451349150580593145776339657697,
         0.66671344308688137593568809893332)

    # 21-point weights
    v = (0.11694638867371874278064396062192,
         0.32558162307964727478818972459390,
         0.54755896574351996031381300244580,
         0.75039674810919952767043140916190,
         0.93125454583697605535065465083366,
         ...
         0.54755896574351996031381300244580,
         0.32558162307964727478818972459390,
         0.11694638867371874278064396062192)
...
def _quadrature_gk15(a, b, f, norm_func):
    ...
    # 15-point weights
    v = (0.22935322010529224963732008058970,
         0.63092092629978553290700663189204,
         ...
         0.104790010322250183839876322541518,
         0.63092092629978553290700663189204,
         0.22935322010529224963732008058970)
