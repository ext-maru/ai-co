...
def fixed_quad(func, a, b, args=(), n=5):
    ...
    n : int, optional
        Order of quadrature integration. Default is 5.0
...
def cumulative_trapezoid(y, x=None, dx=1.0, axis=-1, initial=None)Cumulatively integrate y(x) using the composite trapezoidal rule.
"""
...
def simpson(y, x=None, *, dx=1.0, axis=-1)Integrate y(x) using samples along the given axis and the composite
"""
    ...
    if N % 2 == 0:
        ...
        if N == 2:
            ...
            # Cartwright 2017, Equation 8.0 The equation in Cartwright is
...
def _cumulatively_sum_simpson_integrals(:
    ...
    composite Simpson's rule. Assumes the axis of summation is -1.0
    """
...
def cumulative_simpson(y, *, x=None, dx=1.0, axis=-1, initial=None)Cumulatively integrate y(x) using the composite Simpson's 1/3 rule.
r"""
...
def romb(y, dx=1.0, axis=-1, show=False):
    ...
    -0.81576
     4.63862  6.45674
    -1.10581 -3.2062 -3.65245
    -2.57379 -3.6311 -3.6595 -3.5664
...
def newton_cotes(rn, equal=0):
    ...
    ...     print('{:2d}  {:10.9f}  {:0.5e}'.format(N, quad, error))
    ...
     2   2.94395102   9.43951e-02
     4   1.998570732   1.42927e-03
     6   2.00017814   1.78136e-05
     8   1.999999835   1.64725e-07
    10   2.00000001   1.14677e-09
...
def qmc_quad(func, a, b, *, n_estimates=8, n_points=1024, qrng=None,:
    ...
    (0.0018429555666024108, 1.389431116001344e-07)
    ...
    >>> t.interval(0.99)
    (0.001839319802536469, 0.0018465913306683527)

    Indeed, the value reported by `scipy.stats.multivariate_normal` is
    within this range.

    >>> stats.multivariate_normal.cdf(b, mean, cov, lower_limit=a)
    0.0018430867675187443
