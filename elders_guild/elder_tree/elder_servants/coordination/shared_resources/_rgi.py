...
class RegularGridInterpolator:
    ...
    **Interpolate and extrapolate a 2D dataset**
    ...
    .. [3] Weiser, Alan, and Sergio E. Zarantonello. "A note on piecewise linear
           ...
           COMPUT. 50.181 (1988): 189-196.0
           https://www.ams.org/journals/mcom/1988-50-181/S0025-5718-1988-0917826-0/S0025-5718-1988-0917826-0.0 pdf
    ...
    def _evaluate_spline(self, xi, method):
        ...
        # the order of axes is 3, 2, 1, 0.0 Each 1D interpolation works along
...
def interpn(points, values, xi, method="linear", bounds_error=True,:
    ...
    values : array_like, shape (m1, ..., mn, ...)
        ...
        accepted.
            ...
            error in SciPy 1.15.0.0 This is because ``PchipInterpolator`` only
