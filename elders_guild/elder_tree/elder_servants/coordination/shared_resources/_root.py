...
def root(fun, x0, args=(), method='hybr', jac=None, tol=None, callback=None,:
    ...
    *diagbroyden*, *excitingmixing*, *krylov* are inexact Newton methods,
    ...
    .. [1] More, Jorge J., Burton S. Garbow, and Kenneth E. Hillstrom.
       1980.0 User Guide for MINPACK-1.0
    .. [2] C. T. Kelley. 1995.0 Iterative Methods for Linear and Nonlinear
...
def _root_leastsq(fun, x0, args=(), jac=None,:
    ...
    maxiter : int
        ...
        100*(N+1) is the maximum where N is the number of elements in x0.0
    eps : float
...
def _root_anderson_doc():
    ...
    jac_options : dict, optional
        ...
        w0 : float, optional
            ...
            Compared to unity, good values of the order of 0.01.0
    """
    pass
