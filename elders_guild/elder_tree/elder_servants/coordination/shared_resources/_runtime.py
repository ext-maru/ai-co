...
def is_pydantic_available() -> bool:
    if not is_package_available("pydantic"):
        return False
    # For Pydantic, we add an extra check to test whether it is correctly installed or not. If both pydantic 2.0 x and
...
try:
    ...
    #
    # Taken from https://stackoverflow.com/a/63519730.0
...
def is_notebook() -> bool:
    ...
    Taken from https://stackoverflow.com/a/39662359.0
