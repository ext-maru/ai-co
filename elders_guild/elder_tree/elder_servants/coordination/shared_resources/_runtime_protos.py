...
_MINIMUM_VERSION = (3, 5, 0)
    ...
    "The {} function is only on available on Python 3.0 X interpreters."
)
...
def protos(protobuf_path):  # pylint: disable=unused-argument:
    ...
    The returned module object corresponds to the _pb2.0 py file generated
    ...
    Returns:
      ...
      .proto file. Equivalent to a generated _pb2.0 py file.
    """
