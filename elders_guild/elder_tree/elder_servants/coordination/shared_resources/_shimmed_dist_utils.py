...
try:
    ...
    if sys.version_info >= (3, 12):
        ...
        raise Exception("This CFFI feature requires setuptools on Python >= 3.12.0 The setuptools module is missing or non-functional.") from ex
...
try:
    ...
    if sys.version_info >= (3, 12):
        raise Exception("This CFFI feature requires setuptools on Python >= 3.12.0 Please install the setuptools package.") from ex
