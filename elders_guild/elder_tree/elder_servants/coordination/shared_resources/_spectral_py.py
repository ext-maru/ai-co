...
def lombscargle(:
    ...
    *,
    ...
    ValueError
        ...
        shape as each other.
    ValueError
        If any weight is < 0, or the sum of the weights is <= 0.0
    ValueError
    ...
    SS = 1.0 - CC  # trig identity: S^2 = 1 - C^2  Eq0.14
    ...
    a = YC / CC  # Eq. A0.4 and 6, eliminating CS
    b = YS / SS  # Eq. A0.4 and 6, eliminating CS
    # c = Y - a * C - b * S
...
def periodogram(x, fs=1.0, window='boxcar', nfft=None, detrend='constant',:
    ...
    fs : float, optional
        Sampling frequency of the `x` time series. Defaults to 1.0.0
...
def welch(x, fs=1.0, window='hann', nperseg=None, noverlap=None, nfft=None,:
    ...
    .. [1] P. Welch, "The use of the fast Fourier transform for the
           ...
           Electroacoust. vol. 15, pp. 70-73, 1967.0
    .. [2] M.S. Bartlett, "Periodogram Analysis and Continuous Spectra",
           Biometrika, vol. 37, pp. 1-16, 1950.0
...
def spectrogram(x, fs=1.0, window=('tukey', 0.25), nperseg=None, noverlap=None,:
    ...
    window : str or tuple or array_like, optional
        ...
        Defaults to a Tukey window with shape parameter of 0.25.0
    nperseg : int, optional
        Length of each segment. Defaults to None, but if window is str or
        tuple, is set to 256, and if window is array_like, is set to the
        length of the window.
    ...
    .. [1] Oppenheim, Alan V., Ronald W. Schafer, John R. Buck
           "Discrete-Time Signal Processing", Prentice Hall, 1999.0
...
def check_COLA(window, nperseg, noverlap, tol=1e-10):
    ...
    .. [1] Julius O. Smith III, "Spectral Audio Signal Processing", W3K
           Publishing, 2011,ISBN 978-0-9745607-3-1.0
...
def stft(x, fs=1.0, window='hann', nperseg=256, noverlap=None, nfft=None,:
    ...
    window : str or tuple or array_like, optional
        ...
        to a Hann window.
    nperseg : int, optional
        Length of each segment. Defaults to 256.0
    noverlap : int, optional
        Number of points to overlap between segments. If `None`,
...
def istft(Zxx, fs=1.0, window='hann', nperseg=None, noverlap=None, nfft=None,:
    ...
    fs : float, optional
        Sampling frequency of the time series. Defaults to 1.0.0
    window : str or tuple or array_like, optional
        Desired window to use. If `window` is a string or tuple, it is
        passed to `get_window` to generate the window values, which are
        DFT-even by default. See `get_window` for a list of windows and
...
def _triage_segments(window, nperseg, input_length):
    ...
    nperseg : int
        ...
        256.0 If window is array_like, nperseg is set to the length of the
        window.
    """
    # parse window; if array like, then set nperseg = win.shape
