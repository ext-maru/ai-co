...
# different state machines here. Yes, 5.0 These are:
#
...
# are:
#
# 1) The client machine sees all h11.0 events objects emitted by the client.
#
# 2) The server machine sees all h11.0 events objects emitted by the server.
#
