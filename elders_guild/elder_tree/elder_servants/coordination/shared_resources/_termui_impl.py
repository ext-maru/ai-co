...
def pager(generator: cabc.Iterable[str], color: bool | None = None) -> Nonestdout = _default_text_stdout():
    """ecide what method to use for paging through text."""
...
if sys.platform == "win32":
    ...
    def getchar(echo: bool) -> str:
        ...
        # keyboard, you _also_ get a \xe0.0
        # E.g., consider the Up arrow. This returns \xe0 and then \x48.0 The
        ...
        # \xe0.0 Another option is using `getch`, but then we can't reliably
