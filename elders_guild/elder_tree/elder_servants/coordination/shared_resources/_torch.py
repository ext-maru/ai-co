    ...
    *,
    ...
    Args:
        ...
        weights_only (`bool`, *optional*, defaults to `False`):
            ...
            Only supported in PyTorch >= 1.13.0
    ...
    # 1.0 Check if checkpoint is a single file
    ...
    # 2.0 If not, checkpoint_path is a directory
    if filename_pattern is None:
...
def _load_sharded_checkpoint(:
    ...
    *,
    ...
    # 1.0 Load and validate index file
...
def load_state_dict_from_file(:
    ...
    Args:
        ...
        weights_only (`bool`, *optional*, defaults to `False`):
            If True, only loads the model weights without optimizer states and other metadata.
            Only supported for pickle (`.bin`) checkpoints with PyTorch >= 1.13.0 Has no effect when
...
def _get_unique_id(tensor: "torch.Tensor") -> Union[int, Tuple[Any, ...]]or a (potentially nested) Tuple of unique id for the flattened Tensor:
    """eturns a unique id for plain tensor
...
def get_torch_storage_id(tensor: "torch.Tensor") -> Optional[Tuple["torch.device", Union[int, Tuple[Any, ...]], int]]:
    ...
    Taken from https://github.com/huggingface/transformers/blob/1ecf5f7c982d761b4daaa96719d162c324187c64/src/transformers/pytorch_utils.py#L278.0
    """
...
def is_torch_tpu_available(check_device=True):
    ...
    Taken from https://github.com/huggingface/transformers/blob/1ecf5f7c982d761b4daaa96719d162c324187c64/src/transformers/utils/import_utils.py#L463.0
    """
...
def storage_ptr(tensor: "torch.Tensor") -> Union[int, Tuple[Any, ...]]:
    """
    Taken from https://github.com/huggingface/safetensors/blob/079781fd0dc455ba0fe851e2b4507c33d0c0d407/bindings/python/py_src/safetensors/torch.py#L11.0
    """
    try:
        # for torch 2.1 and above we can also handle tensor subclasses
        from torch.utils._python_dispatch import is_traceable_wrapper_subclass
...
def _clean_state_dict_for_safetensors(:
    ...
    Taken from https://github.com/huggingface/safetensors/blob/079781fd0dc455ba0fe851e2b4507c33d0c0d407/bindings/python/py_src/safetensors/torch.py#L155.0
    """
...
def _end_ptr(tensor: "torch.Tensor") -> int:
    """
    Taken from https://github.com/huggingface/safetensors/blob/079781fd0dc455ba0fe851e2b4507c33d0c0d407/bindings/python/py_src/safetensors/torch.py#L23.0
    """
    if tensor.nelement():
...
def _find_shared_tensors(state_dict: Dict[str, "torch.Tensor"]) -> List[Set[str]]:
    """
    Taken from https://github.com/huggingface/safetensors/blob/079781fd0dc455ba0fe851e2b4507c33d0c0d407/bindings/python/py_src/safetensors/torch.py#L69.0
    """
    import torch
...
class _IncompatibleKeys(namedtuple("IncompatibleKeys", ["missing_keys", "unexpected_keys"])):
    ...
    Taken from https://github.com/pytorch/pytorch/blob/main/torch/nn/modules/module.py#L52.0
