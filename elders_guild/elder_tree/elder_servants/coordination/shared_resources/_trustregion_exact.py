...
def estimate_smallest_singular_value(U)value and the correspondent right singular vector in O(n**2) operations.
"""Given upper triangular matrix ``U`` estimate the smallest singular
    ...
    .. [1] Cline, A. K., Moler, C. B., Stewart, G. W., Wilkinson, J. H.
           An estimate for the condition number of a matrix.  1979.0
           SIAM Journal on Numerical Analysis, 16(2), 368-375.0
    """
    ...
    # "Matrix computations". Forth Edition. JHU press. pp. 140-142.0
    for k in range(n):
        wp = (1-p[k]) / U.T[k, k]
        wm = (-1-p[k]) / U.T[k, k]
...
def gershgorin_bounds(H):
    ...
    .. [1] Conn, A. R., Gould, N. I., & Toint, P. L.
           Trust region methods. 2000.0 Siam. pp. 19.0
    """
...
class IterativeSubproblem(BaseQuadraticSubproblem):
    ...
    .. [1] A.R. Conn, N.I. Gould, and P.L. Toint, "Trust region methods",
           Siam, pp. 169-200, 2000.0
    .. [2] J. Nocedal and  S. Wright, "Numerical optimization",
           Springer Science & Business Media. pp. 83-91, 2006.0
    ...
    # As recommended there it value is fixed in 0.01.0
    UPDATE_COEFF = 0.01
    ...
    def __init__(self, x, fun, jac, hess, hessp=None,:
        ...
        # "Matrix computations". Forth Edition. JHU press., p0.165.0
    ...
    def solve(self, tr_radius):
        ...
        while True:
            ...
            if info == 0 and self.jac_mag > self.CLOSE_TO_ZERO:
                ...
                # formula (4.44) p0.87 from ref [2]_.
