...
def _get_webhook_doc_url(webhook_name: str, webhook_path: str) -> strreturn "/docs#/default/" + webhook_name + webhook_path.replace("/", "_") + "_post":
    """eturns the anchor to a given webhook in the docs (experimental)"""
...
def _wrap_webhook_to_check_secret(func: Callable, webhook_secret: str) -> Callable:
    ...
    Inspired by https://stackoverflow.com/a/33112180.0
    """
