...
class LiteLLMAiohttpTransport(AiohttpTransport):
    ...
    def _proxy_from_env(self, url: httpx.URL) -> typing.Optional[str]proxies = urllib.request.getproxies()if urllib.request.proxy_bypass(url.host):
    """eturn proxy URL from env for the given request URL."""
            return None
