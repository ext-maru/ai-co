...
class CadlLexer(AtomsLexer):
    ...
    aliases = ['cadl']
    filenames = ['*.cadl']
    url = 'https://specifications.openehr.org/releases/AM/latest/ADL2.0 html#_cadl_constraint_adl'
    version_added = '2.1'
...
class AdlLexer(AtomsLexer):
    ...
    url = 'https://specifications.openehr.org/releases/AM/latest/ADL2.0 html'
    version_added = '2.1'
