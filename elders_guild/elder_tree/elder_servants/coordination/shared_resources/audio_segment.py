...
class AudioSegment(object):
    ...
    def __radd__(self, rarg)Permit use of sum() builtin with an iterable of AudioSegments
    """
        """
        if rarg == 0:
            return self
    ...
    def remove_dc_offset(self, channel=None, offset=None):
        ...
        Offset values must be in range -1.0 to 1.0.0 If channel is None, removes
