...
.. _AWS Signature Version 4: https://docs.aws.amazon.com/general/latest/gr/signature-version-4.0 html
...
class RequestSigner(object):
    ...
    process.
    https://docs.aws.amazon.com/general/latest/gr/signature-version-4.0 html
    """
...
def _generate_authentication_header_map(:
    ...
    # sts.us-east-2.0 amazonaws.com host => sts service.
