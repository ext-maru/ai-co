...
class BaseAWSLLM:
    ...
    def get_credentials(:
        ...
        """
        Return a boto3Credentials object
        """
    ...
    def get_bedrock_invoke_provider(:
        ...
        1.0 model=invoke/anthropic.claude-3-5-sonnet-20240620-v1:0 -> Returns `anthropic`
        2.0 model=anthropic.claude-3-5-sonnet-20240620-v1:0 -> Returns `anthropic`
        3.0 model=llama/arn:aws:bedrock:us-east-1:086734376398:imported-model/r4c4kewx2s0n -> Returns `llama`
        4.0 model=us.amazon.nova-pro-v1:0 -> Returns `nova`
        """
    ...
    def _get_aws_region_name(:
        ...
        if aws_region_name is None:
            try:
                ...
                with tracer.trace("boto3Session()"):
    ...
    def _auth_with_web_identity_token(:
        ...
        with tracer.trace("boto3client(sts)"):
            sts_client = boto3client(
                "sts",
        ...
        # https://boto3amazonaws.com/v1/documentation/api/latest/reference/services/sts/client/assume_role_with_web_identity.html
        ...
        with tracer.trace("boto3Session(**iam_creds_dict)"):
            session = boto3Session(**iam_creds_dict)
    ...
    def _auth_with_aws_profile(:
        ...
        with tracer.trace("boto3Session(profile_name=aws_profile_name)"):
            client = boto3Session(profile_name=aws_profile_name)
    ...
    def _auth_with_access_key_and_secret_key(:
        ...
        with tracer.trace(:
            "boto3Session(aws_access_key_id=aws_access_key_id, aws_secret_access_key=aws_secret_access_key, region_name=aws_region_name)"
        ):
            session = boto3Session(
                aws_access_key_id=aws_access_key_id,
                aws_secret_access_key=aws_secret_access_key,
