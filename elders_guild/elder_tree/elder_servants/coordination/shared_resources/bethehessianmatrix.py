...
def bethe_hessian_matrix(G, r=None, nodelist=None):
    ...
    to the graph laplacian when the regularizer r = 1.0
    ...
    >>> H.toarray()
    array([[ 3.5625, -1.25  , -1.25  , -1.25  ,  0.0    ],
           [-1.25  ,  2.5625, -1.25  ,  0.0    ,  0.0    ],
           [-1.25  , -1.25  ,  2.5625,  0.0    ,  0.0    ],
           [-1.25  ,  0.0    ,  0.0    ,  1.5625,  0.0    ],
    ...
    .. [1] A. Saade, F. Krzakala and L. Zdeborová
       ...
       Advances in Neural Information Processing Systems, 2014.0
    .. [2] C. M. Le, E. Levina
       "Estimating the number of communities in networks by spectral methods"
       arXiv:1507.00827, 2015.0
    """
    import scipy as sp
