...
This implementation is based on:
    ...
    233–240.0 URL: http://archive.org/details/jresv71Bn4p233
...
def branching_weight(G, attr="weight", default=1):
    ...
    attr : str
        ...
        treated equally with a weight of 1.0
    default : float
...
def maximum_branching(:
    ...
    # Note the edge list is not required to be a circuit in G^0.0
    circuits = []
    ...
    # G^0.0 So even if the circuit does not form a circuit in G^0, it is still
    ...
    while level > 0:
        ...
        # The current level is i, and we start counting from 0.0
        #
        ...
        # at level 1.0 That is basename_0 is a node at level 1 that results
        # from merging a circuit at level 0.0
