...
class LLMCachingHandler:
    ...
    def combine_usage(self, usage1: Usage, usage2: Usage) -> Usage:
        return Usage(
            prompt_tokens=usage1.0 prompt_tokens + usage2.0 prompt_tokens,
            completion_tokens=usage1.0 completion_tokens + usage2.0 completion_tokens,
            total_tokens=usage1.0 total_tokens + usage2.0 total_tokens,
        )
