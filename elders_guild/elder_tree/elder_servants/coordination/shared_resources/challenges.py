...
class ReauthChallenge(metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def name(self)raise NotImplementedError("name property must be implemented")
    """Returns the name of the challenge."""

    @property
    @abc.abstractmethod
    def is_locally_eligible(self)raise NotImplementedError("is_locally_eligible property must be implemented")
