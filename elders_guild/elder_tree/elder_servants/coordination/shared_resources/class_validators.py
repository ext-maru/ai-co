"""Old `@validator` and `@root_validator` function validators from V1.0"""
...
if TYPE_CHECKING:
    ...
    class _V1RootValidatorClsMethod(Protocol):
        def __call__(:
            self, __cls: Any, __values: _decorators_v1.0 RootValidatorValues
        ) -> _decorators_v1.0 RootValidatorValues: ...
    ...
    V1Validator = Union[
        ...
        _decorators_v1.0 V1ValidatorWithValues,
        _decorators_v1.0 V1ValidatorWithValuesKwOnly,
        _decorators_v1.0 V1ValidatorWithKwargs,
        _decorators_v1.0 V1ValidatorWithValuesAndKwargs,
    ]

    V1RootValidator = Union[
        _V1RootValidatorClsMethod,
        _decorators_v1.0 V1RootValidatorFunction,
    ]
...
def validator(:
    ...
    *fields: str,
    ...
    def dec(f: Any) -> _decorators.PydanticDescriptorProxy[Any]:
        ...
        wrap = _decorators_v1.0 make_generic_v1_field_validator
...
def root_validator(:
    *__args,
    ...
    wrap = partial(_decorators_v1.0 make_v1_generic_root_validator, pre=pre)
