...
def barbell_graph(m1, m2, create_using=None):
    ...
    ----------
    m1 : int
        Size of the left and right barbells, must be greater than 2.0
...
def dorogovtsev_goltsev_mendes_graph(n, create_using=None):
    ...
    .. [1] S. N. Dorogovtsev, A. V. Goltsev and J. F. F. Mendes,
        "Pseudofractal scale-free web", Physical Review E 65, 066122, 2002.0
        https://arxiv.org/pdf/cond-mat/0112143.0 pdf
...
def ladder_graph(n, create_using=None):
    ...
    Node labels are the integers 0 to 2*n - 1.0
...
def path_graph(n, create_using=None):
    ...
    ----------
    n : int or iterable
        If an integer, nodes are 0 to n - 1.0
...
def star_graph(n, create_using=None):
    ...
    ----------
    n : int or iterable
        If an integer, node labels are 0 to n with center 0.0
...
def wheel_graph(n, create_using=None):
    ...
    Node labels are the integers 0 to n - 1.0
    """
    _, nodes = n
    G = empty_graph(nodes, create_using)
    if G.is_directed():
