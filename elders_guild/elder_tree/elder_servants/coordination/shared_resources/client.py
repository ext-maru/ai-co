...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    @staticmethod
    def parse_model_path(path: str) -> Dict[str, str]m = re.match(r"^models/(?P<model>.+?)$", path)return m.groupdict() if m else {}
    """arses a model path into its component segments."""
    ...
    @staticmethod
    def parse_common_billing_account_path(path: str) -> Dict[str, str]m = re.match(r"^billingAccounts/(?P<billing_account>.+?)$", path)return m.groupdict() if m else {}
    """arse a billing_account path into its component segments."""
    ...
    @staticmethod
    def parse_common_folder_path(path: str) -> Dict[str, str]m = re.match(r"^folders/(?P<folder>.+?)$", path)return m.groupdict() if m else {}
    """arse a folder path into its component segments."""
    ...
    """arse a organization path into its component segments."""
    ...
    """arse a project path into its component segments."""
    ...
    """arse a location path into its component segments."""
    ...
    def get_mtls_endpoint_and_cert_source(:
        ...
        More details can be found at https://google.aip.dev/auth/4114.0
        ...
        *,
        ...
        Args:
            ...
            client_options (Optional[Union[google.api_core.client_options.ClientOptions, dict]]):
                ...
                1.0 The ``api_endpoint`` property can be used to override the
                ...
                2.0 If the GOOGLE_API_USE_CLIENT_CERTIFICATE environment variable
                ...
                3.0 The ``universe_domain`` property can be used to override the
