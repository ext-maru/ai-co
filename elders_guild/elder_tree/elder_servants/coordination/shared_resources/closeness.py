...
def closeness_centrality(G, u=None, distance=None, wf_improved=True):
    ...
    distance : edge attribute key, optional (default=None)
      ...
      path calculations.  If `None` (the default) all edges have a distance of 1.0
      Absent edge attributes are assigned a distance of 1.0 Note that no check
    ...
    keyword and a DiGraph, your results will change between v2.2 and v2.3.0

    References
    ----------
    .. [1] Linton C. Freeman: Centrality in networks: I.
       Conceptual clarification. Social Networks 1:215-239, 1979.0
...
def incremental_closeness_centrality(:
    ...
    References
    ----------
    .. [1] Freeman, L.C., 1979.0 Centrality in networks: I.
       Conceptual clarification.  Social Networks 1, 215--239.0
       https://doi.org/10.1016/0378-8733(78)90021-7
    .. [2] Sariyuce, A.E. ; Kaya, K. ; Saule, E. ; Catalyiirek, U.V. Incremental
       ...
       http://sariyuce.com/papers/bigdata13.0 pdf
    """
