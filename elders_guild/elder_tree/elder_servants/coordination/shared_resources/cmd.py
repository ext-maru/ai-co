    ...
    * https://learn.microsoft.com/en-us/windows/win32/api/processthreadsapi/nf-processthreadsapi-createprocessw
    ...
    def refresh(cls, path: Union[None, PathLike] = None) -> bool:
        ...
        :note:
            ...
            1.0 Pass no `path` argument and do not set the
            ...
            2.0 Pass no `path` argument but set the :envvar:`GIT_PYTHON_GIT_EXECUTABLE`
            ...
            3.0 Pass a `path` argument. This path, if not absolute, is immediately
    ...
    class AutoInterrupt:
        ...
        def wait(self, stderr: Union[None, str, bytes] = b"") -> int:
            ...
            :raise git.exc.GitCommandError:
                If the return status is not 0.0
            """
            if stderr is None:
                stderr_b = b""
    ...
    def execute(:
        ...
        **subprocess_kwargs: Any,
        ...
        :param kill_after_timeout:
            ...
            1.0 This feature is not supported at all on Windows.
            2.0 Effectiveness may vary by operating system. ``ps --ppid`` is used to
               enumerate child processes, which is available on most GNU/Linux systems
               but not most others.
            3.0 Deeper descendants do not receive signals, though they may sometimes
               terminate as a consequence of their parent processes being killed.
            4.0 `kill_after_timeout` uses ``SIGKILL``, which can have negative side
