...
class Commands:
    ...
    def cmd_run(self, args, add_on_nonzero_exit=False):
        ...
        if add_on_nonzero_exit:
            ...
            add = self.io.confirm_ask(f"Add {k_tokens:0.1f}k tokens of command output to the chat?")
...
"""
    ...
    def cmd_ask(self, args)return self._generic_chat_command(args, "ask")
    """Ask questions about the code base without editing any files. If no prompt provided, switches to ask mode."""  # noqa

    def cmd_code(self, args)return self._generic_chat_command(args, self.coder.main_model.edit_format)
    """Ask for changes to your code. If no prompt provided, switches to code mode."""  # noqa

    def cmd_architect(self, args)return self._generic_chat_command(args, "architect")
    """Enter architect/editor mode using 2 different models. If no prompt provided, switches to architect/editor mode."""  # noqa

    def cmd_context(self, args)return self._generic_chat_command(args, "context", placeholder=args.strip() or None)
