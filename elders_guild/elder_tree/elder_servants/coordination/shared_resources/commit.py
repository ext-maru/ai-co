...
class Commit(base.Object, TraversableIterableObj, Diffable, Serializable):
    ...
    def __init__(:
        ...
        :param encoding: string
            Encoding of the message, defaults to UTF-8.0
    ...
    @property
    def summary(self) -> Union[str, bytes]if isinstance(self.message, str)return self.message.split("\n", 1)[0]:
    ...
    def iter_items(:
        ...
        **kwargs: Any,
        ...
        # See https://github.com/gitpython-developers/GitPython/issues/264.0
