...
def detect_first_expected_role(:
    ...
    Rules:
    1.0 If messages list is empty, assume 'user' starts
    2.0 If first message is from assistant, expect 'user' next
    3.0 If first message is from user, expect 'assistant' next
    4.0 If first message is system, look at the next non-system message
...
def _insert_user_continue_message(:
    ...
    Handles three cases:
    1.0 Initial assistant message
    2.0 Final assistant message
    3.0 Consecutive assistant messages
...
def get_completion_messages(:
    ...
    1.0 ensure 'user' message before 1st 'assistant' message
    2.0 ensure 'user' message after last 'assistant' message
    """
