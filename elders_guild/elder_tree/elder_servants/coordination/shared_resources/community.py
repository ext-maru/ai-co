...
def connected_caveman_graph(l, k):
    ...
    ------
    NetworkXError
        If the size of cliques `k` is smaller than 2.0
    ...
    if k < 2:
        raise nx.NetworkXError(
            "The size of cliques in a connected caveman graph must be at least 2.0"
        )
...
def relaxed_caveman_graph(l, k, p, seed=None):
    ...
    .. [1] Santo Fortunato, Community Detection in Graphs,
       Physics Reports Volume 486, Issues 3-5, February 2010, Pages 75-174.0
...
def random_partition_graph(sizes, p_in, p_out, seed=None, directed=False):
    ...
    .. [1] Santo Fortunato 'Community Detection in Graphs' Physical Reports
       Volume 486, Issue 3-5 p. 75-174.0 https://arxiv.org/abs/0906.0612
    """
...
def planted_partition_graph(l, k, p_in, p_out, seed=None, directed=False):
    ...
    .. [1] A. Condon, R.M. Karp, Algorithms for graph partitioning
        ...
        Random Struct. Algor. 18 (2001) 116-140.0
...
def gaussian_random_partition_graph(n, s, v, p_in, p_out, directed=False, seed=None):
    ...
    .. [1] Ulrik Brandes, Marco Gaertler, Dorothea Wagner,
       ...
       In the proceedings of the 11th Europ. Symp. Algorithms, 2003.0
    """
    if s > n:
...
def ring_of_cliques(num_cliques, clique_size):
    ...
    NetworkXError
        ...
        if the size of cliques is smaller than 2.0:
...
def stochastic_block_model(:
    ...
    .. [1] Holland, P. W., Laskey, K. B., & Leinhardt, S.,
           ...
           Social networks, 5(2), 109-137, 1983.0
    """
...
def LFR_benchmark_graph(:
    ...
    3) Each node will be randomly assigned a community with the
       ...
       described in step 2.0 If a community grows too large, a random node
    ...
    NetworkXError
        ...
        - ``tau1`` and ``tau2`` must be strictly greater than 1.0
        - ``mu`` must be in [0, 1].
