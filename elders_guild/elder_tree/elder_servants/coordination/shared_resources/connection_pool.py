...
class AsyncConnectionPool(AsyncRequestInterface):
    ...
    def _assign_requests_to_connections(self) -> list[AsyncConnectionInterface]:
        ...
        for pool_request in queued_requests:
            ...
            #
            # 1.0 There is an existing connection that can handle the request.
            # 2.0 We can create a new connection to handle the request.
            # 3.0 We can close an idle connection and then create a new connection
