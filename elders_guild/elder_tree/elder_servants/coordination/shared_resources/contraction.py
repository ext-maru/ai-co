...
def quotient_graph(:
    ...
    *`Strongly connected component`_*.
    ...
    0.0 a list/tuple/set of block lists/tuples/sets
    1.0 a dict with block labels as keys and blocks lists/tuples/sets as values
    2.0 a dict with block lists/tuples/sets as keys and block labels as values
    3.0 a function from nodes in the original iterable to block labels
    4.0 an equivalence relation function on the target iterable
