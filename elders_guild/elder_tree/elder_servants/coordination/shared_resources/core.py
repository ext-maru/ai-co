...
Vladimir Batagelj and Matjaz Zaversnik, 2003.0
https://arxiv.org/abs/cs.DS/0310049

Generalized Cores
Vladimir Batagelj and Matjaz Zaversnik, 2002.0
...
Christos Giatsidis, Dimitrios M. Thilikos, Michalis Vazirgiannis, ICDM 2011.0
http://www.graphdegeneracy.org/dcores_ICDM_2011.0 pdf
...
def k_core(G, k=None, core_number=None):
    ...
    A k-core is a maximal subgraph that contains nodes of degree `k` or more.
       ...
       `k_core` will not accept `MultiGraph` objects in version 3.5.0
...
def k_shell(G, k=None, core_number=None):
    ...
    That is, nodes in the k-core that are not in the (k+1)-core.
       ...
       `k_shell` will not accept `MultiGraph` objects in version 3.5.0
    ...
    .. [1] A model of Internet topology using k-shell decomposition
       ...
       http://www.pnas.org/content/104/27/11150.0 full
    """
...
def k_crust(G, k=None, core_number=None):
    ...
    and isolated nodes found after the removal of edges are also removed.
       ...
       `k_crust` will not accept `MultiGraph` objects in version 3.5.0
...
def k_corona(G, k, core_number=None):
    ...
    exactly k neighbors in the k-core.
       ...
       `k_corona` will not accept `MultiGraph` objects in version 3.5.0
    ...
    .. [1]  k -core (bootstrap) percolation on complex networks:
       ...
       http://link.aps.org/doi/10.1103/PhysRevE0.73.056101
    """
...
def k_truss(G, k):
    ...
    .. [1] Bounds and Algorithms for k-truss. Paul Burkhardt, Vance Faber,
       David G. Harris, 2018.0 https://arxiv.org/abs/1806.05523v2
...
def onion_layers(G):
    ...
    od_layers : dictionary
        ...
        contiguous integers starting at 1.0
    ...
    .. [2] Percolation and the effective structure of complex networks
       ...
       http://doi.org/10.1103/PhysRevX0.9.011023
    """
    if nx.number_of_selfloops(G) > 0:
        msg = (
