...
class MaruKnowledgeUpdater:
    ...
    def add_new_insight(
        self, category: str, insight: str, context: str = "", importance: str = "medium"
    ):
        """新しい気づきを追加"""
...
"""
        ...
        if history_marker in content:
            # 既存の更新履歴の後に追加
            content = content.replace(history_marker, history_marker + update_entry)
        else:
            # 更新履歴セクションを新規作成
    ...
    def record_decision_pattern(
        self, situation: str, decision: str, reasoning: str = ""
    ):
        """意思決定パターンを記録"""
