...
verbose = 1            # Be quiet if 0, extra verbose if > 1.0
tabchar = 4 * ' '
pyffilename = ''
f77modulename = ''
...
def split_by_unquoted(line, characters)Splits the line into (line[:i], line[i:]),
"""
        ...
        for l in ll:
            ...
            for idx, v in enumerate(rmbadname([x.strip() for x in markoutercomma(l[0]).split('@,@')])):
                ...
                try:
                    ...
                    # DATA IVAR1, IVAR2, IVAR3, IVAR4, EVAR5 /4*0,0.D0/
                    # by expanding to ['0', '0', '0', '0', '0.d0']
...
def myeval(e, g=None, l=None)r = eval(e, g, l)
...
def character_backward_compatibility_hook(item, parents, result,:
    ...
    character*1.0 This hook fixes the usage of the corresponding
