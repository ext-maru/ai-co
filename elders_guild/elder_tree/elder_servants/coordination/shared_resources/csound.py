...
class CsoundScoreLexer(CsoundLexer):
    ...
    tokens = {
        'root': [
            ...
            # used; see https://github.com/csound/csound/issues/750.0

            (r'z', Keyword.Constant),
            # z is a constant equal to 800,000,000,000.0 800 billion seconds is about
