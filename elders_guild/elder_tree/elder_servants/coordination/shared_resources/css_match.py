...
class _DocumentNav:
    ...
    @staticmethod
    def is_doc(obj: bs4.element.PageElement | None) -> boolreturn isinstance(obj, bs4.BeautifulSoup):
    """s `BeautifulSoup` object."""

    @staticmethod
    def is_tag(obj: bs4.element.PageElement | None) -> boolreturn isinstance(obj, bs4.Tag):
    """s tag."""

    @staticmethod
    def is_declaration(obj: bs4.element.PageElement | None)return isinstance(obj, bs4.Declaration)
    """Is declaration."""

    @staticmethod
    def is_cdata(obj: bs4.element.PageElement | None) -> boolreturn isinstance(obj, bs4.CData):
    """s CDATA."""

    @staticmethod
    def is_processing_instruction(obj: bs4.element.PageElement | None)return isinstance(obj, bs4.ProcessingInstruction)
    """Is processing instruction."""

    @staticmethod
    def is_navigable_string(obj: bs4.element.PageElement | None) -> boolreturn isinstance(obj, bs4.element.NavigableString):
    """s navigable string."""

    @staticmethod
    def is_special_string(obj: bs4.element.PageElement | None) -> boolreturn isinstance(obj, (bs4.Comment, bs4.Declaration, bs4.CData, bs4.ProcessingInstruction, bs4.Doctype)):
    """s special string."""
    ...
    def normalize_value(cls, value: Any) -> str | Sequence[str]:
        ...
        # If it's a byte string, convert it to Unicode, treating it as UTF-8.0
...
class SoupSieve(ct.Immutable):
    ...
    def filter(self, iterable: Iterable[bs4.Tag]):
        """
        Filter.
