...
probability of ``u`` to either the original value or 1.0 So the conditional
...
.. [3] Shachter, Ross D. "Bayes-ball: The rational pastime (for
   ...
   on Uncertainty in Artificial Intelligence (UAI), (pp. 480–487). 1998.0
...
def find_minimal_d_separator(G, x, y, *, included=None, restricted=None):
    ...
    .. [1] van der Zander, Benito, and Maciej Liśkiewicz. "Finding
        ...
        Uncertainty in Artificial Intelligence, pp. 637-647.0 PMLR, 2020.0
    """
    if not nx.is_directed_acyclic_graph(G):
        raise nx.NetworkXError("graph should be directed acyclic")
