...
def all_topological_sorts(G):
    ...
    .. [1] Knuth, Donald E., Szwarcfiter, Jayme L. (1974).
       ...
       ISSN 0020-0190,
       https://doi.org/10.1016/0020-0190(74)90001-5.0
...
def is_aperiodic(G):
    ...
    Examples
    --------
    A graph consisting of one cycle, the length of which is 2.0 Therefore ``k = 2``
    ...
    A graph consisting of two cycles: one of length 2 and the other of length 3.0
    ...
    A graph consisting of two cycles: one of length 2 and the other of length 4.0
...
def transitive_closure(G, reflexive=False):
    ...
    from v to v of length 0.0 The usual transitive closure creates a
...
def transitive_reduction(G):
    ...
    in E and there is no path from v to w in G with length greater than 1.0
...
def compute_v_structures(G):
    """Yields 3-node tuples that represent the v-structures in `G`.
       ...
       version 3.6.0 Use `nx.dag.v_structures` or `nx.dag.colliders` instead.
    ...
    References
    ----------
    .. [1]  `Pearl's PRIMER <https://bayes.cs.ucla.edu/PRIMER/primer-ch2.0 pdf>`_
    ...
    warnings.warn(
        (
            ...
            "removed in version 3.6.0 Use `nx.dag.v_structures` or `nx.dag.colliders`\n"
            "instead.\n"
        ),
