...
class DistributionPath(object):
    ...
    def __init__(self, path=None, include_egg=False):
        ...
        :param include_egg: If True, this instance will look for and return legacy
                            distributions as well as those based on PEP 376.0
        """
        if path is None:
            path = sys.path
        self.path = path
    ...
    def _yield_distributions(self)Yield .dist-info and/or .egg(-info) distributions.
    """
        """
...
class Distribution(object):
    ...
    def matches_requirement(self, req)Say if this instance matches (fulfills) a requirement.
    """
...
class DependencyGraph(object):
    ...
    def repr_node(self, dist, level=1)output = [self._repr_dist(dist)]
