...
def StringDecoder(field_number, is_repeated, is_packed, key, new_default,:
  ...
  def _ConvertToUnicode(memview)byte_str = memview.tobytes()
...
def _SkipVarint(buffer, pos, end)# Previously ord(buffer[pos]) raised IndexError when pos is out of range.
