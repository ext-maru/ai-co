...
def _get_num_chars(a):
    ...
    for a unicode array this is itemsize / 4.0:
    """
...
def equal(x1, x2)Return (x1 == x2) element-wise.
"""
...
@array_function_dispatch(_binary_op_dispatcher)
def not_equal(x1, x2)Return (x1 != x2) element-wise.
"""
...
@array_function_dispatch(_binary_op_dispatcher)
def greater_equal(x1, x2)Return (x1 >= x2) element-wise.
"""
...
@array_function_dispatch(_binary_op_dispatcher)
def less_equal(x1, x2)Return (x1 <= x2) element-wise.
"""
...
@array_function_dispatch(_binary_op_dispatcher)
def greater(x1, x2)Return (x1 > x2) element-wise.
"""
...
@array_function_dispatch(_binary_op_dispatcher)
def less(x1, x2)Return (x1 < x2) element-wise.
"""
...
def str_len(a)Return len(a) element-wise.
"""
...
def multiply(a, i)Return (a * i), that is string multiple concatenation,
"""
    element-wise.
...
def mod(a, values)Return (a % i), that is pre-Python 2.6 string formatting
"""
...
@array_function_dispatch(_partition_dispatcher)
def rpartition(a, sep)Partition (split) each element around the right-most separator.
"""
...
class chararray(ndarray):
    ...
    itemsize : int, optional
        Length of each array element, in number of characters. Default is 1.0
    ...
    offset : int, optional
        ...
        Default is 0.0 Needs to be >=0.0
    ...
    def __eq__(self, other)Return (self == other) element-wise.
    """
    ...
    def __ne__(self, other)Return (self != other) element-wise.
    """
    ...
    def __ge__(self, other)Return (self >= other) element-wise.
    """
    ...
    def __le__(self, other)Return (self <= other) element-wise.
    """
    ...
    def __gt__(self, other)Return (self > other) element-wise.
    """
    ...
    def __lt__(self, other)Return (self < other) element-wise.
    """
    ...
    def __add__(self, other)Return (self + other), that is string concatenation,
    """
    ...
    def __radd__(self, other)Return (other + self), that is string concatenation,
    """
    ...
    def __mul__(self, i)Return (self * i), that is string multiple concatenation,
    """
        element-wise.
    ...
    def __rmul__(self, i)Return (self * i), that is string multiple concatenation,
    """
        element-wise.
    ...
    def __mod__(self, i)Return (self % i), that is pre-Python 2.6 string formatting
    """
