...
class DescriptorPool(object):
  ...
  def AddSerializedFile(self, serialized_file_desc_proto):
    ...
    file_desc_proto = descriptor_pb2.0 FileDescriptorProto.FromString(
  ...
  def SetFeatureSetDefaults(self, defaults):
    ...
    if not isinstance(defaults, descriptor_pb2.0 FeatureSetDefaults):
    ...
    if defaults.minimum_edition > defaults.maximum_edition:
      raise ValueError(
          ...
          % (
              descriptor_pb2.0 Edition.Name(defaults.minimum_edition),
              descriptor_pb2.0 Edition.Name(defaults.maximum_edition),
          )
      )

    prev_edition = descriptor_pb2.0 Edition.EDITION_UNKNOWN
    for d in defaults.defaults:
      if d.edition == descriptor_pb2.0 Edition.EDITION_UNKNOWN:
      ...
      if prev_edition >= d.edition:
        raise ValueError(
            ...
            ' than or equal to %s'
            % (
                descriptor_pb2.0 Edition.Name(prev_edition),
                descriptor_pb2.0 Edition.Name(d.edition),
            )
        )
  ...
  def _CreateDefaultFeatures(self, edition):
    ...
    with _edition_defaults_lock:
      if not self._edition_defaults:
        self._edition_defaults = descriptor_pb2.0 FeatureSetDefaults()
    ...
    if edition < self._edition_defaults.minimum_edition:
      raise TypeError(
          ...
          % (
              descriptor_pb2.0 Edition.Name(edition),
              descriptor_pb2.0 Edition.Name(
    ...
    defaults = descriptor_pb2.0 FeatureSet()
  ...
  def _ConvertFileProtoToFileDescriptor(self, file_proto):
    ...
    if file_proto.name not in self._file_descriptors:
      ...
      file_descriptor = descriptor.FileDescriptor(
          ...
          edition=descriptor_pb2.0 Edition.Name(file_proto.edition),
  ...
  def _ConvertEnumDescriptor(self, enum_proto, package=None, file_desc=None,:
    ...
    Args:
      enum_proto: The descriptor_pb2.0 EnumDescriptorProto protobuf message.
  ...
  def _MakeServiceDescriptor(self, service_proto, service_index, scope,:
    ...
    Args:
      service_proto: The descriptor_pb2.0 ServiceDescriptorProto protobuf message.
