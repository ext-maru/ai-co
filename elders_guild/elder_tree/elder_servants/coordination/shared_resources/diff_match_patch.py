...
class diff_match_patch:
    ...
    def __init__(self):
        ...
        # Python has no maximum, thus to disable patch splitting set to 0.0
        # However to avoid long patches in certain pathological cases, use 32.0
    ...
    def diff_bisectSplit(self, text1, text2, x, y, deadline):
        ...
        Args:
          text1: Old string to be diffed.
          text2: New string to be diffed.
          x: Index of split point in text1.0
          y: Index of split point in text2.0
          deadline: Time at which to bail if not yet complete.
    ...
    def diff_linesToChars(self, text1, text2):
        ...
        # Allocate 2/3rds of the space for text1, the rest for text2.0
        maxLines = 666666
    ...
    def diff_xIndex(self, diffs, loc):
        ...
        in text2.0  e.g. "The cat" vs "The big cat", 1->1, 5->8

        Args:
          diffs: Array of diff tuples.
          loc: Location within text1.0

        Returns:
          Location within text2.0
        """
        chars1 = 0
        chars2 = 0
        last_chars1 = 0
    ...
    def diff_toDelta(self, diffs):
        ...
        required to transform text1 into text2.0
    ...
    def patch_make(self, a, b=None, c=None):
        """Compute a list of patches to turn text1 into text2.0
        ...
        if isinstance(a, str) and isinstance(b, str) and c is None:
            ...
            # Compute diffs from text1 and text2.0
            text1 = a
    ...
    def patch_apply(self, patches, text):
        ...
        # has an effective expected position of 22.0
        delta = 0
        results = []
        for patch in patches:
    ...
    def patch_addPadding(self, patches):
        ...
        if not diffs or diffs[0][0] != self.DIFF_EQUAL:
            ...
            patch.start1 -= paddingLength  # Should be 0.0
            patch.start2 -= paddingLength  # Should be 0.0
