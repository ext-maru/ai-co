...
class CSharpLexer(RegexLexer):
    ...
    # http://www.ecma-international.org/publications/files/ECMA-ST/Ecma-334.0 pdf
...
class FSharpLexer(RegexLexer):
    ...
    # See http://msdn.microsoft.com/en-us/library/dd233181.0 aspx and/or
