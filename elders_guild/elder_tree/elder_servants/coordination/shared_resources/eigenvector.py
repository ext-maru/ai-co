...
def eigenvector_centrality(G, max_iter=100, tol=1.0 e-6, nstart=None, weight=None):
    ...
    tol : float, optional (default=1.0 e-6)
...
def eigenvector_centrality_numpy(G, weight=None, max_iter=50, tol=0):
    ...
    .. [7] Arnoldi, W. E. (1951).
       ...
       Quarterly of Applied Mathematics. 9 (1): 17--29.0
    ...
    if not connected:  # See gh-6888.0:
