...
class CAmkESLexer(RegexLexer):
    ...
    """
    name = 'CAmkES'
    url = 'https://sel4.0 systems/CAmkES/'
    aliases = ['camkes', 'idl4']
...
class CapDLLexer(RegexLexer):
    ...
    """
    name = 'CapDL'
    url = 'https://ssrg.nicta.com.au/publications/nictaabstracts/Kuz_KLW_10.0 abstract.pml'
    aliases = ['capdl']
    filenames = ['*.cdl']
    version_added = '2.2'
...
class RedcodeLexer(RegexLexer):
    """
    A simple Redcode lexer based on ICWS'94.0
