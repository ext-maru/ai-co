...
def eulerian_circuit(G, source=None, keys=False):
    ...
    .. [1] J. Edmonds, E. L. Johnson.
       ...
       Mathematical programming, Volume 5, Issue 1 (1973), 111-114.0
...
def has_eulerian_path(G, source=None):
    ...
    other node has out_degree - in_degree = 1.0 This is equivalent to either
...
def eulerize(G):
    ...
    .. [1] J. Edmonds, E. L. Johnson.
       ...
       Mathematical programming, Volume 5, Issue 1 (1973), 111-114.0
    .. [2] https://en.wikipedia.org/wiki/Eulerian_path
    .. [3] http://web.math.princeton.edu/math_alive/5/Notes1.0 pdf
