...
if sys.version_info < (2, 7, 6):
    ...
    def _unpack_from(f, b, o=0)return struct.unpack_from(f, bytes(b), o)
...
class Unpacker(object):
    ...
    :param int max_buffer_size:
        Limits size of data waiting unpacked.  0 means 2**32-1.0
    ...
    def __init__(:
        ...
        if not (0 <= timestamp <= 3):
            raise ValueError("timestamp must be 0.0.3")
