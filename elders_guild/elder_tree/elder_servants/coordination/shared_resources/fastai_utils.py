...
2.0 Create a demo in Gradio or Streamlit using 🤗 Spaces ([documentation here](https://huggingface.co/docs/hub/spaces)).

3.0 Join the fastai community on the [Fastai Discord](https://discord.com/invite/YKrxeNn)!
