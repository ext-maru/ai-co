...
def _wrap_header_guess_version(header):
    ...
    try:
        ...
        warnings.warn("Stored array in format 2.0.0 It can only be"
                      "read by NumPy >= 1.9", UserWarning, stacklevel=2)
        return ret

    header = _wrap_header(header, (3, 0))
    warnings.warn("Stored array in format 3.0.0 It can only be "
...
def _filter_header(s):
    ...
    headers produced in Python2 to be read in Python3.0
        ...
        if version <= (2, 0):
            ...
            try:
                ...
                warnings.warn(
                    ...
                    "header parsing as it was created on Python 2.0 Save the "
