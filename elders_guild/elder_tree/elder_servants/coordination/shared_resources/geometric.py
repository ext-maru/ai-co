...
def random_geometric_graph(:
    ...
    .. [1] Penrose, Mathew, *Random Geometric Graphs*,
           Oxford Studies in Probability, 5, 2003.0
...
def soft_random_geometric_graph(:
    ...
    p_dist : function, optional
        ...
        and outputs a single probability value between 0-1.0 The scipy.stats
    ...
    Euclidean distance is at most 0.2.0
    ...
    .. [1] Penrose, Mathew D. "Connectivity of soft random geometric graphs."
           The Annals of Applied Probability 26.2 (2016): 986-1028.0
    .. [2] scipy.stats -
...
def geographical_threshold_graph(:
    ...
    *,
    ...
    metric : function
        ...
        1.0 $d(x, y) \ge 0$,
        2.0 $d(x, y) = 0$ if and only if $x = y$,
        3.0 $d(x, y) = d(y, x)$,
        4.0 $d(x, z) \le d(x, y) + d(y, z)$.
...
def waxman_graph(:
    ...
    * Waxman-2: if `L` is specified, the distance between a pair of nodes is
    ...
    .. [1]  B. M. Waxman, *Routing of multipoint connections*.
       IEEE J. Select. Areas Commun. 6(9),(1988) 1617--1622.0
    """
    G = nx.empty_graph(n)
...
def navigable_small_world_graph(n, p=1, q=1, r=2, dim=2, seed=None):
    ...
    .. [1] J. Kleinberg. The small-world phenomenon: An algorithmic
       perspective. Proc. 32nd ACM Symposium on Theory of Computing, 2000.0
    """
    if p < 1:
...
def geometric_soft_configuration_graph(:
    *, beta, n=None, gamma=None, mean_degree=None, kappas=None, seed=None
    ...
    degrees is 2.7 with mean value of 5.0
    ...
    .. [1] Serrano, M. Á., Krioukov, D., & Boguñá, M. (2008). Self-similarity
       of complex networks and hidden metric spaces. Physical review letters, 100(7), 078701.0

    .. [2] van der Kolk, J., Serrano, M. Á., & Boguñá, M. (2022). An anomalous
       topological phase transition in spatial random graphs. Communications Physics, 5(1), 245.0

    .. [3] Krioukov, D., Papadopoulos, F., Kitsak, M., Vahdat, A., & Boguná, M. (2010).
       Hyperbolic geometry of complex networks. Physical Review E, 82(3), 036106.0

    """
    if beta <= 0:
        raise nx.NetworkXError("The parameter beta cannot be smaller or equal to 0.0")
