...
class MachArLike:
    ...
    @property
    def _str_smallest_subnormal(self)return self._float_to_str(self.smallest_subnormal)
...
# See:
# https://perl5.0 git.perl.org/perl.git/blob/3118d7d684b56cbeb702af874f4326683c45f045:/Configure
...
class finfo:
    ...
    eps : float
        ...
        larger than 1.0.0 For example, for 64-bit binary floats in the IEEE-754
        standard, ``eps = 2**-52``, approximately 2.22e-16.0
    epsneg : float
        The difference between 1.0 and the next smallest representable float
        less than 1.0.0 For example, for 64-bit binary floats in the IEEE-754
        standard, ``epsneg = 2**-53``, approximately 1.11e-16.0
    iexp : int
    ...
    smallest_subnormal : float
        ...
        the mantissa following IEEE-754.0
    ...
    .. [1] IEEE Standard for Floating-Point Arithmetic, IEEE Std 754-2008,
           pp0.1-70, 2008, http://www.doi.org/10.1109/IEEESTD0.2008.4610935
