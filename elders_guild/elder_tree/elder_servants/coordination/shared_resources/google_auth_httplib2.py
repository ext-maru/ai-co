...
"""Transport adapter for httplib2.0"""
...
class Request(transport.Request):
    ...
    def __call__(:
        ...
        """Make an HTTP request using httplib2.0
...
def _make_default_http()return httplib2.Http()
...
class AuthorizedHttp(object):
    ...
    def add_certificate(self, key, cert, domain, password=None)self.http.add_certificate(key, cert, domain, password=password)
