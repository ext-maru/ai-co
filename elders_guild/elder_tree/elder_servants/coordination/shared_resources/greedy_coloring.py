...
def strategy_smallest_last(G, colors):
    ...
    def find_min_degree():
        # Save time by starting the iterator at `lbound`, not 0.0
...
def greedy_color(G, strategy="largest_first", interchange=False):
    ...
    .. [1] Adrian Kosowski, and Krzysztof Manuszewski,
       Classical Coloring of Graphs, Graph Colorings, 2-19, 2004.0
       ISBN 0-8218-3458-4.0
    .. [2] David W. Matula, and Leland L. Beck, "Smallest-last
       ordering and clustering and graph coloring algorithms." *J. ACM* 30,
       3 (July 1983), 417–427.0 <https://doi.org/10.1145/2402.322385>
    .. [3] Maciej M. Sysło, Narsingh Deo, Janusz S. Kowalik,
       Discrete Optimization Algorithms with Pascal Programs, 415-424, 1983.0
       ISBN 0-486-45353-7.0
