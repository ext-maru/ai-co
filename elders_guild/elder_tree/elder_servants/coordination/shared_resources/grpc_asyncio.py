...
from google.ai.generativelanguage_v1.0 types import model, model_service
    ...
    async def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER:
            ...
            grpc_request = {
                ...
                extra={
                    "serviceName": "google.ai.generativelanguage.v1.0 ModelService",
...
class ModelServiceGrpcAsyncIOTransport(ModelServiceTransport):
    ...
    def __init__(:
        ...
        *,
        ...
        self._wrap_with_kind = (
            "kind" in inspect.signature(gapic_v1.0 method_async.wrap_method).parameters
        )
    ...
    def get_model(:
        ...
        if "get_model" not in self._stubs:
            self._stubs["get_model"] = self._logged_channel.unary_unary(
                "/google.ai.generativelanguage.v1.0 ModelService/GetModel",
    ...
    def list_models(:
        ...
        if "list_models" not in self._stubs:
            self._stubs["list_models"] = self._logged_channel.unary_unary(
                "/google.ai.generativelanguage.v1.0 ModelService/ListModels",
    ...
    def _wrap_method(self, func, *args, **kwargs):
        ...
        return gapic_v1.0 method_async.wrap_method(func, *args, **kwargs)
    ...
    def cancel_operation(:
        self,
    ) -> Callable[[operations_pb2.0 CancelOperationRequest], None]:
        ...
        if "cancel_operation" not in self._stubs:
            self._stubs["cancel_operation"] = self._logged_channel.unary_unary(
                ...
                request_serializer=operations_pb2.0 CancelOperationRequest.SerializeToString,
    ...
    def get_operation(:
        ...
        if "get_operation" not in self._stubs:
            self._stubs["get_operation"] = self._logged_channel.unary_unary(
                ...
                request_serializer=operations_pb2.0 GetOperationRequest.SerializeToString,
                response_deserializer=operations_pb2.0 Operation.FromString,
            )
    ...
    def list_operations(:
        ...
        if "list_operations" not in self._stubs:
            self._stubs["list_operations"] = self._logged_channel.unary_unary(
                ...
                request_serializer=operations_pb2.0 ListOperationsRequest.SerializeToString,
                response_deserializer=operations_pb2.0 ListOperationsResponse.FromString,
            )
