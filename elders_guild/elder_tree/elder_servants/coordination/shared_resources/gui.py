...
class SigSlot:
    ...
    def _setup(self)self.panel = pn.pane.PaneBase()
    ...
    def show(self, threads=False)self.panel.show(threads=threads, verbose=False)
...
class FileSelector(SigSlot):
    ...
    @property
    def storage_options(self)return ast.literal_eval(self.kwargs.value) or {}
    ...
    def open_file(self, mode="rb", compression=None, encoding=None):
        ...
        encoding: str (optional)
            If using text mode, use this encoding; defaults to UTF8.0
        """
