...
class JWTHandler:
    ...
    async def auth_jwt(self, token: str) -> dict:
        ...
        if public_key is not None and isinstance(public_key, dict):
            ...
            try:
                cert = x509.0 load_pem_x509_certificate(
...
class JWTAuthManager:
    ...
    @staticmethod
    def get_all_team_ids(jwt_handler: JWTHandler, jwt_valid_token: dict) -> Set[str]team_ids_from_groups = jwt_handler.get_team_ids_from_jwt(token=jwt_valid_token):
