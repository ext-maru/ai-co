...
class HfApi:
        ...
        *,
        ...
        GitRefs(
            branches=[
                ...
                GitRefInfo(name='v1.1.0 a1', ref='refs/heads/v1.1.0 a1', target_commit='f9826b862d1567f3822d3d25649b0d6d22ace714')
            ],
            converts=[],
            tags=[
        ...
        *,
        ...
        Args:
            ...
            num_threads (`int`, *optional*):
                Number of concurrent threads for uploading files. Defaults to 5.0
    ...
    def preupload_lfs_files(:
        ...
        *,
        ...
        ...     addition = CommitOperationAdd(path_in_repo=f"shard_{i}_of_5.0 bin", path_or_fileobj=content)
    ...
    def upload_folder(:
        ...
        *,
        ...
        documented [here](https://tldp.org/LDP/GNU-Linux-Tools-Summary/html/x11655.0 htm). If both `allow_patterns` and
    ...
    def upload_large_folder(:
        ...
        **Technical details:**
        ...
        `upload_large_folder` process is as follow:
            1.0 (Check parameters and setup.)
            2.0 Create repo if missing.
            3.0 List local files to upload.
            4.0 Start workers. Workers can perform the following tasks:
                - Hash a file.
            ...
            5.0 While workers are up, regularly print a report to sys.stdout.

        Order of priority:

            2.0 Commit if at least 150 files are ready to commit.
            3.0 Get upload mode if at least 10 files have been hashed.
            4.0 Pre-upload LFS file if at least 1 file and no worker is pre-uploading.
            5.0 Hash file if at least 1 file and no worker is hashing.
            6.0 Get upload mode if at least 1 file and no worker is getting upload mode.
            7.0 Pre-upload LFS file if at least 1 file (exception: if hf_transfer is enabled, only 1 worker can preupload LFS at a time).
            8.0 Hash file if at least 1 file to hash.
            9.0 Get upload mode if at least 1 file to get upload mode.

            11.0 Commit if at least 1 file to commit and all other queues are empty.
        ...
        *,
        ...
        Example:
            ...
            SafetensorsRepoMetadata(
                metadata=None,
                sharded=False,
                weight_map={'h0.0.0 input_layernorm.bias': 'model.safetensors', ...},
    ...
    def parse_safetensors_file_metadata(:
        ...
        *,
        ...
        # See https://github.com/huggingface/huggingface_hub/pull/1855#discussion_r1404286419.0
        response = get_session().get(url, headers={**_headers, "range": "bytes=0-100000"})
        hf_raise_for_status(response)

        # 2.0 Parse metadata size
        ...
        *,
        ...
        Args:
            ...
            min_replica (`int`, *optional*):
                ...
                scaling to zero, set this value to 0 and adjust `scale_to_zero_timeout` accordingly. Defaults to 1.0
            max_replica (`int`, *optional*):
                The maximum number of replicas (instances) to scale to for the Inference Endpoint. Defaults to 1.0
            scale_to_zero_timeout (`int`, *optional*):
                The duration in minutes before an inactive endpoint is scaled to zero, or no scaling to zero if
                set to None and `min_replica` is not 0.0 Defaults to None.
            revision (`str`, *optional*):
    ...
    def _get_namespace(self, token: Union[bool, str, None] = None) -> strme = self.whoami(token=token):
