...
ytdist = array([662.0, 877.0, 255.0, 412.0, 996.0, 295.0, 468.0, 268.0, 400.0, 754.0,
                564.0, 138.0, 219.0, 869.0, 669.0])

linkage_ytdist_single = array([[2.0, 5.0, 138.0, 2.0],
                               [3.0, 4.0, 219.0, 2.0],
                               [0.0, 7.0, 255.0, 3.0],
                               [1.0, 8.0, 268.0, 4.0],
                               [6.0, 9.0, 295.0, 6.0]])

linkage_ytdist_complete = array([[2.0, 5.0, 138.0, 2.0],
                                 [3.0, 4.0, 219.0, 2.0],
                                 [1.0, 6.0, 400.0, 3.0],
                                 [0.0, 7.0, 412.0, 3.0],
                                 [8.0, 9.0, 996.0, 6.0]])

linkage_ytdist_average = array([[2.0, 5.0, 138.0, 2.0],
                                [3.0, 4.0, 219.0, 2.0],
                                [0.0, 7.0, 333.5, 3.0],
                                [1.0, 6.0, 347.5, 3.0],
                                [8.0, 9.0, 680.77777778, 6.0]])

linkage_ytdist_weighted = array([[2.0, 5.0, 138.0, 2.0],
                                 [3.0, 4.0, 219.0, 2.0],
                                 [0.0, 7.0, 333.5, 3.0],
                                 [1.0, 6.0, 347.5, 3.0],
                                 [8.0, 9.0, 670.125, 6.0]])
...
linkage_ytdist_single_olo = array([[5.0, 2.0, 138.0, 2.0],
                                   [4.0, 3.0, 219.0, 2.0],
                                   [7.0, 0.0, 255.0, 3.0],
                                   [1.0, 8.0, 268.0, 4.0],
                                   [6.0, 9.0, 295.0, 6.0]])
...
linkage_X_centroid = array([[3.0, 4.0, 0.36265956, 2.0],
                            [1.0, 5.0, 1.77045373, 2.0],
                            [0.0, 2.0, 2.55760419, 2.0],
                            [6.0, 8.0, 6.43614494, 4.0],
                            [7.0, 9.0, 15.17363237, 6.0]])

linkage_X_median = array([[3.0, 4.0, 0.36265956, 2.0],
                          [1.0, 5.0, 1.77045373, 2.0],
                          [0.0, 2.0, 2.55760419, 2.0],
                          [6.0, 8.0, 6.43614494, 4.0],
                          [7.0, 9.0, 15.17363237, 6.0]])

linkage_X_ward = array([[3.0, 4.0, 0.36265956, 2.0],
                        [1.0, 5.0, 1.77045373, 2.0],
                        [0.0, 2.0, 2.55760419, 2.0],
...
linkage_X_ward_olo = array([[4.0, 3.0, 0.36265956, 2.0],
