...
class HtmlFormatter(Formatter):
    ...
    `tagsfile`
        ...
        The tags file is assumed to be encoded in UTF-8.0
    ...
    **Subclassing the HTML formatter**
    ...
    def _get_css_classes(self, ttype)cls = self._get_css_class(ttype)
    ...
    def _get_css_inline_styles(self, ttype)cclass = self.ttype2class.get(ttype)
