...
class AsyncHTTPHandler:
    ...
    def _get_ssl_connector_kwargs(:
        ...
        1.0 If ssl_context is provided -> use the custom SSL context
        2.0 If ssl_verify is False -> disable SSL verification (ssl=False)
        3.0 If ssl_verify is True/None -> use default SSL context with certifi CA bundle
