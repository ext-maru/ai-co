...
# See https://www.rfc-editor.org/rfc/rfc9110.0 html#name-overview
# and https://www.rfc-editor.org/rfc/rfc9110.0 html#name-tokens
#
#     method = token
#     tchar = "!" / "#" / "$" / "%" / "&" / "'" / "*" / "+" / "-" / "." /
#             "^" / "_" / "`" / "|" / "~" / DIGIT / ALPHA
...
class HeadersParser:
    ...
    def parse_headers(:
        ...
        while line:
            ...
            # https://www.rfc-editor.org/rfc/rfc9112.0 html#section-5.1-2
            ...
            # https://www.rfc-editor.org/rfc/rfc9110.0 html#section-5.5-5
...
def _is_supported_upgrade(headers: CIMultiDictProxy[str]) -> boolreturn headers.get(hdrs.UPGRADE, "").lower() in {"tcp", "websocket"}:
    """heck if the upgrade header is supported."""
...
class HttpParser(abc.ABC, Generic[_MsgT]):
    ...
    def parse_headers(:
        ...
        # https://www.rfc-editor.org/rfc/rfc9110.0 html#section-5.5-6
        # https://www.rfc-editor.org/rfc/rfc9110.0 html#name-collected-abnf
        singletons = (
            hdrs.CONTENT_LENGTH,
        ...
        if conn:
            ...
            if v == "close":
                ...
                close_conn = False
            # https://www.rfc-editor.org/rfc/rfc9110.0 html#name-101-switching-protocols
    ...
    def parse_message(self, lines: List[bytes]) -> RawResponseMessage:
        ...
        if close is None:
            if version_o <= HttpVersion10:
                close = True
            # https://www.rfc-editor.org/rfc/rfc9112.0 html#name-message-body-length
            elif 100 <= status_i < 200 or status_i in {204, 304}:
                close = False
            elif hdrs.CONTENT_LENGTH in headers or hdrs.TRANSFER_ENCODING in headers:
                close = False
            else:
                # https://www.rfc-editor.org/rfc/rfc9112.0 html#section-6.3-2.8
                close = True
...
class DeflateBuffer:
    ...
    def feed_data(self, chunk: bytes, size: int) -> None:
        ...
        # RFC1950
        # bits 0.0.3 = CM = 0b1000 = 8 = "deflate"
        # bits 4.0.7 = CINFO = 1.0.7 = windows size.
        if (:
