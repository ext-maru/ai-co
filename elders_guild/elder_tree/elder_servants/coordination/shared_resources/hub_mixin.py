...
class ModelHubMixin:
    ...
    @classmethod
    def _is_jsonable(cls, value: Any) -> boolif is_dataclass(value):
    ...
    @classmethod
    def _encode_arg(cls, arg: Any) -> Anyif is_dataclass(arg)return asdict(arg)  # type: ignore[arg-type]
    ...
    @classmethod
    def _decode_arg(cls, expected_type: Type[ARGS_T], value: Any) -> Optional[ARGS_T]if is_simple_optional_type(expected_type):
...
class PyTorchModelHubMixin(ModelHubMixin):
    ...
    def _save_pretrained(self, save_directory: Path) -> Nonemodel_to_save = self.module if hasattr(self, "module") else self  # type: ignore
