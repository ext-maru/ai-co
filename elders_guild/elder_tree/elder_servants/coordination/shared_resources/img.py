...
class FontManager:
    ...
    def get_text_size(self, text)Get the text size (width, height).
    """
        """
...
class ImageFormatter(Formatter):
    ...
    def format(self, tokensource, outfile)Format ``tokensource``, an iterable of ``(tokentype, tokenstring)``
    """
        ...
        for pos, value, font, text_fg, text_bg in self.drawables:
            if text_bg:
                # see deprecations https://pillow.readthedocs.io/en/stable/releasenotes/9.2.0.0 html#font-size-and-offset-methods
