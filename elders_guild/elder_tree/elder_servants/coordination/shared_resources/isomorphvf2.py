...
considered in the matching of G1 and G2.0
...
GM.mapping stores the isomorphism mapping from G1 to G2.0
...
DiGM.mapping stores the isomorphism mapping from G1 to G2.0
...
[1]   Luigi P. Cordella, Pasquale Foggia, Carlo Sansone, Mario Vento,
      ...
      vol. 26,  no. 10,  pp. 1367-1372,  Oct.,  2004.0
...
class GraphMatcher:
    ...
    def candidate_pairs_iter(self):
        """Iterator over candidate pairs of nodes in G1 and G2.0"""
    ...
    def isomorphisms_iter(self):
        """Generator over isomorphisms between G1 and G2.0"""
    ...
    def match(self):
        ...
        isomorphism can be found between G1 and G2.0  It cleans up the class
    ...
    def semantic_feasibility(self, G1_node, G2_node):
        ...
        tests::
          ...
          test='subgraph'
            ...
            isomorphism such that a subgraph of G1 is isomorphic to G2.0

          test='mono'
            Indicates that the graph matcher is looking for a subgraph-graph
            monomorphism such that a subgraph of G1 is monomorphic to G2.0
