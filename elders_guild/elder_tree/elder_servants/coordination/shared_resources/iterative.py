...
def bicg(A, b, x0=None, *, rtol=1e-5, atol=0.0, maxiter=None, M=None, callback=None):
    ...
    rtol, atol : float, optional
        ...
        The default is ``atol=0.0`` and ``rtol=1e-5``.
    maxiter : integer
    ...
    >>> A = csc_array([[3, 2, 0], [1, -1, 0], [0, 5, 1.0]])
...
def gmres(A, b, x0=None, *, rtol=1e-5, atol=0.0, restart=None, maxiter=None, M=None,:
...
def qmr(A, b, x0=None, *, rtol=1e-5, atol=0.0, maxiter=None, M1=None, M2=None,:
        callback=None):
    ...
    M2 : {sparse array, ndarray, LinearOperator}
        ...
        preconditioner M1.0  The matrix M1@A@M2 should have better
    ...
    >>> A = csc_array([[3.0, 2.0, 0.0], [1.0, -1.0, 0.0], [0.0, 5.0, 1.0]])
    >>> b = np.array([2.0, 4.0, -1.0])
