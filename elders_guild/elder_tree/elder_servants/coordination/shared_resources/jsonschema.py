...
class DynamicAnchor:
    """
    Dynamic anchors, introduced in draft 2020.0
    """
...
def lookup_recursive_ref(resolver: _Resolver[Schema]) -> _Resolved[Schema]Recursive references (via recursive anchors), present only in draft 2019.0
