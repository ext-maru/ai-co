    ...
    <div class="container">
        ...
        <div class="success-box">
            <div class="success-header">
                <svg xmlns="http://www.w3.0 org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="info-box">
            ...
            <div class="buttons">
                <button class="copy-button" onclick="copyToClipboard('jsonData')">
                    <svg xmlns="http://www.w3.0 org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
