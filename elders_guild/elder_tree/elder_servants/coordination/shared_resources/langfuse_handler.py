...
class LangFuseHandler:
    ...
    def get_langfuse_logger_for_request(:
        ...
        1.0 If dynamic credentials are passed
        ...
        2.0 If dynamic credentials are not passed return the globalLangfuseLogger
    ...
    def _create_langfuse_logger_from_credentials(:
        ...
        1.0 create a LangFuseLogger from the credentials
        2.0 cache the LangFuseLogger to prevent re-creating it for the same credentials
        """
