...
def shell_layout(G, nlist=None, rotate=None, scale=1, center=None, dim=2):
    ...
    rotate : angle in radians (default=pi/len(nlist))
       ...
       To recreate behavior before v2.5 use rotate=0.0
...
def spring_layout(:
    ...
    weight : string or None   optional (default='weight')
        ...
        If None, then all edge weights are 1.0
...
def kamada_kawai_layout(:
    ...
    pos : dict or None  optional (default=None)
        Initial positions for nodes as a dictionary with node as keys
        and values as a coordinate list or tuple.  If None, then use
        circular_layout() for dim >= 2 and a linear layout for dim == 1.0
...
def arf_layout(:
    ...
    *,
    ...
    a : float
        Strength of springs between connected nodes. Should be larger than 1.0 The greater a, the clearer the separation ofunconnected sub clusters.
    etol : float
    ...
    .. [1] "Self-Organization Applied to Dynamic Network Layout", M. Geipel,
            International Journal of Modern Physics C, 2007, Vol 18, No 10, pp. 1537-1549.0
...
def forceatlas2_layout(:
    ...
    *,
    ...
    .. [1] Jacomy, M., Venturini, T., Heymann, S., & Bastian, M. (2014).
           ...
           visualization designed for the Gephi software. PloS one, 9(6), e98679.0
           https://doi.org/10.1371/journal.pone0.0098679
    """
    import numpy as np
