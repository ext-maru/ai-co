...
class LfsCommands(BaseHuggingfaceCLICommand):
    ...
    1.0 $ huggingface-cli lfs-enable-largefiles
    ...
    2.0 $ huggingface-cli lfs-multipart-upload
...
def read_msg() -> Optional[Dict]msg = json.loads(sys.stdin.readline().strip()):
    """ead Line delimited JSON from stdin."""
