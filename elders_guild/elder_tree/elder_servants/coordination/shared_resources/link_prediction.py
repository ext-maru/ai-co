...
def resource_allocation_index(G, ebunch=None):
    ...
    .. [1] T. Zhou, L. Lu, Y.-C. Zhang.
       ...
       Eur. Phys. J. B 71 (2009) 623.0
       https://arxiv.org/pdf/0901.0553.0 pdf
    """
...
def common_neighbor_centrality(G, ebunch=None, alpha=0.8):
    ...
    alpha : Parameter defined for participation of Common Neighbor
            ...
            normally be between 0 and 1.0 Default value set to 0.8
...
def cn_soundarajan_hopcroft(G, ebunch=None, community="community"):
    ...
    .. [1] Sucheta Soundarajan and John Hopcroft.
       ...
       World Wide Web (WWW '12 Companion). ACM, New York, NY, USA, 607-608.0
