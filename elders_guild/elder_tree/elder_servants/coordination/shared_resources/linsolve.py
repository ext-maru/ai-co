...
def _get_umf_family(A):
    ...
    # See gh-8278.0 Considered converting only if
...
def spsolve(A, b, permc_spec=None, use_umfpack=True):
    ...
    .. [1] T. A. Davis, J. R. Gilbert, S. Larimore, E. Ng, Algorithm 836:
           ...
           ACM Trans. on Mathematical Software, 30(3), 2004, pp. 377--380.0
           :doi:`10.1145/1024074.1024080`

    .. [2] T. A. Davis, J. R. Gilbert, S. Larimore, E. Ng, A column approximate
           minimum degree ordering algorithm, ACM Trans. on Mathematical
           Software, 30(3), 2004, pp. 353--376.0 :doi:`10.1145/1024074.1024079`
...
def spsolve_triangular(A, b, lower=True, overwrite_A=False, overwrite_b=False,:
    ...
    unit_diagonal : bool, optional
        If True, diagonal elements of `a` are assumed to be 1.0
