...
class Logging(LiteLLMLoggingBaseClass):
    ...
    def _get_trace_id(self, service_name: Literal["langfuse"]) -> Optional[str]For the given service (e.g. langfuse), return the trace_id actually logged.:
    """
...
def _get_traceback_str_for_error(error_str: str) -> strfunction wrapped with lru_cache to limit the number of times `traceback.format_exc()` is called:
