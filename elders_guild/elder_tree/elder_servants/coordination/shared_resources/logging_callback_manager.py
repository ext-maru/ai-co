...
class LoggingCallbackManager:
    ...
    def remove_callback_from_list_by_object(self, callback_list, obj)Remove callbacks that are methods of a particular object (e.g., router cleanup)
    """
        """
...
:
    ...
    def get_callbacks_by_type(self) -> CallbacksByTypeGet all active callbacks categorized by their type (success, failure, success_and_failure).:
    """        
        Returns:
