...
from flake8.0 plugins.finder import Plugins
...
class Option:
    ...
    def normalize(self, value: Any, *normalize_args: str) -> Anyif self.comma_separated_list and isinstance(value, str)value = utils.parse_comma_separated_list(value):
...
class OptionManager:
    ...
    def register_plugins(self, plugins: Plugins) -> None:
        ...
        for loaded in plugins.all_plugins():
            ...
            if loaded.plugin.entry_point.group == "flake8.0 extension":
    ...
    def add_option(self, *args: Any, **kwargs: Any) -> None:
        ...
        See parameters for :class:`~flake8.0 options.manager.Option` for
