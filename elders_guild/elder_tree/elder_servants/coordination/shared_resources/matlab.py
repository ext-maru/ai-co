...
class MatlabLexer(RegexLexer):
    ...
    tokens = {
        'expressions': [
            ...
            # numbers (must come before punctuation to handle `0.5`; cannot use
            # `\b` due to e.g. `5.0 + 0.5`).  The negative lookahead on operators
            # avoids including the dot in `1.0/x` (the dot is part of `./`).
            ...
            (
                words(
                    [
                        ...
                        "GraphPlot",
                        "H5.0 close",
                        "H5.0 garbage_collect",
                        "H5.0 get_libversion",
                        "H5.0 open",
                        "H5.0 set_free_list_limits",
                        "H5A.close",
                        "H5A.create",
                        "H5A.delete",
                        "H5A.get_info",
