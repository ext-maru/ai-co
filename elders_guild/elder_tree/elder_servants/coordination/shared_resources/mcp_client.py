...
class MCPClient:
    ...
    async def __aenter__(self)await self.client.__aenter__()
    """Enter the context manager"""
        await self.exit_stack.__aenter__()
        return self

    async def __aexit__(self, exc_type, exc_val, exc_tb)await self.client.__aexit__(exc_type, exc_val, exc_tb)
    """Exit the context manager"""
        await self.cleanup()

    async def cleanup(self)await self.client.close()
    """Clean up resources"""
