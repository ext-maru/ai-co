"""
1.0 Allow proxy admin to perform create, update, and delete operations on MCP servers in the db.
2.0 Allows users to view the mcp servers they have access to.
