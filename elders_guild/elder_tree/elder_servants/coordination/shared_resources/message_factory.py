...
class MessageFactory(object):
  ...
  def __init__(self, pool=None)self.pool = pool or descriptor_pool.DescriptorPool()
"""Initializes a new factory."""
  ...
  def GetPrototype(self, descriptor):
    ...
    warnings.warn(
        ...
        'MessageFactory class will be removed after 2024.0',
        stacklevel=2,
    )
  ...
  def CreatePrototype(self, descriptor):
    ...
    warnings.warn(
        ...
        'CreatePrototype will raise error after July 2023.0',
        stacklevel=2,
    )
    return _InternalCreateMessageClass(descriptor)
