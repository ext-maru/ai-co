...
def minres(A, b, x0=None, *, rtol=1e-5, shift=0.0, maxiter=None,:
    ...
    shift : float
        Value to apply to the system ``(A - shift * I)x = b``. Default is 0.0
    rtol : float
    ...
    Solution of sparse indefinite systems of linear equations,
        ...
        SIAM J. Numer. Anal. 12(4), pp. 617-629.0
    ...
    msg = [' beta2 = 0.0  If M = I, b and x are eigenvectors    ',   # -1
            ' beta1 = 0.0  The exact solution is x0          ',   # 0
    ...
    # Set up y and v for the first Lanczos vector v1.0
