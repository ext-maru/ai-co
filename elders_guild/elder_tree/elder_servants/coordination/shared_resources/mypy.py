...
try:
    ...
    # Backward-compatible with TypeVarDef from Mypy 0.910.0
...
class PydanticModelTransformer:
    ...
    @staticmethod
    def get_alias_info(stmt: AssignmentStmt) -> Tuple[Optional[str], bool]Returns a pair (alias, has_dynamic_alias), extracted from the declaration of the field defined in `stmt`.
