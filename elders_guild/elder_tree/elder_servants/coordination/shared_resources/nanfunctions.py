...
def _remove_nan_1d(arr1d, overwrite_input=False)Equivalent to arr1d[~arr1d.isnan()], but in a different order
"""
...
def nanmedian(a, axis=None, out=None, overwrite_input=False, keepdims=np._NoValue):
    ...
    axis : {int, sequence of int, None}, optional
        ...
        A sequence of axes is supported since version 1.9.0.0
    out : ndarray, optional
        Alternative output array in which to place the result. It must
        have the same shape and buffer length as the expected output,
...
def nanpercentile(:
    ...
    method : str, optional
        ...
        1.0 'inverted_cdf'
        2.0 'averaged_inverted_cdf'
        3.0 'closest_observation'
        4.0 'interpolated_inverted_cdf'
        5.0 'hazen'
        6.0 'weibull'
        7.0 'linear'  (default)
        8.0 'median_unbiased'
        ...
        following discontinuous variations of the default 'linear' (7.0) option:
