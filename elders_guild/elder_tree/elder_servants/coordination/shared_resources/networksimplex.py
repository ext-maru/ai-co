...
class _DataEssentialsAndFunctions:
    ...
    def find_cycle(self, i, p, q)Returns the nodes and edges on the cycle containing edge i == (p, q)
    """
    ...
    def remove_edge(self, s, t)Remove an edge (s, t) where parent[t] == s from the spanning tree.
    """
        """
    ...
    def add_edge(self, i, p, q)Add an edge (p, q) to the spanning tree where q is the root of a subtree.
    """
        """
        last_p = self.last_descendent_dft[p]
...
def network_simplex(G, demand="demand", capacity="capacity", weight="weight"):
    ...
    weight : string
        ...
        that edge. If not present, the weight is considered to be 0.0
    ...
    node v a demand a 1.0 Then run the network simplex. The value of a
    ...
    .. [1] Z. Kiraly, P. Kovacs.
           ...
           Acta Universitatis Sapientiae, Informatica 4(1):67--118.0 2012.0
    .. [2] R. Barr, F. Glover, D. Klingman.
           Enhancement of spanning tree labeling procedures for network
           optimization.
           INFOR 17(1):16--34.0 1979.0
    """
    ###########################################################################
