...
class BagObj:
    ...
    def __dir__(self)Enables dir(bagobj) to list the files in an NpzFile.
    """
...
class NpzFile(Mapping):
    ...
    allow_pickle : bool, optional
        ...
        .. versionchanged:: 1.16.3
            Made default False in response to CVE-2019-6446.0

    pickle_kwargs : dict, optional
        Additional keyword arguments to pass on to pickle.load.
        These are only useful when loading object arrays saved on
        Python 2 when using Python 3.0
...
def save(file, arr, allow_pickle=True, fix_imports=True):
    ...
    fix_imports : bool, optional
        ...
        Python 2, so that the pickle data stream is readable with Python 2.0
...
def _read(fname, *, delimiter=',', comment='#', quote='"',:
    ...
    ndmin : int, optional
        ...
        Allowed values are 0, 1 or 2.0  Default is 0.0
    ...
    >>> a2
    array([(1.0 , 10, b'alpha'), (2.3, 25, b'beta'), (4.5, 16, b'gamma')],
    ...
    if len(imaginary_unit) != 1:
        raise ValueError('len(imaginary_unit) must be 1.0')
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,:
    ...
    skiprows : int, optional
        Skip the first `skiprows` lines, including comments; default: 0.0
    ...
    ndmin : int, optional
        ...
        Legal values: 0 (default), 1 or 2.0
    ...
    array([1.e+00, 2.5e+00, 3.e+03, 1.8e+02, 5.e+00])
    ...
    array([('alpha, #42', 10.0), ('beta, #64',  2.0)],
...
def savetxt(fname, X, fmt='%0.18e', delimiter=' ', newline='\n', header='',:
    ...
    fmt : str or sequence of strs, optional
        ...
        * a single specifier, `fmt='%0.4e'`, resulting in numbers formatted
          like `' (%s+%sj)' % (fmt, fmt)`
        * a full string specifying every real and imaginary part, e.g.
          `' %0.4e %+0.4ej %0.4e %+0.4ej %0.4e %+0.4ej'` for 3 columns
        * a list of specifiers, one per column - in this case, the real
          and imaginary part must have separate specifiers,
          e.g. `['%0.3e + %0.3ej', '(%0.15e%+0.15ej)']` for 2 columns
    delimiter : str, optional
    ...
    encoding : {None, str}, optional
        ...
        you will not be able to load the file in NumPy versions < 1.14.0 Default
        is 'latin1'.
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,:
    ...
    skiprows : int, optional
        `skiprows` was removed in numpy 1.10.0 Please use `skip_header` instead.
    ...
    missing : variable, optional
        `missing` was removed in numpy 1.10.0 Please use `missing_values`
        instead.
    ...
    max_rows : int,  optional
        ...
        at the same time.  If given, the value must be at least 1.0 Default is
    ...
    * Individual values are not stripped of spaces by default.
    ...
    if max_rows is not None:
        ...
        if max_rows < 1:
            raise ValueError("'max_rows' must be at least 1.0")
...
#        else:
    ...
    if dtype is None:
        ...
        if names and dtype.names is not None:
            dtype.names = names
        # Case 1.0 We have a structured type
        if len(dtype_flat) > 1:
        ...
        # Case #2.0 We have a basic dtype
        else:
