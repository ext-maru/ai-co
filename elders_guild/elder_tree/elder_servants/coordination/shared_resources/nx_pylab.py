...
def draw_networkx(G, pos=None, arrows=None, with_labels=True, **kwds):
    ...
    node_color : color or array of colors (default='#1f78b4')
        ...
        floats from 0-1.0 If numeric values are specified they will be
...
def draw_networkx_nodes(:
    ...
    pos : dictionary
        A dictionary with nodes as keys and positions as values.
        Positions should be sequences of length 2.0
    ...
    edgecolors : [None | scalar | sequence] (default = node_color)
        ...
        from 0-1.0 If numeric values are specified they will be mapped to colors
