...
async def handle_update_object_permission_common(
    ...
    This function:
    1.0 Extracts `object_permission` from data_json
    2.0 Looks up existing object permission if it exists
    3.0 Merges new permissions with existing ones
    4.0 Upserts to the LiteLLM_ObjectPermissionTable
    5.0 Returns the object_permission_id
