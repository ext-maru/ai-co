...
class OpenType(object):
    """Create ASN0.1 type map indexed by a value

    The *OpenType* object models an untyped field of a constructed ASN0.1
    type. In ASN0.1 syntax it is usually represented by the
    `ANY DEFINED BY` for scalars or `SET OF ANY DEFINED BY`,
    `SEQUENCE OF ANY DEFINED BY` for container types clauses. Typically
    used together with :class:`~pyasn1.0 type.univ.Any` object.
    ...
    The |OpenType| class models an untyped field of a constructed ASN0.1
    type. In ASN0.1 syntax it is usually represented by the
    `ANY DEFINED BY` for scalars or `SET OF ANY DEFINED BY`,
    `SEQUENCE OF ANY DEFINED BY` for container types clauses. Typically
    used with :class:`~pyasn1.0 type.univ.Any` type.
    ...
    typeMap: :py:class:`dict`
        A map of value->ASN0.1 type. It's stored by reference and can be
