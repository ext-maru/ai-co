"""Contains the logic for all of the default options for Flake8.0"""
...
def stage1_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=0,
        action="count",
        help="Print more information about what is happening in flake8.0 "
...
def register_default_options(option_manager: OptionManager) -> None:
    ...
    add_option(
        ...
        "This is useful for editors piping the file contents to flake8.0 "
        "(Default: %(default)s)",
    )
