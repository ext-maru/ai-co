...
from typing import (
	Any,
	AnyStr,
	Iterable,  # Replaced by `collections.abc.Iterable` in 3.9.0
	Iterator,  # Replaced by `collections.abc.Iterator` in 3.9.0
	Match as MatchHint,  # Replaced by `re.Match` in 3.9.0
	Optional,  # Replaced by `X | None` in 3.10.0
	Pattern as PatternHint,  # Replaced by `re.Pattern` in 3.9.0
	Tuple,  # Replaced by `tuple` in 3.9.0
	Union)  # Replaced by `X | Y` in 3.10.0
...
class RegexPattern(Pattern):
	...
	def __eq__(self, other: 'RegexPattern') -> boolTests the equality of this regex pattern with *other* (:class:`RegexPattern`)
"""
