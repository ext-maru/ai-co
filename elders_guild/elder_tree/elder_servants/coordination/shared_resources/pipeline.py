...
class _Pipeline(Generic[_InT, _OutT]):
    ...
    def predicate(self: _Pipeline[_InT, _NewOutT], func: Callable[[_NewOutT], bool]) -> _Pipeline[_InT, _NewOutT]return self.constrain(annotated_types.Predicate(func)):
    """onstrain a value to meet a certain predicate."""

    def gt(self: _Pipeline[_InT, _NewOutGt], gt: _NewOutGt) -> _Pipeline[_InT, _NewOutGt]return self.constrain(annotated_types.Gt(gt)):
    """onstrain a value to be greater than a certain value."""

    def lt(self: _Pipeline[_InT, _NewOutLt], lt: _NewOutLt) -> _Pipeline[_InT, _NewOutLt]return self.constrain(annotated_types.Lt(lt)):
    """onstrain a value to be less than a certain value."""

    def ge(self: _Pipeline[_InT, _NewOutGe], ge: _NewOutGe) -> _Pipeline[_InT, _NewOutGe]return self.constrain(annotated_types.Ge(ge)):
    """onstrain a value to be greater than or equal to a certain value."""

    def le(self: _Pipeline[_InT, _NewOutLe], le: _NewOutLe) -> _Pipeline[_InT, _NewOutLe]return self.constrain(annotated_types.Le(le)):
    """onstrain a value to be less than or equal to a certain value."""

    def len(self: _Pipeline[_InT, _NewOutLen], min_len: int, max_len: int | None = None) -> _Pipeline[_InT, _NewOutLen]return self.constrain(annotated_types.Len(min_len, max_len)):
    """onstrain a value to have a certain length."""
    ...
    def multiple_of(self: _Pipeline[_InT, Any], multiple_of: Any) -> _Pipeline[_InT, Any]return self.constrain(annotated_types.MultipleOf(multiple_of)):
    """onstrain a value to be a multiple of a certain number."""

    def eq(self: _Pipeline[_InT, _OutT], value: _OutT) -> _Pipeline[_InT, _OutT]return self.constrain(_Eq(value)):
    """onstrain a value to be equal to a certain value."""

    def not_eq(self: _Pipeline[_InT, _OutT], value: _OutT) -> _Pipeline[_InT, _OutT]return self.constrain(_NotEq(value)):
    """onstrain a value to not be equal to a certain value."""

    def in_(self: _Pipeline[_InT, _OutT], values: Container[_OutT]) -> _Pipeline[_InT, _OutT]return self.constrain(_In(values)):
    """onstrain a value to be in a certain set."""

    def not_in(self: _Pipeline[_InT, _OutT], values: Container[_OutT]) -> _Pipeline[_InT, _OutT]return self.constrain(_NotIn(values)):
    """onstrain a value to not be in a certain set."""
    ...
    # operators
    def otherwise(self, other: _Pipeline[_OtherIn, _OtherOut]) -> _Pipeline[_InT | _OtherIn, _OutT | _OtherOut]return _Pipeline((_PipelineOr(self, other),)):
    """ombine two validation chains, returning the result of the first chain if it succeeds, and the second chain if it fails."""

    __or__ = otherwise

    def then(self, other: _Pipeline[_OutT, _OtherOut]) -> _Pipeline[_InT, _OtherOut]return _Pipeline((_PipelineAnd(self, other),)):
    """ipe the result of one validation chain into another."""
