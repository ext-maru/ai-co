...
def power(G, k):
    ...
    References
    ----------
    .. [1] J. A. Bondy, U. S. R. Murty, *Graph Theory*. Springer, 2008.0
...
def corona_product(G, H):
    ...
    [1] M. Tavakoli, F. Rahbarnia, and A. R. Ashrafi,
        ...
        doi: 10.22108/toc0.2014.5542.0
    [2] A. Faraji, "Corona Product in Graph Theory," Ali Faraji, May 11, 2021.0
...
def modular_product(G, H):
    ...
    .. [1] R. Hammack, W. Imrich, and S. Klavžar,
        "Handbook of Product Graphs", CRC Press, 2011.0
    ...
    .. [2] H. G. Barrow and R. M. Burstall,
        ...
        1976, https://doi.org/10.1016/0020-0190(76)90049-1.0
    ...
    .. [3] V. G. Vizing, "Reduction of the problem of isomorphism and isomorphic
        ...
        All-Union Conference on Problems of Theoretical Cybernetics. 1974.0
    """
