...
#
# 1.0 As a protocol class, it can be used in type annotations to describe the
#    available methods and attributes of a validator

# 3.0 It is runtime_checkable, meaning that it can be used in isinstance()
#    checks.
#
...
class Validator(Protocol):
    ...
    def is_type(self, instance: Any, type: str) -> boolCheck if the instance is of the given (JSON Schema) type.:
    """
        Arguments:
