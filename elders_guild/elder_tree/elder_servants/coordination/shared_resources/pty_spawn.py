...
class spawn(SpawnBase):
    ...
    def send(self, s):
        ...
        other systems honor the POSIX0.1 definition PC_MAX_CANON -- 1024
    ...
    def interact(self, escape_character=chr(29),:
        ...
        function to decode and encode back to UTF-8.0
...
def spawnu(*args, **kwargs)kwargs.setdefault('encoding', 'utf-8')
