...
class PtyProcess(object):
    ...
    def spawn(:
        ...
        # [issue #119] 1.0 Before forking, open a pipe in the parent process.
        ...
        if pid == CHILD:
            ...
            # [issue #119] 3.0 The child closes the reading end and sets the
            ...
            try:
                ...
                # [issue #119] 5.0 If exec fails, the child writes the error
        ...
        # [issue #119] 2.0 After forking, the parent closes the writing end
        # of the pipe and reads from the reading end.
        os.close(exec_err_pipe_write)
        exec_err_data = os.read(exec_err_pipe_read, 4096)
        os.close(exec_err_pipe_read)

        # [issue #119] 6.0 The parent reads eof (a zero-length read) if the
