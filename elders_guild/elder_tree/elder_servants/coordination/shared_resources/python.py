...
class PythonLexer(RegexLexer):
    """
    For Python source code (version 3.0 x).
...
class Python2Lexer(RegexLexer):
    ...
    url = 'https://www.python.org'
    aliases = ['python2', 'py2']
    filenames = []  # now taken over by PythonLexer (3.0 x)
...
class PythonTracebackLexer(RegexLexer):
    """
    For Python 3.0 x tracebacks, with support for chained exceptions.
