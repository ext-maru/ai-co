...
1.0 Obtaining a list of challenges from the reauth server.
2.0 Running through each challenge and sending the result back to the reauth
   server.
3.0 Refreshing the access token using the returned rapt token.
"""
