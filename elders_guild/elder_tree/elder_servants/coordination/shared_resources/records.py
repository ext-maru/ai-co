...
of these using structured types, such as::
  ...
  >>> a
  array([(1, 2.0), (1, 2.0)], dtype=[('x', '<i8'), ('y', '<f8')])
...
class recarray(ndarray):
    ...
    1.0 Create a standard ndarray and convert it to a record array,
       using ``arr.view(np.recarray)``
    2.0 Use the `buf` keyword.
    3.0 Use `np.rec.fromrecords`.
    ...
    >>> x
    array([(1.0, 2), (3.0, 4)], dtype=[('x', '<f8'), ('y', '<i8')])
...
def fromarrays(arrayList, dtype=None, shape=None, formats=None,:
    ...
    >>> r
    rec.array([(1, b'a', 1.1), (2, b'dd', 2.0 ), (3, b'xyz', 3.0 ),
               (4, b'12', 4.0 )],
...
def fromfile(fd, dtype=None, shape=None, offset=0, formats=None,:
    ...
    if hasattr(fd, 'readinto'):
        # GH issue 2504.0 fd supports io.RawIOBase or io.BufferedIOBase interface.
