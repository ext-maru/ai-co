...
class EvalResult:
    ...
    For more information on the model-index spec, see https://github.com/huggingface/hub-docs/blob/main/modelcard.md?plain=1.0
...
class CardData:
    ...
    def get(self, key: str, default: Any = None) -> Anyvalue = self.__dict__.get(key):
    """et value for a given metadata key."""
        return default if value is None else value

    def pop(self, key: str, default: Any = None) -> Anyreturn self.__dict__.pop(key, default):
    """op value for a given metadata key."""
    ...
    def __len__(self) -> intreturn len(self.__dict__):
    """eturn the number of metadata keys set."""
