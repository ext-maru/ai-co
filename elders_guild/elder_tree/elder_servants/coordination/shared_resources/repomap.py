...
SQLITE_ERRORS = (sqlite3OperationalError, sqlite3DatabaseError, OSError)
...
class RepoMap:
    ...
    def get_repo_map(:
        ...
        if self.verbose:
            ...
            self.io.tool_output(f"Repo-map: {num_tokens / 1024:0.1f} k-tokens")
    ...
    def get_ranked_tags(:
        ...
        for (fname, ident), rank in ranked_definitions:
            # print(f"{rank:0.03f} {fname} {ident}")
    ...
    def get_ranked_tags_map_uncached(:
        ...
        while lower_bound <= upper_bound:
            ...
            if middle > 1500:
                show_tokens = f"{middle / 1000.0:0.1f}K"
            else:
