...
class Repository:
    ...
    def git_config_username_and_email(self, git_user: Optional[str] = None, git_email: Optional[str] = None)Sets git username and email (only in the current repo).
    """
    ...
    def auto_track_large_files(self, pattern: str = ".") -> List[str]Automatically track large files (files that weigh more than 10MBs) with:
    """        git-lfs.
    ...
    def lfs_prune(self, recent=False):
        ...
        Args:
            recent (`bool`, *optional*, defaults to `False`):
                ...
                [link](https://github.com/git-lfs/git-lfs/blob/f3d43f0428a84fc4f1e5405b76b5a73ec2437e65/docs/man/git-lfs-prune0.1.0 ronn#recent-files)
