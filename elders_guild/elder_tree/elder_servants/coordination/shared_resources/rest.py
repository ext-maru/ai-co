...
class OperationsRestTransport(OperationsTransport):
    ...
    def _list_operations(:
        ...
        *,
        ...
        retry: OptionalRetry = gapic_v1.0 method.DEFAULT,
        timeout: Optional[float] = None,
        compression: Optional[grpc.Compression] = gapic_v1.0 method.DEFAULT,
    ...
    def list_operations(:
        ...
        [operations_pb2.0 ListOperationsRequest], operations_pb2.0 ListOperationsResponse:
    ]:
    ...
    def get_operation(:
        self,
    ) -> Callable[[operations_pb2.0 GetOperationRequest], operations_pb2.0 Operation]:
        return self._get_operation

    @property
    def delete_operation(:
        self,
    ) -> Callable[[operations_pb2.0 DeleteOperationRequest], empty_pb2.0 Empty]:
        return self._delete_operation

    @property
    def cancel_operation(:
        self,
    ) -> Callable[[operations_pb2.0 CancelOperationRequest], empty_pb2.0 Empty]:
