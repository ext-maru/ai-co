...
DEFAULT_CLIENT_INFO = gapic_v1.0 client_info.ClientInfo(
...
class AsyncOperationsRestTransport(OperationsTransport):
    ...
    designed to return [Operation][google.api_core.operations_v1.0 Operation] to the
    ...
    def __init__(:
        ...
        *,
        ...
        client_info: gapic_v1.0 client_info.ClientInfo = DEFAULT_CLIENT_INFO,
        ...
        Args:
            ...
            client_info (google.api_core.gapic_v1.0 client_info.ClientInfo):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_operations: gapic_v1.0 method_async.wrap_method(
            ...
            self.get_operation: gapic_v1.0 method_async.wrap_method(
                self.get_operation,
                default_retry=retries_async.AsyncRetry(
                    initial=0.5,
                    maximum=10.0,
            ...
            self.delete_operation: gapic_v1.0 method_async.wrap_method(
            ...
            self.cancel_operation: gapic_v1.0 method_async.wrap_method(
    ...
    async def _list_operations(
        self,
        request: operations_pb2.0 ListOperationsRequest,
        *,

        # to allow configuring retryable error codes.
        retry=gapic_v1.0 method_async.DEFAULT,
        timeout: Optional[float] = None,
        metadata: Sequence[Tuple[str, str]] = (),
    ) -> operations_pb2.0 ListOperationsResponse:
        r"""Asynchronously call the list operations method over HTTP.

        Args:
            request (~.operations_pb2.0 ListOperationsRequest):
                The request object. The request message for
                [Operations.ListOperations][google.api_core.operations_v1.0 Operations.ListOperations].
        ...
        query_params_request = operations_pb2.0 ListOperationsRequest()
        ...
        # Return the response
        api_response = operations_pb2.0 ListOperationsResponse()
        json_format.Parse(content, api_response, ignore_unknown_fields=False)
        return api_response

    async def _get_operation(
        self,
        request: operations_pb2.0 GetOperationRequest,
        *,
        ...
        timeout: Optional[float] = None,
        metadata: Sequence[Tuple[str, str]] = (),
    ) -> operations_pb2.0 Operation:
        r"""Asynchronously call the get operation method over HTTP.

        Args:
            request (~.operations_pb2.0 GetOperationRequest):
                The request object. The request message for
                [Operations.GetOperation][google.api_core.operations_v1.0 Operations.GetOperation].
            timeout (float): The timeout for this request.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        ...
        # Jsonify the query params
        query_params_request = operations_pb2.0 GetOperationRequest()
        json_format.ParseDict(transcoded_request["query_params"], query_params_request)
        query_params = json_format.MessageToDict(
            query_params_request,
            preserving_proto_field_name=False,
        ...
        # Return the response
        api_response = operations_pb2.0 Operation()
        json_format.Parse(content, api_response, ignore_unknown_fields=False)
        return api_response

    async def _delete_operation(
        self,
        request: operations_pb2.0 DeleteOperationRequest,
        *,
        ...
        Args:
            request (~.operations_pb2.0 DeleteOperationRequest):
                The request object. The request message for
                [Operations.DeleteOperation][google.api_core.operations_v1.0 Operations.DeleteOperation].
        ...
        # Jsonify the query params
        query_params_request = operations_pb2.0 DeleteOperationRequest()
        json_format.ParseDict(transcoded_request["query_params"], query_params_request)
        query_params = json_format.MessageToDict(
            query_params_request,
            preserving_proto_field_name=False,
        ...
        return empty_pb2.0 Empty()

    async def _cancel_operation(
        self,
        request: operations_pb2.0 CancelOperationRequest,
        *,
        ...
        Args:
            request (~.operations_pb2.0 CancelOperationRequest):
                The request object. The request message for
                [Operations.CancelOperation][google.api_core.operations_v1.0 Operations.CancelOperation].
            timeout (float): The timeout for this request.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
        ...
        body_request = operations_pb2.0 CancelOperationRequest()
        ...
        # Jsonify the query params
        query_params_request = operations_pb2.0 CancelOperationRequest()
        json_format.ParseDict(transcoded_request["query_params"], query_params_request)
        query_params = json_format.MessageToDict(
            query_params_request,
            preserving_proto_field_name=False,
    ...
    def list_operations(:
        ...
        [operations_pb2.0 ListOperationsRequest],
        Coroutine[Any, Any, operations_pb2.0 ListOperationsResponse],:
    ]:
    ...
    def get_operation(:
        ...
        [operations_pb2.0 GetOperationRequest],
        Coroutine[Any, Any, operations_pb2.0 Operation],:
    ]:
    ...
    def delete_operation(:
        ...
        [operations_pb2.0 DeleteOperationRequest], Coroutine[Any, Any, empty_pb2.0 Empty]:
    ]:
    ...
    def cancel_operation(:
        ...
        [operations_pb2.0 CancelOperationRequest], Coroutine[Any, Any, empty_pb2.0 Empty]:
    ]:
