...
class ParseResults:
    ...
    def haskeys(self) -> boolSince ``keys()`` returns an iterator, this method is helpful in bypassing
    
        code that looks for the existence of any defined results names.
        return not not self._tokdict

    def pop(self, *args, **kwargs)Removes and returns item at specified index (default= ``last``).:
