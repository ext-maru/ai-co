...
class Corpus:
    ...
    def query(:
        ...
        Args:
            ...
            results_count: The maximum number of `Chunk`s to return; must be less than 100.0
            request_options: Options for the request.
        ...
        if results_count:
            if results_count > 100:
                raise ValueError(
                    "Invalid operation: The number of results returned must be between 1 and 100.0"
                )
