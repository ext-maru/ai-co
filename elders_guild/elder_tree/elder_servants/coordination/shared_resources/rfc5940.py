...
#
# Created by Russ Housley with assistance from asn1ate v0.0.6.0.0
...
#
# ASN0.1 source from:
# https://www.rfc-editor.org/rfc/rfc5940.0 txt
#

from pyasn1.0 type import namedtype
from pyasn1.0 type import tag
...
OCSPResponse = rfc2560.0 OCSPResponse
...
ContentInfo = rfc5652.0 ContentInfo
...
# is added to the ones that are in rfc5652.0 py
...
rfc5652.0 otherRevInfoFormatMap.update(_otherRevInfoFormatMapUpdate)
