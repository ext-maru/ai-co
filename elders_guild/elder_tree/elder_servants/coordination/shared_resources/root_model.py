...
class RootModel(BaseModel, typing.Generic[RootModelRootType], metaclass=_RootModelMetaclass):
    ...
    def __copy__(self) -> Selfcls = type(self)m = cls.__new__(cls)
    """eturns a shallow copy of the model."""
        _object_setattr(m, '__dict__', copy(self.__dict__))
        _object_setattr(m, '__pydantic_fields_set__', copy(self.__pydantic_fields_set__))
        return m

    def __deepcopy__(self, memo: dict[int, Any] | None = None) -> Selfcls = type(self)m = cls.__new__(cls)
    """eturns a deep copy of the model."""
