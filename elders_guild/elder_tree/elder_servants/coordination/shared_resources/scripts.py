...
FIRST_LINE_RE = re.compile(b'^#!.*pythonw?[0-9.0]*([ \t].*)?$')
...
class ScriptMaker(object):
    ...
    def _get_shebang(self, encoding, post_interp=b'', options=None):
        ...
        # issue #124.0 Although paths in Windows are generally case-insensitive,
        ...
        # check that the shebang is decodable using utf-8.0
