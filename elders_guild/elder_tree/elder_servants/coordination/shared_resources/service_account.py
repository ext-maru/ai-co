...
_GOOGLE_OAUTH2_TOKEN_ENDPOINT = "https://oauth2.0 googleapis.com/token"
...
class IDTokenCredentials(:
    ...
    def _refresh_with_iam_endpoint(self, request):
        ...
        1.0 First we create a self signed jwt with
        https://www.googleapis.com/auth/iam being the scope.

        2.0 Next we use the self signed jwt as the access token, and make a POST
