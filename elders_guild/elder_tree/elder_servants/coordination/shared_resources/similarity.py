...
def graph_edit_distance(:
    ...
    """Returns GED (graph edit distance) between graphs G1 and G2.0

    Graph edit distance is a graph similarity measure analogous to
    Levenshtein distance for strings.  It is defined as minimum cost
    of edit path (sequence of node and edge edit operations)
    transforming graph G1 to graph isomorphic to G2.0
...
def optimal_edit_paths(:
    ...
    """Returns all minimum-cost edit paths transforming G1 to G2.0

    Graph edit path is a sequence of node and edge edit operations
    transforming graph G1 to graph isomorphic to G2.0  Edit operations
...
def simrank_similarity(:
    ...
    and ``C`` is a float decay or importance factor between 0 and 1.0
...
def panther_similarity(:
    ...
    weight : string or None, optional (default="weight")
        ...
        used as a weight. If None then each edge has weight 1.0
    ...
    .. [1] Zhang, J., Tang, J., Ma, C., Tong, H., Jing, Y., & Li, J.
           ...
           Association for Computing Machinery. https://doi.org/10.1145/2783258.2783267.0
    """
    import numpy as np
