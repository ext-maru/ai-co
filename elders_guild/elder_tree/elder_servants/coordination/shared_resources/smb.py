...
class SMBFileSystem(AbstractFileSystem):
    ...
    def __init__(:
        ...
        **kwargs,
        ...
        port: int or None
            Port to connect with. Usually 445, sometimes 139.0
        ...
        register_session_retry_factor: int
            ...
            Number must be equal to or greater than 1.0 Optimal factor is 10.0
        auto_mkdir: bool
    ...
    def created(self, path)wpath = _as_unc_path(self.host, path)
    ...
    def modified(self, path)wpath = _as_unc_path(self.host, path)
    ...
    def copy(self, path1, path2, **kwargs)wpath1 = _as_unc_path(self.host, path1)
