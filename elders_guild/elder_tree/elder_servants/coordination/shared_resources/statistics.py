"""Statistic collection logic for Flake8.0"""
...
class Statistics:
    """Manager of aggregated statistics for a run of Flake8.0"""
...
class Key(NamedTuple):
    ...
    @classmethod
    def create_from(cls, error: Violation) -> Keyreturn cls(filename=error.filename, code=error.code):
    """reate a Key from :class:`flake8.violation.Violation`."""
