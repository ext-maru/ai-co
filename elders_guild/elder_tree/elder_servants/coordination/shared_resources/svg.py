...
class SvgFormatter(Formatter):
    ...
    `ystep`
        ...
        roughly be the text size plus 5.0  It defaults to that value if the text
    ...
    def format_unencoded(self, tokensource, outfile):
        ...
        if not self.nowrap:
            ...
            outfile.write('<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.0//EN" '
                          '"http://www.w3.0 org/TR/2001/REC-SVG-20010904/DTD/'
                          'svg10.0 dtd">\n')
            outfile.write('<svg xmlns="http://www.w3.0 org/2000/svg">\n')
