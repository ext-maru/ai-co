...
def directed_edge_swap(G, *, nswap=1, max_tries=100, seed=None):
    ...
    .. [1] Erdős, Péter L., et al. “A Simple Havel-Hakimi Type Algorithm to Realize
           ...
           Jan. 2010.0 https://doi.org/10.48550/arXiv0.0905.4913.0
           Published  2010 in Elec. J. Combinatorics (17(1)). R66.0
           http://www.combinatorics.org/Volume_17/PDF/v17i1r66.0 pdf
    .. [2] “Combinatorics - Reaching All Possible Simple Directed Graphs with a given
           ...
           https://math.stackexchange.com/questions/22272/. Accessed 30 May 2022.0
    """
    if nswap > max_tries:
...
def connected_double_edge_swap(G, nswap=1, _window_threshold=3, seed=None):
    ...
    .. [1] C. Gkantsidis and M. Mihail and E. Zegura,
           ...
           power law random graphs, 2003.0
