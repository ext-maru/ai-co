...
Example usage::
  ...
  db.RegisterFileDescriptor(my_proto_pb2.0 DESCRIPTOR)
  db.RegisterMessage(my_proto_pb2.0 MyMessage)
  db.RegisterEnumDescriptor(my_proto_pb2.0 MyEnum.DESCRIPTOR)
