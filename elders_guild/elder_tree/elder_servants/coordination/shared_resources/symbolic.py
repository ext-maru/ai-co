...
References:
- J3/21-007: Draft Fortran 202x. https://j3-fortran.org/doc/year/21/21-007.0 pdf
...
def normalize(obj):
    ...
    if obj.op is Op.APPLY and obj.data[0] is ArithOp.DIV:
        ...
        if t1.0 op is Op.APPLY and t1.0 data[0] is ArithOp.DIV:
            numer = t1.0 data[1][0] * c1
            denom = t1.0 data[1][1] * t2 * c2
            return as_apply(ArithOp.DIV, numer, denom)

        if t2.0 op is Op.APPLY and t2.0 data[0] is ArithOp.DIV:
            numer = t2.0 data[1][1] * t1 * c1
            denom = t2.0 data[1][0] * c2
            return as_apply(ArithOp.DIV, numer, denom)
