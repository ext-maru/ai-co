...
class TestDualAnnealing:
    ...
    def test_from_docstring(self):
        ...
        assert_allclose(ret.x,
                        [-4.26437714e-09, -3.91699361e-09, -1.86149218e-09,
                         ...
                         -3.93616815e-09, -6.55623025e-09, -6.5775280e-09,
                         -5.0668935e-09], atol=4e-8)
        assert_allclose(ret.fun, 0.00000, atol=5e-13)

        (0, 100, 1000, 1.097587941791923),
    ...
    def test_callable_jac_hess_with_args_gh11052(self):
        ...
        # used; check that this is resolved. Example is from gh-11052.0
