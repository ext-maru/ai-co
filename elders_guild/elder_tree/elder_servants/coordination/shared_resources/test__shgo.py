...
class StructTest3(StructTestFunction):
    ...
    http://www.ai7.0 uni-bayreuth.de/test_problem_coll.pdf
...
class TestShgoSobolTestFunctions:
    ...
    # Sobol algorithm
    def test_f1_1_sobol(self)x[0]**2 + x[1]**2 with bounds=[(-1, 6), (-1, 6)]"""run_test(test1_1)
    """Multivariate test function 1:

    def test_f1_2_sobol(self)x[0]**2 + x[1]**2 with bounds=[(0, 1), (0, 1)]"""run_test(test1_2)
    """Multivariate test function 1:

    def test_f1_3_sobol(self)x[0]**2 + x[1]**2 with bounds=[(None, None),(None, None)]""":
    """Multivariate test function 1:
        options = {'disp': True}
        run_test(test1_3, options=options)

    def test_f2_1_sobol(self)f(x) = (x - 30) * sin(x) with bounds=[(0, 60)]"""run_test(test2_1)
    """Univariate test function on

    def test_f2_2_sobol(self)f(x) = (x - 30) * sin(x) bounds=[(0, 4.5)]"""run_test(test2_2)
    """Univariate test function on

    def test_f3_sobol(self)run_test(test3_1):
    ...
    def test_f5_1_sobol(self)# run_test(test5_1, n=30)run_test(test5_1, n=60)
    """NLP: Eggholder, multimodal"""

    def test_f5_2_sobol(self)# run_test(test5_1, n=60, iters=5)run_test(test5_1, n=60, iters=5)
    """NLP: Eggholder, multimodal"""

        # def test_t911(self)#    run_test(test11_1)
...
class TestShgoSimplicialTestFunctions:
    ...
    def test_f1_1_simplicial(self)x[0]**2 + x[1]**2 with bounds=[(-1, 6), (-1, 6)]"""run_test(test1_1, n=1, sampling_method='simplicial')
    """Multivariate test function 1:

    def test_f1_2_simplicial(self)x[0]**2 + x[1]**2 with bounds=[(0, 1), (0, 1)]"""run_test(test1_2, n=1, sampling_method='simplicial')
    """Multivariate test function 1:

    def test_f1_3_simplicial(self)with bounds=[(None, None),(None, None)]"""run_test(test1_3, n=5, sampling_method='simplicial')
    """Multivariate test function 1: x[0]**2 + x[1]**2

    def test_f2_1_simplicial(self)f(x) = (x - 30) * sin(x) with bounds=[(0, 60)]""":
    """Univariate test function on
        options = {'minimize_every_iter': False}
        run_test(test2_1, n=200, iters=7, options=options,
                 sampling_method='simplicial')

    def test_f2_2_simplicial(self)f(x) = (x - 30) * sin(x) bounds=[(0, 4.5)]"""run_test(test2_2, n=1, sampling_method='simplicial')
    """Univariate test function on

    def test_f3_simplicial(self)run_test(test3_1, n=1, sampling_method='simplicial'):
    """NLP: Hock and Schittkowski problem 18"""

    @pytest.mark.slow
    def test_f4_simplicial(self)run_test(test4_1, n=1, sampling_method='simplicial'):
    """NLP: (High dimensional) Hock and Schittkowski 11 problem (HS11)"""
...
class TestShgoArguments:
    def test_1_1_simpl_iter(self)run_test(test1_2, n=None, iters=2, sampling_method='simplicial'):
    ...
    def test_2_1_sobol_iter(self)run_test(test1_2, n=None, iters=1, sampling_method='sobol'):
    ...
    def test_2_2_sobol_iter(self):
        ...
        res = shgo(test2_1.0 f, test2_1.0 bounds, constraints=test2_1.0 cons,
                   n=None, iters=1, sampling_method='sobol')

        np.testing.assert_allclose(res.x, test2_1.0 expected_x, rtol=1e-5, atol=1e-5)
        np.testing.assert_allclose(res.fun, test2_1.0 expected_fun, atol=1e-5)
    ...
    def test_4_1_known_f_min(self):
        ...
        options = {'f_min': test4_1.0 expected_fun,
                   'f_tol': 1e-6,
    ...
    def test_5_1_simplicial_argless(self)res = shgo(test1_1.0 f, test1_1.0 bounds, constraints=test1_1.0 cons)np.testing.assert_allclose(res.x, test1_1.0 expected_x, rtol=1e-5, atol=1e-5)
    ...
    def test_5_2_sobol_argless(self):
        ...
        res = shgo(test1_1.0 f, test1_1.0 bounds, constraints=test1_1.0 cons,
                   sampling_method='sobol')
        np.testing.assert_allclose(res.x, test1_1.0 expected_x, rtol=1e-5, atol=1e-5)

    def test_6_1_simplicial_max_iter(self):
        """Test that maximum iteration option works on TestFunction 3"""
        options = {'max_iter': 2}
        res = shgo(test3_1.0 f, test3_1.0 bounds, constraints=test3_1.0 cons,
                   options=options, sampling_method='simplicial')
        np.testing.assert_allclose(res.x, test3_1.0 expected_x, rtol=1e-5, atol=1e-5)
        np.testing.assert_allclose(res.fun, test3_1.0 expected_fun, atol=1e-5)
    ...
    def test_7_2_minkwargs(self):
        ...
        SHGO(test3_1.0 f, test3_1.0 bounds, constraints=test3_1.0 cons[0],
             minimizer_kwargs=minimizer_kwargs, options=options)
    ...
    def test_9_cons_g(self)SHGO(test3_1.0 f, test3_1.0 bounds, constraints=test3_1.0 cons[0]):
    ...
    def test_10_finite_time(self):
        ...
        res = shgo(f, test1_1.0 bounds, iters=5, options=options)
    ...
    def test_11_f_min_0(self):
        ...
        options = {'f_min': 0.0,
                   'disp': True}
        res = shgo(test1_2.0 f, test1_2.0 bounds, n=10, iters=None,
    ...
    def test_12_sobol_inf_cons(self):
        ...
        options = {'maxtime': 1e-15,
                   'f_min': 0.0}
        res = shgo(test1_2.0 f, test1_2.0 bounds, n=1, iters=None,
                   options=options, sampling_method='sobol')
    ...
    def test_21_2_derivative_options(self, derivative):
        ...
        # see gh-12963.0 check that this is resolved
        """
    ...
    def test_21_3_hess_options_rosen(self):
        ...
        routine. Previous report gh-14533.0
        """
    ...
    def test_21_arg_tuple_sobol(self):
        ...
        # see gh-12114.0 check that this is resolved"""
...
class TestShgoFailures:
    def test_1_maxiter(self):
        ...
        options = {'maxiter': 2}
        res = shgo(test4_1.0 f, test4_1.0 bounds, n=2, iters=None,
                   options=options, sampling_method='sobol')
    ...
    def test_2_sampling(self):
        ...
        assert_raises(ValueError, shgo, test1_1.0 f, test1_1.0 bounds,
    ...
    def test_4_1_bound_err(self)bounds = [(6, 3), (3, 5)]assert_raises(ValueError, shgo, test1_1.0 f, bounds)
    """Specified bounds ub > lb"""

    def test_4_2_bound_err(self)bounds = [(3, 5, 5), (3, 5)]assert_raises(ValueError, shgo, test1_1.0 f, bounds)
    ...
    def test_6_1_lower_known_f_min(self):
        ...
        options = {  # Specify known function value
            'f_min': test2_1.0 expected_fun + 2.0,
            'f_tol': 1e-6,
            # Specify number of local iterations to perform+
            'minimize_every_iter': True,
            'local_iter': 1,
            'infty_constraints': False}
        args = (test2_1.0 f, test2_1.0 bounds)
        kwargs = {'constraints': test2_1.0 cons,
                  'n': None,
                  'iters': None,
                  'options': options,
                  'sampling_method': 'sobol'
...
def test_equality_constraints():
    # gh16260
    bounds = [(0.9, 4.0)] * 2  # Constrain probabilities to 0 and 1.0
    ...
    bounds = [(0, 1.0)] * 4
    # sum of variable should equal 1.0
    def faulty(x):
