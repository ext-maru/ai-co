...
def is_parametric_dtype(dtype)is 0, or a datetime without units)
...
class TestScalarDiscovery:
    ...
    def test_default_dtype_instance(self, dtype_char):
        if dtype_char in "SU":
            ...
            # Legacy behaviour was to use V8.0 The reason was float64 being the
...
class TestArrayLikes:
    ...
    def test_too_large_array_error_paths(self)arr = np.array(0, dtype="uint8")
