...
axis_nan_policy_cases = [
    ...
    (stats.fligner, tuple(), {'center': 'trimmed', 'proportiontocut': 0.1},
     2, 2, False, None),
...
# `foneway`
@pytest.mark.filterwarnings('ignore:all input arrays have length 1.0:RuntimeWarning')
...
def _check_arrays_broadcastable(arrays, axis):
    ...
    # 1.0 they are equal, or
    # 2.0 one of them is 1
    # ...
...
def test_masked_dtype():
    ...
    # upcast the arrays to np.float64.0 After gh16662, check expected promotion
