...
class TestStringAssumedLength(util.F2PyTest):
    sources = [util.getpath("tests", "src", "string", "gh24008.0 f")]

    def test_gh24008(self):
        self.module.greet("joe", "bob")

class TestStringOptionalInOut(util.F2PyTest):
    sources = [util.getpath("tests", "src", "string", "gh24662.0 f90")]
...
class TestNewCharHandling(util.F2PyTest):
    ...
    sources = [
        util.getpath("tests", "src", "string", "gh25286.0 pyf"),
        util.getpath("tests", "src", "string", "gh25286.0 f90")
    ]
