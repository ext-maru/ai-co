...
class TestCLI(TestCase):
    ...
    def test_custom_error_format(self):
        ...
        self.assertOutputs(
            ...
            exit_code=1,
            stderr=":An error._-_0.12::Another error._-_0.12::BOOM._-_.foo:",
        )
    ...
    def test_custom_error_format_applies_to_schema_errors(self):
        ...
        self.assertOutputs(
            ...
            exit_code=1,
            stderr=":12 is not valid under any of the given schemas._-_0.12:",
        )
    ...
    def test_it_validates_using_draft7_when_specified(self):
        """
        Specifically, `const` validation applies for Draft 7.0
        """
        schema = """
            {
    ...
    def test_it_validates_using_draft4_when_specified(self):
        """
        Specifically, `const` validation *does not* apply for Draft 4.0
        """
        schema = """
            {
