...
class TestClient(unittest.TestCase):
    ...
    def set_fail(self, e, batch)print("FAIL", e, batch)  # noqa: T201
    ...
    def test_shutdown(self):
        ...
        # 1.0 client queue is empty
        # 2.0 consumer thread has stopped
        self.assertTrue(client.queue.empty())
