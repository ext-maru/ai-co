...
def test_gh17775_regression(x, n, sf, cdf, pdf, rtol):
    # Regression test for gh-17775.0 In scipy 1.9.3 and earlier,
...
def test_rvs_gh2069_regression():
    # Regression tests for gh-2069.0  In scipy 0.17 and earlier,
...
def check_distribution_rvs(dist, args, alpha, rvs):
    ...
    # alpha is a significance level, ~0.1
...
def test_moments_with_array_gh12192_regression():
    ...
    vals9 = stats.chi.moment(order=2, df=[1, 2, 3], loc=[1.0, 0.0, 2.0],
                             scale=[1.0, -3.0, 0.0])
...
def test_broadcasting_in_moments_gh12192_regression():
    ...
    vals3 = stats.chi.moment(order=1, df=[[1.0], [2.0], [3.0]], loc=[0.0, 1.0, 2.0],
                             scale=[-1.0, 0.0, 3.0])
