...
class TestNoSpace(util.F2PyTest):
    ...
    sources = [util.getpath("tests", "src", "crackfortran", "gh15035.0 f")]
...
class TestPublicPrivate:
    ...
    def test_nowrap_private_proceedures(self, tmp_path):
        fpath = util.getpath("tests", "src", "crackfortran", "gh23879.0 f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
...
class TestExternal(util.F2PyTest):
    ...
    sources = [util.getpath("tests", "src", "crackfortran", "gh17859.0 f")]
...
class TestCrackFortran(util.F2PyTest):
    ...
    sources = [util.getpath("tests", "src", "crackfortran", "gh2848.0 f90")]
...
class TestFunctionReturn(util.F2PyTest):
    sources = [util.getpath("tests", "src", "crackfortran", "gh23598.0 f90")]
...
class TestFortranGroupCounters(util.F2PyTest):
    def test_end_if_comment(self):
        # gh-23533
        fpath = util.getpath("tests", "src", "crackfortran", "gh23533.0 f")
        try:
...
class TestF77CommonBlockReader():
    def test_gh22648(self, tmp_path):
        fpath = util.getpath("tests", "src", "crackfortran", "gh22648.0 pyf")
