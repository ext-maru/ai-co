...
class TestCycles:
    ...
    def test_cycle_basis_self_loop(self)G = nx.Graph()
...
class TestCycleEnumeration:
    ...
    def test_chordless_cycles_giant_hamiltonian(self):
        ...
        # of length n/2.0  The remaining edges each belong to a triangle
...
class TestFindCycle:
    ...
    def test_multidigraph_original(self):
        # Node 2 doesn't need to be searched again from visited from 4.0
