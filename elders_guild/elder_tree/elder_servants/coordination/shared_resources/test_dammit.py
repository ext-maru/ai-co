...
class TestUnicodeDammit(object):
    ...
    def test_ignore_invalid_codecs(self):
        utf8_data = "Räksmörgås".encode("utf-8")
        for bad_encoding in [".utf8", "...", "utF---16.0!"]:
...
<i>\310\322\321\220\312\321\355\344</i></html>"""
    ...
    def test_known_definite_versus_user_encodings(self):
        ...
        # Here's a document in ISO-8859-8.0
        hebrew = b"\xed\xe5\xec\xf9"
    ...
    def test_detwingle_ignores_multibyte_characters(self):
        ...
        # in \x93.0 \x93 is a smart quote if interpreted as
        # Windows-1252.0 But our code knows to skip over multibyte
...
class TestEntitySubstitution(object):
    ...
    def test_html5_entity_with_variation_selector(self):
        ...
        # VARIATION SELECTOR 1.0 We can handle this.
