...
class TestDateTime:
    ...
    def test_datetime_scalar_construction(self):
        ...
        assert_equal(np.datetime64(datetime.date(2045, 3, 25), 'ms'),
                     np.datetime64('2045-03-25T00:00:00.00'))
    ...
    def test_pickle(self):
        ...
        for proto in range(2, pickle.HIGHEST_PROTOCOL + 1):
            ...
            dt = np.dtype('M8[W]')
            assert_equal(pickle.loads(pickle.dumps(dt, protocol=proto)), dt)
            scalar = np.datetime64('2016-01-01T00:00:00.00000000')
            assert_equal(pickle.loads(pickle.dumps(scalar, protocol=proto)),
                         scalar)
            delta = scalar - np.datetime64('2015-01-01T00:00:00.00000000')
    ...
    def test_cast_overflow(self):
        # gh-4486
        def cast():
            numpy.datetime64("1971-01-01 00:00:00.00000000000000").astype("<M8[D]")
    ...
    def test_datetime_compare(self):
        ...
        a = np.datetime64('2000-03-12T18:00:00.00000')
        b = np.array(['2000-03-12T18:00:00.00000',
                      '2000-03-12T17:59:59.999999',
                      '2000-03-12T18:00:00.00001',
