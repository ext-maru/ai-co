...
def hello_world_f90(tmpdir_factory)fdat = util.getpath("tests", "src", "cli", "hiworld.f90").read_text()
...
@pytest.fixture(scope="session")
def gh23598_warn(tmpdir_factory)fdat = util.getpath("tests", "src", "crackfortran", "gh23598Warn.f90").read_text()
...
@pytest.fixture(scope="session")
def gh22819_cli(tmpdir_factory)fdat = util.getpath("tests", "src", "cli", "gh_22819.pyf").read_text()
...
@pytest.fixture(scope="session")
def hello_world_f77(tmpdir_factory)fdat = util.getpath("tests", "src", "cli", "hi77.f").read_text()
...
@pytest.fixture(scope="session")
def retreal_f77(tmpdir_factory)fdat = util.getpath("tests", "src", "return_real", "foo77.f").read_text()
"""Generates a single f77 file for testing"""
...
@pytest.fixture(scope="session")
def f2cmap_f90(tmpdir_factory)fdat = util.getpath("tests", "src", "f2cmap", "isoFortranEnvMap.f90").read_text()
"""Generates a single f90 file for testing"""
