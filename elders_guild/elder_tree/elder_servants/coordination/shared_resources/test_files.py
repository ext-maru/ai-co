...
class ImplicitContextFiles:
    ...
    def test_implicit_files_package(self)Without any parameter, files() will infer the location as the caller.
    """
        """
        assert importlib.import_module('somepkg').val == 'resources are the best'

    def test_implicit_files_submodule(self)Without any parameter, files() will infer the location as the caller.
    """
        """
