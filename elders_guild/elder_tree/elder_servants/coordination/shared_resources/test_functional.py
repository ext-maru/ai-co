...
class FunctionalAPIBase:
    ...
    def test_read_text(self):
        self.assertEqual(
            resources.read_text(self.anchor01, 'utf-8.0 file'),
            'Hello, UTF-8 world!\n',
        )
        self.assertEqual(
            resources.read_text(
        ...
        with self.assertRaises(UnicodeDecodeError):
            resources.read_text(self.anchor01, 'utf-16.0 file')
        self.assertEqual(
            resources.read_text(
                self.anchor01,
                'binary.file',
    ...
    def test_read_binary(self):
        self.assertEqual(
            resources.read_binary(self.anchor01, 'utf-8.0 file'),
            b'Hello, UTF-8 world!\n',
        )
        for path_parts in self._gen_resourcetxt_path_parts():
            self.assertEqual(
    ...
    def test_open_text(self):
        with resources.open_text(self.anchor01, 'utf-8.0 file') as f:
        ...
        with resources.open_text(self.anchor01, 'utf-16.0 file') as f:
            with self.assertRaises(UnicodeDecodeError):
                f.read()
        with resources.open_text(:
            self.anchor01,
    ...
    def test_open_binary(self):
        with resources.open_binary(self.anchor01, 'utf-8.0 file') as f:
    ...
    def test_path(self):
        with resources.path(self.anchor01, 'utf-8.0 file') as path:
            with open(str(path), encoding='utf-8') as f:
                self.assertEqual(f.read(), 'Hello, UTF-8 world!\n')
        with resources.path(self.anchor01) as path:
            with open(os.path.join(path, 'utf-8.0 file'), encoding='utf-8') as f:
                self.assertEqual(f.read(), 'Hello, UTF-8 world!\n')

    def test_is_resource(self):
        is_resource = resources.is_resource
        self.assertTrue(is_resource(self.anchor01, 'utf-8.0 file'))
    ...
    def test_contents(self):
        ...
        self.assertGreaterEqual(
            set(c),
            {'utf-8.0 file', 'utf-16.0 file', 'binary.file', 'subdirectory'},
        )
        with (:
            ...
            list(resources.contents(self.anchor01, 'utf-8.0 file'))
