...
class TestIndexing:
    ...
    def test_slicing_no_floats(self):
        ...
        # should still get the DeprecationWarning if step = 0.0
        assert_raises(TypeError, lambda: a[::0.0])
    ...
    def test_trivial_fancy_not_possible(self):
        ...
        # used when the index is not contiguous or 1D, see also gh-11467.0
        a = np.arange(6)
    ...
    def test_subclass_writeable(self):
        d = np.rec.array([('NGC1001', 11), ('NGC1002', 1.0), ('NGC1003', 1.0)],
    ...
    def test_structured_advanced_indexing(self):
        ...
        # for structured datatypes, see gh-15387.0 This test can behave randomly.
...
class TestMultiIndexingAutomated:
    ...
    NOTE:
        ...
        * Behavior was written to match numpy version 1.8.0 (though a
          first version matched 1.7.0)
    ...
    def setup_method(self):
        ...
        self.complex_indices = ['skip', Ellipsis,
            ...
            np.array([0.0, 1.0])]  # invalid datatype
    ...
    def _get_multi_index(self, arr, indices):
        ...
        for i, indx in enumerate(in_indices):
            ...
            if not isinstance(indx, np.ndarray):
                ...
                # is not safe. It rejects np.array([1.0, 2.0]) but not
                # [1.0, 2.0] as index (same for ie. np.take).
        ...
        for ax, indx in enumerate(in_indices):
            ...
            if indx.ndim == 0:
                ...
                # possibly after broadcasting it away (1.7.0 or earlier).
...
class TestFloatNonIntegerArgument:
    ...
    and ``a[0.5]``, or other functions like ``array.reshape(1.0, -1)``.
