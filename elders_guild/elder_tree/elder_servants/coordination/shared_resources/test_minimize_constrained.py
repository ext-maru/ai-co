...
class Elec:
    ...
    .. [1] E. D. Dolan, J. J. Mor\'{e}, and T. S. Munson,
           "Benchmarking optimization software with COPS 3.0.0",
            Argonne National Lab., Argonne, IL (US), 2004.0
    """
...
class TestTrustRegionConstr:
    ...
    """
    Here we minimize x^2+y^2 subject to x^2-y^2>1.0
    ...
    def test_empty_constraint(self):
        ...
        constraint = NonlinearConstraint(constraint, 1.0, np.inf,
