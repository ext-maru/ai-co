...
def test_compare_medians_ms():
    ...
    assert_almost_equal(ms.compare_medians_ms(x, y2), 0.17116406778)
...
class TestQuantiles:
    data = [0.706560797,0.727229578,0.990399276,0.927065621,0.158953014,
            ...
            0.936947700,0.132359948,0.46041972,0.641675031,0.945530547,
            ...
            0.47841438,0.466295911,0.583850781,0.840581845,0.550086491,
            0.466470062,0.504765074,0.226855960,0.362641207,0.891620942,
            0.127898691,0.490094097,0.44882048,0.41441695,0.317976349,
            ...
            0.388382017,0.863530727,0.06514031,0.118007779,0.924024803,
            ...
            0.827928620,0.480283781,0.594514455,0.213641488,0.24194386,
            0.536668589,0.699497811,0.892804071,0.93835427,0.731107772]

    def test_hdquantiles(self):
        data = self.data
        assert_almost_equal(ms.hdquantiles(data,[0.0, 1.0]),
                            [0.06514031, 0.995309248])
    ...
    def test_hdquantiles_sd(self):
        ...
        assert_almost_equal(hd_std_errs, [0.379258, 0.380656, 0.380013])
...
def test_median_cihs():
    ...
    #       0.88043148, 0.3911248, 0.93805564, 0.95326961, 0.25291112,
