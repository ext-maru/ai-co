...
@pytest.fixture
def restore_singleton_bitgen()orig_bitgen = np.random.get_bit_generator()
...
class TestMultinomial:
    ...
    def test_multinomial_pvals_float32(self):
        x = np.array([9.9e-01, 9.9e-01, 1.0 e-09, 1.0 e-09, 1.0 e-09, 1.0 e-09,
                      1.0 e-09, 1.0 e-09, 1.0 e-09, 1.0 e-09], dtype=np.float32)
        pvals = x / x.sum()
...
class TestRandomDist:
    ...
    def test_dirichlet(self):
        ...
        assert_array_almost_equal(actual, desired, decimal=15)
        bad_alpha = np.array([5.4e-01, -1.0 e-16])
    ...
    def test_dirichlet_bad_alpha(self):
        # gh-2089
        alpha = np.array([5.4e-01, -1.0 e-16])
    ...
    def test_pareto(self):
        ...
        #   https://mail.python.org/pipermail/numpy-discussion/2012-September/063801.0 html
