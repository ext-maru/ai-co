...
class TestRegression:
    ...
    def test_VonMises_range(self):
        ...
        # Regression test for ticket #986.0
    ...
    def test_p_zero_stream(self):
        # Regression test for gh-14522.0  Ensure that future versions
        # generate the same variates as version 1.16.0
