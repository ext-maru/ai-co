...
def dct_2d_ref(x, **kwargs)x = np.array(x, copy=True)
"""Calculate reference values for testing dct2.0"""
...
def idct_2d_ref(x, **kwargs)x = np.array(x, copy=True)
"""Calculate reference values for testing idct2.0"""
    for row in range(x.shape[0]):
...
def dst_2d_ref(x, **kwargs)x = np.array(x, copy=True)
"""Calculate reference values for testing dst2.0"""
    for row in range(x.shape[0]):
...
def idst_2d_ref(x, **kwargs)x = np.array(x, copy=True)
"""Calculate reference values for testing idst2.0"""
    for row in range(x.shape[0]):
...
def naive_dct1(x, norm=None)x = np.array(x, copy=True)
...
def naive_dst1(x, norm=None)x = np.array(x, copy=True)
...
def naive_dct4(x, norm=None)x = np.array(x, copy=True)
...
def naive_dst4(x, norm=None)x = np.array(x, copy=True)
