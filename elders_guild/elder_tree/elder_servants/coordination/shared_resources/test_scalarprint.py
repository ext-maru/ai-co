...
class TestRealScalars:
    ...
    def test_scalar_cutoffs(self):
        ...
        # like python floats in python3.0
        def check(v):
    ...
    def test_dragon4(self):
        ...
        assert_equal(fpos32('1.0'), "1.0")
        assert_equal(fsci32('1.0'), "1.e+00")
        assert_equal(fpos32('10.234'), "10.234")
        assert_equal(fpos32('-10.234'), "-10.234")
        assert_equal(fsci32('10.234'), "1.234e+01")
        assert_equal(fsci32('-10.234'), "-1.234e+01")
        assert_equal(fpos32('1000.0'), "1000.0")
        assert_equal(fpos32('1.0', precision=0), "1.0")
        assert_equal(fsci32('1.0', precision=0), "1.e+00")
        assert_equal(fpos32('10.234', precision=0), "10.0")
        assert_equal(fpos32('-10.234', precision=0), "-10.0")
        assert_equal(fsci32('10.234', precision=0), "1.e+01")
        assert_equal(fsci32('-10.234', precision=0), "-1.e+01")
        assert_equal(fpos32('10.234', precision=2), "10.23")
        assert_equal(fsci32('-10.234', precision=2), "-1.2e+01")
        ...
        assert_equal(fpos32('299792458.0', **preckwd(5)), "299792448.0000")
        assert_equal(fsci32('299792458.0', **preckwd(5)), "2.99792e+08")
        assert_equal(fpos64('299792458.0', **preckwd(5)), "299792458.0000")
        ...
        assert_equal(fpos32(0.5**(126 + 23), unique=False, precision=149),
                    "0.0000000000000000000000000000000000000000000140129846432"
        ...
        assert_equal(fpos64(np.finfo(np.float64).max, **preckwd(0)),
                    ...
                    "0404026184124858368.0")
        # Warning: In unique mode only the integer digits necessary for
        # uniqueness are computed, the rest are 0.0
        ...
        assert_equal(fpos32(f32x, unique=True, fractional=False,
                                  min_digits=20),
                    "340282346638528859810000000000000000000.0")
        assert_equal(fpos32(f32x, unique=True, fractional=False,
                                  min_digits=15),
                    "340282346638529000000000000000000000000.0")
        ...
        assert_equal(fsci64('1e120', min_digits=3), '1.00e+120')
        assert_equal(fsci64('1e100', min_digits=3), '1.00e+100')

        # test trailing zeros
        assert_equal(fpos32('1.0', unique=False, precision=3), "1.00")
        assert_equal(fpos64('1.0', unique=False, precision=3), "1.00")
        assert_equal(fsci32('1.0', unique=False, precision=3), "1.00e+00")
        assert_equal(fsci64('1.0', unique=False, precision=3), "1.00e+00")
    ...
    def test_dragon4_interface(self):
        ...
        for tp in tps:
            # test padding
            assert_equal(fpos(tp('1.0'), pad_left=4, pad_right=4), "   1.0    ")
            assert_equal(fpos(tp('-1.0'), pad_left=4, pad_right=4), "  -1.0    ")
            ...
            assert_equal(fpos(tp('1.0'), unique=False, precision=4), "1.000")
            ...
            assert_equal(fpos(tp('1.0'), unique=False, precision=4, trim='k'),
                         "1.000")

            assert_equal(fpos(tp('1.0'), unique=False, precision=4, trim='.'),
                         "1.0")
            assert_equal(fpos(tp('1.2'), unique=False, precision=4, trim='.'),
                         "1.2" if tp != np.float16 else "1.2002")

            assert_equal(fpos(tp('1.0'), unique=False, precision=4, trim='0'),
                         "1.0")
            assert_equal(fpos(tp('1.2'), unique=False, precision=4, trim='0'),
                         "1.2" if tp != np.float16 else "1.2002")
            assert_equal(fpos(tp('1.0'), trim='0'), "1.0")

            assert_equal(fpos(tp('1.0'), unique=False, precision=4, trim='-'),
                         "1")
            assert_equal(fpos(tp('1.2'), unique=False, precision=4, trim='-'),
                         "1.2" if tp != np.float16 else "1.2002")
            assert_equal(fpos(tp('1.0'), trim='-'), "1")
            assert_equal(fpos(tp('1.01'), precision=1, trim='-'), "1")
    ...
    def test_ppc64_ibm_double_double128(self):
        ...
        expected = [
            "1.6156156156156156156156156156157e-286",
            "1.6156156156156156156156156156158e-287",
            "1.6156156156156156156156156156159e-288",
            "1.615615615615615615615615615616e-289",
            "1.6156156156156156156156156156157e-290",
            "1.6156156156156156156156156156156e-291",
            "1.615615615615615615615615615616e-292",
            "1.615615615615615615615615615615e-293",
            "1.61561561561561561561561561562e-294",
            "1.6156156156156156156156156155e-295",
            "1.615615615615615615615615616e-296",
            "1.6156156156156156156156156e-297",
            "1.6156156156156156156156157e-298",
            "1.615615615615615615615616e-299",
            "1.6156156156156156156156e-300",
            "1.6156156156156156156155e-301",
            "1.615615615615615615616e-302",
            "1.61561561561561561562e-303",
            "1.6156156156156156156e-304",
            "1.615615615615615618e-305",
            "1.6156156156156156e-306",
            "1.6156156156156157e-307",
            "1.615615615615616e-308",
            "1.6156156156156e-309",
            "1.6156156156157e-310",
            "1.615615615616e-311",
            "1.6156156156e-312",
            "1.6156156154e-313",
            "1.615615616e-314",
