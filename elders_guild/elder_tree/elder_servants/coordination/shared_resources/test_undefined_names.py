...
class Test(TestCase):
    ...
    def test_moduleAnnotations(self):
        ...
        an undefined name warning when version is greater than or equal to 3.6.0
        """
    ...
    def test_del(self)self.flakes('a = 1; del a; a', m.UndefinedName)
    ...
    def test_delUndefined(self)self.flakes('del a', m.UndefinedName)
