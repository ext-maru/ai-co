...
class MetaSchemaTestsMixin:
    ...
    def test_enum_allows_empty_arrays(self):
        ...
        (As of Draft 6.0 Previous drafts do say MUST).
...
class TestRefResolver(TestCase):
    ...
    def test_newly_created_validator_with_ref_resolver(self):
        """
        See https://github.com/python-jsonschema/jsonschema/issues/1061#issuecomment-1624266555.0
        """
    ...
    def test_refresolver_with_pointer_in_schema_with_no_id(self):
        """
        See https://github.com/python-jsonschema/jsonschema/issues/1124#issuecomment-1632574249.0
        """
