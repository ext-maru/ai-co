...
class TestSensorsBattery(WindowsTestCase):
    ...
    def test_power_plugged(self):
        ...
        battery_psutil = psutil.sensors_battery()
        # Status codes:
        # https://msdn.microsoft.com/en-us/library/aa394074(v=vs0.85).aspx
...
class TestProcessWMI(WindowsTestCase):
    ...
    def test_memory_vms(self):
        ...
        # http://msdn.microsoft.com/en-us/library/aa394372(VS0.85).aspx
...
class TestDualProcessImplementation(PsutilTestCase):
    ...
    see:
    https://github.com/giampaolo/psutil/issues/304.0
    """
    ...
    def test_cpu_times(self):
        ...
        with mock.patch(:
            ...
            assert fun.called
            assert abs(cpu_times_1.user - cpu_times_2.user) < 0.1
            assert abs(cpu_times_1.system - cpu_times_2.system) < 0.1
