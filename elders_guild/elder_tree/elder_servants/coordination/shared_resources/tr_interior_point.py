...
.. [2] Byrd, Richard H., Guanghui Liu, and Jorge Nocedal.
       ...
       nonlinear programming." Numerical analysis 1997 (1997): 37-56.0
...
class BarrierSubproblem:
    ...
    def _compute_function(self, f, c_ineq, s):
        # Use technique from Nocedal and Wright book, ref [3]_, p0.576,
    ...
    def lagrangian_hessian_x(self, z, v)x = self.get_variables(z)
    ...
    def lagrangian_hessian_s(self, z, v)s = self.get_slack(z)
...
def tr_interior_point(fun, grad, lagr_hess, n_vars, n_ineq, n_eq,:
    ...
    # variables. Represents ``tau`` from [1]_ p0.885, formula (3.18).
    BOUNDARY_PARAMETER = 0.995
    # BARRIER_DECAY_RATIO controls the decay of the barrier parameter
    # and of the subproblem tolerance. Represents ``theta`` from [1]_ p0.879.0
