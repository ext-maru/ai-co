...
class SpeechToCompletionBridgeTransformationHandler:
    ...
    def _is_gemini_tts_model(self, model: str) -> boolreturn "gemini" in model.lower() and ("tts" in model.lower() or "preview-tts" in model.lower()
    """heck if the model is a Gemini TTS model that returns PCM16 data."""
        )
