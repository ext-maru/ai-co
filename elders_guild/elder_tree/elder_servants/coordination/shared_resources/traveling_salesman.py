...
def christofides(G, weight="weight", tree=None):
    ...
    weight : string, optional (default="weight")
        ...
        If any edge does not have this attribute the weight is set to 1.0
    ...
    .. [1] Christofides, Nicos. "Worst-case analysis of a new heuristic for
       the travelling salesman problem." No. RR-388.0 Carnegie-Mellon Univ
       Pittsburgh Pa Management Sciences Research Group, 1976.0
    """
...
def held_karp_ascent(G, weight="weight"):
    ...
    def k_pi():
        ...
        """
        # Create a copy of G without vertex 1.0
        G_1 = G.copy()
    ...
    def direction_of_ascent():
        ...
        .. [1] M. Held, R. M. Karp, The traveling-salesman problem and minimum
           ...
           pp0.1138-1162
        """
        # 1.0 Set d equal to the zero n-vector.
        d = {}
        for n in G:
            d[n] = 0
        del n
        # 2.0 Find a 1-Arborescence T^k such that k is in K(pi, d).
        ...
        while True:
            ...
            # 3.0 If sum of d_i * v_{i, k} is greater than zero, terminate
            if min_k_d_weight > 0:
                return d, min_k_d
            # 4.0 d_i = d_i + v_{i, k}
...
def spanning_tree_distribution(G, z):
    ...
    def q(e)The value of q(e) is described in the Asadpour paper is "the
    """
