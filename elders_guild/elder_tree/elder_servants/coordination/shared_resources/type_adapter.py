...
def _getattr_no_parents(obj: Any, attribute: str) -> Anyif hasattr(obj, '__dict__'):
...
def _type_has_config(type_: Any) -> booltype_ = _typing_extra.annotated_type(type_) or type_:
    """eturns whether the type has config."""
    try:
