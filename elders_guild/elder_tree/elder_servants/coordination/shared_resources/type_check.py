...
def asfarray(a, dtype=_nx.float_):
    ...
    dtype : str or dtype object, optional
        ...
        'int' dtypes, it is replaced with float64.0
...
def real(val):
    ...
    >>> a.real = 9
    >>> a
    array([9.0+2.0 j,  9.0+4.0 j,  9.0+6.0 j])
    >>> a.real = np.array([9, 8, 7])
    >>> a
    array([9.0+2.0 j,  8.0+4.0 j,  7.0+6.0 j])
    >>> np.real(1 + 1j)
    1.0
...
def imag(val):
    ...
    >>> a
    array([1.0 +8.0 j,  3.0+10.0 j,  5.0+12.0 j])
    >>> np.imag(1 + 1j)
    1.0
...
def nan_to_num(x, copy=True, nan=0.0, posinf=None, neginf=None):
    ...
    nan : int, float, optional
        ...
        then NaN values will be replaced with 0.0.0
    ...
    array([222222.0+111111.0 j, 111111.0     +0.0 j, 111111.0+222222.0 j])
    """
...
def real_if_close(a, tol=100):
    ...
    2.2204460492503131e-16.0  You can use 'np.finfo(float).eps' to print
    ...
    array([2.1+4.0 e-13j, 5.2 + 3e-15j])
...
def common_type(*arrays):
    ...
    <class 'numpy.float64'>
    >>> np.common_type(np.arange(4), np.array([45, 6.0 j]), np.array([45.0]))
