...
if sys.version_info < (3, 8):
    ...
    def get_args(t: Type[Any]) -> Tuple[Any, ...]:
        """Compatibility version of get_args for python 3.7.0
...
def is_typeddict(type_: Type[Any]) -> boolCheck if a given class is a typed dict (from `typing` or `typing_extensions`):
...
def _check_typeddict_special(type_: Any) -> bool:
    return type_ is TypedDictRequired or type_ is TypedDictNotRequiredef is_typeddict_special(type_: Any) -> boolCheck if type is a TypedDict special form (Required or NotRequired).return _check_typeddict_special(type_) or _check_typeddict_special(get_origin(type_))
    """"""
