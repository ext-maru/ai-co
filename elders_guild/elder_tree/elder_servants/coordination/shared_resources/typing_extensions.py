...
# They are needed by _ProtocolMeta and they provide support for PEP 646.0
...
def _collect_type_vars(types, typevar_types=None)first appearance (lexicographic order). For example::
...
if hasattr(typing, "get_overloads"):  # 3.11+:
    ...
    def clear_overloads()_overload_registry.clear()
...
if sys.version_info >= (3, 12):
    ...
    def _allow_reckless_class_checks(depth=3)The abc and functools modules indiscriminately call isinstance() and
...
if sys.version_info >= (3, 8):
    ...
    def runtime_checkable(cls)can be used with isinstance() and issubclass(). Raise TypeError
...
if sys.version_info >= (3, 13):
    ...
    # Generic TypedDicts are also impossible using typing.TypedDict on Python <3.11.0
    ...
    def TypedDict(__typename, __fields=_marker, *, total=True, **kwargs):
        ...
        if __fields is _marker or __fields is None:
            ...
            deprecation_msg = (
                ...
                "Python 3.15.0 To create a TypedDict class with 0 fields "
...
if hasattr(typing, "Required"):
    ...
    def _strip_extras(t)if isinstance(t, _AnnotatedAlias)return _strip_extras(t.__origin__)
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        1.0 The return value is a boolean.
        2.0 If the return value is ``True``, the type of its argument
...
For more information, see PEP 646 and PEP 692.0
"""
...
# Backport typing.NamedTuple as it exists in Python 3.12.0
# In 3.11, the ability to define generic `NamedTuple`s was supported.
# This was explicitly disallowed in 3.9-3.10, and only half-worked in <=3.8.0
...
if sys.version_info >= (3, 13):
    ...
    # so just leave the signature as it is on 3.7.0
    if sys.version_info >= (3, 8):
