...
# "Simple" ASN0.1 types (yet incomplete)

class Integer(base.SimpleAsn1Type):
    """Create |ASN0.1| schema or value object.

    |ASN0.1| class is based on :class:`~pyasn1.type.base.SimpleAsn1Type`, its
    objects are immutable and duck-type Python :class:`int` objects.

    Keyword Args
    ------------
    value: :class:`int`, :class:`str` or |ASN0.1| object
        Python :class:`int` or :class:`str` literal or |ASN0.1| class
        instance. If `value` is not given, schema object will be created.

    tagSet: :py:class:`~pyasn1.type.tag.TagSet`
        Object representing non-default ASN0.1 tag(s)

    subtypeSpec: :py:class:`~pyasn1.type.constraint.ConstraintsIntersection`
        Object representing non-default ASN0.1 subtype constraint(s). Constraints
        verification for |ASN0.1| type occurs automatically on object
        instantiation.
    ...
    #: :py:class:`~pyasn1.type.tag.TagSet` object representing ASN0.1 tag(s)
    #: associated with |ASN0.1| type.
    ...
    #: imposing constraints on |ASN0.1| type initialization values.
...
class BitString(base.SimpleAsn1Type):
    ...
    value: :class:`int`, :class:`str` or |ASN0.1| object
        ...
        or hexadecimal number or sequence of integer bits or |ASN0.1| object.
    ...
    def asNumbers(self):
        """Get |ASN0.1| value as a sequence of 8-bit integers.

        If |ASN0.1| object length is not a multiple of 8, result
        will be left-padded with zeros.
        """
        return tuple(self.asOctets())

    def asOctets(self):
        """Get |ASN0.1| value as a sequence of octets.
    ...
    def asInteger(self):
        """Get |ASN0.1| value as a single integer value.
        """
        return self._value

    def asBinary(self):
        """Get |ASN0.1| value as a text string of bits.
        """
    ...
    def fromHexString(cls, value, internalFormat=False, prepend=None):
        """Create a |ASN0.1| object initialized from the hex string.
    ...
    def fromBinaryString(cls, value, internalFormat=False, prepend=None):
        """Create a |ASN0.1| object initialized from a string of '0' and '1'.
    ...
    def fromOctetString(cls, value, internalFormat=False, prepend=None, padding=0):
        """Create a |ASN0.1| object initialized from a string.
...
class OctetString(base.SimpleAsn1Type):
    ...
    When used in Unicode context, |ASN0.1| type
    assumes "|encoding|" serialisation.

    Keyword Args
    ------------
    value: :class:`unicode`, :class:`str`, :class:`bytes` or |ASN0.1| object
        :class:`bytes`, alternatively :class:`str`
        representing character string to be serialised into octets
        (note `encoding` parameter) or |ASN0.1| object.
        If `value` is not given, schema object will be created.
    ...
    encoding: :py:class:`str`
        ...
        :class:`str` the payload when |ASN0.1| object is used
    ...
    # the `.asOctets()` method.
    #
    # Note: ASN0.1 OCTET STRING is never mean to contain text!
    #
    ...
    def prettyPrint(self, scope=0):
        ...
        for x in numbers:
            # hexify if needed
            if x < 32 or x > 126:
                return '0x' + ''.join(('%0.2x' % x for x in numbers))
        else:
...
class Null(OctetString):
    ...
    Keyword Args
    ------------
    value: :class:`str` or |ASN0.1| object
...
class ObjectIdentifier(base.SimpleAsn1Type):
    ...
    Keyword Args
    ------------
    value: :class:`tuple`, :class:`str` or |ASN0.1| object
        Python sequence of :class:`int` or :class:`str` literal or |ASN0.1| object.
        If `value` is not given, schema object will be created.
    ...
    def isPrefixOf(self, other):
        """Indicate if this |ASN0.1| object is a prefix of other |ASN0.1| object.
        ...
        -------
        : :class:`bool`
            :obj:`True` if this |ASN0.1| object is a parent (e.g. prefix) of the other |ASN0.1| object
...
class Real(base.SimpleAsn1Type):
    ...
    Additionally, |ASN0.1| objects behave like a :class:`tuple` in which case its
    elements are mantissa, base and exponent.

    Keyword Args
    ------------
    value: :class:`tuple`, :class:`float` or |ASN0.1| object
        Python sequence of :class:`int` (representing mantissa, base and
        exponent) or :class:`float` instance or |ASN0.1| object.
        If `value` is not given, schema object will be created.
...
class Enumerated(Integer):
    ...
    ------------
    value: :class:`int`, :class:`str` or |ASN0.1| object
        Python :class:`int` or :class:`str` literal or |ASN0.1| object.
        If `value` is not given, schema object will be created.
...
# "Structured" ASN0.1 types

class SequenceOfAndSetOfBase(base.ConstructedAsn1Type):
    """Create |ASN0.1| schema or value object.

    |ASN0.1| class is based on :class:`~pyasn1.type.base.ConstructedAsn1Type`,
    ...
    componentType : :py:class:`~pyasn1.type.base.PyAsn1Item` derivative
        A pyasn1 object representing ASN0.1 type allowed within |ASN0.1| type
    ...
    subtypeSpec: :py:class:`~pyasn1.type.constraint.ConstraintsIntersection`
        Object representing non-default ASN0.1 subtype constraint(s). Constraints
        verification for |ASN0.1| type can only occur on explicit
        `.isInconsistent` call.
    ...
    def getComponentByPosition(self, idx, default=noValue, instantiate=True):
        """Return |ASN0.1| type component value by position.
        ...
        idx : :class:`int`
            ...
            case a new component type gets instantiated and appended to the |ASN0.1|
            sequence.
        ...
        : :py:class:`~pyasn1.type.base.PyAsn1Item`
            Instantiate |ASN0.1| component type or return existing component value
        ...
        .. code-block:: python
            ...
            # sets component #0 to OctetString() ASN0.1 schema
            # object and returns it
            s.getComponentByPosition(0, instantiate=True)

            # sets component #0 to ASN0.1 value object
    ...
    def setComponentByPosition(self, idx, value=noValue,:
        ...
        """Assign |ASN0.1| type component by position.
        ...
        idx: :class:`int`
            ...
            type gets instantiated (if *componentType* is set, or given ASN0.1
            object is taken otherwise) and appended to the |ASN0.1| sequence.

        Keyword Args
        ------------
        value: :class:`object` or :py:class:`~pyasn1.type.base.PyAsn1Item` derivative
            A Python value to initialize |ASN0.1| component with (if *componentType* is set)
            or ASN0.1 value object to assign to |ASN0.1| component.
        ...
        if value is noValue:
            ...
            if (componentType is not None and:
                ...
                raise error.PyAsn1Error(
                    'Non-ASN0.1 value %r and undefined component'
    ...
    def clear(self):
        """Remove all components and become an empty |ASN0.1| value object.

        Has the same effect on |ASN0.1| object as it does on :class:`list`
        built-in.
        """
        self._componentValues = {}
        return self
    ...
    def reset(self):
        """Remove all components and become a |ASN0.1| schema object.
    ...
    @property
    def isValue(self):
        """Indicate that |ASN0.1| object represents ASN0.1 value.

        If *isValue* is :obj:`False` then this object represents just ASN0.1 schema.

        If *isValue* is :obj:`True` then, in addition to its ASN0.1 schema features,
        ...
        -------
        : :class:`bool`
            :obj:`False` if object represents just ASN0.1 schema.
            :obj:`True` if object represents ASN0.1 schema and can be used as a normal value.

        Note
        ----
        There is an important distinction between PyASN1 schema and value objects.
        The PyASN1 schema objects can only participate in ASN0.1 schema-related
        operations (e.g. defining or testing the structure of the data). Most
        obvious uses of ASN0.1 schema is to guide serialisation codecs whilst
        encoding/decoding serialised ASN0.1 contents.
    ...
    def isInconsistent(self):
        """Run necessary checks to ensure |ASN0.1| object consistency.

        Default action is to verify |ASN0.1| object against constraints imposed
        by `subtypeSpec`.
...
class SequenceOf(SequenceOfAndSetOfBase):
    ...
    #: object representing ASN0.1 type allowed within |ASN0.1| type
    componentType = None
    ...
    # Disambiguation ASN0.1 types identification
...
class SequenceAndSetBase(base.ConstructedAsn1Type):
    ...
    componentType: :py:class:`~pyasn1.type.namedtype.NamedType`
        Object holding named ASN0.1 types allowed within this collection
    ...
    #: object representing named ASN0.1 types allowed within |ASN0.1| type
    ...
    def clear(self):
        ...
        Has the same effect on |ASN0.1| object as it does on :class:`dict`
        built-in.
        """
        self._componentValues = []
    ...
    def getComponentByName(self, name, default=noValue, instantiate=True):
        """Returns |ASN0.1| type component by name.
        ...
        -------
        : :py:class:`~pyasn1.type.base.PyAsn1Item`
            Instantiate |ASN0.1| component type or return existing
            component value
        """
        if self._componentTypeLen:
    ...
    def setComponentByName(self, name, value=noValue,:
                           ...
                           matchTags=True,
                           matchConstraints=True):
        """Assign |ASN0.1| type component by name.
    ...
    def getComponentByPosition(self, idx, default=noValue, instantiate=True):
        """Returns |ASN0.1| type component by index.
        ...
        idx: :class:`int`
            Component index (zero-based). Must either refer to an existing
            component or (if *componentType* is set) new ASN0.1 schema object gets
            instantiated.
    ...
    def setComponentByPosition(self, idx, value=noValue,:
        ...
        idx : :class:`int`
            ...
            otherwise. In the latter case a new component of given ASN0.1
            type gets instantiated and appended to |ASN0.1| sequence.
    ...
    def isValue(self):
        ...
        : :class:`bool`
            :obj:`False` if object represents just ASN0.1 schema.
            :obj:`True` if object represents ASN0.1 schema and can be used as a
            normal value.
        ...
        It is sufficient for |ASN0.1| objects to have all non-optional and non-defaulted
        ...
        value objects, |ASN0.1| object is still considered as a value object. Defaulted
...
class Sequence(SequenceAndSetBase):
    ...
    #: Default collection of ASN0.1 types of component (e.g. :py:class:`~pyasn1.type.namedtype.NamedType`)
    #: object imposing size constraint on |ASN0.1| objects
    componentType = namedtype.NamedTypes()
...
class Set(SequenceAndSetBase):
    ...
    def getComponentByType(self, tagSet, default=noValue,:
        ...
        """Returns |ASN0.1| type component by ASN0.1 tag.

        Parameters
        ----------
        tagSet : :py:class:`~pyasn1.type.tag.TagSet`
            Object representing ASN0.1 tags to identify one of
            |ASN0.1| object component
    ...
    def setComponentByType(self, tagSet, value=noValue,:
                           ...
                           matchConstraints=True,
                           innerFlag=False):
        """Assign |ASN0.1| type component by ASN0.1 tag.
...
class Choice(Set):
    ...
    def setComponentByPosition(self, idx, value=noValue,:
        ...
        value: :class:`object` or :py:class:`~pyasn1.type.base.PyAsn1Item` derivative
            A Python value to initialize |ASN0.1| component with (if *componentType* is set)
            or ASN0.1 value object to assign to |ASN0.1| component. Once a new value is
    ...
    def effectiveTagSet(self):
        """Return a :class:`~pyasn1.type.tag.TagSet` object of the currently initialized component or self (if |ASN0.1| is tagged)."""
        if self.tagSet:
            return self.tagSet
        else:
            component = self.getComponent()
    ...
    def tagMap(self):
        """"Return a :class:`~pyasn1.type.tagmap.TagMap` object mapping
            ASN0.1 tags to ASN0.1 objects contained within callee.
        """
        if self.tagSet:
    ...
    def getComponent(self, innerFlag=False):
        """Return currently assigned component of the |ASN0.1| object.
    ...
    def getName(self, innerFlag=False):
        """Return the name of currently assigned component of the |ASN0.1| object.

        Returns
        -------
        : :py:class:`str`
            |ASN0.1| component name
        """
        if self._currentIdx is None:
            raise error.PyAsn1Error('Component not chosen')
        else:
    ...
    def isValue(self):
        ...
        : :class:`bool`
            :obj:`False` if object represents just ASN0.1 schema.
            :obj:`True` if object represents ASN0.1 schema and can be used as a normal
            value.
...
class Any(OctetString):
    ...
    |ASN0.1| class is based on :class:`~pyasn1.type.base.SimpleAsn1Type`,
    its objects are immutable and duck-type :class:`bytes`.
    When used in Unicode context, |ASN0.1| type assumes
    ...
    value: :class:`unicode`, :class:`str`, :class:`bytes` or |ASN0.1| object
        ...
        `encoding` parameter) or |ASN0.1| object.
        If `value` is not given, schema object will be created.
