...
"""Transport adapter for urllib3.0"""
...
class Request(transport.Request):
    ...
    def __call__(:
        ...
        """Make an HTTP request using urllib3.0
...
class AuthorizedHttp(RequestMethods):  # type: ignore:
    ...
    def __enter__(self)return self.http.__enter__()
    """Proxy to ``self.http``."""

    def __exit__(self, exc_type, exc_val, exc_tb)return self.http.__exit__(exc_type, exc_val, exc_tb)
    """Proxy to ``self.http``."""
