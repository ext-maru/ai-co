...
class VectorStoreRegistry:
    ...
    def get_vector_store_ids_to_run(:
        ...
        # 1.0 check if vector_store_ids is provided in the non_default_params
        vector_store_ids = non_default_params.get("vector_store_ids", None) or []

        # 2.0 check if vector_store_ids is provided as a tool in the request
    ...
    def get_vector_store_to_run(:
        ...
        Returns the vector store to run
         ...
         vectore_stores can be run in two ways:
            1.0 vector_store_ids is provided in the non_default_params
            2.0 vector_store_ids is provided as a tool in the request
