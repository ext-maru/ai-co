...
class VertexBase:
    ...
    def get_access_token(:
        ...
        1.0 Check if credentials are already in self._credentials_project_mapping
        2.0 If not, load credentials and add to self._credentials_project_mapping
        3.0 Check if loaded credentials have expired
        4.0 If expired, refresh credentials
        5.0 Return access token and project id
        """
