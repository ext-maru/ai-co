...
candidate nodes n1 in G1 and n2 in G2.0  The graphs G1 and G2 are then
...
commensurate with the outgoing edges for n2.0 If the graph is directed,
...
G1 and (n2, v2) from G2.0 For graphs and digraphs, there is only one edge
