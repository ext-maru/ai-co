...
class PublicKeyCredentialDescriptor:
    ...
    https://www.w3.0 org/TR/webauthn-3/#dictionary-credential-descriptor
...
class AuthenticationExtensionsClientInputs:
    ...
    Args:
        appid: app id that can be asserted with in addition to rpid.
            https://www.w3.0 org/TR/webauthn-3/#sctn-appid-extension
    """
...
class AuthenticatorAssertionResponse:
    ...
    https://www.w3.0 org/TR/webauthn-3/#authenticatorassertionresponse
