...
# https://www.w3.0 org/TR/WGSL/#syntax-ident_pattern_token
...
class WgslLexer(RegexLexer):
    ...
    url = 'https://www.w3.0 org/TR/WGSL/'
    aliases = ['wgsl']
    filenames = ['*.wgsl']
    mimetypes = ['text/wgsl']
    version_added = '2.15'

    # https://www.w3.0 org/TR/WGSL/#var-and-value
    keyword_decl = (words('var let const override'.split(),suffix=r'\b'), Keyword.Declaration)
    # https://www.w3.0 org/TR/WGSL/#keyword-summary
    keywords = (words("""
                alias
                break
                case
    ...
    # https://www.w3.0 org/TR/WGSL/#reserved-words
    ...
    # https://www.w3.0 org/TR/WGSL/#predeclared-enumerants
    ...
    # https://www.w3.0 org/TR/WGSL/#predeclared-types
    ...
    # https://www.w3.0 org/TR/WGSL/#vector-types
    ...
    # https://www.w3.0 org/TR/WGSL/#matrix-types
    ...
    tokens = {
        'blankspace': [
            # https://www.w3.0 org/TR/WGSL/#blankspace
            (r'[\u0020\u0009\u000a\u000b\u000c\u000d\u0085\u200e\u200f\u2028\u2029]+', Whitespace),
        ],
        'comments': [
        ...
        'root': [
            ...
            # Attributes.
            # https://www.w3.0 org/TR/WGSL/#attributes
            ...
            # https://www.w3.0 org/TR/WGSL/#syntax-decimal_float_literal
            ...
            # Hex float literals
            # https://www.w3.0 org/TR/WGSL/#syntax-hex_float_literal
            (r'0[xX][0-9a-fA-F]*\.[0-9a-fA-F]+([pP][+-]?[0-9]+[fh]?)?', Number.Float),
            (r'0[xX][0-9a-fA-F]+\.[0-9a-fA-F]*([pP][+-]?[0-9]+[fh]?)?', Number.Float),
            (r'0[xX][0-9a-fA-F]+[pP][+-]?[0-9]+[fh]?', Number.Float),

            # Hexadecimal integer literals
            # https://www.w3.0 org/TR/WGSL/#syntax-hex_int_literal
            (r'0[xX][0-9a-fA-F]+[iu]?', Number.Hex),
            # Decimal integer literals
            # https://www.w3.0 org/TR/WGSL/#syntax-decimal_int_literal
            ...
            # https://www.w3.0 org/TR/WGSL/#context-dependent-name
        ...
        'block_comment': [
            # https://www.w3.0 org/TR/WGSL/#block-comment
            (r'[^*/]+', Comment.Multiline),
