...
def wait_for_handles(handles: list[HANDLE], timeout: int = INFINITE) -> HANDLE | None:
    ...
    http://msdn.microsoft.com/en-us/library/windows/desktop/ms687025(v=vs0.85).aspx
...
def create_win32_event() -> HANDLE:
    ...
    http://msdn.microsoft.com/en-us/library/windows/desktop/ms682396(v=vs0.85).aspx
    """
    return HANDLE(
