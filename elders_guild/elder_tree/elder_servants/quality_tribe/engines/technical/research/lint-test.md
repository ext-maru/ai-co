...
category: technical
dependencies: []
description: Aider can automatically lint and test your code every time it makes changes.
  This helps identify and repair any problems introduced by the AI edits.
