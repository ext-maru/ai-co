...
def mock_worker_status():
    """モックワーカーステータス"""
    from elders_guild.elder_tree.elf_forest_worker_manager import WorkerStatus
    return WorkerStatus(
        name='test_worker',
        pid=12345,
        status='running',
...
from elders_guild.elder_tree.elf_forest_worker_manager import (
...
class TestSystemImports:
    ...
    def test_project_imports(self):
        ...
        # エラーが発生しないものをテスト
        try:
            from elders_guild.elder_tree.elf_forest_worker_manager import ElfForestWorkerManager
