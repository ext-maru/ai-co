...
from elders_guild.elder_tree.elder_flow_servant_executor_real import GitKeeperServantReal
from elders_guild.elder_tree.elder_servants.integrations.aider.aider_elder_integration import (
...
class TestAiderDiffMergeCapabilities:
    ...
    def temp_git_repo(self):
        """Create temporary git repository with branches"""
...
"""
    ...
    @pytest.mark.asyncio
    async def test_basic_diff_functionality(self, git_keeper, temp_git_repo):
...
"""
    ...
    async def test_multi_file_diff_analysis(
        self, aider_integration, git_keeper, temp_git_repo
    ):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_merge_conflict_detection(self, git_keeper, temp_git_repo):
...
"""
    ...
    async def test_diff_based_quality_suggestions(
        self, aider_integration, temp_git_repo
    ):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_branch_diff_comparison(self, git_keeper, temp_git_repo):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_patch_generation_and_application(self, git_keeper, temp_git_repo):
