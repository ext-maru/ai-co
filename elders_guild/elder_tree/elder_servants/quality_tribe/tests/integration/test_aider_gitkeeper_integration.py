...
class TestAiderGitKeeperIntegration:
    ...
    @pytest.mark.asyncio
    async def test_git_keeper_servant_basic_operations(self, git_keeper, temp_git_repo):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_aider_command_line_interface(self, temp_git_repo):
...
class TestAiderIntegrationPerformance:
    ...
    async def test_pre_commit_performance(
        self, aider_integration, benchmark, temp_git_repo
    ):
