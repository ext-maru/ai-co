...
from elders_guild.elder_tree.elder_flow_pre_commit_handler import ElderFlowPreCommitHandler, PreCommitError
from elders_guild.elder_tree.elder_flow_quality_gate_optimizer import ElderFlowQualityGateOptimizer, QualityMetrics
...
"""
        ...
        self.assertEqual(errors[0].modified_files, ["test1.0.py", "test2.0.py"])
        self.assertEqual(errors[1].hook_id, "end-of-file-fixer")
        self.assertEqual(errors[1].modified_files, ["test1.0.py"])
