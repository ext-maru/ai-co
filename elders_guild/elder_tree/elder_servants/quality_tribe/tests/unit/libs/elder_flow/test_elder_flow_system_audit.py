...
# システムコンポーネントのインポート
try:
    from elders_guild.elder_tree.claude_task_tracker import ClaudeTaskTracker
except ImportError:
    ClaudeTaskTracker = None

try:
    from elders_guild.elder_tree.postgres_claude_task_tracker import PostgreSQLClaudeTaskTracker
except ImportError:
