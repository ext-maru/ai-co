...
"""
import pytest
from elders_guild.elder_tree.elder_flow_violation_types import (
    ViolationSeverity,
    ViolationType,
    ViolationDefinition
)
...
class TestViolationDefinition:
    ...
    def test_incomplete_implementation_definition(self):
        ...
        assert 'TODO' in definition['detection_patterns']
        assert 'FIXME' in definition['detection_patterns']
