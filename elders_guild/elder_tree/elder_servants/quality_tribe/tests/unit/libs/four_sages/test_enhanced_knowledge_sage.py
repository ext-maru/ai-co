...
try:
    ...
    from elders_guild.elder_tree.four_sages.knowledge.vector_search_engine import VectorSearchEngine
    from elders_guild.elder_tree.four_sages.knowledge.knowledge_schema import KnowledgeEntry, KnowledgeVector
except ImportError:
...
class TestEnhancedKnowledgeSage:
    ...
    @pytest.fixture
    async def temp_knowledge_sage(self):
        """Create temporary Enhanced Knowledge Sage for testing"""
    ...
    @pytest.mark.asyncio
    async def test_elders_legacy_compliance(self, temp_knowledge_sage):
        """Test Elders Legacy architecture compliance"""
        sage = temp_knowledge_sage
    ...
    @pytest.mark.asyncio 
    async def test_vector_search_engine(self, temp_knowledge_sage):
    ...
    @pytest.mark.asyncio
    async def test_enhanced_knowledge_storage(self, temp_knowledge_sage, sample_knowledge_entries):
    ...
    @pytest.mark.asyncio
    async def test_semantic_vector_search(self, temp_knowledge_sage, sample_knowledge_entries):
    ...
    @pytest.mark.asyncio
    async def test_batch_knowledge_processing(self, temp_knowledge_sage, sample_knowledge_entries):
    ...
    @pytest.mark.asyncio
    async def test_advanced_knowledge_schema(self, temp_knowledge_sage):
    ...
    @pytest.mark.asyncio
    async def test_knowledge_indexing_performance(self, temp_knowledge_sage):
    ...
    @pytest.mark.asyncio
    async def test_quality_gates_integration(self, temp_knowledge_sage):
    ...
    @pytest.mark.asyncio
    async def test_capabilities_and_health(self, temp_knowledge_sage):
