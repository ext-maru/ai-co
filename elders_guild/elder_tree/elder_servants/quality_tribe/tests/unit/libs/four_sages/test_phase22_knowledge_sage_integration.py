...
# テスト対象モジュール
from elders_guild.elder_tree.four_sages.knowledge.knowledge_sage import KnowledgeSage, KnowledgeType, KnowledgeConfidence
from elders_guild.elder_tree.four_sages.knowledge.tracking_data_integrator import TrackingDataIntegrator
from elders_guild.elder_tree.four_sages.knowledge.execution_linked_knowledge_entry import ExecutionLinkedKnowledgeEntry
from elders_guild.elder_tree.four_sages.knowledge.pattern_extraction_engine import PatternExtractionEngine
from elders_guild.elder_tree.four_sages.knowledge.predictive_recommendation_system import PredictiveRecommendationSystem
from elders_guild.elder_tree.four_sages.knowledge.self_evolving_knowledge_manager import SelfEvolvingKnowledgeManager
...
class TestExecutionLinkedKnowledgeEntry:
    ...
    def test_execution_evidence_addition(self, knowledge_entry):
        """実行証拠追加テスト"""
        from elders_guild.elder_tree.four_sages.knowledge.execution_linked_knowledge_entry import ExecutionEvidence, ExecutionContext
    ...
    def test_prediction_capability(self, knowledge_entry):
        """予測機能テスト"""
        from elders_guild.elder_tree.four_sages.knowledge.execution_linked_knowledge_entry import ExecutionContext
