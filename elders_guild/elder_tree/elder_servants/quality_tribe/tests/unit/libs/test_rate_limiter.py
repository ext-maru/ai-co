...
from elders_guild.elder_tree.integrations.github.rate_limiter import GitHubRateLimiter, get_rate_limiter, safe_github_request
...
if __name__ == "__main__":
    async def main():
        ...
        if success:
            ...
            print("\n✅ すべてのテストが正常に完了しました！")
            print("\n💡 レート制限管理システムの使用方法:")
            print("   from elders_guild.elder_tree.integrations.github.rate_limiter import safe_github_request")
