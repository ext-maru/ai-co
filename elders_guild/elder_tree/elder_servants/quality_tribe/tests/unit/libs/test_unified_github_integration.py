...
from elders_guild.elder_tree.integrations.github.unified_github_manager import UnifiedGitHubManager, get_unified_github_manager
from elders_guild.elder_tree.integrations.github.systems.comprehensive_error_handling import ErrorSeverity, CircuitState
from elders_guild.elder_tree.integrations.github.systems.rate_limit_management import RateLimitInfo
...
class TestAPIImplementations:
    ...
    def test_get_issues_pagination(self):
        """Issue取得のページネーションテスト"""
        from elders_guild.elder_tree.integrations.github.api_implementations.get_issues import GitHubGetIssuesImplementation
    ...
    def test_update_issue_audit_logging(self):
        """Issue更新の監査ログテスト"""
        from elders_guild.elder_tree.integrations.github.api_implementations.update_issue import GitHubUpdateIssueImplementation
    ...
    def test_create_pull_request_conflict_detection(self):
        """PR作成のコンフリクト検出テスト"""
        from elders_guild.elder_tree.integrations.github.api_implementations.create_pull_request import \
    ...
    def test_get_pull_requests_caching(self):
        """PR取得のキャッシングテスト"""
        from elders_guild.elder_tree.integrations.github.api_implementations.get_pull_requests import GitHubGetPullRequestsImplementation
...
class TestSystemComponents:
    ...
    def test_error_handler_statistics(self):
        """エラーハンドラ統計テスト"""
        from elders_guild.elder_tree.integrations.github.systems.comprehensive_error_handling import GitHubErrorHandler
    ...
    def test_rate_limit_manager_metrics(self):
        """レート制限管理メトリクステスト"""
        from elders_guild.elder_tree.integrations.github.systems.rate_limit_management import RateLimitManager
