...
from elders_guild.elder_tree.integrations.github.improved_conflict_analyzer import (
    ImprovedConflictAnalyzer, ConflictType, ResolutionStrategy, 
    ConflictInfo, RiskLevel as ConflictRiskLevel
)
from elders_guild.elder_tree.integrations.github.branch_updater import (
...
class TestImprovedConflictAnalyzer:
    ...
    def analyzer(self, temp_repo):
        ...
        return ImprovedConflictAnalyzer(temp_dir)
...
class TestIntegration:
    ...
    async def test_full_conflict_resolution_flow(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # アナライザーとアップデーター初期化
            analyzer = ImprovedConflictAnalyzer(temp_dir)
            updater = BranchUpdater(temp_dir)
