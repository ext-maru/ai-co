...
class TestHelperClasses:
    ...
    def test_schema_designer(self):
        """スキーマ設計器テスト"""
        from elders_guild.elder_tree.elder_servants.dwarf_workshop.database_shaper import SchemaDesigner
    ...
    def test_performance_optimizer(self):
        """パフォーマンス最適化器テスト"""
        from elders_guild.elder_tree.elder_servants.dwarf_workshop.database_shaper import (
    ...
    def test_index_architect(self):
        """インデックスアーキテクトテスト"""
        from elders_guild.elder_tree.elder_servants.dwarf_workshop.database_shaper import IndexArchitect
