...
from elders_guild.elder_tree.elder_system.elder_flow_safety_check import (
    ElderFlowSafetyChecker, 
    SafetyCheckResult,
    SafetyLevel,
    ElderFlowRecommendation
)
from elders_guild.elder_tree.elder_system.issue_classifier import IssueType, ClassificationResult
...
class TestElderFlowSafetyChecker:
    ...
    def test_integration_with_issue_classifier(self, safety_checker):
        ...
        from elders_guild.elder_tree.elder_system.issue_classifier import IssueTypeClassifier
