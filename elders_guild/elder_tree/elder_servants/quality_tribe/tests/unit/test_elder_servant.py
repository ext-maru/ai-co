...
class TestElderServantFoundationFixes(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_initial_health_status_improvement(self):
        ...
        # タスク実行後の改善確認
        from elders_guild.elder_tree.elder_servants.base.elder_servant import ServantRequest, TaskPriority
    ...
    async def test_registry_integration_stability(self):
        """レジストリ統合安定性テスト"""
        from elders_guild.elder_tree.elder_servants.base.elder_servant import ServantRegistry
