...
from elders_guild.elder_tree.four_sages_diagnostic_system import (
...
class TestFourSagesDiagnosticSystem:
    ...
    def setup_method(self):
        ...
        self.diagnostic.base_path = self.temp_dir
    ...
    async def test_knowledge_base_check_healthy(self):
        """健全な知識ベースのテスト"""
        # テスト用知識ベース作成
        kb_dir = self.temp_dir / "knowledge_base"
        kb_dir.mkdir()
    ...
    async def test_auto_fix_missing_database(self):
        ...
        result = DiagnosticResult(
            ...
            details={"expected_path": str(self.temp_dir / "task_history.db")},
        ...
        assert (self.temp_dir / "task_history.db").exists()
    ...
    async def test_auto_fix_missing_knowledge_base(self):
        ...
        result = DiagnosticResult(
            ...
            details={"expected_path": str(self.temp_dir / "knowledge_base")},
    ...
    async def test_auto_fix_missing_directory(self):
        ...
        result = DiagnosticResult(
            ...
            details={"expected_path": str(self.temp_dir / "libs")},
        ...
        # ディレクトリが作成されたことを確認
        assert (self.temp_dir / "libs").exists()
