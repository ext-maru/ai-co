...
from elders_guild.elder_tree.four_sages_integration import FourSagesIntegration
...
class TestFourSagesIntegration:
    ...
    @pytest.fixture
    def integration_system(self, temp_db_path):
        """テスト用統合システムインスタンス"""
        with patch('libs.four_sages_integration.PROJECT_ROOT', temp_db_path.parent):
            system = FourSagesIntegration()
            system.db_path = temp_db_path
