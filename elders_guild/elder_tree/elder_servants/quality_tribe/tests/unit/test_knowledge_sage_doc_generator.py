...
from elders_guild.elder_tree.knowledge_sage_doc_generator import KnowledgeSageDocGenerator
...
class TestKnowledgeSageDocGenerator:
    ...
    async def test_initialization(self, doc_generator):
        ...
        assert hasattr(doc_generator, 'templates')
    ...
    async def test_changelog_generation(self, doc_generator):
        ...
        version_history = [
            ...
            },
            {
                "version": "1.2.1", 
                "date": "2024-01-10",
                "changes": ["Fixed bug in tagging", "Updated documentation"],
                "type": "patch"
            }
        ]
    ...
    @pytest.mark.asyncio
    async def test_template_customization(self, doc_generator):
        ...
        result = await doc_generator.generate_from_template(
