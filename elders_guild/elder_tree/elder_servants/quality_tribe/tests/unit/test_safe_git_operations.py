...
from elders_guild.elder_tree.integrations.github.safe_git_operations import SafeGitOperations
...
class TestSafeGitOperationsIntegration(unittest.TestCase):
    ...
    def test_helper_functions_exist(self):
        """ヘルパー関数の存在確認"""
        from elders_guild.elder_tree.integrations.github.safe_git_operations import (
    ...
    def test_safe_git_global_instance(self):
        """グローバルインスタンスの存在確認"""
        from elders_guild.elder_tree.integrations.github.safe_git_operations import safe_git
