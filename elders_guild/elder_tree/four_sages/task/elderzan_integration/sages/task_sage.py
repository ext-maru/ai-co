...
from ...shared_enums import Priority, SageType
...
class TaskSageIntegration:
    ...
    async def update_task_status(
        self, task_id: str, status: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        タスク状態更新
    ...
    async def prioritize_tasks(
        self, task_list: List[str], context: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
        """
        タスク優先順位決定
        ...
        try:
            ...
            # 優先順位計算
            prioritized_tasks = await self._calculate_task_priorities(
    ...
    async def _process_task_data(
        ...
        # 緊急度評価
        processed_data["urgency_score"] = await self._calculate_urgency_score(
            processed_data
        )

        # 複雑度評価
        processed_data["complexity_score"] = await self._calculate_complexity_score(
            processed_data
        )
    ...
    async def _calculate_task_priorities(
        self, task_details: List[Dict[str, Any]], context: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
        """
        タスク優先順位計算
