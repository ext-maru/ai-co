...
from core.common_utils import EMOJI, generate_task_id


def send_task(
    prompt: str, task_type: str = "code", priority: str = "normal"
) -> Optional[str]:
    """
    タスクをキューに送信
    ...
    try:
        ...
        channel.basic_publish(
            ...
            properties=pika.BasicProperties(
                delivery_mode=2, priority=priority_map.get(priority, 5)  # 永続化
            ),
        )
