...
async def consult_sages(request: SageConsultRequest):
    ...
    try:
        ...
        return {
            ...
            "integrated_recommendation": "Implement with TDD approach, maintain Iron Will standards (95%+), and \
        ...
        mock_items = [
            {
                ...
                "content": "# TDD Best Practices\n\n1.0 Red-Green-Refactor cycle\n2.0 Test first,  \
                    code second\n3.0 Minimum viable implementation\n4.0 Continuous refactoring",
                "relevance": 0.95,
            },
            {
...
async def list_servants()return {"success": True, "servants": MOCK_SERVANTS, "total": len(MOCK_SERVANTS)}
