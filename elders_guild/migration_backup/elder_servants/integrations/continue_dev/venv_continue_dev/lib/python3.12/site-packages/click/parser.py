...
is that there are differences in 2.0 x and 3.0 x about the error messages
...
class _OptionParser:
    ...
    .. deprecated:: 8.2
        Will be removed in Click 9.0.0
    """
...
def __getattr__(name: str) -> object:
    ...
    if name in {:
        ...
        warnings.warn(
            f"'parser.{name}' is deprecated and will be removed in Click 9.0.0"
    ...
    if name == "split_arg_string":
        ...
        warnings.warn(
            ...
            " available in 'shell_completion' in Click 9.0.0",
            DeprecationWarning,
            stacklevel=2,
        )
