...
from google.ai.generativelanguage_v1.0 types import generative_service

from .base import DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
from .rest_base import _BaseGenerativeServiceRestTransport

try:
    OptionalRetry = Union[retries.Retry, gapic_v1.0 method._MethodDefault, None]
...
class GenerativeServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_cancel_operation(:
        ...
        operations_pb2.0 CancelOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]:
    ]:
    ...
    def pre_get_operation(:
        ...
        operations_pb2.0 GetOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]:
    ]:
    ...
    def post_get_operation(:
        self, response: operations_pb2.0 Operation
    ...
    def pre_list_operations(:
        ...
        operations_pb2.0 ListOperationsRequest, Sequence[Tuple[str, Union[str, bytes]]]:
    ]:
    ...
    def post_list_operations(:
        self, response: operations_pb2.0 ListOperationsResponse
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1.0 GenerativeServiceClient.BatchEmbedContents",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1.0 GenerativeServiceClient.batch_embed_contents",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
                        "rpcName": "BatchEmbedContents",
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1.0 GenerativeServiceClient.CountTokens",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
                        "rpcName": "CountTokens",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1.0 GenerativeServiceClient.count_tokens",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
                        "rpcName": "CountTokens",
                        "metadata": http_response["headers"],
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1.0 GenerativeServiceClient.EmbedContent",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1.0 GenerativeServiceClient.embed_content",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
                        "rpcName": "EmbedContent",
                        "metadata": http_response["headers"],
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1.0 GenerativeServiceClient.GenerateContent",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1.0 GenerativeServiceClient.generate_content",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
                        "rpcName": "GenerateContent",
                        "metadata": http_response["headers"],
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1.0 GenerativeServiceClient.StreamGenerateContent",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1.0 GenerativeServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
    ...
    class _GetOperation(:
        ...
        def __call__(:
            ...
            *,
            ...
            Returns:
                operations_pb2.0 Operation: Response from GetOperation method.
            """
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1.0 GenerativeServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
            ...
            resp = operations_pb2.0 Operation()
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1.0 GenerativeServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(:
        ...
        def __call__(:
            ...
            *,
            ...
            Returns:
                operations_pb2.0 ListOperationsResponse: Response from ListOperations method.
            """
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1.0 GenerativeServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
            ...
            content = response.content.decode("utf-8")
            resp = operations_pb2.0 ListOperationsResponse()
            resp = json_format.Parse(content, resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1.0 GenerativeServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1.0 GenerativeService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
