...
class GenerativeServiceClient(metaclass=GenerativeServiceClientMeta):
    ...
    @staticmethod
    def parse_cached_content_path(path: str) -> Dict[str, str]m = re.match(r"^cachedContents/(?P<id>.+?)$", path)return m.groupdict() if m else {}
    """arses a cached_content path into its component segments."""
