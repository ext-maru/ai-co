...
from google.ai.generativelanguage_v1beta2.0 types import model, model_service
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta2.0 ModelServiceClient.GetModel",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 ModelService",
                        "rpcName": "GetModel",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1beta2.0 ModelServiceClient.get_model",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 ModelService",
                        "rpcName": "GetModel",
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta2.0 ModelServiceClient.ListModels",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 ModelService",
                        "rpcName": "ListModels",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1beta2.0 ModelServiceClient.list_models",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 ModelService",
                        "rpcName": "ListModels",
                        "metadata": http_response["headers"],
