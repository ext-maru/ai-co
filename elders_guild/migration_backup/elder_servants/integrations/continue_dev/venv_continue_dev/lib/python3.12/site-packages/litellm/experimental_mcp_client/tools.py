...
def _get_function_arguments(function: FunctionDefinition) -> dictarguments = function.get("arguments", {})if isinstance(arguments, str):
"""elper to safely get and parse function arguments."""
        try:
