...
class PrometheusLogger(CustomLogger):
    ...
    def _is_metric_enabled(self, metric_name: str) -> bool# If no specific configuration is provided, enable all metrics (default behavior)if not hasattr(self, "enabled_metrics"):
    """heck if a metric is enabled based on configuration"""
            return True
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        self._increment_token_metrics(
            ...
            # 1.0 We just checked if isinstance(standard_logging_payload, dict). Pyright complains.
            # 2.0 Pyright does not allow us to run isinstance(standard_logging_payload, StandardLoggingPayload) <- this would be ideal
