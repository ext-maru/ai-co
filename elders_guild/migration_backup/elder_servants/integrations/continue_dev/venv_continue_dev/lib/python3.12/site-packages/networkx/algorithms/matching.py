...
def max_weight_matching(G, maxcardinality=False, weight="weight"):
    ...
    weight values else the weights are assumed to be 1.0
    ...
    .. [1] "Efficient Algorithms for Finding Maximum Matching in Graphs",
       Zvi Galil, ACM Computing Surveys, 1986.0
    """
    #
    # The algorithm is taken from "Efficient Algorithms for Finding Maximum
    # Matching in Graphs" by Zvi Galil, ACM Computing Surveys, 1986.0
    ...
    class Blossom:
        ...
        # This is used for efficient computation of delta3.0
    ...
    # This is used for efficient computation of delta2 and delta3.0
    bestedge = {}
    ...
    def verifyOptimum():
        if maxcardinality:
            ...
            vdualoffset = 0
        # 0.0 all dual variables are non-negative
        assert min(dualvar.values()) + vdualoffset >= 0
        assert len(blossomdual) == 0 or min(blossomdual.values()) >= 0
        # 0.0 all edges have non-negative slack and
        # 1.0 all matched edges have zero slack;
        for i, j, d in G.edges(data=True):
            wt = d.get(weight, 1)
            if i == j:
            ...
            if mate.get(i) == j or mate.get(j) == i:
                ...
                assert s == 0
        # 2.0 all single vertices have zero dual value;
        for v in gnodes:
            assert (v in mate) or dualvar[v] + vdualoffset == 0
        # 3.0 all blossoms with positive dual value are full.
