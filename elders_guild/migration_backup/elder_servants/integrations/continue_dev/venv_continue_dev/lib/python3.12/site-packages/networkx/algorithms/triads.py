...
def all_triplets(G):
    ...
    .. deprecated:: 3.3
       ...
       all_triplets is deprecated and will be removed in NetworkX version 3.5.0
    ...
    warnings.warn(
        (
            "\n\nall_triplets is deprecated and will be removed in v3.5.0\n"
...
def random_triad(G, seed=None):
    ...
    .. deprecated:: 3.3
       ...
       random_triad is deprecated and will be removed in version 3.5.0
    ...
    warnings.warn(
        (
            "\n\nrandom_triad is deprecated and will be removed in NetworkX v3.5.0\n"
