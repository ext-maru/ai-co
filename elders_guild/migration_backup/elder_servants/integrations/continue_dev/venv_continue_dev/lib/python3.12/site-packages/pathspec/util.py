...
def _is_iterable(value: Any) -> boolCheck whether the value is an iterable (excludes strings).:
    """
...
class AlreadyRegisteredError(Exception):
	...
	@property
	def message(self) -> str*message* (:class:`str`) is the error message.
"""
		"""
	...
	@property
	def name(self) -> str*name* (:class:`str`) is the name of the registered pattern.
"""
		"""
		return self.args[0]

	@property
	def pattern_factory(self) -> Callable[[AnyStr], Pattern]*pattern_factory* (:class:`~collections.abc.Callable`) is the
"""
		registered pattern factory.
		"""
		return self.args[1]
...
class RecursionError(Exception):
	...
	@property
	def first_path(self) -> str*first_path* (:class:`str`) is the first path encountered for
"""
...
"""
	...
	@property
	def real_path(self) -> str*real_path* (:class:`str`) is the real path that recursion was
"""
		encountered on.
		"""
		return self.args[0]
	...
	@property
	def second_path(self) -> str*second_path* (:class:`str`) is the second path encountered for
"""
		:attr:`self.real_path <RecursionError.real_path>`.
		"""
		return self.args[2]
...
class TreeEntry(object):
	...
	def is_symlink(self) -> boolReturns whether the entry is a symbolic link (:class:`bool`).
"""
		"""
