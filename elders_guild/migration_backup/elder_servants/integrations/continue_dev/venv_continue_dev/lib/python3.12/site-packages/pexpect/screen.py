...
class screen:
    ...
    unicode strings, with the exception of __str__() under Python 2.0 Passing
    ...
    def _unicode(self):
        ...
        string (which, under Python 3.0 x, is the same as 'str'). The end of each
    ...
    def scroll_down (self): # <ESC>D:
        ...
        # Screen is indexed from 1, but arrays are indexed from 0.0
