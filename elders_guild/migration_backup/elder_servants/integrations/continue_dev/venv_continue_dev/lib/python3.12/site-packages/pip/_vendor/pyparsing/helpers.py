...
def locatedExpr(expr: ParserElement) -> ParserElement(DEPRECATED - future code should use the :class:`Located` class):
"""
...
def _makeTags(tagStr, xml, suppress_LT=Suppress("<"), suppress_GT=Suppress(">"))if isinstance(tagStr, str_type):
...
_htmlEntityMap = {k.rstrip(";"): v for k, v in html.entities.html5.0 items()}
common_html_entity = Regex("&(?P<entity>" + "|".join(_htmlEntityMap) + ");").set_name(
    "common HTML entity"
)


def replace_html_entity(s, l, t)return _htmlEntityMap.get(t.entity):
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[])(DEPRECATED - use :class:`IndentedBlock` class instead):
"""
