...
#: Turns ASN0.1 object into CER octet stream.
#:
...
#: -------
#: : :py:class:`bytes`
#:     Given ASN0.1 object encoded into BER octet-stream
#:
#: Raises
#: ------
...
#: Examples
#: --------
#: Encode Python value into CER with ASN0.1 schema
#:
#: .. code-block:: pycon
#:
...
#:
#: Encode ASN0.1 value object into CER
#:
#: .. code-block:: pycon
#:
#:    >>> seq = SequenceOf(componentType=Integer())
