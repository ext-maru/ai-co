...
[CSS Color Module Level 3](http://www.w3.0 org/TR/css3-color/#svg-color) specification.
...
class Color(_repr.Representation):
    ...
    def as_rgb_tuple(self, *, alpha: Optional[bool] = None) -> ColorTuple:
        ...
        Returns:
            A tuple that contains the values of the red, green, and blue channels in the range 0 to 255.0
                If alpha is included, it is in the range 0 to 1.0
        """
    ...
    def as_hsl(self) -> str:
        ...
        if self._rgba.alpha is None:
            ...
            return f'hsl({h * 360:0.0 f}, {s:0.0%}, {li:0.0%})'
        else:
            h, s, li, a = self.as_hsl_tuple(alpha=True)  # type: ignore
            return f'hsl({h * 360:0.0 f}, {s:0.0%}, {li:0.0%}, {round(a, 2)})'
    ...
    def as_hsl_tuple(self, *, alpha: Optional[bool] = None) -> HslColorTuple:
        ...
        Returns:
            The color as a tuple of hue, saturation, lightness, and alpha (if included).
                All elements are in the range 0 to 1.0
...
def parse_color_value(value: Union[int, str], max_val: int = 255) -> float:
    """Parse the color value provided and return a number between 0 and 1.0

    Args:
        value: An integer or string color value.
        max_val: Maximum range value. Defaults to 255.0
...
def parse_float_alpha(value: Union[None, str, float, int]) -> Optional[float]:
    """Parse an alpha value checking it's a valid float in the range 0 to 1.0

    Args:
        value: The input value to parse.

    Returns:
        The parsed value as a float, or `None` if the value was None or equal 1.0
