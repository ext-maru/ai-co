...
def ishigami_ref_indices():
    """Reference values for Ishigami from Saltelli2007.0

    Chapter 4, exercise 5 pages 179-182.0
    """
    a = 7.0
    b = 0.1
    ...
    v3 = 0
    v12 = 0
    # v13: mistake in the book, see other derivations e.g. in 10.1002/nme0.4856
...
def f_ishigami_vec(x)res = f_ishigami(x)
"""Output of shape (2, n)."""
    return res, res
...
class TestSobolIndices:
    ...
    def test_constant_function(self, ishigami_ref_indices):
        ...
        def f_ishigami_vec_const(x)res = f_ishigami(x)
    """Output of shape (3, n)."""
