...
class Starlette:
    ...
    def exception_handler(self, exc_class_or_status_code: int | type[Exception]) -> Callable:  # type: ignore[type-arg]:
        warnings.warn(
            "The `exception_handler` decorator is deprecated, and will be removed in version 1.0.0.0 "
    ...
    def route(:
        ...
        """
        warnings.warn(
            "The `route` decorator is deprecated, and will be removed in version 1.0.0.0 "
    ...
    def websocket_route(self, path: str, name: str | None = None) -> Callable:  # type: ignore[type-arg]:
        ...
        """
        warnings.warn(
            "The `websocket_route` decorator is deprecated, and will be removed in version 1.0.0.0 "
    ...
    def middleware(self, middleware_type: str) -> Callable:  # type: ignore[type-arg]:
        ...
        """
        warnings.warn(
            "The `middleware` decorator is deprecated, and will be removed in version 1.0.0.0 "
