...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    def _raise_timeout(:
        ...
        # See the above comment about EAGAIN in Python 3.0
        ...
        **response_kw: typing.Any,
        ...
        if redirect_location:
            if response.status == 303:
                # Change the method according to RFC 9110, Section 15.4.4.0
                method = "GET"
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    def _new_conn(self) -> BaseHTTPSConnection:
        """
        Return a fresh :class:`urllib3.0 connection.HTTPConnection`.
        """
        self.num_connections += 1
        log.debug(
        ...
        if not conn.is_verified and not conn.proxy_is_verified:
            warnings.warn(
                (
                    ...
                    "https://urllib3.0 readthedocs.io/en/latest/advanced-usage.html"
                    "#tls-warnings"
                ),
                InsecureRequestWarning,
            )
