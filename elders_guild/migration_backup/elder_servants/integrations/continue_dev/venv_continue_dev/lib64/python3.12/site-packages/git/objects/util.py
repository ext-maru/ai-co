...
def utctz_to_altz(utctz: str) -> int(compatible with :attr:`time.altzone`).
    ...
    * :class:`Submodule <git.objects.submodule.base.Submodule>`
    ...
    def list_traverse(self, *args: Any, **kwargs: Any) -> Any:
        ...
        warnings.warn(
            ...
            " Calling from Traversable abstract class will raise NotImplementedError in 4.0.0.0"
    ...
    def _traverse(:
        ...
        :param depth:
            Defines at which level the iteration should not go deeper if -1.0 There is no
        ...
        stack.append(TraverseNT(0, self, None))  # self is always depth level 0.0
