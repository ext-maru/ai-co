...
class SafetyRating(proto.Message):
    ...
    Attributes:
        category (google.ai.generativelanguage_v1.0 types.HarmCategory):
            Required. The category for this rating.
        probability (google.ai.generativelanguage_v1.0 types.SafetyRating.HarmProbability):
...
class SafetySetting(proto.Message):
    ...
    Attributes:
        ...
        threshold (google.ai.generativelanguage_v1.0 types.SafetySetting.HarmBlockThreshold):
