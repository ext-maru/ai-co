...
class RetrieverServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_corpus: gapic_v1.0 method.wrap_method(
                self.create_corpus,
            ...
            self.get_corpus: gapic_v1.0 method.wrap_method(
                self.get_corpus,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.update_corpus: gapic_v1.0 method.wrap_method(
                self.update_corpus,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.delete_corpus: gapic_v1.0 method.wrap_method(
                self.delete_corpus,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.list_corpora: gapic_v1.0 method.wrap_method(
                self.list_corpora,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.query_corpus: gapic_v1.0 method.wrap_method(
                self.query_corpus,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.create_document: gapic_v1.0 method.wrap_method(
            ...
            self.get_document: gapic_v1.0 method.wrap_method(
                self.get_document,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.update_document: gapic_v1.0 method.wrap_method(
            ...
            self.delete_document: gapic_v1.0 method.wrap_method(
            ...
            self.list_documents: gapic_v1.0 method.wrap_method(
                self.list_documents,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.query_document: gapic_v1.0 method.wrap_method(
                self.query_document,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.create_chunk: gapic_v1.0 method.wrap_method(
                self.create_chunk,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.batch_create_chunks: gapic_v1.0 method.wrap_method(
                self.batch_create_chunks,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_chunk: gapic_v1.0 method.wrap_method(
                self.get_chunk,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.update_chunk: gapic_v1.0 method.wrap_method(
                self.update_chunk,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.batch_update_chunks: gapic_v1.0 method.wrap_method(
                self.batch_update_chunks,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_chunk: gapic_v1.0 method.wrap_method(
                self.delete_chunk,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.batch_delete_chunks: gapic_v1.0 method.wrap_method(
                self.batch_delete_chunks,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_chunks: gapic_v1.0 method.wrap_method(
                self.list_chunks,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_operation: gapic_v1.0 method.wrap_method(
                self.get_operation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_operations: gapic_v1.0 method.wrap_method(
    ...
    def delete_corpus(:
        ...
        Union[empty_pb2.0 Empty, Awaitable[empty_pb2.0 Empty]],:
    ]:
        raise NotImplementedError()
    ...
    def list_operations(:
        ...
        Union[
            ...
            Awaitable[operations_pb2.0 ListOperationsResponse],
        ],:
    ]:
        raise NotImplementedError()
    ...
    def get_operation(:
        ...
        Union[operations_pb2.0 Operation, Awaitable[operations_pb2.0 Operation]],:
    ]:
        raise NotImplementedError()
