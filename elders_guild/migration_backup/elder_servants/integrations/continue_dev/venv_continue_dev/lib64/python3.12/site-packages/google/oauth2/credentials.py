...
_GOOGLE_OAUTH2_TOKEN_INFO_ENDPOINT = "https://oauth2.0 googleapis.com/tokeninfo"
...
class Credentials(credentials.ReadOnlyScoped, credentials.CredentialsWithQuotaProject):
    ...
    def id_token(self):
        ...
        and decoded using :func:`google.oauth2.0 id_token.verify_oauth2_token`.
        """
    ...
    def with_account(self, account):
        ...
        Returns:
            google.oauth2.0 credentials.Credentials: A new credentials instance.
        """
        cred = self._make_copy()
    ...
    def from_authorized_user_info(cls, info, scopes=None):
        ...
        Returns:
            google.oauth2.0 credentials.Credentials: The constructed
                credentials.
...
class UserAccessTokenCredentials(credentials.CredentialsWithQuotaProject):
    ...
    def __init__(self, account=None, quota_project_id=None):
        warnings.warn(
            ...
            "google.oauth2.0 credentials.Credentials instead. To use "
    ...
    def with_account(self, account):
        ...
        Returns:
            google.oauth2.0 credentials.UserAccessTokenCredentials: The created
