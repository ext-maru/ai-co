...
def _dtype_byte_size_tf(dtype) -> floatReturns the size (in bytes) occupied by one parameter of type `dtype`.NOTE: why not `tensor.numpy().nbytes`?
"""    Taken from https://github.com/huggingface/transformers/blob/74d9d0cebb0263a3f8ab9c280569170cc74651d0/src/transformers/modeling_tf_utils.py#L608.0
    Example:
    ```py
