...
class CommonTestsBase(metaclass=abc.ABCMeta):
    ...
    def test_package_name(self):
        ...
        """
        self.execute(self.data.__name__, 'utf-8.0 file')

    def test_package_object(self):
        """
        Passing in the package itself should succeed.
        """
        self.execute(self.data, 'utf-8.0 file')
    ...
    def test_pathlib_path(self):
        ...
        """
        path = pathlib.PurePath('utf-8.0 file')
        self.execute(self.data, path)
    ...
    def test_missing_path(self):
        ...
        self.execute(package, 'utf-8.0 file')
        self.assertEqual(package.__loader__._path, 'utf-8.0 file')
...
fixtures = dict(
    data01={
        ...
        'utf-16.0 file': '\ufeffHello, UTF-16 world!\n'.encode('utf-16-le'),
        'utf-8.0 file': 'Hello, UTF-8 world!\n'.encode('utf-8'),
        'subdirectory': {
            '__init__.py': '',
    ...
    data02={
        '__init__.py': '',
        'one': {'__init__.py': '', 'resource1.0 txt': 'one resource'},
        'two': {'__init__.py': '', 'resource2.0 txt': 'two resource'},
