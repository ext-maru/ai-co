...
class AmazonStabilityConfig:
    """
    Reference: https://us-west-2.0 console.aws.amazon.com/bedrock/home?region=us-west-2#/providers?model=stability.stable-diffusion-xl-v0
    ...
    - `width` (integer): Default: `512`. multiple of 64 >= 128.0 Width of the image to generate, in pixels, in an increment divible by 64.0
        Engine-specific dimension validation:

        - SDXL Beta: must be between 128x128 and 512x896 (or 896x512); only one dimension can be greater than 512.0
        - SDXL v0.9: must be one of 1024x1024, 1152x896, 1216x832, 1344x768, 1536x640, 640x1536, 768x1344, 832x1216, or 896x1152
        - SDXL v1.0: same as SDXL v0.9
        - SD v1.6: must be between 320x320 and 1536x1536

    - `height` (integer): Default: `512`. multiple of 64 >= 128.0 Height of the image to generate, in pixels, in an increment divible by 64.0
        Engine-specific dimension validation:
