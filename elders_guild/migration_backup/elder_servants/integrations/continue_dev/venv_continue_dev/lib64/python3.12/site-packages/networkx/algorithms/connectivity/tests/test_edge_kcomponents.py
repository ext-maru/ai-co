...
def test_tarjan_bridge():
    ...
    # doi:10.1016/0020-0190(74)90003-9.0
...
def test_undirected_aux_graph():
    ...
    # http://journals.plos.org/plosone/article?id=10.1371/journal.pone0.136264
...
def test_four_clique():
    paths = [
        ...
        # Case where the nodes bridging them do not have degree less than 3.0
        (100, 13),
        (12, 100, 22),
        (13, 200, 23),
        (14, 300, 24),
