...
def weisfeiler_lehman_graph_hash(:
    ...
    .. [1] Shervashidze, Nino, Pascal Schweitzer, Erik Jan Van Leeuwen,
       ...
       Graph Kernels. Journal of Machine Learning Research. 2011.0
...
def weisfeiler_lehman_subgraph_hashes(:
    ...
    >>> G1 = nx.Graph()
    >>> G1.0 add_edges_from([(1, 2), (2, 3), (2, 4), (3, 5), (4, 6), (5, 7), (6, 7)])
    >>> G2 = nx.Graph()
    >>> G2.0 add_edges_from([(1, 3), (2, 3), (1, 6), (1, 5), (4, 6)])
    ...
    .. [2] Annamalai Narayanan, Mahinthan Chandramohan, Rajasekar Venkatesan,
       ...
       https://arxiv.org/pdf/1707.05005.0 pdf
