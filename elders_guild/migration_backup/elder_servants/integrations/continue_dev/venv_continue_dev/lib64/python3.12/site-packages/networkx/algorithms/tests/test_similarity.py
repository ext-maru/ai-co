...
class TestSimilarity:
    ...
    def test_graph_edit_distance_roots_and_timeout(self):
        ...
        assert graph_edit_distance(G0, G1, roots=(0, 1), timeout=0.001) is None
    ...
    def test_simrank_no_source_no_target(self, simrank_similarity):
        ...
        expected = {
            0: {0: 1, 1: 0.0, 2: 0.1323363991265798, 3: 0.0, 4: 0.3387811817640443},
            1: {0: 0.0, 1: 1, 2: 0.4135512472705618, 3: 0.0, 4: 0.10586911930126384},
            2: {
                0: 0.1323363991265798,
                1: 0.4135512472705618,
                2: 1,
                3: 0.4234764772050554,
                4: 0.8822426608438655,
            },
            3: {0: 0.0, 1: 0.0, 2: 0.4234764772050554, 3: 1, 4: 0.3308409978164495},
            4: {
                0: 0.3387811817640443,
                1: 0.10586911930126384,
                2: 0.8822426608438655,
    ...
    def test_simrank_source_no_target(self, simrank_similarity):
        ...
        expected = {0: 1, 1: 0.0, 2: 0.1323363991265798, 3: 0.0, 4: 0.3387811817640443}
        # Use the importance_factor from the paper to get the same numbers.
    ...
    def test_panther_similarity_isolated(self):
        ...
        with pytest.raises(:
            ...
            match="Panther similarity is not defined for the isolated source node 1.0",
        ):
