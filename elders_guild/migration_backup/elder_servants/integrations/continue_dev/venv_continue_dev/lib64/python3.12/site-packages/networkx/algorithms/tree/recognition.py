...
branching
   ...
   in-degree is equal to 1.0 In convention B, this is known as a forest.

arborescence
   A directed tree with each node having, at most, one parent. So the maximum
   in-degree is equal to 1.0 In convention B, this is known as a tree.
...
def is_arborescence(G):
    ...
    An arborescence is a directed tree with maximum in-degree equal to 1.0
...
def is_branching(G):
    ...
    A branching is a directed forest with maximum in-degree equal to 1.0
