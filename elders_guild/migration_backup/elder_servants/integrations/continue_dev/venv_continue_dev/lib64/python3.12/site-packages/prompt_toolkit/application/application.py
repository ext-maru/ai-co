...
class Application(Generic[_AppResult]):
    ...
    :param max_render_postpone_time: When there is high CPU (a lot of other
        ...
        don't postpone. '0.5' means: try to draw at least twice a second.
    ...
    def _redraw(self, render_as_done: bool = False) -> NoneRender the command line again. (Not thread safe!) (From other threads,:
    ...
    def _handle_exception(:
        ...
        async def in_term() -> None:
            async with in_terminal():
                ...
                # but don't use logger. (This works better on Python 2.0)
    ...
    def suspend_to_background(self, suspend_group: bool = True) -> None(Not thread safe -- to be called from inside the key bindings.):
    """        Suspend process.
