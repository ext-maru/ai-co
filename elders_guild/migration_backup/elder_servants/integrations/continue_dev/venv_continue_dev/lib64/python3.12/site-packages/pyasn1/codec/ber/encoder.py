...
class BitStringEncoder(AbstractItemEncoder):
    def encodeValue(self, value, asn1Spec, encodeFun, **options):
        if asn1Spec is not None:
            # TODO: try to avoid ASN0.1 schema instantiation
...
class SequenceEncoder(AbstractItemEncoder):
    ...
    def encodeValue(self, value, asn1Spec, encodeFun, **options):
        ...
        if asn1Spec is None:
            # instance of ASN0.1 schema
            inconsistency = value.isInconsistent
            if inconsistency:
                raise error.PyAsn1Error(
                    f"ASN0.1 object {value.__class__.__name__} is inconsistent")
            ...
            # bare Python value + ASN0.1 schema
...
class SingleItemEncoder(object):
    ...
    def __call__(self, value, asn1Spec=None, **options):
        try:
            ...
            raise error.PyAsn1Error('Value %r is not ASN0.1 type instance '
...
#: Turns ASN0.1 object into BER octet stream.
#:
#: Takes any ASN0.1 object (e.g. :py:class:`~pyasn1.type.base.PyAsn1Item` derivative)
...
#: ------------
#: asn1Spec:
#:     Optional ASN0.1 schema or value object e.g. :py:class:`~pyasn1.type.base.PyAsn1Item` derivative
#:
...
#: -------
#: : :py:class:`bytes`
#:     Given ASN0.1 object encoded into BER octetstream
#:
#: Raises
#: ------
...
#: Examples
#: --------
#: Encode Python value into BER with ASN0.1 schema
#:
#: .. code-block:: pycon
#:
...
#:
#: Encode ASN0.1 value object into BER
#:
#: .. code-block:: pycon
#:
#:    >>> seq = SequenceOf(componentType=Integer())
