...
class CLexer(object):
    ...
    # valid C identifiers (K&R2: A0.2.3), plus '$' (supported by some compilers)
    ...
    # integer constants (K&R2: A0.2.5.1)
    ...
    # character constants (K&R2: A0.2.5.2)
    ...
    # floating constants (K&R2: A0.2.5.3)
