...
def dctn(x, type=2, shape=None, axes=None, norm=None, overwrite_x=False):
    ...
    type : {1, 2, 3, 4}, optional
        Type of the DCT (see Notes). Default type is 2.0
...
def dstn(x, type=2, shape=None, axes=None, norm=None, overwrite_x=False):
    ...
    x : array_like
        The input array.
    type : {1, 2, 3, 4}, optional
        Type of the DST (see Notes). Default type is 2.0
    shape : int or array_like of ints or None, optional
        The shape of the result.  If both `shape` and `axes` (see below) are
        None, `shape` is ``x.shape``; if `shape` is None but `axes` is
        not None, then `shape` is ``numpy.take(x.shape, axes, axis=0)``.
...
def dct(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False):
    ...
    Inverse DCT generally refers to DCT type 3.0
    ...
    **Type I**
    ...
    .. note::
       The DCT-I is only supported for input size > 1.0
    ...
    **Type IV**
    ...
    .. [1] 'A Fast Cosine Transform in One and Two Dimensions', by J.
           ...
           :doi:`10.1109/TASSP0.1980.1163351` (1980).
    ...
    >>> import numpy as np
    >>> fft(np.array([4.0, 3.0, 5.0, 10.0, 5.0, 3.0])).real
    array([ 30.0,  -8.0,   6.0,  -2.0,   6.0,  -8.0])
    >>> dct(np.array([4.0, 3.0, 5.0, 10.0]), 1)
    array([ 30.0,  -8.0,   6.0,  -2.0])
...
def idct(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False):
    ...
    'The' IDCT is the IDCT of type 2, which is the same as DCT of type 3.0

    IDCT of type 1 is the DCT of type 1, IDCT of type 2 is the DCT of type
    3, and IDCT of type 3 is the DCT of type 2.0 IDCT of type 4 is the DCT
    of type 4.0 For the definition of these types, see `dct`.
    ...
    >>> import numpy as np
    >>> ifft(np.array([ 30.0,  -8.0,   6.0,  -2.0,   6.0,  -8.0])).real
    array([  4.0,   3.0,   5.0,  10.0,   5.0,   3.0])
    >>> idct(np.array([ 30.0,  -8.0,   6.0,  -2.0]), 1) / 6
    array([  4.0,   3.0,   5.0,  10.0])
...
def dst(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False):
    ...
    **Type I**
    ...
    Note that the DST-I is only supported for input size > 1.0
...
def idst(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False):
    ...
    Notes
    -----
    'The' IDST is the IDST of type 2, which is the same as DST of type 3.0

    IDST of type 1 is the DST of type 1, IDST of type 2 is the DST of type
    3, and IDST of type 3 is the DST of type 2.0 For the definition of these
    types, see `dst`.
