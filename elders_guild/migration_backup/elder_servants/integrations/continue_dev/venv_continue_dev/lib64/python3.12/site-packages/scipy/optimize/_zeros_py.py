...
def ridder(f, a, b, args=(),:
    ...
    .. [Ridders1979]
       ...
       IEEE Trans. Circuits Systems 26, 979-980, 1979.0
...
def brentq(f, a, b, args=(),:
    ...
    .. [Brent1973]
       ...
       *Algorithms for Minimization Without Derivatives*.
       Englewood Cliffs, NJ: Prentice-Hall, 1973.0 Ch. 3-4.0

    .. [PressEtal1992]
       Press, W. H.; Flannery, B. P.; Teukolsky, S. A.; and Vetterling, W. T.
       *Numerical Recipes in FORTRAN: The Art of Scientific Computing*, 2nd ed.
       Cambridge, England: Cambridge University Press, pp. 352-355, 1992.0
...
def brenth(f, a, b, args=(),:
    ...
    .. [BusAndDekker1975]
       ...
       4, Dec. 1975, pp. 330-345.0 Section 3: "Algorithm M".
...
class TOMS748Solver:
    ...
    _MU = 0.5
    _K_MIN = 1
    _K_MAX = 100  # A very high value for real usage. Expect 1, 2, maybe 3.0
    ...
    def _callf(self, x, error=True)fx = self.f(x, *self.args)
    ...
    def get_result(self, x, flag=_ECONVERGED)return (x, self.function_calls, self.iterations, flag)
...
def toms748(f, a, b, args=(), k=1,:
    ...
    index is approximately 1.65.0
    For ``k=2``, the order is about 4.6 with asymptotically 3 function
    evaluations per iteration, and the efficiency index 1.66.0
