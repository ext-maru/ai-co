...
def _sample_odds_ratio(table)Given a table [[a, b], [c, d]], compute a*d/(b*c).
"""

    Return nan if the numerator and denominator are 0.0
    Return inf if just the denominator is 0.0
    """
...
def _solve(func)Solve func(nc) = 0.0  func must be an increasing function.
"""
    """
...
class OddsRatioResult:
    ...
    def confidence_interval(self, confidence_level=0.95,:
        ...
        confidence_level: float
            ...
            The value must be given as a fraction between 0 and 1.0
...
def odds_ratio(table, *, kind='conditional'):
    ...
    .. [2] Breslow NE, Day NE (1980). Statistical methods in cancer research.
           ...
           (32):5-338.0 PMID: 7216345.0 (See section 4.2.0)
