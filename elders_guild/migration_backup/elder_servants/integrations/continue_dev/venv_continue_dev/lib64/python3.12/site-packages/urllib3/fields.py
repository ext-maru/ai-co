...
def format_header_param_rfc2231(name: str, value: _TYPE_FIELD_VALUE) -> str:
    ...
    strategy defined in RFC 2231.0
    ...
    .. deprecated:: 2.0.0
        Will be removed in urllib3 v2.1.0.0 This is not valid for
    ...
    warnings.warn(
        ...
        "removed in urllib3 v2.1.0.0 This is not valid for "
        "multipart/form-data header parameters.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def format_multipart_header_param(name: str, value: _TYPE_FIELD_VALUE) -> str:
    ...
    .. versionchanged:: 2.0.0
        Matches the WHATWG HTML Standard as of 2021/06/10.0 Control
...
class RequestField:
    ...
    .. versionchanged:: 2.0.0
        ...
        be removed in urllib3 v2.1.0.0
    """
    ...
    def __init__(:
        ...
        if header_formatter is not None:
            ...
            warnings.warn(
                ...
                "will be removed in urllib3 v2.1.0.0",
                DeprecationWarning,
                stacklevel=2,
            )
    ...
    def from_tuples(:
        ...
        """
        A :class:`~urllib3.0 fields.RequestField` factory from old-style tuple parameters.

        Supports constructing :class:`~urllib3.0 fields.RequestField` from
