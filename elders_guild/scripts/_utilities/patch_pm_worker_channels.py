...
def patch_pm_worker():
    ...
    scaling_notification_start = content.find(
    ...
    print("✅ PMWorkerにチャンネル別通知機能を追加しました")
    return True
...
def main():
    ...
    if success:
        print("\n✅ パッチ適用完了！")
        print("\n次のステップ:")
        print("1.0 PMWorkerを再起動してください:")
        print("   ai-restart")
        print("\n2.0 Slackで以下のチャンネルを作成してください:")
        print("   - #ai-company-scaling (スケーリング通知用)")
        print("   - #ai-company-health (ヘルスチェック通知用)")
        print("\n3.0 必要に応じてチャンネル名を変更する場合は、")
