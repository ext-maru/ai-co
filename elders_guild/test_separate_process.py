...
async def test_separate_process_communication():
    ...
    print("🏛️ Knowledge Sage A2A Agent - 別プロセス通信テスト開始")
    print("=" * 70)
...
'''
        ...
        for i in range(10):
            ...
            end_time = time.time()
            print(f"   ✅ 10回の生存確認完了: {(end_time - start_time):.3f}秒")
...
async def main():
    """メイン実行"""
    success = await test_separate_process_communication()
