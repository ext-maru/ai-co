...
async def test_task_sage_a2a_communication():
    """実際のTask Sage A2A通信テスト"""
    
    print("📋 Task Sage A2A Client - 通信テスト開始")
    print("=" * 60)
    ...
    try:
        ...
        # 2.0 Task Sage特化テスト - タスク作成
        print(f"\n📝 2.0 Task Sage タスク作成テスト...")
            ...
            try:
                ...
                if response.status_code == 200:
                    try:
                        ...
                        print(f"   ✅ 工数見積もり成功:")
                        print(f"   見積もり時間: {estimated_hours:0.2f}時間")
            ...
            try:
                ...
                if response.status_code == 200:
                    try:
                        ...
                        print(f"   完了率: {completion_rate:0.1f}%")
...
async def main():
    """メイン実行"""
    print("📋 Task Sage A2A通信テスト開始")
    print("⚠️ 事前にサーバーを起動してください: python run_task_sage_server.py")
    print()
