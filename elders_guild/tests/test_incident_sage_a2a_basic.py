...
class TestIncidentSageA2ABasic:
    ...
    async def run_basic_tests(self) -> Dict[str, Any]:
        """基本テスト実行"""
        print("🚨 Incident Sage A2A Agent - 基本テストスイート開始")
        print("=" * 70)
        
        test_methods = [
            ("business_logic_test", self.test_business_logic_basic),
            ("a2a_agent_test", self.test_a2a_agent_basic),
            ...
            ("monitoring_test", self.test_monitoring_basic),
            ("pattern_learning_test", self.test_pattern_learning),
            ("statistics_test", self.test_statistics_basic),
            ("health_check_test", self.test_health_check),
            ("error_handling_test", self.test_error_handling_basic)
        ]
...
async def main():
    """メイン実行"""
    print("🚨 Incident Sage A2A Agent - 基本テスト開始")
    print("=" * 70)
    ...
    # テスト実行
    test_suite = TestIncidentSageA2ABasic()
    results = await test_suite.run_basic_tests()
