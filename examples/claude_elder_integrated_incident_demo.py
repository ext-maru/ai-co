...
def demo_usage_examples():
    ...
    print("```python")
    print("from libs.claude_elder_integrated_incident_manager import get_integrated_incident_manager")
    print()
    ...
    print("print(f'Claude integrated: {stats[\"claude_integration\"][\"total_integrated\"]}')")
    print("print(f'Elder council summoned: {stats[\"claude_integration\"][\"elder_council_summoned\"]}')")
    print("```")
