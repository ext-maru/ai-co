...
from libs.claude_elder_incident_integration import get_incident_integration, claude_error_handler
...
async def demo_automatic_incident_handling():
    ...
    try:
        ...
        result = await claude_error_handler(e, {
            "task": "testing_import",
    ...
    if council_files:
        ...
        for council_file in council_files[-3:]:  # 最新3件
            ...
            try:
                ...
                print(f"    Sages required: {len(council_data.get('sages_required', []))}")
