...
async def message_demo(slack):
    ...
    message = SlackMessage(channel="general", text="Hello from Elders Guild! 🤖")
    ...
    blocks = [
        {
            "type": "header",
            "text": {"type": "plain_text", "text": "Elders Guild System Status"},
        },
        {
            "type": "section",
            "text": {
...
async def sages_demo(slack):
    ...
    sages = [
        (
            "Knowledge Sage",
            "New knowledge base article added: 'Slack Integration Best Practices'",
        ),
        (
            "Task Oracle",
            "Task #12345 completed successfully - Slack API implementation",
        ),
        ("Crisis Sage", "System alert: All monitoring systems are green"),
        (
            "Search Mystic",
            "RAG search optimization completed - 15% improvement in response time",
        ),
    ]
