...
class EldersKnowledgeManager:
    ...
    def add_elder(self, name: str, expertise: List[str], description: str = "", 
                  reliability_score: float = 1.0) -> int:
        """新しいエルダーを追加"""
    ...
    def add_knowledge(self, title: str, content: str, category_id: int, 
                     elder_id: int, tags: List[str] = None, 
        ...
        with self._get_connection() as conn:
            with conn.cursor() as cur:
                cur.execute("""
                    ...
                    RETURNING id
                """, (
                    title, content, category_id, elder_id,
    ...
    def _search_knowledge_fallback(self, query: str, limit: int = 10,
                                 category_id: Optional[int] = None,
                                 elder_id: Optional[int] = None) -> List[Dict[str, Any]]:
    ...
    def add_knowledge_relation(self, source_id: int, target_id: int,
                             relation_type: str, strength: float = 0.5) -> int:
        """知識間の関連を追加"""
        with self._get_connection() as conn:
            with conn.cursor() as cur:
                cur.execute("""
    ...
    def get_related_knowledge(self, knowledge_id: int, 
