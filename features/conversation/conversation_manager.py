...
from features.conversation.conversation_db import ConversationDB
...
class ConversationManager:
    ...
    def start_conversation(self, task_id: str, initial_prompt: str, 
    ...
    def add_worker_message(self, conversation_id: str, worker_id: str, 
    ...
    def add_pm_message(self, conversation_id: str, content: str, 
                      message_type: str = 'instruction') -> int:
        """PMからのメッセージ"""
        return self.db.add_message(
            conversation_id,
            sender='pm',
    ...
    def request_user_input(self, conversation_id: str, question: str,
    ...
    def get_conversation_summary(self, conversation_id: str) -> Dict:
        ...
        return {
            ...
            'waiting_user': any(msg['message_type'] == 'user_question' 
                               and msg == messages[-1] for msg in messages)
        }
