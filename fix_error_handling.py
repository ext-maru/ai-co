...
class ErrorHandlingFixer:
    ...
    def __init__(self):
        ...
        self.missing_error_handling = {
            ...
            "github_integration.py": [
                "send_error_notification", "send_task_notification", 
                "send_elder_council_report", "_get_response_requirement",
                "_categorize_error", "_format_details_markdown", 
                "_format_updates_markdown"
            ],
            "github_aware_rag.py": ["__init__", "build_context_with_github", "_guess_relevant_files"],
        }
    ...
    def add_error_handling_to_function(self, source_code: str, function_name: str) -> str:
        ...
        try:
            ...
            class ErrorHandlingTransformer(ast.NodeTransformer):
                ...
                def visit_FunctionDef(self, node):
                    if node.name == self.target_func and not check_function_has_try_except(node):
                ...
                if match:
                    ...
                    if not re.search(r'\n\s*try:', func_body_start):
                        ...
                        if indent_match:
                            ...
                            self.fixed_count += 1
                            print(f"✅ Added error handling to {func_name} in {file_path.name}")
