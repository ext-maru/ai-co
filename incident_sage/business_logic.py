...
from incident_sage.abilities.incident_models import (
...
class IncidentProcessor:
    ...
    def __init__(self, data_dir: Optional[Path] = None, test_mode: bool = False):
    ...
    def _row_to_incident(self, row) -> Incident:
        ...
        return Incident(
            ...
            source=row['source'] or "incident_processor",
