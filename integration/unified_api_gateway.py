...
try:
    from integration.unified_entity_manager import (
        ...
        IncidentEntity, TaskEntity, EntityRelationship,
        create_knowledge_entity, create_incident_entity, create_task_entity
    )
    from integration.unified_rag_manager import UnifiedRAGManager, SearchQuery
except ImportError:
    # フォールバック
    ...
    from .unified_rag_manager import UnifiedRAGManager, SearchQuery
...
async def unified_search():
    ...
    try:
        ...
        return jsonify({
            ...
            'primary_results': [entity_to_dict(entity) for entity in result.primary_results],
            'related_entities': [entity_to_dict(entity) for entity in result.related_entities],
...
async def search_knowledge():
    ...
    try:
        ...
        return jsonify({
            'success': True,
            'results': [entity_to_dict(entity) for entity in result.primary_results],
