...
class SystemRecovery:
    ...
    def emergency_recovery(self, severity: str = "high") -> Dict:
        ...
        # 最終状態評価
        recovery_result["final_status"] = self._evaluate_recovery_success(
            recovery_result
        )
    ...
    def _check_services(self) -> Dict:
        ...
        for service_name, config in self.critical_components.items():
            try:
                ...
                services[service_name] = {"error": str(e), "is_running": False}
    ...
    def _check_network(self) -> Dict:
        ...
        for name, host in test_hosts:
            try:
                ...
                network[name] = {"reachable": result.returncode == 0, "host": host}
            except:
                network[name] = {"reachable": False, "host": host, "error": "timeout"}
    ...
    def _verify_connectivity(self) -> bool:
        ...
        try:
            ...
            return all(
                host_info.get("reachable", False) for host_info in network.values()
            )
        except:
            return False
