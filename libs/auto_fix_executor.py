...
class AutoFixExecutor(BaseManager):
    ...
    def execute_fix(self, analysis: Dict, error_info: Dict) -> Dict:
        ...
        try:
            self.logger.info(f"自動修正開始: {analysis['category']} - {analysis['matched_pattern']}")
    ...
    def get_statistics(self) -> Dict:
        ...
        if stats['total_executions'] > 0:
            stats['success_rate'] = (stats['successful_fixes'] / stats['total_executions']) * 100
        else:
