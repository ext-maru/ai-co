...
class ConversationDB:
    ...
    def init_db(self):
        ...
        # インデックス
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_conv_task ON conversations(task_id)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_conv_state ON conversations(state)')
