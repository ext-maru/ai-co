...
class KnowledgeSageProxy(BaseSageProxy):
    ...
    async def get_knowledge(self, query: str, context: Optional[Dict] = None) -> Dict[str, Any]:
        """知識を取得"""
    ...
    async def save_knowledge(self, category: str, content: str, metadata: Optional[Dict] = None) -> Dict[str, Any]:
        """知識を保存"""
        return await self.call_sage(
            "save_knowledge",
            category=category,
    ...
    async def search_knowledge(self, keywords: List[str], filters: Optional[Dict] = None) -> List[Dict[str, Any]]:
        """知識を検索"""
        return await self.call_sage(
            "search_knowledge",
            keywords=keywords,
    ...
    async def update_knowledge(self, knowledge_id: str, updates: Dict[str, Any]) -> Dict[str, Any]:
        """知識を更新"""
        return await self.call_sage(
            "update_knowledge",
    ...
    async def get_knowledge_stats(self, category: Optional[str] = None) -> Dict[str, Any]:
        """知識統計を取得"""
        return await self.call_sage(
            "get_knowledge_stats",
            category=category
