...
class DockerTemplateManager:
        ...
        self.template_library = {
            ...
            ProjectType.WEB_API: {
                SecurityLevel.DEVELOPMENT: DockerTemplate(
                    ...
                    packages=["fastapi", "uvicorn", "pydantic", "sqlalchemy", "alembic"],
                    python_packages=["fastapi[all]", "uvicorn[standard]", "python-multipart", 
                    ...
                    development_tools=["pytest", "black", "flake8", "mypy", "pre-commit"],
            ...
            ProjectType.ML_RESEARCH: {
                SecurityLevel.DEVELOPMENT: DockerTemplate(
                    ...
                    ports=["8888:8888", "6006:6006", "5000:5000"],  # Jupyter, TensorBoard, MLflow
                    volumes=["./:/workspace", "./data:/workspace/data", "./models:/workspace/models"],
                    environment_vars={
            ...
            ProjectType.FULL_STACK_WEB: {
                SecurityLevel.DEVELOPMENT: DockerTemplate(
                    ...
                    python_packages=[],
                    node_packages=[
                        "react", "next", "@types/react", "@types/node",
                        "express", "cors", "helmet", "morgan",
                        "prisma", "@prisma/client", "pg", "@types/pg",
                        "jest", "@testing-library/react", "eslint", "prettier"
                    ],
            ...
            ProjectType.MICROSERVICES: {
                SecurityLevel.RESTRICTED: DockerTemplate(
                    ...
                    python_packages=[
                        "fastapi", "uvicorn", "pydantic", "redis", "celery",
                        "aioredis", "httpx", "python-consul", "prometheus-client"
                    ],
                    node_packages=[],
    ...
    def generate_dockerfile(self, template: DockerTemplate, 
                           optimization_profile: str = "development") -> str:
        """Generate optimized Dockerfile from template"""
        
        optimization = self.optimization_profiles.get(optimization_profile, 
                                                      self.optimization_profiles["development"])
    ...
    def generate_docker_compose(self, template: DockerTemplate, 
    ...
    def create_template_environment(self, project_path: Path, 
    ...
    def _create_management_scripts(self, docker_dir: Path, 
                                  template: DockerTemplate, project_name: str):
...
""")
        ...
        logs_script.write_text(f"""#!/bin/bash
...
""")
        ...
        health_script.write_text(f"""#!/bin/bash
...
""")
    ...
    def get_template_for_project(self, project_type: str, 
                                security_level: SecurityLevel) -> Optional[DockerTemplate]:
        ...
        fallback_order = {
            SecurityLevel.SANDBOX: [SecurityLevel.RESTRICTED, SecurityLevel.DEVELOPMENT],
            SecurityLevel.RESTRICTED: [SecurityLevel.DEVELOPMENT, SecurityLevel.SANDBOX],
            SecurityLevel.DEVELOPMENT: [SecurityLevel.RESTRICTED, SecurityLevel.SANDBOX],
            SecurityLevel.TRUSTED: [SecurityLevel.DEVELOPMENT, SecurityLevel.RESTRICTED]
        }
...
if __name__ == "__main__":
    ...
    web_api_template = manager.get_template_for_project("web_api", SecurityLevel.DEVELOPMENT)
    if web_api_template:
