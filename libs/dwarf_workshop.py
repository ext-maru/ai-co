        ...
        for test_file in test_files:
            try:
                ...
                if 'from libs.ai_command_helper import' in content:
                    content = content.replace('from libs.ai_command_helper import', '# from libs.ai_command_helper import')
...
'''
    ...
    def generate_missing_tests(self):
        ...
        for py_file in python_files:
            ...
            test_file = self.project_root / f"tests/unit/{py_file.parent.name}/test_{py_file.stem}.py"
