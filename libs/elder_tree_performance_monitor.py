"""
elder_tree_performance_monitor - Auto-generated module by Incident Knights
...
class ElderTreePerformanceMonitor:
...
# Export
__all__ = ["ElderTreePerformanceMonitor", "setup", "main"]
