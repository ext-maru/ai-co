"""
elders_guild_connection_manager - Auto-generated module by Incident Knights
...
class EldersGuildConnectionManager:
...
# Export
__all__ = ['EldersGuildConnectionManager', 'setup', 'main']
