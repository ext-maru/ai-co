...
class ElderZanIntegratedAPI:
    ...
    async def create_session(self, user_id: str, project_path: str, context: Dict[str, Any]) -> str:
        """
        セッション作成API
        ...
        try:
            # パフォーマンス監視開始
            await self.performance_monitor.start_operation(operation_id, 'create_session')
    ...
    async def get_session(self, session_id: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """
        セッション取得API
    ...
    async def update_session(self, session_id: str, update_data: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """
        セッション更新API
        ...
        try:
            # パフォーマンス監視開始
            await self.performance_monitor.start_operation(operation_id, 'update_session')
            ...
            updated_session = await self.hybrid_storage.update_session(
                session_id, 
                optimized_data.get('update_data', update_data), 
                context
            )
    ...
    async def delete_session(self, session_id: str, context: Dict[str, Any]) -> bool:
        ...
        try:
            # パフォーマンス監視開始
            await self.performance_monitor.start_operation(operation_id, 'delete_session')
    ...
    async def list_sessions(self, user_id: str, context: Dict[str, Any], 
        ...
        try:
            # パフォーマンス監視開始
            await self.performance_monitor.start_operation(operation_id, 'list_sessions')
            ...
            # セッション一覧取得
            sessions = await self.hybrid_storage.list_sessions(user_id, context, filters)
    ...
    async def get_session_metrics(self, session_id: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """
        セッションメトリクス取得API
        ...
        try:
            # パフォーマンス監視開始
            await self.performance_monitor.start_operation(operation_id, 'get_session_metrics')
    ...
    async def _notify_sages(self, event_type: str, session_id: str, context: Dict[str, Any]):
        """
        4賢者システムへの通知
