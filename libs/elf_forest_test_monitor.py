        ...
        def flow_monitor():
            while self.monitoring_active:
                try:
                    ...
                    self._add_elf_report(
                        ElfType.FLOW, f"フロー最適化エラー: {e}", priority="error"
                    )
                    time.sleep(60)
        ...
        def time_monitor():
            while self.monitoring_active:
                try:
                    ...
                    self._add_elf_report(
                        ElfType.TIME, f"時間管理エラー: {e}", priority="error"
                    )
                    time.sleep(120)
        ...
        def balance_monitor():
            while self.monitoring_active:
                try:
                    ...
                    self._add_elf_report(
                        ElfType.BALANCE, f"リソース管理エラー: {e}", priority="error"
                    )
                    time.sleep(90)
        ...
        def healing_monitor():
            while self.monitoring_active:
                try:
                    ...
                    self._add_elf_report(
                        ElfType.HEALING, f"修復エラー: {e}", priority="error"
                    )
                    time.sleep(60)
        ...
        def wisdom_monitor():
            while self.monitoring_active:
                try:
                    ...
                    self._add_elf_report(
                        ElfType.WISDOM, f"学習エラー: {e}", priority="error"
                    )
                    time.sleep(180)
