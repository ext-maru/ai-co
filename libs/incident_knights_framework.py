...
class Issue:
    ...
    def __init__(self, category: IssueCategory, severity: IssueSeverity, description: str):
...
'''
    ...
    def deploy_import_fix_knight(self):
        ...
        for test_file in test_files:
            try:
                ...
                logger.debug(f"Import fix skipped for {test_file}: {e}")
    ...
    def fix_imports_in_file(self, file_path: Path):
        ...
        fixes = [
            ...
            ('from libs.ai_command_helper import', '# from libs.ai_command_helper import'),
            ...
            ('from tests.mock_utils import', '''import sys
from pathlib import Path
    ...
    def deploy_test_runner_knight(self):
        ...
        for batch in test_batches:
            try:
                ...
                logger.debug(f"Test batch failed: {batch}: {e}")
