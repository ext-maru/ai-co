...
class GitHubCreatePullRequestImplementation:
    ...
    def create_pull_request(
        ...
        try:
            ...
            return {
                "success": True,
                "pull_request": updated_pr["pull_request"] if updated_pr["success"] else pr,
    ...
    def _validate_pr_params(self, title: str, head: str, base: str) -> Dict[str, Any]:
        ...
        if not head or not head.strip():
            return {
                "valid": False,
                "error": "Head branch cannot be empty"
            }
    ...
    def _check_branches_exist(self, head: str, base: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to check branches: {e}"
            }
    ...
    def _enable_auto_merge(self, pr_number: int) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Auto-merge requested for PR #{pr_number} (requires GraphQL API)")
            return {
                "success": False,
