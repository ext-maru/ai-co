...
class GitHubRepositoryInfo:
    ...
    async def get_repository_info(self, owner: str, repo: str, use_cache: bool = True) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if use_cache and cache_key in self.cache:
                ...
                if (datetime.now() - cached_data["timestamp"]).seconds < 300:  # 5 minutes
            ...
            raise APIError(f"Unexpected error during repository info retrieval: {str(e)}")
