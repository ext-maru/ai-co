...
class GitHubIssuesList:
    ...
    async def list_issues(self, owner: str, repo: str, 
        ...
        try:
            ...
            # Process issues data
            processed_issues = [self._process_issue_data(issue) for issue in response["data"]]
            ...
            logger.info(f"Issues retrieved successfully for {owner}/{repo}: {len(processed_issues)} issues")
