...
class GitHubUpdateIssueImplementation:
    ...
    def _validate_update_params(
        ...
        if state_reason and state_reason not in ["completed", "not_planned", "reopened"]:
            return {
                "valid": False,
                "error": f"Invalid state_reason: {state_reason}"
            }
    ...
    def remove_label(self, issue_number: int, label_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if response["success"]:
                ...
                return {
                    "success": True,
                    "labels": labels_response.get("data", [])
                }
            else:
                return {
                    "success": False,
