    ...
    def _check_initial_limits(self) -> None:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.warning(f"Failed to load initial rate limits: {response.status_code}")
                
        except Exception as e:
            logger.warning(f"Could not check initial rate limits: {e}")
    
    def update_from_headers(self, headers: Dict[str, str], endpoint: str = "core") -> None:
        """
        ...
        with self._lock:
            ...
            if endpoint in self.rate_limits:
                ...
                if limit_info.is_exhausted:
                    ...
                    logger.warning(f"Rate limit exhausted for {endpoint}. Wait {wait_time:.0f}s")
                ...
                if limit_info.remaining < 100:
                    ...
                    interval = limit_info.time_until_reset / max(limit_info.remaining, 1)
