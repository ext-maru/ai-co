...
class SlackIntegrationMCPServer:
    ...
    def setup_tools(self):
        ...
        @self.server.tool()
        async def send_worker_status(worker_name: str, status: str, details: str = None):
            """ワーカーのステータスをSlackに通知"""
            # ステータスに応じた絵文字を選択
            emoji_map = {
                'started': '🟢',
        ...
        @self.server.tool()
        async def send_error_alert(error_type: str, error_message: str, source: str = None):
            """エラーアラートをSlackに送信"""
            # エラーメッセージの作成
        ...
        async def send_daily_summary():
            ...
            try:
                ...
                summary += "_Generated by AI Company MCP_"
