...
class PDCAAutomationEngine:
    ...
    async def execute_improvements(self, improvements: List[Improvement]) -> List[Improvement]:
        ...
        for improvement in improvements:
            try:
                ...
                # エラーはインシデント賢者に報告
                self.four_sages.incident_sage.report_error(e, {
    ...
    async def run_continuous_cycle(self):
        ...
        while True:
            try:
                ...
                self.four_sages.incident_sage.report_critical_error(e, {
    ...
    async def _capture_current_metrics_for_improvement(self, improvement: Improvement) -> Dict[str, float]:
        """改善後のメトリクス取得"""
        # 実装は省略
        return {}
