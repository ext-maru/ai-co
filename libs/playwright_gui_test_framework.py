...
class AICompanyDashboardTest:
    ...
    def test_dashboard_load(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # メインコンテンツ確認
            if not self.framework.expect_visible(".dashboard-main, #dashboard-main, main"):
    ...
    def test_interactive_elements(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                first_button = self.framework.page.query_selector("button:not([type='submit'])")
...
def run_playwright_gui_tests(base_url: str = "http://localhost:5555", headless: bool = True) -> Dict[str, Any]:
