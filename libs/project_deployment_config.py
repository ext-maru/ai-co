...
class ProjectDeploymentManager:
    ...
    def _ensure_config_directories(self):
        ...
        directories = [
            ...
            self.config_dir / "global" / "templates",
    ...
    def _load_override_config(self, project_name: str, environment: str) -> Dict[str, Any]:
        """オーバーライド設定読み込み"""
        override_files = [
    ...
    def validate_config(self, project_name: str, environment: str) -> tuple[bool, List[str]]:
        """設定検証"""
        errors = []
    ...
    def create_project_config(self, project_name: str, template: str = "web-app", 
        ...
        try:
            ...
            project_config = {
                ...
                'four_sages_custom': template_config.get('four_sages_custom', {}),
                'notifications': template_config.get('notifications', {}),
    ...
    def _load_template(self, template: str) -> Dict[str, Any]:
        """テンプレート読み込み"""
        ...
        if template_path.exists():
            ...
            # デフォルトテンプレート
            return self._create_default_template(template)
    
    def _create_default_template(self, template: str) -> Dict[str, Any]:
        """デフォルトテンプレート作成"""
        templates = {
            'web-app': {
        ...
        return templates.get(template, templates['web-app'])
    ...
    def set_deployment_method(self, project_name: str, environment: str, method: str) -> bool:
        ...
        try:
            ...
            logger.info(f"プロジェクト '{project_name}' の {environment} 環境のデプロイ方法を '{method}' に設定しました")
            return True
    ...
    def _assess_deployment_risk(self, config: DeploymentConfig) -> str:
        ...
        # 承認フローチェック
        if not config.environments.get('production', {}).get('approval_required', False):
            risk_factors += 3
    ...
    def generate_deployment_report(self, project_name: str, environment: str) -> Dict[str, Any]:
        """デプロイレポート生成"""
        try:
            config = self.get_project_config(project_name, environment)
            ...
            report = {
                ...
                'four_sages_analysis': self.sages.generate_deployment_analysis(config.to_dict()),
