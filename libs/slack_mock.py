...
class MockWebClient:
    ...
    def chat_postMessage(self, channel, text=None, blocks=None, attachments=None,
                        thread_ts=None, **kwargs):
    ...
    def files_upload(self, channels=None, content=None, file=None, filename=None,
        ...
        file_obj = {
            ...
            "channels": channels.split(",") if isinstance(channels, str) else (channels or [])
        }
