...
class TaskHistoryDB(BaseManager):
    ...
    def search_similar_tasks(self, prompt: str, limit: int = 5) -> List[Dict[str, Any]]:
    ...
    def get_recent_tasks(self, limit: int = 10) -> List[Dict[str, Any]]:
        """Get recent tasks"""
        results = self.execute_query(
            "SELECT * FROM task_history ORDER BY timestamp DESC LIMIT ?", (limit,)
        )
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        stats = {"total_tasks": 0, "workers": {}, "models": {}, "recent_activity": []}
    ...
    def save_task(
        ...
        **kwargs,
        ...
        return self.add_task(
            task_id, worker, prompt, model=model, task_type=task_type, **kwargs
        )
    ...
    def search_tasks(self, query: str, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            results = self.execute_query(
                search_query, (like_pattern, like_pattern, like_pattern, limit)
            )
            return results
        except Exception as e:
