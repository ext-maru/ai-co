...
class NotificationHandler:
    ...
    def send_notification(self, title: str, message: str, 
        ...
        if severity in ['error', 'critical'] and self.config.get('elder_notification', True):
...
"""
    ...
    def send_recovery_report(self, worker_name: str, 
    ...
    def send_health_summary(self, health_data: Dict[str, Dict[str, Any]]):
        ...
        """
        unhealthy_workers = [
            name for name, data in health_data.items()
    ...
    def get_notification_history(self, limit: int = 50, 
                               ...
                               worker_name: Optional[str] = None) -> List[Dict[str, Any]]:
        """
        通知履歴を取得
    ...
    def clear_notification_history(self, before_date: Optional[datetime] = None):
        ...
        logger.info(f"Notification history cleared. Remaining: {len(self.notification_history)}")
