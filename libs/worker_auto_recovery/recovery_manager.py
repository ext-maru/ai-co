...
class WorkerRecoveryManager:
    ...
    def _load_config(self, config_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        default_config = {
            ...
            "notification": {"slack_enabled": True, "log_enabled": True},
        }
    ...
    def _handle_recovery(self, worker_name: str, health_data: Dict[str, Any]):
        ...
        try:
            ...
            if recovery_result.get("success"):
                ...
                self.recovery_cooldown[worker_name] = datetime.now() + timedelta(
    ...
    def _escalate_recovery_failure(
        self, worker_name: str, recovery_result: Dict[str, Any]
    ):
        """復旧失敗時のエスカレーション"""
        # Elder Councilへの報告
        try:
...
def main():
    ...
    parser.add_argument(
        "command",
        choices=["start", "stop", "status", "recover"],
