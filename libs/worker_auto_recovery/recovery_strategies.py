...
class RecoveryStrategies:
    ...
    def execute_recovery(self, worker_name: str, strategy: str, 
    ...
    def soft_restart(self, worker_name: str, health_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                'success': False,
                'error': f'Soft restart failed: {e}'
            }
    
    def hard_restart(self, worker_name: str, health_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ハードリスタート（強制終了して再起動）
    ...
    def resource_recovery(self, worker_name: str, health_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                'success': False,
                'error': f'Resource recovery failed: {e}'
            }
    
    def queue_recovery(self, worker_name: str, health_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                'success': False,
                'error': f'Queue recovery failed: {e}'
            }
    
    def get_recovery_history(self, worker_name: Optional[str] = None, 
