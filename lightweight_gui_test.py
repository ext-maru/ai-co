...
class LightweightGUITester:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    result["message"] += f" - Content length: {len(response.text)} chars"
    ...
    def test_html_structure(self):
        ...
        try:
            ...
            checks = [
                ("<!doctype html" in html or "<html" in html, "HTML document structure"),
...
def main():
    ...
    try:
        ...
        print("   1. Install system dependencies: sudo apt install chromium-browser libnss3")
