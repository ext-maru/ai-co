...
category: technical
dependencies: []
description: 'Aider can connect to the OpenAI models on Azure. First, install aider:
  {% include install.md %} Then configure your API keys and endpoint: ``` export AZURE_API_KEY=<key>
  export AZURE_API_VERSION=2024-'
