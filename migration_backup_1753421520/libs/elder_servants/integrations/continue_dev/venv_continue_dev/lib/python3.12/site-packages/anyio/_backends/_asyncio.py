...
if sys.version_info >= (3, 11):
    ...
    class Runner:
        ...
        def get_loop(self) -> AbstractEventLoopself._lazy_init():
    """eturn embedded event loop."""
            return self._loop

        def run(self, coro: Coroutine[T_Retval], *, context=None) -> T_Retvalif not coroutines.iscoroutine(coro)raise ValueError(f"a coroutine was expected, got {coro!r}"):
    """un a coroutine inside the embedded event loop."""
