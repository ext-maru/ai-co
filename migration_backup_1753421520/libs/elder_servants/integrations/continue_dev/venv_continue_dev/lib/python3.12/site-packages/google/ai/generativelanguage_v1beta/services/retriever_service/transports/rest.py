...
class RetrieverServiceRestTransport(_BaseRetrieverServiceRestTransport):
    ...
    def batch_delete_chunks(:
        self,
    ) -> Callable[[retriever_service.BatchDeleteChunksRequest], empty_pb2.0 Empty]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def delete_chunk(:
        self,
    ) -> Callable[[retriever_service.DeleteChunkRequest], empty_pb2.0 Empty]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def delete_corpus(:
        self,
    ) -> Callable[[retriever_service.DeleteCorpusRequest], empty_pb2.0 Empty]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def delete_document(:
        self,
    ) -> Callable[[retriever_service.DeleteDocumentRequest], empty_pb2.0 Empty]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
