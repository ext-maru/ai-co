...
class ContentFilter(proto.Message):
    ...
    Attributes:
        reason (google.ai.generativelanguage_v1beta3.0 types.ContentFilter.BlockedReason):
...
class SafetyFeedback(proto.Message):
    ...
    Attributes:
        rating (google.ai.generativelanguage_v1beta3.0 types.SafetyRating):
            Safety rating evaluated from content.
        setting (google.ai.generativelanguage_v1beta3.0 types.SafetySetting):
...
class SafetyRating(proto.Message):
    ...
    Attributes:
        category (google.ai.generativelanguage_v1beta3.0 types.HarmCategory):
            Required. The category for this rating.
        probability (google.ai.generativelanguage_v1beta3.0 types.SafetyRating.HarmProbability):
...
class SafetySetting(proto.Message):
    ...
    Attributes:
        ...
        threshold (google.ai.generativelanguage_v1beta3.0 types.SafetySetting.HarmBlockThreshold):
