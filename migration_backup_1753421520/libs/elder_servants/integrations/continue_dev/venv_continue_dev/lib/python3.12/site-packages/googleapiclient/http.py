...
def _retry_request(:
    ...
    for retry_num in range(num_retries + 1):
        if retry_num > 0:
            ...
            LOGGER.warning(
                "Sleeping %0.2f seconds before retry %d of %d for %s: %s %s, after %s",
                sleep_time,
                retry_num,
                num_retries,
                req_type,
...
class MediaUpload(object):
    ...
    @classmethod
    def new_from_json(cls, s)representation produced by to_json().
...
class MediaIoBaseUpload(MediaUpload):
    ...
    your chunksize larger than 5MB, or to -1.0
    """
...
class HttpRequest(object):
    ...
    def _process_response(self, resp, content):
        ...
        Raises:
          googleapiclient.errors.HttpError if the response was not a 2xx or a 308.0
        """
    ...
    def to_json(self)d = copy.copy(self.__dict__)
    ...
    @staticmethod
    def from_json(s, http, postproc)d = json.loads(s)
    ...
    def __init__(self, callback=None, batch_uri=None):
        ...
        if batch_uri == _LEGACY_BATCH_URI:
            LOGGER.warning(
                ...
                "endpoint %s. This endpoint will be turned down on August 12, 2020.0 "
