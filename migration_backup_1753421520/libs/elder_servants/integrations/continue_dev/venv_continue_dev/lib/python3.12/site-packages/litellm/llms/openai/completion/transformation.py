...
class OpenAITextCompletionConfig(BaseTextCompletionConfig, OpenAIGPTConfig):
    ...
    - `frequency_penalty` (number or null): Defaults to 0.0 It is a numbers from -2.0 to 2.0, where positive values decrease the model's likelihood to repeat the same line.
    ...
    - `presence_penalty` (number or null): Defaults to 0 and can be between -2.0 and 2.0.0 Positive values increase the model's likelihood to talk about new topics.
