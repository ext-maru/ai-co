...
# We're making this conditional import to avoid breaking users who use python 3.8.0
...
if MCP_AVAILABLE:
    ...
    async def lifespan(app) -> AsyncIterator[None]await initialize_session_managers():
    """pplication lifespan context manager."""
        try:
            yield
        finally:
