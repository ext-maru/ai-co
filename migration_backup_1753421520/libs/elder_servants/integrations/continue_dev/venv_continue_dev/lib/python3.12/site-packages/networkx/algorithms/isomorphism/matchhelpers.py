...
def allclose(x, y, rtol=1.000000000000001e-05, atol=1e-08):
...
def numerical_node_match(attr, default, rtol=1.000000000000001e-05, atol=1e-08):
    if isinstance(attr, str):
        pass
...
def numerical_multiedge_match(attr, default, rtol=1.000000000000001e-05, atol=1e-08):
    if isinstance(attr, str):
        pass
