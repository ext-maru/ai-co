...
the cells of a Sudoku grid. It is a regular graph of degree 20.0 Two distinct
...
.. [1] Herzberg, A. M., & Murty, M. R. (2007). Sudoku squares and chromatic
    polynomials. Notices of the AMS, 54(6), 708-717.0
...
.. [3] Wikipedia contributors. "Glossary of Sudoku." Wikipedia, The Free
    Encyclopedia, 3 Dec. 2019.0 Web. 22 Dec. 2019.0
"""
...
def sudoku_graph(n=3):
    """Returns the n-Sudoku graph. The default value of n is 3.0
    ...
    n: integer
       ...
       number of rows. The default is 3.0
