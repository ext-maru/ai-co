...
class TestGeomspace:
    ...
    def test_complex(self):
        ...
        assert_allclose(y, [-2-3j, -0.29058977-4.15771027j,
                            2.8885354-4.34146838j, 4.58345529-3.16355218j,
    ...
    def test_start_stop_array(self):
        ...
        start = array([1.e0, 32.0, 1j, -4j, 1+1j, -1])
        stop = array([1.e4, 2.0, 16j, -324j, 10000+10000j, 1])
...
class TestLinspace:
    ...
    def test_denormal_numbers(self):
        # Regression test for gh-5437.0 Will probably fail when compiled
