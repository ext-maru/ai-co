...
class OGridClass(nd_grid):
    ...
    greater than 1.0  The dimension and number of the output arrays are
...
class RClass(AxisConcatenator):
    ...
    1.0 If the index expression contains comma separated arrays, then stack
       them along their first axis.
    2.0 If the index expression contains slice notation or scalars then create
    ...
    array([-1.0 , -0.6, -0.2,  0.2,  0.6,  1.0 ,  0.0 ,  0.0 ,  0.0 ,  5.0 ,  6.0 ])
