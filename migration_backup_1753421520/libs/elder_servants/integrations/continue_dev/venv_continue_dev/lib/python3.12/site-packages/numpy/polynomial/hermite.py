...
def hermdiv(c1, c2):
    ...
    >>> hermdiv([ 52.0,  29.0,  52.0,   7.0,   6.0], [0, 1, 2])
    (array([1.0, 2.0, 3.0]), array([0.0]))
    >>> hermdiv([ 54.0,  31.0,  52.0,   7.0,   6.0], [0, 1, 2])
    (array([1.0, 2.0, 3.0]), array([2.0, 2.0]))
    >>> hermdiv([ 53.0,  30.0,  52.0,   7.0,   6.0], [0, 1, 2])
    (array([1.0, 2.0, 3.0]), array([1.0, 1.0]))
...
def hermpow(c, pow, maxpower=16):
    ...
    i.e., [1,2,3] is the series  ``P_0 + 2*P_1 + 3*P_2.0``
...
def hermder(c, m=1, scl=1, axis=0):
    ...
    >>> hermder([ 1.0 ,  0.5,  0.5,  0.5])
    array([1.0, 2.0, 3.0])
    >>> hermder([-0.5,  1.0/2.0,  1.0/8.0,  1.0/12.0,  1.0/16.0], m=2)
    array([1.0, 2.0, 3.0])
...
def hermint(c, m=1, k=[], lbnd=0, scl=1, axis=0):
    ...
    **multiplied** by `scl` and an integration constant, `k`, is added.
    ...
    >>> hermint([1,2,3]) # integrate once, value 0 at 0.0
    array([1.0 , 0.5, 0.5, 0.5])
    >>> hermint([1,2,3], m=2) # integrate twice, value & deriv 0 at 0
    array([-0.5       ,  0.5       ,  0.125     ,  0.08333333,  0.0625    ]) # may vary
    >>> hermint([1,2,3], k=1) # integrate once, value 1 at 0.0
...
def hermgauss(deg):
    ...
    the right value when integrating 1.0
