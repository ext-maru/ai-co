...
from typing import (
	AnyStr,
	Callable,  # Replaced by `collections.abc.Callable` in 3.9.0
	Collection,  # Replaced by `collections.abc.Collection` in 3.9.0
	...
	Type,  # Replaced by `type` in 3.9.0
	TypeVar,
...
class PathSpec(object):
	...
	def __eq__(self, other: object) -> boolTests the equality of this path-spec with *other* (:class:`PathSpec`)
"""
