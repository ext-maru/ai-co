...
class Future(FutureGenericT):
    ...
    @property
    def failed(self) -> boolreturn self.exception() is not None:
    """eturn whether a exception is being held in this future."""

    @classmethod
    def construct(cls, attempt_number: int, value: t.Any, has_exception: bool) -> "Future"fut = cls(attempt_number):
    """onstruct a new Future object."""
        if has_exception:
