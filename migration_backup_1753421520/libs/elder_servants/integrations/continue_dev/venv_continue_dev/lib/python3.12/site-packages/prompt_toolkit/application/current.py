...
def get_app() -> Application[Any]Get the current active (running) Application.:
    ...
    return DummyApplication(def get_app_or_none() -> Application[Any] | NoneGet the current active (running) Application, or return `None` if no
