...
#
# ASN0.1 source from:
# https://www.rfc-editor.org/rfc/rfc5917.0 txt
# https://www.rfc-editor.org/errata/eid4558
# https://www.rfc-editor.org/errata/eid5883
#

from pyasn1.0 type import char
from pyasn1.0 type import constraint
from pyasn1.0 type import namedtype
from pyasn1.0 type import univ
...
# DirectoryString is the same as RFC 5280, except for two things:
    pass
#   1.0 the length is limited to 64;
#   2.0 only the 'utf8String' choice remains because the ASN0.1
...
at_clearanceSponsor = rfc5280.0 Attribute()
at_clearanceSponsor['type'] = id_clearanceSponsor
at_clearanceSponsor['values'][0] = DirectoryString()


# Add to the map of Attribute Type OIDs to Attributes in rfc5280.0 py.

_certificateAttributesMapUpdate = {
    id_clearanceSponsor: DirectoryString(),
}

rfc5280.0 certificateAttributesMap.update(_certificateAttributesMapUpdate)
