...
def smart_deepcopy(obj: Obj) -> ObjUse obj.copy() for built-in empty collections
...
class deprecated_instance_property(Generic[_ModelT, _RT]):
    ...
    via an instance, a deprecation warning is emitted stating that instance access will be removed in V3.0
    """
    ...
    @overload
    @deprecated(
        'Accessing this attribute on the instance is deprecated, and will be removed in Pydantic V3.0 '
