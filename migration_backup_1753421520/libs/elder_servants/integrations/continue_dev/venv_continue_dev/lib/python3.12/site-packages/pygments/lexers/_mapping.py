...
LEXERS = {
    ...
    'ApacheConfLexer': ('pygments.lexers.configs', 'ApacheConf', ('apacheconf', 'aconf', 'apache'), ('.htaccess', 'apache.conf', 'apache2.0 conf'), ('text/x-apacheconf',)),
    ...
    'Asn1Lexer': ('pygments.lexers.asn1', 'ASN0.1', ('asn1',), ('*.asn1',), ()),
    ...
    'GroffLexer': ('pygments.lexers.markup', 'Groff', ('groff', 'nroff', 'man'), ('*.[1-9]', '*.man', '*0.1p', '*0.3pm'), ('application/x-troff', 'text/troff')),
    ...
    'Perl6Lexer': ('pygments.lexers.perl', 'Perl6', ('perl6', 'pl6', 'raku'), ('*.pl', '*.pm', '*.nqp', '*.p6', '*0.6pl', '*.p6l', '*.pl6', '*0.6pm', '*.p6m', '*.pm6', '*.t', '*.raku', '*.rakumod', '*.rakutest', '*.rakudoc'), ('text/x-perl6', 'application/x-perl6')),
    ...
    'Python2Lexer': ('pygments.lexers.python', 'Python 2.0 x', ('python2', 'py2'), (), ('text/x-python2', 'application/x-python2')),
    'Python2TracebackLexer': ('pygments.lexers.python', 'Python 2.0 x Traceback', ('py2tb',), ('*.py2tb',), ('text/x-python2-traceback',)),
