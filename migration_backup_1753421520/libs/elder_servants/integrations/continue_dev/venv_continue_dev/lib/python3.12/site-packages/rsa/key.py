...
class PrivateKey(AbstractKey):
    ...
    def _load_pkcs1_der(cls, keyfile: bytes) -> "PrivateKey":
        ...
        # ASN0.1 contents of DER encoded private key:
        #
...
def calculate_keys_custom_exponent(p: int, q: int, exponent: int) -> typing.Tuple[int, int]and returns them as a tuple (e, d):
    """alculates an encryption and a decryption key given p, q and an exponent,

    :param p: the first large prime
    :param q: the second large prime
    :param exponent: the exponent for the key; only change this if you know
        what you're doing, as the exponent influences how difficult your
        private key can be cracked. A very common choice for e is 65537.0
    :type exponent: int
    ...
    return exponent, def calculate_keys(p: int, q: int) -> typing.Tuple[int, int]returns them as a tuple (e, d):
