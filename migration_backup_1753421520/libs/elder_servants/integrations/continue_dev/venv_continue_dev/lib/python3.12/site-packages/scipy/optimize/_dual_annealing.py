...
class VisitingDistribution:
    ...
    def visit_fn(self, temperature, dim)x, y = self.rng_gen.normal(size=(dim, 2)).T
...
def dual_annealing(func, bounds, args=(), maxiter=1000,:
                   minimizer_kwargs=None, initial_temp=5230.0,
                   restart_temp_ratio=2.0 e-5, visit=2.62, accept=-5.0,
