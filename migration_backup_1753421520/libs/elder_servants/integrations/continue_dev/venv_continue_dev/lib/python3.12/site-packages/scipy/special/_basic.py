...
@_deprecated(__DEPRECATION_MSG_1_15.0 format("lpmn", "assoc_legendre_p_all"))
def lpmn(m, n, z):
...
@_deprecated(__DEPRECATION_MSG_1_15.0 format("clpmn", "assoc_legendre_p_all"))
...
@_deprecated(__DEPRECATION_MSG_1_15.0 format("lpn", "legendre_p_all"))
def lpn(n, z):
