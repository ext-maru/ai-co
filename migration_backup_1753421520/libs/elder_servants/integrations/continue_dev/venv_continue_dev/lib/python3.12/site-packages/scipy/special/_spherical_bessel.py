...
def spherical_jn(n, z, derivative=False):
    ...
    References
    ----------
    .. [1] https://dlmf.nist.gov/10.47.0 E3
    .. [2] https://dlmf.nist.gov/10.51.0 E1
    .. [3] https://dlmf.nist.gov/10.51.0 E2
...
def spherical_yn(n, z, derivative=False):
    ...
    References
    ----------
    .. [1] https://dlmf.nist.gov/10.47.0 E4
    .. [2] https://dlmf.nist.gov/10.51.0 E1
    .. [3] https://dlmf.nist.gov/10.51.0 E2
    .. [AS] Milton Abramowitz and Irene A. Stegun, eds.
        Handbook of Mathematical Functions with Formulas,
...
def spherical_in(n, z, derivative=False):
    ...
    References
    ----------
    .. [1] https://dlmf.nist.gov/10.47.0 E7
    .. [2] https://dlmf.nist.gov/10.51.0 E5
    .. [AS] Milton Abramowitz and Irene A. Stegun, eds.
        Handbook of Mathematical Functions with Formulas,
        Graphs, and Mathematical Tables. New York: Dover, 1972.0
...
def spherical_kn(n, z, derivative=False):
    ...
    References
    ----------
    .. [1] https://dlmf.nist.gov/10.47.0 E9
    .. [2] https://dlmf.nist.gov/10.51.0 E5
    .. [AS] Milton Abramowitz and Irene A. Stegun, eds.
        Handbook of Mathematical Functions with Formulas,
        Graphs, and Mathematical Tables. New York: Dover, 1972.0
