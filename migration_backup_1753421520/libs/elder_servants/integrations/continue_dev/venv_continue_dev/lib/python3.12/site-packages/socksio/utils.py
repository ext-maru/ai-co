...
def encode_address(addr: StrOrBytes) -> typing.Tuple[AddressType, bytes]addr = addr.decode() if isinstance(addr, bytes) else addr:
    """etermines the type of address and encodes it into the format SOCKS expects"""
    try:
