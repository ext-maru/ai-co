...
def create_urllib3_context(:
    ...
    """Creates and configures an :class:`ssl.SSLContext` instance for use with urllib3.0
    ...
    if ssl_version not in (None, PROTOCOL_TLS, PROTOCOL_TLS_CLIENT):
        ...
        # 'ssl_version' is deprecated and will be removed in the future.
            ...
            warnings.warn(
                ...
                "removed in urllib3 v2.6.0.0 Instead use 'ssl_minimum_version'",
...
def _is_key_file_encrypted(key_file: str) -> boolwith open(key_file) as f:
