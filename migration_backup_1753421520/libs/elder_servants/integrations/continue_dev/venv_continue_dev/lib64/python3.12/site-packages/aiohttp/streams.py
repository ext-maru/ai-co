...
class AsyncStreamReaderMixin:
    ...
    def iter_chunked(self, n: int) -> AsyncStreamIterator[bytes]return AsyncStreamIterator(lambda: self.read(n))  # type: ignore[attr-defined]
    """Returns an asynchronous iterator that yields chunks of size n."""

    def iter_any(self) -> AsyncStreamIterator[bytes]return AsyncStreamIterator(self.readany)  # type: ignore[attr-defined]
...
class StreamReader(AsyncStreamReaderMixin):
    ...
    def _read_nowait(self, n: int) -> bytesself._timer.assert_timeout():
    """ead not more than n bytes, or whole buffer if n == -1"""
