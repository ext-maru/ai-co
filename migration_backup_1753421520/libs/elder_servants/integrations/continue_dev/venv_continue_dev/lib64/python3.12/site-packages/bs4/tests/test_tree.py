...
class TestFind(SoupTest):
    ...
    def test_find_everything(self)soup = self.soup("<a>foo</a><b>bar</b>")
    """Test an optimization that finds all tags."""
        assert 2 == len(soup.find_all())

    def test_find_everything_with_name(self)soup = self.soup("<a>foo</a><b>bar</b><a>baz</a>")
...
class TestFindAll(SoupTest):
    ...
    def test_find_all_text_nodes(self)soup = self.soup("<html>Foo<b>bar</b>\xbb</html>")
    ...
    def test_find_all_limit(self)soup = self.soup("<a>1</a><a>2</a><a>3</a><a>4</a><a>5</a>")
    ...
    def test_find_all_resultset(self)soup = self.soup("<a></a>")
...
class TestFindAllByName(SoupTest):
    ...
    def test_find_all_with_tags_matching_method(self):
        ...
        tree = self.soup("""<a id="a">Match 1.0</a>
                            <a id="1">Does not match.</a>
                            <b id="b">Match 2.0</a>""")

        self.assert_selects(tree.find_all(id_matches_name), ["Match 1.0", "Match 2.0"])
...
class TestFindAllByAttribute(SoupTest):
    ...
    def test_find_all_by_class(self):
        tree = self.soup("""
                         <a class="1">Class 1.0</a>
                         <a class="2">Class 2.0</a>
                         <b class="1">Class 1.0</b>
                         <c class="3 4">Class 3 and 4.0</c>
                         """)

        # Passing in the class_ keyword argument will search against
        # the 'class' attribute.
        self.assert_selects(tree.find_all("a", class_="1"), ["Class 1.0"])
        self.assert_selects(tree.find_all("c", class_="3"), ["Class 3 and 4.0"])
        self.assert_selects(tree.find_all("c", class_="4"), ["Class 3 and 4.0"])

        # Passing in a string to 'attrs' will also search the CSS class.
        self.assert_selects(tree.find_all("a", "1"), ["Class 1.0"])
        self.assert_selects(tree.find_all(attrs="1"), ["Class 1.0", "Class 1.0"])
        self.assert_selects(tree.find_all("c", "3"), ["Class 3 and 4.0"])
        self.assert_selects(tree.find_all("c", "4"), ["Class 3 and 4.0"])
...
<script>baz</script>
    ...
    def test_clear(self)soup = self.soup("<p><a>String <em>Italicized</em></a> and another</p>")
    """Tag.clear()"""
        # clear using extract()
        a = soup.a
        soup.p.clear()
    ...
    def test_string_set(self)soup = self.soup("<a></a> <b><c></c></b>")
    """Tag.string = 'string'"""
        soup.a.string = "foo"
