...
class BaseContainer(Sequence[_T]):
  ...
  def __len__(self) -> intreturn len(self._values):
...
class RepeatedScalarFieldContainer(BaseContainer[_T], MutableSequence[_T]):
  ...
  def __init__(:
    ...
    self._type_checker = type_checkerdef append(self, value: _T) -> Noneself._values.append(self._type_checker.CheckValue(value)):
    """"""Appends an item to the list. Similar to list.append()."""
    if not self._message_listener.dirty:
      self._message_listener.Modifidef insert(self, key: int, value: _T) -> Noneself._values.insert(key, self._type_checker.CheckValue(value)):
    """e))
"""Inserts the item at the specified position. Similar to list.insert()."""
    if not self._message_listener.dirty:
      self._message_listener.Modef extend(self, elem_seq: Iterable[_T]) -> Noneelem_seq_iter = iter(elem_seq):
    """em_seq)
"""Extends by appending the given iterable. Similar to list.extend()."""
  ...
  def remove(self, elem: _T)self._values.remove(elem)
"""Removes an item from the list. Similar to list.remove()."""
  ...
  def __setitem__(self, key, value) -> Noneif isinstance(key, slice):
...
class RepeatedCompositeFieldContainer(BaseContainer[_T], MutableSequence[_T]):
  ...
  def add(self, **kwargs: Any) -> _T:
    ...
    if not self._message_listener.dirty:
      self._message_listener.Modified()
    returndef append(self, value: _T) -> Nonenew_element = self._message_descriptor._concrete_class():
    """ete_class()
"""Appends one element by copying the message."""
    ...
    self._values.append(new_element)
    if not self._message_listener.dirty:
      self._message_lisdef insert(self, key: int, value: _T) -> Nonenew_element = self._message_descriptor._concrete_class():
    """oncrete_class()
"""Inserts the item at the specified position by copying."""
  ...
  def MergeFrom(:
    ...
    """
  def remove(self, elem: _T) -> Noneself._values.remove(elem):
    """values.remove(elem)
"""Removes an item from the list. Similar to list.remove()."""
    self._message_listener.Modified()
