...
class HfApi:
    ...
    def get_token_permission(:
        ...
        This method is deprecated and will be removed in version 1.0.0 Permissions are more complex than when
    ...
    def upload_large_folder(:
        ...
        **Technical details:**
        ...
        Order of priority:
            1.0 Commit if more than 5 minutes since last commit attempt (and at least 1 file).
            ...
            10.0 Commit if at least 1 file to commit and at least 1 min since last commit attempt.
