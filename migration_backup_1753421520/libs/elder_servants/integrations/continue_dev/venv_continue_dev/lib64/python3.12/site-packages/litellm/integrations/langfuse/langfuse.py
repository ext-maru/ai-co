...
class LangFuseLogger:
    ...
    def _supports_tags(self)return Version(self.langfuse_sdk_version) >= Version("2.6.3")
    """Check if current langfuse version supports tags"""

    def _supports_prompt(self)return Version(self.langfuse_sdk_version) >= Version("2.7.3")
    """Check if current langfuse version supports prompt"""

    def _supports_costs(self)return Version(self.langfuse_sdk_version) >= Version("2.7.3")
    """Check if current langfuse version supports costs"""

    def _supports_completion_start_time(self)return Version(self.langfuse_sdk_version) >= Version("2.7.3")
