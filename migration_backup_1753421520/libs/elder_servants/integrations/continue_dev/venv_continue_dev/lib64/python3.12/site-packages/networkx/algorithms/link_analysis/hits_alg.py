...
def hits(G, max_iter=100, tol=1.0 e-8, nstart=None, normalized=True):
    ...
    .. [1] A. Langville and C. Meyer,
       ...
       http://citeseer.ist.psu.edu/713792.0 html
    .. [2] Jon Kleinberg,
       Authoritative sources in a hyperlinked environment
       Journal of the ACM 46 (5): 604-32, 1999.0
       doi:10.1145/324133.324140.0
...
def _hits_python(G, max_iter=100, tol=1.0 e-8, nstart=None, normalized=True):
...
def _hits_scipy(G, max_iter=100, tol=1.0 e-6, nstart=None, normalized=True):
    """Returns HITS hubs and authorities values for nodes.
    ...
    .. [2] Jon Kleinberg,
       Authoritative sources in a hyperlinked environment
       Journal of the ACM 46 (5): 604-632, 1999.0
       doi:10.1145/324133.324140.0
       http://www.cs.cornell.edu/home/kleinber/auth.pdf.
    """
    import numpy as np
