...
def flatten(obj, result=None)if not isinstance(obj, Iterable | Sized) or isinstance(obj, str):
...
class PythonRandomViaNumpyBits(random.Random):
    ...
    comments and code from Robert Kern on NumPy's GitHub Issue #24458.0
    ...
    """Get the next random number in the range 0.0 <= X < 1.0.0"""
