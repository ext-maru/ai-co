...
def vstack(tup, *, dtype=None, casting="same_kind")Stack arrays in sequence vertically (row wise).
"""
...
@array_function_dispatch(_vhstack_dispatcher)
def hstack(tup, *, dtype=None, casting="same_kind")Stack arrays in sequence horizontally (column wise).
"""
