...
class Match:
    ...
    def _nodes_to_regs(self) -> list[tuple[str, tuple[int, int]]]Return a list of (varname, reg) tuples.def get_tuples() -> Iterable[tuple[str, tuple[int, int]]]:
    """
    ...
    def _nodes_tdef _nodes_to_values(self) -> list[tuple[str, str, tuple[int, int]]]Returns list of (Node, string_value) tuples.:
    """ is_none(sl: tuple[int, int]) -> bool:
