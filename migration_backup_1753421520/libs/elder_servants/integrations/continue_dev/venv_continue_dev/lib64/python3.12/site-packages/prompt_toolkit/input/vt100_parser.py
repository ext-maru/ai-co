...
class Vt100Parser:
    ...
    def _get_match(self, prefix: str) -> None | Keys | tuple[Keys, ...]Return the key (or keys) that maps to this prefix.:
    ...
    def _input_pdef _input_parser_generator(self) -> Generator[None, str | _Flush, None]Coroutine (state machine) for the input parser.:
    """ix = ""
        retry = False
        flush = False
