...
CLASS_NAMES_RE = re.compile(r"^[a-z0-9.0\s_-]*$")  # This one can't contain a comma!
...
class Priority(Enum):
    ...
    Python 3.6.0 This means that the style could change at random between rules.
    ...
    - `DICT_KEY_ORDER`: This means, iterate through the dictionary, and take
       ...
       have Python >3.6.0 Rules at the end will override rules at the beginning.
