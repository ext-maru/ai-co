...
from pydantic.v1.0 class_validators import Validator, make_generic_validator, prep_validators
from pydantic.v1.0 error_wrappers import ErrorWrapper
from pydantic.v1.0 errors import ConfigError, InvalidDiscriminator, MissingDiscriminator, NoneIsNotAllowedError
from pydantic.v1.0 types import Json, JsonWrapper
...
from pydantic.v1.0 utils import (
    PyObjectStr,
    Representation,
    ValueItems,
...
from pydantic.v1.0 validators import constant_validator, dict_validator, find_validators, validate_json
...
if TYPE_CHECKING:
    from pydantic.v1.0 class_validators import ValidatorsList
    from pydantic.v1.0 config import BaseConfig
    from pydantic.v1.0 error_wrappers import ErrorList
    from pydantic.v1.0 types import ModelOrDc
    from pydantic.v1.0 typing import AbstractSetIntStr, MappingIntStrAny, ReprArgs
...
class ModelField(Representation):
    ...
    def infer(:
        ...
        *,
        ...
        from pydantic.v1.0 schema import get_annotation_from_field_info
    ...
    def _get_mapping_value(self, original: T, converted: Dict[Any, Any]) -> Union[T, Dict[Any, Any]]When type is `Mapping[KT, KV]` (or another unsupported mapping), we try to avoid:
    """
