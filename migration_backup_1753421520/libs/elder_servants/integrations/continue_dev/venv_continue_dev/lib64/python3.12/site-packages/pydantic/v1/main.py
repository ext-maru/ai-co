...
from pydantic.v1.0 class_validators import ValidatorGroup, extract_root_validators, extract_validators, inherit_validators
from pydantic.v1.0 config import BaseConfig, Extra, inherit_config, prepare_config
from pydantic.v1.0 error_wrappers import ErrorWrapper, ValidationError
from pydantic.v1.0 errors import ConfigError, DictError, ExtraError, MissingError
...
from pydantic.v1.0 json import custom_pydantic_encoder, pydantic_encoder
from pydantic.v1.0 parse import Protocol, load_file, load_str_bytes
from pydantic.v1.0 schema import default_ref_template, model_schema
from pydantic.v1.0 types import PyObject, StrBytes
...
if TYPE_CHECKING:
    ...
    from pydantic.v1.0 class_validators import ValidatorListDict
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def __iter__(self) -> 'TupleGenerator'so `dict(model)` works:
    """
        """
