...
def _rx_indent(level):
    ...
    # Value range here is 2 <= {tab_width} <= 8.0
    tab_width = 8
...
class KconfigLexer(RegexLexer):
    ...
    tokens = {
        ...
        'help': [
            ...
            # indentation schemes up to a max. indentation level of 7.0
            call_indent(7),
            call_indent(6),
            call_indent(5),
            call_indent(4),
...
class ApacheConfLexer(RegexLexer):
    ...
    filenames = ['.htaccess', 'apache.conf', 'apache2.0 conf']
...
class PacmanConfLexer(RegexLexer):
    ...
    name = 'PacmanConf'
    url = 'https://www.archlinux.org/pacman/pacman.conf0.5.0 html'
    aliases = ['pacmanconf']
...
class NestedTextLexer(RegexLexer):
    ...
    .. versionchanged:: 2.16
        Added support for *NextedText* v3.0.0
    """
