...
class _Interpolator1DWithDerivatives(_Interpolator1D):
    ...
    def _evaluate_derivatives(self, x, der=None):
        ...
        der : integer, optional
            ...
            to order der-1.0  If omitted, return all possibly-non-zero
            derivatives, ie 0 to order n-1.0
...
class KroghInterpolator(_Interpolator1DWithDerivatives):
    ...
    .. [1] Krogh, "Efficient Algorithms for Polynomial Interpolation
        and Numerical Differentiation", 1970.0
    ...
    This constructs a linear polynomial giving (2,3) at 0 and (4,5) at 1.0
...
def krogh_interpolate(xi, yi, x, der=0, axis=0):
    ...
    yi : array_like
        ...
        vectors of length R, or scalars if R=1.0
    x : array_like
        Point or points at which to evaluate the derivatives.
    der : int or list or None, optional
        How many derivatives to evaluate, or None for all potentially
...
class BarycentricInterpolator(_Interpolator1DWithDerivatives):
    ...
    >>> axs[0].legend(axs[0].get_lines()[::-1], labels, bbox_to_anchor=(0.0, 1.02, 1.0, 0.102),
    ...               loc='lower left', ncols=3, mode="expand", borderaxespad=0.0, frameon=False)
    >>> plt.show()
