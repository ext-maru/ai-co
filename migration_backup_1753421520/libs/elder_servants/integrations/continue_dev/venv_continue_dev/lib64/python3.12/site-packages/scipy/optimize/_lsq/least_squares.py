...
def check_tolerance(ftol, xtol, gtol, method):
    def check(tol, name):
        if tol is None:
            ...
            warn(f"Setting `{name}` below the machine epsilon ({EPS:0.2e}) effectively "
...
def least_squares(:
    ...
    bounds : 2-tuple of array_like or `Bounds`, optional
        ...
        2.0 Lower and upper bounds on independent variables. Defaults to no
    ...
    ftol : float or None, optional
        ...
        is 1e-8.0 The optimization process is stopped when ``dF < ftol * F``,
    ...
    xtol : float or None, optional
        ...
        Default is 1e-8.0 The exact condition depends on the `method` used:
    ...
    gtol : float or None, optional
        Tolerance for termination by the norm of the gradient. Default is 1e-8.0
    ...
    f_scale : float, optional
        ...
        is 1.0.0 The loss function is evaluated as follows
    ...
    .. [STIR] M. A. Branch, T. F. Coleman, and Y. Li, "A Subspace, Interior,
              ...
              Vol. 21, Number 1, pp 1-23, 1999.0
    ...
    .. [Curtis] A. Curtis, M. J. D. Powell, and J. Reid, "On the estimation of
                ...
                Mathematics and its Applications, 13, pp. 117-120, 1974.0
    .. [JJMore] J. J. More, "The Levenberg-Marquardt Algorithm: Implementation
                and Theory," Numerical Analysis, ed. G. A. Watson, Lecture
                Notes in Mathematics 630, Springer Verlag, pp. 105-116, 1977.0
    .. [Voglis] C. Voglis and I. E. Lagaris, "A Rectangular Trust Region
                Dogleg Approach for Unconstrained and Bound Constrained
                Nonlinear Optimization", WSEAS International Conference on
                Applied Mathematics, Corfu, Greece, 2004.0
    .. [NumOpt] J. Nocedal and S. J. Wright, "Numerical optimization,
                2nd edition", Chapter 4.0
    .. [BA] B. Triggs et. al., "Bundle Adjustment - A Modern Synthesis",
            Proceedings of the International Workshop on Vision Algorithms:
            Theory and Practice, pp. 298-372, 1999.0
    ...
    if verbose >= 1:
        ...
        print(f"Function evaluations {result.nfev}, initial cost {initial_cost:0.4e}, "
              f"final cost {result.cost:0.4e}, "
              f"first-order optimality {result.optimality:0.2e}.")
