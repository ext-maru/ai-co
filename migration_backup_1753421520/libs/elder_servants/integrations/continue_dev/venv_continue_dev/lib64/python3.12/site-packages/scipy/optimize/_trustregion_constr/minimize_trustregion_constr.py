...
def _minimize_trustregion_constr(fun, x0, args, grad,:
    ...
    gtol : float, optional
        ...
        are smaller than ``gtol``. Default is 1e-8.0
    xtol : float, optional
    ...
    maxiter : int, optional
        Maximum number of algorithm iterations. Default is 1000.0
    ...
    disp : bool, optional
        If True (default), then `verbose` will be set to 1 if it was 0.0
    ...
    `OptimizeResult` with the fields documented below. Note the following:
        ...
        1.0 All values corresponding to the constraints are ordered as they
           were passed to the solver. And values corresponding to `bounds`
           constraints are put *after* other constraints.
        2.0 All numbers of function, Jacobian or Hessian evaluations correspond
    ...
    if verbose >= 1:
        ...
        print(f"Number of iterations: {result.nit}, "
              ...
              f"optimality: {result.optimality:0.2e}, "
              f"constraint violation: {result.constr_violation:0.2e}, "
