...
class TestSLSQP:
    ...
    which has a maximum at x=2, y=1.0
    """
    ...
    def test_gh1758(self):
        ...
        # implement two equality constraints, in R^2.0
        def fun(x):
            return np.sqrt(x[1])
    ...
    def test_parameters_stay_within_bounds(self):
        # gh11403.0 For some problems the SLSQP Fortran code suggests a step
