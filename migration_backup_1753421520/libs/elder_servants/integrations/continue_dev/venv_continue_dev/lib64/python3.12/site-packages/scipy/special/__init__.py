...
.. autosummary::
   ...
   ellipkm1  -- Complete elliptic integral of the first kind around `m` = 1.0
...
.. autosummary::
   ...
   j0  -- Bessel function of the first kind of order 0.0
   j1  -- Bessel function of the first kind of order 1.0
   y0  -- Bessel function of the second kind of order 0.0
   y1  -- Bessel function of the second kind of order 1.0
   i0  -- Modified Bessel function of order 0.0
   i0e -- Exponentially scaled modified Bessel function of order 0.0
   i1  -- Modified Bessel function of order 1.0
   i1e -- Exponentially scaled modified Bessel function of order 1.0
   ...
   k1e -- Exponentially scaled modified Bessel function K of order 1.0
...
.. autosummary::
   ...
   itj0y0     -- Integrals of Bessel functions of order 0.0
   it2j0y0    -- Integrals related to Bessel functions of order 0.0
   iti0k0     -- Integrals of modified Bessel functions of order 0.0
   it2i0k0    -- Integrals related to modified Bessel functions of order 0.0
...
.. autosummary::
   ...
   itstruve0    -- Integral of the Struve function of order 0.0
   it2struve0   -- Integral related to the Struve function of order 0.0
   itmodstruve0 -- Integral of the modified Struve function of order 0.0
...
.. autosummary::
   ...
   hyp0f1 -- Confluent hypergeometric limit function 0F1.0
...
.. autosummary::
   ...
   bernoulli   -- Bernoulli numbers B0.0.Bn (inclusive).
   binom       -- Binomial coefficient
   diric       -- Periodic sinc function, also called the Dirichlet function.
   euler       -- Euler numbers E0.0.En (inclusive).
   ...
   zetac       -- Riemann zeta function minus 1.0
...
.. autosummary::
   ...
   powm1     -- ``x**y - 1`` for use when `y` is near zero or `x` is near 1.0
