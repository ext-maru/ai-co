...
class SlackIntegrationManager:
    ...
    def get_integration_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "features": {"messaging": True, "notifications": True, "slash_commands": True, "workflows": True},
...
class GitHubIntegrationManager:
    ...
    def get_integration_status(self) -> Dict[str, Any]:
        ...
        return {
            "service": "github",
            "connected": self.is_connected,
            "features": {"issues": True, "pull_requests": True, "actions": True, "webhooks": True},
...
class TeamsIntegrationManager:
    ...
    def get_integration_status(self) -> Dict[str, Any]:
        ...
        return {
            "service": "teams",
            "connected": self.is_connected,
            "features": {"messaging": True, "adaptive_cards": True, "connectors": True, "apps": False},
    ...
    def trigger_webhook(self, event: str, data: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for webhook in self.webhooks:
            if webhook["active"] and event in webhook["events"]:
                # 実際の送信処理（モック）
                results.append({"webhook_id": webhook["id"], "status": "sent", "timestamp": datetime.now().isoformat()})
        return results
...
def get_github_repositories():
    ...
    try:
        ...
        return jsonify({"success": True, "repositories": repos, "count": len(repos)})
    except Exception as e:
        return jsonify({"success": False, "error": str(e)}), 500
...
def get_webhooks():
    """Webhook一覧取得"""
    return jsonify({"success": True, "webhooks": webhook_manager.webhooks, "count": len(webhook_manager.webhooks)})
...
def trigger_webhook():
    ...
    try:
        ...
        return jsonify({"success": True, "triggered": len(results), "results": results})
