            ...
            for worker_id, worker_data in monitor.workers_status.items():
                workers[worker_id] = {
                    **worker_data,
                    ...
                    "last_updated": (
                        worker_data["last_updated"].isoformat() if worker_data.get("last_updated") else None
                    ),
                }
        ...
        try:
            ...
            detailed_info = {
                **worker_status,
                ...
                "last_updated": (
                    worker_status["last_updated"].isoformat() if worker_status.get("last_updated") else None
                ),
            }
