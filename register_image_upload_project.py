...
from libs.elder_project_manager import ElderProjectManager, ProjectInfo, ProjectStatus, ProjectPriority, ElderRole
from libs.unified_auth_provider import create_demo_auth_system, User
...
def main():
    ...
    # 登録されたプロジェクトの詳細を表示
    user = User(username="claude_elder", elder_role=ElderRole.CLAUDE_ELDER, sage_type=None)
    ...
    if registered_project:
        ...
        print(f"   📅 更新日時: {registered_project.updated_at.strftime('%Y-%m-%d %H:%M:%S')}")
