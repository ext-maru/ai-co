...
class A2AMonitoringSystem:
    ...
    def check_a2a_communication_activity(self) -> Dict[str, Any]:
                    ...
                    with open(log_path, 'r') as f:
                        ...
                        for line in lines[-50:]:
                            if any(keyword in line.lower() for keyword in 
                                   ['a2a', 'council', 'sage', 'agent', 'communication']):
        ...
        try:
            ...
            logger.debug(f"RabbitMQキュー確認エラー: {e}")
    ...
    def record_communication(self, source_agent: str, target_agent: str, 
        ...
        try:
            ...
            if self.communication_stats["total_messages"] > 0:
                self.communication_stats["success_rate"] = (
                    1.0 - (self.communication_stats["error_count"] / 
    ...
    def generate_monitoring_report(self) -> Dict[str, Any]:
        ...
        if self.communication_stats["error_count"] > 0:
            error_rate = (self.communication_stats["error_count"] / 
                         max(self.communication_stats["total_messages"], 1))
                ...
                try:
                    ...
                    if activity["recent_logs"]:
                        self.record_communication(
                            "system", "monitoring", "health_check", 
                            "success", 0.1, None, {"logs_found": len(activity["recent_logs"])}
                        )
