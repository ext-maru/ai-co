...
from libs.enhanced_error_handling import (
    smart_retry, RetryStrategy, ErrorClassifier, task_executor
)
import logging
...
def main():
    """エラーハンドリングシステムのデモ"""
    print("=" * 60)
    print("🛡️ AI Company 強化エラーハンドリングシステム")
    print("=" * 60)
    ...
    print("✅ デモ完了！")
    print("\n💡 使用方法:")
    print("1. @smart_retry デコレーターで自動リトライ")
    print("2. task_executor.execute_with_resilience() で安全実行")
    print("3. エラー履歴は自動的に記録・分析されます")
    print("=" * 60)
