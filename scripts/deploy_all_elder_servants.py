...
class ElderServantCoordinator:
    ...
    def deploy_all_servants(self):
        ...
        servants = [
            ("IMPORT FIX KNIGHT", self.project_root / "scripts" / "fix_all_test_imports.py"),
            ("COVERAGE ENHANCEMENT KNIGHT", self.project_root / "scripts" / "coverage_enhancement_knight.py"),
        ...
        self.run_servant("INCIDENT KNIGHTS", self.project_root / "scripts" / "incident_knights.py")
