...
## 概要
AI Companyの中核を成す4つの賢者による自律的管理システム。
...
## 協調の魔法
4賢者は相互に連携し、AI Companyの自律的運営を実現する。""",
            "spell_type": "system",
...
if __name__ == "__main__":
    ...
    print("🔮 これらの呪文は永遠に保存され、AI Companyの礎となります")
    print()
