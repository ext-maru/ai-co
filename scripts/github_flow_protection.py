            ...
            if master_exists:
                if main_exists:
                    ...
                    if result.returncode == 0 and result.stdout.strip():
                        ...
                        merge_result = self.run_git("merge master --no-ff -m 'chore: merge master into main before cleanup'")
...
# AI Company GitHub Flow Protection Hook
...
def main():
    """メイン実行関数"""
    print("🏛️ AI Company GitHub Flow Protection System")
