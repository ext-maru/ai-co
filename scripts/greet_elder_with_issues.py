...
class ElderGreetingWithIssues:
    ...
    def __init__(self):
        ...
        self.knowledge_manager = KnowledgeBaseManager() if KnowledgeBaseManager else None
...
"""
        ...
        # JSON形式でも保存
        json_filepath = council_dir / f"council_{timestamp.strftime('%Y%m%d_%H%M%S')}_issues.json"
