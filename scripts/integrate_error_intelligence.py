...
def create_integration_config():
    ...
    config = {
        "error_intelligence_integration": {
            "enabled": True,
            "workers": {
                "task_worker": {"enabled": True, "auto_retry_on_fix": True},
                "pm_worker": {"enabled": True, "auto_retry_on_fix": True},
                "result_worker": {"enabled": True, "auto_retry_on_fix": False},
            },
            "dlq_monitoring": {"enabled": True, "check_interval": 30, "batch_size": 10},
        }
    }
