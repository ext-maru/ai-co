...
class AICommandMigrator:
    ...
    def generate_report(self) -> Dict:
        ...
        report = {
            ...
            "summary": {
                "success_rate": (self.stats["files_modified"] / max(self.stats["files_scanned"], 1)) * 100,
        ...
        report_path = reports_dir / f"ai_command_migration_report_{self.timestamp.strftime('%Y%m%d_%H%M%S')}.json"
...
"""
        ...
        md_path = Path("/home/aicompany/ai_co/reports") / f"AI_COMMAND_MIGRATION_REPORT_{self.timestamp.strftime('%Y%m%d')}.md"
