...
class WorkerOrganizer:
    def __init__(self):
        ...
        self.archive_dir = self.workers_dir / '_archived' / datetime.now().strftime('%Y%m%d')
        self.worker_mapping = {}
    ...
    def analyze_workers(self):
        ...
        worker_groups = {
            'pm_worker': {
                ...
                'duplicates': ['pm_worker.py', 'pm_worker_v2.py', 'enhanced_pm_worker.py', 
                               'pm_worker_gitflow.py', 'quality_pm_worker.py']
            },
            'task_worker': {
                'primary': 'task_worker.py',
                'duplicates': ['enhanced_task_worker.py', 'quality_task_worker.py', 
    ...
    def generate_report(self):
        ...
        report = {
            ...
            'summary': {
                ...
                'archived_count': len(list(self.archive_dir.glob('*.py'))) if self.archive_dir.exists() else 0
            }
        }
