...
def demo_analysis():
    ...
    try:
        ...
        temporal_query = SemanticQuery(
            query_text="",
            query_type=AnalysisType.TEMPORAL_ANALYSIS
        )
...
def main():
    ...
    parser.add_argument('--type', choices=[t.value for t in AnalysisType], 
                       default='similarity_search', help='Analysis type')
