        ...
        try:
            ...
            if test_results["total_tests"] > 0:
                ...
                if test_results["failed_tests"] == 0:
                    ...
                    gate_result["message"] = f"{test_results['failed_tests']} of {test_results['total_tests']} tests failed"
            else:
...
def main():
    ...
    parser.add_argument("--report-only", action="store_true",
                       help="Report only (don't enforce)")
    parser.add_argument("--output", default="reports/quality_gates_results.json",
