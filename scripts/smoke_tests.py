...
class SmokeTest:
    ...
    def test_api_connectivity(self) -> bool:
        ...
        try:
            response = requests.get(
                f"{base_url}{api_endpoint}/status",
                timeout=timeout
            )
            return response.status_code in [200, 404]  # 404 is ok if endpoint doesn't exist yet
        except requests.RequestException:
            return False
    ...
    def test_cron_scheduling(self) -> bool:
        ...
        try:
            ...
            from core.scheduling import validate_cron_expression, calculate_next_cron_run
    ...
    def _check_local_process(self) -> bool:
        ...
        try:
            ...
            return True  # For local development, we don't require processes to be running
        except subprocess.TimeoutExpired:
            return False
