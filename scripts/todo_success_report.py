...
# 1. 実行結果サマリー
result_file = Path(
    "/home/aicompany/ai_co/ai_todo/ai_self_growth_result_20250703_133040.json"
)
if result_file.exists():
    ...
    print(
        f"  📈 成功率: {result['success_rate']*100:.0f}% ({result['successful']}/{result['total_tasks']}タスク)"
    )
...
# 3. 自己診断レポート
diagnosis_file = Path(
    "/home/aicompany/ai_co/ai_todo/reports/self_diagnosis_20250703.json"
)
