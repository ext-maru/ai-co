...
python3 scripts/unified_interface_cli.py --create-templates
"""
...
class UnifiedInterfaceCLI:
    ...
    async def create_templates(self):
        ...
        try:
            # テンプレートディレクトリ作成
            await self.interface_system._create_template_files()
    ...
    async def run_cli():
        try:
            if args.start_server:
                ...
                print("   python3 scripts/unified_interface_cli.py --create-templates")
