    ...
    def __init__(self):
        ...
        self.template_info = {
            ...
            "parameters": {
                ...
                "auth_required": {"type": "bool", "default": True, "description": "Whether authentication is required"},
                "validation": {"type": "bool", "default": True, "description": "Include request validation"},
            },
        }
...
async def list_{resource}s(
    ...
    {"current_user = Depends(get_current_user)" if auth else ""}
):
...
{"from ..auth import auth_required" if params.get("auth_required", True) else ""}
