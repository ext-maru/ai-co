...
from libs.elder_servants.base.elder_servant import TaskStatus, ServantCategory
...
''',
    ...
    print(f"✓ セキュリティテスト生成: vulnerability_coverage={security_result.result_data['vulnerability_coverage']}")
