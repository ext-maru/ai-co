...
from libs.elder_servants.base.elder_servant_base import ServantCapability, ServantDomain
...
async def main():
    ...
    try:
        ...
        print(
            f"🧪 成功率: {results['test_summary']['success_rate']:.1%} ({results['test_summary']['successful_tests']}/{results['test_summary']['total_tests']})"
        )
