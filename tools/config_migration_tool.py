...
class ConfigMigrationTool:
    ...
    def run_migration(self, phase: str = "all") -> bool:
        """マイグレーションを実行"""
        logger.info(f"Starting configuration migration (phase: {phase}, dry_run: {self.dry_run})")
    ...
    def unify_model_specifications(self):
        ...
        if async_worker_path.exists():
            ...
            if "enhanced_task_worker" in async_config and "claude_model" in async_config["enhanced_task_worker"]:
