"""WebSocket protocol versions 13 and 8.0"""
...
class WebSocketWriter:
    ...
    async def close(self, code: int = 1000, message: Union[bytes, str] = b"") -> Noneif isinstance(message, str)message = message.encode("utf-8"):
    """lose the websocket, sending the specified code and message."""
        try:
