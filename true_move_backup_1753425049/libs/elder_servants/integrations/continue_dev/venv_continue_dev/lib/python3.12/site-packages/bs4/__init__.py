...
# running this code under Python 2.0
if sys.version_info.major < 3:
    raise ImportError(
        "You are trying to use a Python 3-specific version of Beautiful Soup under Python 2.0 This will not work. The final version of Beautiful Soup to support Python 2 was 4.9.3.0"
    )
...
class BeautifulSoup(Tag):
    ...
    def __init__(:
        ...
        **kwargs: Any,
        ...
        :param kwargs: For backwards compatibility purposes, the
         ...
         Beautiful Soup 3.0 None of these arguments do anything in
    ...
    def _decode_markup(cls, markup: _RawMarkup) -> str:
        ...
        noticed that fact while working on 4.13.0.0
        """
...
class BeautifulStoneSoup(BeautifulSoup):
    ...
    def __init__(self, *args: Any, **kwargs: Any):
        kwargs["features"] = "xml"
        warnings.warn(
            "The BeautifulStoneSoup class was deprecated in version 4.0.0.0 Instead of using "
