...
class TestSoupStrainer(SoupTest):
    ...
    def test_search_tag_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert (
                msg
                == "Call to deprecated method search_tag. (Replaced by allow_tag_creation) -- Deprecated since version 4.13.0.0"
            )
    ...
    def test_search_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert (
                msg
                == "Call to deprecated method search. (Replaced by match) -- Deprecated since version 4.13.0.0"
            )
