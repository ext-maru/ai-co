...
def get_best_encoding(stream: t.IO[t.Any]) -> strrv = getattr(stream, "encoding", None) or sys.getdefaultencoding()if is_ascii_encoding(rv):
"""eturns the default stream encoding if not found."""
        return "utf-8"
    return rv
