...
class TreeModifier:
    ...
    def _index_by_name(self, name: str) -> intfor i, t in enumerate(self._cache):
    ...
    def __delitem__(self, name: str) -> Noneindex = self._index_by_name(name):
    """elete an item with the given name if it exists."""
        if index > -1:
