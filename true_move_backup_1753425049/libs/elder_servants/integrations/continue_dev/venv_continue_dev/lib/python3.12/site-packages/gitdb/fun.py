...
def loose_object_header_info(m):return: tuple(type_string, uncompressed_size_in_bytes) the type string of the
"""
...
def pack_object_header_info(data):return: tuple(type_id, uncompressed_size_in_bytes, byte_offset)
"""
...
def msb_size(data, offset=0):return: tuple(read_bytes, size) read the msb size from the given random
"""
