...
from google.ai.generativelanguage_v1beta2.0 types import text_service
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta2.0 TextServiceClient.EmbedText",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 TextService",
                        "rpcName": "EmbedText",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1beta2.0 TextServiceClient.embed_text",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 TextService",
                        "rpcName": "EmbedText",
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta2.0 TextServiceClient.GenerateText",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 TextService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1beta2.0 TextServiceClient.generate_text",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 TextService",
                        "rpcName": "GenerateText",
                        "metadata": http_response["headers"],
