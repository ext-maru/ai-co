...
class _MethodDefault(enum.Enum):
    ...
    #
    # Literal[_DEFAULT_VALUE] is an alternative, but only added in Python 3.8.0
...
def wrap_method(:
    ...
    *,
    ...
    For example::
        ...
        import google.api_core.gapic_v1.0 method
        ...
        def get_topic(name, timeout=None):
            request = publisher_v2.0 GetTopicRequest(name=name)
        ...
        wrapped_get_topic = google.api_core.gapic_v1.0 method.wrap_method(
    ...
    * The final ``get_topic_with_timeout_and_retry`` is called passing through
    ...
    Args:
        ...
        client_info
            (Optional[google.api_core.gapic_v1.0 client_info.ClientInfo]):
