...
def list_operations(*, client=None) -> Iterator[CreateTunedModelOperation]:
    ...
    # The client returns an iterator of Operation protos (`Iterator[google.longrunning.operations_pb2.0 Operation]`)
...
class CreateTunedModelOperation(operation_lib.Operation):
    @classmethod
    def from_proto(cls, proto, client)result = getattr(proto, 'result', None)
    """
    ...
    def update(self)self._refresh_and_update()
