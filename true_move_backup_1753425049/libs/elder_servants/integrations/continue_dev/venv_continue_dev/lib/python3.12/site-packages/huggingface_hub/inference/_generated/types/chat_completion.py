...
class ChatCompletionInput(BaseInferenceType):
    ...
    """Number between -2.0 and 2.0.0 Positive values penalize new tokens based on their existing
    ...
    """Number between -2.0 and 2.0.0 Positive values penalize new tokens based on whether they
    ...
    """What sampling temperature to use, between 0 and 2.0 Higher values like 0.8 will make the
