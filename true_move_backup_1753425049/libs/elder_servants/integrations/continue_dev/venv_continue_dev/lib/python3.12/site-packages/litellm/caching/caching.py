...
class Cache:
    def __init__(:
        ...
        **kwargs,
        ...
        Args:
            ...
            redis_flush_size (int, optional): The number of keys to flush at a time. Defaults to 1000.0 Only used if batch redis set caching is used.
    ...
    def _get_model_param_value(self, kwargs: dict) -> str:
        ...
        1.0 If caching groups are set, then return the caching group as the model https://docs.litellm.ai/docs/routing#caching-across-model-groups
        2.0 Else if a model_group is set, then return the model_group as the model. This is used for all requests sent through the litellm.Router()
        3.0 Else use the `model` passed in kwargs
        """
    ...
    def _get_preset_cache_key_from_kwargs(self, **kwargs) -> Optional[str]:
        ...
        1.0 optional params like max_tokens, get transformed for bedrock -> max_new_tokens
        2.0 avoid doing duplicate / repeated work
        """
        if kwargs:
