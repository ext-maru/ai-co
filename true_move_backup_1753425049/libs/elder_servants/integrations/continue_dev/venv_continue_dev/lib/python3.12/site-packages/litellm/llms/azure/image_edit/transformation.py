...
class AzureImageEditConfig(OpenAIImageEditConfig):
    ...
    def get_complete_url(:
        ...
        - api_base: Base URL, e.g.,
            "https://litellm8397336933.0 openai.azure.com"
            OR
            "https://litellm8397336933.0 openai.azure.com/openai/deployments/<deployment_name>/images/edits?api-version=2024-05-01-preview"
