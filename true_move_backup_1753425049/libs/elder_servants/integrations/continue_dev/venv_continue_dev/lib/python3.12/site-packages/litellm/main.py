    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "azure":
            ...
            raise ValueError(
                "Palm was decommisioned on October 2024.0 Please use the `gemini/` route for Gemini Google AI Studio Models. Announcement: https://ai.google.dev/palm_docs/palm?hl=en"
            )
...
def completion_with_retries(*args, **kwargs)Executes a litellm.completion() with 3 retries
"""
    """
    try:
        import tenacity
...
def text_completion(  # noqa: PLR0915:
    ...
    **kwargs,
    ...
    Args:
        ...
        best_of (Optional[int], optional): Generates best_of completions server-side. Defaults to 1.0
        echo (Optional[bool], optional): Echo back the prompt in addition to the completion. Defaults to False.
        frequency_penalty (Optional[float], optional): Penalize new tokens based on their existing frequency. Defaults to 0.0
        ...
        max_tokens (Optional[int], optional): The maximum number of tokens to generate in the completion. Defaults to 16.0
        n (Optional[int], optional): How many completions to generate for each prompt. Defaults to 1.0
        presence_penalty (Optional[float], optional): Penalize new tokens based on whether they appear in the text so far. Defaults to 0.0
        ...
        temperature (Optional[float], optional): Sampling temperature to use. Defaults to 1.0
        top_p (Optional[float], optional): Nucleus sampling parameter. Defaults to 1.0
