...
class _OPTIONAL_PresidioPIIMasking(CustomGuardrail):
    ...
    async def apply_guardrail(
        ...
        UI will call this function to check:
            1.0 If the connection to the guardrail is working
            2.0 When Testing the guardrail with some text, this function will be called with the input text and returns a text after applying the guardrail
        """
