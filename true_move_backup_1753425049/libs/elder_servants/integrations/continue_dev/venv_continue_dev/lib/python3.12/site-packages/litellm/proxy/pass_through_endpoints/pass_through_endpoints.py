...
class HttpPassThroughEndpointHelpers(BasePassthroughUtils):
    ...
    @staticmethod
    def is_multipart(request: Request) -> boolreturn "multipart/form-data" in request.headers.get("content-type", ""):
    """heck if the request is a multipart/form-data request"""
