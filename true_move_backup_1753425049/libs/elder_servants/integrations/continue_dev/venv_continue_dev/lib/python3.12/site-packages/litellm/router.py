...
class Router:
    ...
    def __init__(  # noqa: PLR0915:
        ...
        max_fallbacks: Optional[
            int
        ] = None,  # max fallbacks to try before exiting the call. Defaults to 5.0
        ...
        Args:
            ...
            client_ttl (int): Time-to-live for cached clients in seconds. Defaults to 3600.0
            polling_interval: (Optional[float]): frequency of polling queue. Only for '.scheduler_acompletion()'. Default is 3ms.
            default_priority: (Optional[int]): the default priority for a request. Only for '.scheduler_acompletion()'. Default is None.
            num_retries (Optional[int]): Number of retries for failed requests. Defaults to 2.0
            ...
            retry_after (int): Minimum time to wait before retrying a failed request. Defaults to 0.0
            allowed_fails (Optional[int]): Number of allowed fails before adding to cooldown. Defaults to None.
            cooldown_time (float): Time to cooldown a deployment after failure in seconds. Defaults to 1.0
    ...
    async def abatch_completion(
        ...
        **kwargs,
        ...
        1.0 Batch Process 1 request to N models on litellm.Router. Pass messages as List[Dict[str, str]] to use this
        2.0 Batch Process N requests to M models on litellm.Router. Pass messages as List[List[Dict[str, str]]] to use this
    ...
    async def make_call(self, original_function: Any, *args, **kwargs)Handler for making a call to the .completion()/.embeddings()/etc. functions.
    """
        """
    ...
    def should_retry_this_error(:
        ...
        """
        1.0 raise an exception for ContextWindowExceededError if context_window_fallbacks is not None
        2.0 raise an exception for ContentPolicyViolationError if content_policy_fallbacks is not None

        2.0 raise an exception for RateLimitError if
    ...
    def _time_to_sleep_before_retry(:
        ...
        It should instantly retry only when:
            1.0 there are healthy deployments in the same model group
            2.0 there are fallbacks for the completion call
        """
    ...
    async def _async_get_healthy_deployments(
        ...
        Returns Tuple of:
        - Tuple[List[Dict], List[Dict]]:
            1.0 healthy_deployments: list of healthy deployments
            2.0 all_deployments: list of all deployments
        """
        _all_deployments: list = []
        try:
            _, _all_deployments = self._common_checks_available_deployment(  # type: ignore
    ...
    def get_deployment_model_info(:
        ...
        1.0 Check if model_id is in model info
        2.0 If not, check if litellm model name is in model info
        3.0 If not, return None
        """
