...
class AWSSecretsManagerV2(BaseAWSLLM, BaseSecretManager):
    ...
    @classmethod
    def load_aws_secret_manager(cls, use_aws_secret_manager: Optional[bool])Initialize AWSSecretsManagerV2 and sets litellm.secret_manager_client = AWSSecretsManagerV2() and litellm._key_management_system = KeyManagementSystem.AWS_SECRET_MANAGER
    """
        """
...
#     asyncio.run(aws_secret_manager_v2.0 async_write_secret(secret_name="test_secret_3", secret_value="test_value_2"))
