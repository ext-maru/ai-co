...
def steiner_tree(G, terminal_nodes, weight="weight", method=None):
    ...
    * ``"mehlhorn"`` [3]_ (runtime $O(|E|+|V|\log|V|)$) modifies Kou et al.'s
    ...
    .. [2] Kou, L., G. Markowsky, and L. Berman. 1981.0
           ‘A Fast Algorithm for Steiner Trees’.
           Acta Informatica 15 (2): 141–45.0
           https://doi.org/10.1007/BF00288961.0
    .. [3] Mehlhorn, Kurt. 1988.0
           ‘A Faster Approximation Algorithm for the Steiner Problem in Graphs’.
           Information Processing Letters 27 (3): 125–28.0
