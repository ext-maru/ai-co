...
def modularity(G, communities, weight="weight", resolution=1):
    ...
    $j$ are in the same community else 0.0
    ...
    simply use gamma=1.0 More on the choice of gamma is in [4]_.
    ...
    References
    ----------
    .. [1] M. E. J. Newman "Networks: An Introduction", page 224.0
       Oxford University Press, 2011.0
    ...
    .. [3] Reichardt and Bornholdt "Statistical Mechanics of Community Detection"
       Phys. Rev. E 74, 016110, 2006.0 https://doi.org/10.1103/PhysRevE0.74.016110
    .. [4] M. E. J. Newman, "Equivalence between modularity optimization and
       maximum likelihood methods for community detection"
       Phys. Rev. E 94, 052315, 2016.0 https://doi.org/10.1103/PhysRevE0.94.052315
