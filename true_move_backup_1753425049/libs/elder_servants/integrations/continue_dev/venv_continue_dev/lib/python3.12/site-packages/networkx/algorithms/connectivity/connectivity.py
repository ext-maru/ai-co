...
def local_node_connectivity(:
    ...
    .. [1] Kammer, Frank and Hanjo Taubig. Graph Connectivity. in Brandes and
        ...
        Notes in Computer Science, Volume 3418, Springer-Verlag, 2005.0
...
def average_node_connectivity(G, flow_func=None):
    ...
    .. [1]  Beineke, L., O. Oellermann, and R. Pippert (2002). The average
            connectivity of a graph. Discrete mathematics 252(1-3), 31-45.0
...
def local_edge_connectivity(:
    ...
    'capacity' for each arc to 1.0 If the input graph is directed we simply
