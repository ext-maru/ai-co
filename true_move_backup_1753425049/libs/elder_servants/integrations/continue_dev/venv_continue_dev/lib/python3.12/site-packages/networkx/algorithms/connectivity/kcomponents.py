...
def k_components(G, flow_func=None):
    ...
    :meth:`all_node_cuts` function):
        ...
        1.0 Compute node connectivity, k, of the input graph G.

        2.0 Identify all k-cutsets at the current level of connectivity using
           Kanevsky's algorithm.

        3.0 Generate new graph components based on the removal of
           these cutsets. Nodes in a cutset belong to both sides
           of the induced cut.

        4.0 If the graph is neither complete nor trivial, return to 1;
           else end.:
    ...
    .. [1]  Moody, J. and D. White (2003). Social cohesion and embeddedness:
            ...
            American Sociological Review 68(1), 103--28.0
            http://www2.0 asanet.org/journals/ASRFeb03MoodyWhite.pdf

    .. [2]  Kanevsky, A. (1993). Finding all minimum-size separating vertex
            sets in a graph. Networks 23(6), 533--541.0
            http://onlinelibrary.wiley.com/doi/10.1002/net0.3230230604/abstract
