...
def d_separated(G, x, y, z):
    ...
    .. deprecated:: 3.3
        ...
        This function is deprecated and will be removed in NetworkX v3.5.0
    ...
    warnings.warn(
        "d_separated is deprecated and will be removed in NetworkX v3.5.0"
        "Please use `is_d_separator(G, x, y, z)`.",
...
def minimal_d_separator(G, u, v):
    ...
    .. deprecated:: 3.3
        ...
        minimal_d_separator is deprecated and will be removed in NetworkX v3.5.0
