...
def junction_tree(G):
    ...
    1.0 Moralize the graph
    2.0 Triangulate the graph
    3.0 Find maximal cliques
    4.0 Build the tree from cliques, connecting cliques with shared
       nodes, set edge-weight to number of shared variables
    5.0 Find maximum spanning tree
