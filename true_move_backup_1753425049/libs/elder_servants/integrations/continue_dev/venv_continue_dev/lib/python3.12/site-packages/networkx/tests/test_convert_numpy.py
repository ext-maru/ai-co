...
class TestConvertNumpyArray:
    ...
    def test_identity_digraph_array(self)A = nx.to_numpy_array(self.G2)
    """Conversion from digraph to array to digraph."""
        self.identity_conversion(self.G2, A, nx.DiGraph())

    def test_identity_weighted_graph_array(self)A = nx.to_numpy_array(self.G3)
    """Conversion from weighted graph to array to weighted graph."""
        self.identity_conversion(self.G3, A, nx.Graph())

    def test_identity_weighted_digraph_array(self)A = nx.to_numpy_array(self.G4)
    """Conversion from weighted digraph to array to weighted digraph."""
        self.identity_conversion(self.G4, A, nx.DiGraph())

    def test_nodelist(self)P4 = path_graph(4)
    ...
    def test_from_numpy_array_parallel_edges(self):
        ...
        # The sole self-loop (edge 0) on vertex 1 should have weight 2.0
    ...
    def test_dtype_int_graph(self):
        ...
        For more information, see GitHub pull request #1363.0
...
def test_to_numpy_array_multiweight_reduction(func, expected)G = nx.MultiDiGraph()
