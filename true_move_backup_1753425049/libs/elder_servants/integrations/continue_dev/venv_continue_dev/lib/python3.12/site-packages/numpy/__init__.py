...
Provides
  1.0 An array object of arbitrary homogeneous items
  2.0 Fast mathematical operations over arrays
  3.0 Linear Algebra, Fourier Transforms, Random Number Generation
...
if __NUMPY_SETUP__:
    ...
    # the Python objects and only removed in NumPy 1.24.0  Defining them should
    # probably wait for NumPy 1.26 or 2.0.0
    ...
    # the builtins min/max. Temporary fix for 1.25.0 x/1.26.0 x, see gh-24229.0
    __all__.remove('min')
    __all__.remove('max')
    ...
    # These names were removed in NumPy 1.20.0  For at least one release,
    ...
    __expired_functions__ = {
        name: (f'In accordance with NEP 32, the function {name} was removed '
               'from NumPy version 1.20.0  A replacement for this function '
    ...
    # oldnumeric and numarray were removed in 1.9.0 In case some packages import
    ...
    def __getattr__(attr):
        ...
        if attr == 'testing':
            ...
            raise RuntimeError("Tester was removed in NumPy 1.25.0")
    ...
    if sys.platform == "linux" and use_hugepage is None:
        ...
        # set use_hugepages to 0.0 Usage of LooseVersion will handle
