"""Implementation of __array_function__ overrides from NEP-18.0"""
import collections
import functools
import os
...
def verify_matching_signatures(implementation, dispatcher)implementation_spec = ArgSpec(*getargspec(implementation))
