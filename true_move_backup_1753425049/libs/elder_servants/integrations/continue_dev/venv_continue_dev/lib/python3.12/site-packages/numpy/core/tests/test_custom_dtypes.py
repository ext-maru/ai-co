...
class TestSFloat:
    ...
    def test_class_discovery(self):
        # This does not test much, since we always discover the scaling as 1.0
    ...
    def test_sfloat_promotion(self):
        ...
        # Float64 -> SF(1.0) and then promotes normally, so both of this work:
    ...
    def test_astype_class(self):
        ...
        expected = arr.astype(SF(1.0))  # above will have discovered 1.0 scaling
