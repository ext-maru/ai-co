...
def hermediv(c1, c2):
    ...
    >>> hermediv([ 14.0,  15.0,  28.0,   7.0,   6.0], [0, 1, 2])
    (array([1.0, 2.0, 3.0]), array([0.0]))
    >>> hermediv([ 15.0,  17.0,  28.0,   7.0,   6.0], [0, 1, 2])
...
def hermeder(c, m=1, scl=1, axis=0):
    ...
    >>> hermeder([ 1.0,  1.0,  1.0,  1.0])
    array([1.0,  2.0,  3.0])
    >>> hermeder([-0.25,  1.0,  1.0/2.0,  1.0/3.0,  1.0/4 ], m=2)
    array([1.0,  2.0,  3.0])
...
def hermeint(c, m=1, k=[], lbnd=0, scl=1, axis=0):
    ...
    **multiplied** by `scl` and an integration constant, `k`, is added.
    ...
    >>> hermeint([1, 2, 3]) # integrate once, value 0 at 0.0
    array([1.0, 1.0, 1.0, 1.0])
    >>> hermeint([1, 2, 3], m=2) # integrate twice, value & deriv 0 at 0
    array([-0.25      ,  1.0        ,  0.5       ,  0.33333333,  0.25      ]) # may vary
    >>> hermeint([1, 2, 3], k=1) # integrate once, value 1 at 0.0
    array([2.0, 1.0, 1.0, 1.0])
    >>> hermeint([1, 2, 3], lbnd=-1) # integrate once, value 0 at -1
    array([-1.0,  1.0,  1.0,  1.0])
    >>> hermeint([1, 2, 3], m=2, k=[1, 2], lbnd=-1)
    array([ 1.83333333,  0.0        ,  0.5       ,  0.33333333,  0.25      ]) # may vary
