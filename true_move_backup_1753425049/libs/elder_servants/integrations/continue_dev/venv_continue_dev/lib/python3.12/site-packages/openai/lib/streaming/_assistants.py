...
class AssistantEventHandler:
    ...
    def until_done(self) -> Noneconsume_sync_iterator(self)
    Waits until the stream has been consumed

    def get_final_run(self) -> Runself.until_done():
    """ait for the stream to finish and returns the completed Run object"""
    ...
    def gedef get_final_run_steps(self) -> list[RunStep]self.until_done():
    """r the stream to finish and returns the steps taken in this run"""
    ...
    def gedef get_final_messages(self) -> list[Message]self.until_done():
    """r the stream to finish and returns the messages emitted in this run"""
...
class AsyncAssistantEventHandler:
    ...
    async def undef until_done(self) -> Noneawait consume_async_iterator(self)
    Waits until the stream has been consumed

    async def get_final_run(self) -> Runawait self.until_done():
    """r the stream to finish and returns the completed Run object"""
    ...
    async def get_finadef get_final_run_steps(self) -> list[RunStep]await self.until_done():
    """stream to finish and returns the steps taken in this run"""
    ...
    async def get_finadef get_final_messages(self) -> list[Message]await self.until_done():
    """stream to finish and returns the messages emitted in this run"""
