...
class SocketSpawn(SpawnBase):
    ...
    def isalive(self)return self.socket.fileno() >= 0
    """ Alive if the fileno is valid """

    def send(self, s) -> ints = self._coerce_send_string(s)
