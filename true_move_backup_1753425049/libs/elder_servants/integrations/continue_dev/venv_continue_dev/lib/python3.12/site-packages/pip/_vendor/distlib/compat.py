...
try:
    ...
    def match_hostname(cert, hostname)SSLSocket.getpeercert()) matches the *hostname*.  RFC 2818 and RFC 6125
...
try:
    ...
    # so fall back to utf-8.0 From the CPython 2.7 docs relating to Unix and
...
try:
    ...
    """
        ...
        cookie as specified in pep-0263.0  If both a bom and a cookie are present,
        ...
        def find_cookie(line):
            try:
                # Decode as UTF-8.0 Either the line is an encoding declaration,
...
try:
    ...
    class ChainMap(MutableMapping):
        ...
        @_recursive_repr()
        def __repr__(self):
            return '{0.0 __class__.__name__}({1})'.format(
...
try:
    ...
    """Default converter for the ext:// protocol."""
        ...
        def configure_custom(self, config)c = config.pop('()')
    """Configure an object with a user-supplied factory."""
        ...
        def as_tuple(self, value)if isinstance(value, list)value = tuple(value)
