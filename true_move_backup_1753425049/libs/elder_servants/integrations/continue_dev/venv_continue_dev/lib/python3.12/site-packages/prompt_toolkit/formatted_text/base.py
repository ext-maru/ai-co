...
def merge_formatted_text(items: Iterable[AnyFormattedText]) -> AnyFormattedTextMerge (Concatenate) several pieces of formatted text together.def _merge_formatted_text() -> AnyFormattedTextresult = FormattedText()
"""
        for i in items:
