...
class Vt100Input(Input):
    ...
    def __init__(self, stdin: TextIO) -> None:
        ...
        try:
            # This should not raise, but can return 0.0
            stdin.fileno()
...
class raw_mode:
    ...
    # 1.0 To avoid the "Inappropriate ioctl for device" crash if somebody would
    ...
    # 2.0 Related, when stdin is an SSH pipe, and no full terminal was allocated.
    ...
    def __enter__(self) -> None:
        ...
        try:
            ...
            # Solaris and derived operating systems it defaults to 4.0 (This is
            # because the VMIN slot is the same as the VEOF slot, which
            # defaults to ASCII EOT = Ctrl-D = 4.0)
