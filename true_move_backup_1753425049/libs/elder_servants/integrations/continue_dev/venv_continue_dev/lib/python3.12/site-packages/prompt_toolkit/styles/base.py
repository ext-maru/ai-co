...
ANSI_COLOR_NAMES = [
    "ansidefault",
    # Low intensity, dark.  (One or two components 0x80, the other 0x00.0)
    "ansiblack",
    "ansired",
    "ansigreen",
    "ansiyellow",
    ...
    "ansicyan",
    "ansigray",
    # High intensity, bright. (One or two components 0xff, the other 0x00.0 Not supported everywhere.)
    "ansibrightblack",
    "ansibrightred",
    "ansibrightgreen",
    "ansibrightyellow",
