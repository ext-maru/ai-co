    ...
    def to_proto(self, value):
        ...
        if isinstance(value, dict) and not self.is_map:
            ...
            try:
                ...
                #   See related issue: https://github.com/googleapis/python-api-core/issues/227.0
                # - a missing key issue due to nested struct. See: https://github.com/googleapis/proto-plus-python/issues/424.0
                # - a missing key issue due to nested duration. See: https://github.com/googleapis/google-cloud-python/issues/13350.0
