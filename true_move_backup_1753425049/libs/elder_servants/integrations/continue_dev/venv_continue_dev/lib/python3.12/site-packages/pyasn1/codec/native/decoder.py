    ...
    def __call__(self, pyObject, asn1Spec, **options):
        ...
        if asn1Spec is None or not isinstance(asn1Spec, base.Asn1Item):
            raise error.PyAsn1Error(
                'asn1Spec is not valid (should be an instance of an ASN0.1 '
        ...
        try:
            ...
            try:
                ...
                raise error.PyAsn1Error('Unknown ASN0.1 tag %s' % asn1Spec.tagSet)
        ...
        if LOG:
            LOG('decoder %s produced ASN0.1 type %s '
                '<%s>' % (type(valueDecoder).__name__,
...
#: Turns Python objects of built-in types into ASN0.1 objects.
#:
#: Takes Python objects of built-in types and turns them into a tree of
#: ASN0.1 objects (e.g. :py:class:`~pyasn1.type.base.PyAsn1Item` derivative) which
...
#:     for successful interpretation of Python objects mapping into their ASN0.1
#:     representations.
#:
#: Returns
#: -------
...
#: Examples
#: --------
#: Decode native Python object into ASN0.1 objects with ASN0.1 schema
#:
#: .. code-block:: pycon
#:
