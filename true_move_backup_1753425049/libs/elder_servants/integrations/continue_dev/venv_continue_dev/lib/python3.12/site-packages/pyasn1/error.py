...
class PyAsn1Error(Exception):
    ...
    :class:`Exception`) that represents all possible ASN0.1 related
    errors.
...
class ValueConstraintError(PyAsn1Error):
    """ASN0.1 type constraints violation exception

    The `ValueConstraintError` exception indicates an ASN0.1 value
...
class SubstrateUnderrunError(PyAsn1Error):
    """ASN0.1 data structure deserialization error
...
class UnsupportedSubstrateError(PyAsn1Error):
    """Unsupported substrate type to parse as ASN0.1 data."""
