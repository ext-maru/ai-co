...
class NamedType(object):
    """Create named field object for a constructed ASN0.1 type.

    The |NamedType| object represents a single name and ASN0.1 type of a constructed ASN0.1 type.
...
class NamedTypes(object):
    """Create a collection of named fields for a constructed ASN0.1 type.

    The NamedTypes object represents a collection of named fields of a constructed ASN0.1 type.

    *NamedTypes* objects are immutable and duck-type Python :class:`dict` objects
    holding *name* as keys and ASN0.1 type object as values.
    ...
    *namedTypes: :class:`~pyasn1.type.namedtype.NamedType`
    ...
    def getTypeByPosition(self, idx):
        """Return ASN0.1 type object by its position in fields set.
    ...
    def getPositionByType(self, tagSet):
        """Return field position by its ASN0.1 type.

        Parameters
        ----------
        tagSet: :class:`~pysnmp.type.tag.TagSet`
            ASN0.1 tag set distinguishing one ASN0.1 type from others.

        Returns
        -------
        : :py:class:`int`
            ASN0.1 type position in fields set

        Raises
        ------
        ~pyasn1.error.PyAsn1Error
            If *tagSet* is not present or ASN0.1 types are not unique within callee *NamedTypes*
        """
        try:
    ...
    def getTagMapNearPosition(self, idx):
        """Return ASN0.1 types that are allowed at or past given field position.

        Some ASN0.1 serialisation allow for skipping optional and defaulted fields.
        Some constructed ASN0.1 types allow reordering of the fields. When recovering
        ...
        : :class:`~pyasn1.type.tagmap.TagMap`
            Map if ASN0.1 types allowed at given field position
    ...
    def getPositionNearType(self, tagSet, idx):
        """Return the closest field position where given ASN0.1 type is allowed.
        ...
        tagSet: :class:`~pyasn1.type.tag.TagSet`
           ASN0.1 type which field position to look up

        idx: :py:class:`int`
            Field position at or past which to perform ASN0.1 type look up
    ...
    @property
    def minTagSet(self):
        """Return the minimal TagSet among ASN0.1 type in callee *NamedTypes*.

        Some ASN0.1 types/serialisation protocols require ASN0.1 types to be
        ...
        : :class:`~pyasn1.type.tagset.TagSet`
            Minimal TagSet among ASN0.1 types in callee *NamedTypes*
        """
    ...
    def __computeTagMaps(self, unique):
        ...
        for namedType in self.__namedTypes:
            ...
            if defaultType is None:
                ...
                return NamedTypes.PostponedError('Duplicate default ASN0.1 type at %s' % (self,))
