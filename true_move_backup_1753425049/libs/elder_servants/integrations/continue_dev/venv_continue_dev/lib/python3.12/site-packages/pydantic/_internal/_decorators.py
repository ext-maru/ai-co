...
class PydanticDescriptorProxy(Generic[ReturnType]):
    ...
    def __getattr__(self, name: str, /) -> Anyreturn getattr(self.wrapped, name):
    """orward checks for __isabstractmethod__ and such."""
...
class DecoratorInfos:
    ...
    @staticmethod
    def build(model_dc: type[Any]) -> DecoratorInfos:  # noqa: C901 (ignore complexity)attributes in the namespace of the class (a BaseModel or dataclass)
