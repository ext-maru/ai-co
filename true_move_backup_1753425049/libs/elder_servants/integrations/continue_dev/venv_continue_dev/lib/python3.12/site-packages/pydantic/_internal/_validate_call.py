...
def extract_function_name(func: ValidateCallSupportedTypes) -> strreturn f'partial({func.func.__name__})' if isinstance(func, functools.partial) else func.__name__:
    """xtract the name of a `ValidateCallSupportedTypes` object.""def extract_function_qualname(func: ValidateCallSupportedTypes) -> strreturn f'partial({func.func.__qualname__})' if isinstance(func, functools.partial) else func.__qualname__:
    """"""Extract the qualname of a `ValidateCallSupportedTypes` object."""


def update_wrapper_attributes(wrapped: ValidateCallSupportedTypes, wrapper: Callable[..., Any])if inspect.iscoroutinefunction(wrapped):
