...
class FuncLexer(RegexLexer):
    ...
    # 1.0 Does not start from "
    # 2.0 Can start from ` and end with `, containing any character
    # 3.0 Starts with underscore or { or } and have more than 1 character after it
    # 4.0 Starts with letter, contains letters, numbers and underscores
