...
class TestResource:
    ...
    def test_subresource_with_different_specification(self):
        ...
        assert list(resource.subresources()) == [
            DRAFT202012.0 create_resource(schema),
        ]
...
class TestResolver:
    ...
    def test_repeated_lookup_from_retrieved_resource(self)A (custom-)retrieved resource is added to the registry returned by:
    """
        looking it up.
        """
        resource = Resource.opaque(contents={"foo": "baz"})
