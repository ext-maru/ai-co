...
def install(:
    *,
    ...
    Args:
        ...
        code_width (Optional[int], optional): Code width (in characters) of traceback. Defaults to 88.0
...
class Traceback:
    ...
    Args:
        ...
        code_width (Optional[int], optional): Number of code characters used to traceback. Defaults to 88.0
