...
def inherit_docstring_from(cls: object) -> Decoratorreplacing occurrences of '%(super)s' with the docstring of the:
    """his decorator modifies the decorated function's docstring by
