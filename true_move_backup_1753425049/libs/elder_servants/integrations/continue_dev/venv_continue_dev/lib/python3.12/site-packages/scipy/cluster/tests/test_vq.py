...
class TestWhiten:
    ...
    def test_whiten_zero_std(self, xp, whiten_lock):
        desired = xp.asarray([[0.0, 1.0, 2.86666544],
                              [0.0, 1.0, 1.32460034],
                              [0.0, 1.0, 3.74382172]])

        obs = xp.asarray([[0.0, 1.0, 0.74109533],
                          [0.0, 1.0, 0.34243798],
                          [0.0, 1.0, 0.96785929]])
...
class TestVq:
    ...
    def test_py_vq(self, xp):
        ...
        # label1.0 dtype varies between int32 and int64 over platforms
    ...
    def test_vq_large_nfeat(self, xp):
        ...
        # codes1.0 dtype varies between int32 and int64 over platforms
...
class TestKMean:
    ...
    def test_kmeans2_empty(self, xp):
        # Regression test for gh-1032.0
        assert_raises(ValueError, kmeans2, xp.asarray([]), 2)

    def test_kmeans_0k(self, xp):
        # Regression test for gh-1073: fail when k arg is 0.0
