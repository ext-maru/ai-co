...
def _x_replacer(args, kwargs, dispatchables)uarray argument replacer to replace the transform input array (``x``)
"""
    """
    if len(args) > 0:
...
def fft(x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None, *,:
    ...
    .. [2] Bluestein, L., 1970, "A linear filtering approach to the
           ...
           Audio and Electroacoustics.* 18 (4): 451-455.0
...
def hfft(x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None, *,:
    ...
    * odd: ``ihfft(hfft(a, 2*len(a) - 1) == a``, within roundoff error.
    ...
    >>> fft(signal).round(10)
    array([ -0.0+0.0 j,   5.0+0.0 j,  -0.0+0.0 j,  15.0-0.0 j,   0.0+0.0 j,   0.0+0.0 j,
            -0.0+0.0 j, -15.0-0.0 j,   0.0+0.0 j,   5.0+0.0 j])
    >>> hfft(signal[:6]).round(10) # Input first half of signal
    array([  0.0,   5.0,   0.0,  15.0,  -0.0,   0.0,   0.0, -15.0,  -0.0,   5.0])
...
def ihfftn(x, s=None, axes=None, norm=None, overwrite_x=False, workers=None, *,:
    ...
    >>> x = np.ones((2, 2, 2))
    >>> scipy.fft.ihfftn(x)
    array([[[1.0+0.0 j,  0.0+0.0 j], # may vary
            [0.0+0.0 j,  0.0+0.0 j]],
           [[0.0+0.0 j,  0.0+0.0 j],
            [0.0+0.0 j,  0.0+0.0 j]]])
