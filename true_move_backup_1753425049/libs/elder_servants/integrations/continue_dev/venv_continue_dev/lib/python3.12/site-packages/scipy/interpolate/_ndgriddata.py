...
def griddata(points, values, xi, method='linear', fill_value=np.nan,:
    ...
    >>> plt.title('Original')
    >>> plt.subplot(222)
    >>> plt.imshow(grid_z0.0 T, extent=(0,1,0,1), origin='lower')
    >>> plt.title('Nearest')
    >>> plt.subplot(223)
    >>> plt.imshow(grid_z1.0 T, extent=(0,1,0,1), origin='lower')
    >>> plt.title('Linear')
    >>> plt.subplot(224)
    >>> plt.imshow(grid_z2.0 T, extent=(0,1,0,1), origin='lower')
    >>> plt.title('Cubic')
