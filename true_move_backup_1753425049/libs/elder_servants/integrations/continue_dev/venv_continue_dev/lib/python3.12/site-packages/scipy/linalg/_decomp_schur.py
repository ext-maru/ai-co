...
def schur(a, output='real', lwork=None, overwrite_a=False, sort=None,:
    ...
    sdim : int
        ...
        for either eigenvalue count as 2.0:
    ...
    LinAlgError
        ...
        1.0 The algorithm failed due to a failure of the QR algorithm to
           compute all eigenvalues.
        2.0 If eigenvalue sorting was requested, the eigenvalues could not be
           reordered due to a failure to separate eigenvalues, usually because
           of poor conditioning.
        3.0 If eigenvalue sorting was requested, roundoff errors caused the
    ...
    array([[ 2.65896708,  1.42440458, -1.92933439],
           [ 0.0        , -0.32948354, -0.49063704],
           [ 0.0        ,  1.31178921, -0.32948354]])
    >>> Z
    array([[0.72711591, -0.60156188, 0.33079564],
           [0.52839428, 0.79801892, 0.28976765],
           [0.43829436, 0.3590414, -0.89811411]])

    >>> T2, Z2 = schur(A, output='complex')
    >>> T2
    array([[ 2.65896708, -1.22839825+1.32378589j,  0.42590089+1.51937378j], # may vary
           [ 0.0        , -0.32948354+0.80225456j, -0.59877807+0.56192146j],
           [ 0.0        ,  0.0                    , -0.32948354-0.80225456j]])
    >>> eigvals(T2)
...
def rsf2csf(T, Z, check_finite=True):
    ...
    >>> T2 , Z2 = rsf2csf(T, Z)
    >>> T2
    array([[2.65896708+0.j, -1.64592781+0.743164187j, -1.21516887+1.0660462j],
           [0.0+0.j , -0.32948354+8.2254558e-01j, -0.82115218-2.77555756e-17j],
           [0.0+0.j , 0.0+0.j, -0.32948354-0.802254558j]])
    >>> Z2
    array([[0.72711591+0.j,  0.28220393-0.31385693j,  0.51319638-0.17258824j],
           [0.52839428+0.j,  0.24720268+0.41635578j, -0.68079517-0.15118243j],
           [0.43829436+0.j, -0.76618703+0.1873251j, -0.3063006+0.46857912j]])
