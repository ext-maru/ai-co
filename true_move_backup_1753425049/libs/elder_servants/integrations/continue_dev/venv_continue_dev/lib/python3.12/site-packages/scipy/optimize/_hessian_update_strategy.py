...
class FullHessianUpdateStrategy(HessianUpdateStrategy):
    ...
    def update(self, delta_x, delta_grad):
        ...
        if np.all(delta_grad == 0.0):
            warn('delta_grad == 0.0.0 Check if the approximated '
...
class BFGS(FullHessianUpdateStrategy):
    ...
    exception_strategy : {'skip_update', 'damp_update'}, optional
        ...
        are explained  in [1]_, p0.536-537.0
    min_curvature : float
    ...
    init_scale : {float, np.array, 'auto'}
        ...
        the initial scale. The heuristic is described in [1]_, p0.143.0
        The default is 'auto'.

    Notes
    -----
    The update is based on the description in [1]_, p0.140.0
...
class SR1(FullHessianUpdateStrategy):
    ...
    Notes
    -----
    The update is based on the description in [1]_, p0.144-146.0
