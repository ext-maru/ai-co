...
def fmin_slsqp(func, x0, eqcons=(), f_eqcons=None, ieqcons=(), f_ieqcons=None,:
               ...
               fprime_ieqcons=None, args=(), iter=100, acc=1.0 E-6,
    ...
    cons = ()
    # 1.0 constraints of the 1st kind (eqcons, ieqcons); no Jacobian; take
    ...
    # 2.0 constraints of the 2nd kind (f_eqcons, f_ieqcons) and their Jacobian
...
def _minimize_slsqp(func, x0, args=(), jac=None, bounds=None,:
                    constraints=(),
                    maxiter=100, ftol=1.0 E-6, iprint=1, disp=False,
    ...
    disp : bool
        ...
        `verbosity` is ignored and set to 0.0
    maxiter : int
    ...
    for ic, con in enumerate(constraints):
        ...
        if cjac is None:
            ...
            # to keep a reference to `fun`, see gh-4240.0
