...
def test_ellip_harm_2():
    ...
    with suppress_warnings() as sup:
        ...
        # Values produced by code from arXiv:1204.267
        assert_almost_equal(ellip_harm_2(5, 8, 2, 1, 10), 0.0108056853382)
        assert_almost_equal(ellip_harm_2(5, 8, 2, 2, 10), 0.0105820513809)
        assert_almost_equal(ellip_harm_2(5, 8, 2, 3, 10), 0.0106058384743)
        assert_almost_equal(ellip_harm_2(5, 8, 2, 4, 10), 0.0106774492306)
        assert_almost_equal(ellip_harm_2(5, 8, 2, 5, 10), 0.0107976356454)
