...
class TestLegendreP:
    ...
    def test_legacy(self):
        ...
        assert_array_almost_equal(p, [1.0000, 0.50000, -0.12500], 4)
        assert_array_almost_equal(pd, [0.0000, 1.0000, 1.50000], 4)
...
class TestLegendreFunctions:
    def test_clpmn(self):
        ...
        assert_array_almost_equal(clp,
                   (np.array([[1.000, z, 0.5*(3*z*z-1)],
                           [0.000, np.sqrt(z*z-1), 3*z*np.sqrt(z*z-1)],
                           [0.000, 0.000, 3*(z*z-1)]]),
                    np.array([[0.000, 1.000, 3*z],
                           [0.000, z/np.sqrt(z*z-1), 3*(2*z*z-1)/np.sqrt(z*z-1)],
                           [0.000, 0.000, 6*z]])),
                    7)
    ...
    def test_lqmn_gt1(self):
        """algorithm for real arguments changes at 1.001
