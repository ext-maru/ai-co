...
def test_roots_jacobi():
    ...
    vgq(rf(-0.5, -0.75), ef(-0.5, -0.75), wf(-0.5, -0.75), -1.0, 1.0,
        25, atol=1e-12)
    vgq(rf(-0.5, -0.75), ef(-0.5, -0.75), wf(-0.5, -0.75), -1.0, 1.0,
        100, atol=1e-11)
    ...
    vgq(rf(18.24, 27.3), ef(18.24, 27.3), wf(18.24, 27.3), -1.0, 1.0, 25,
        atol=1.1e-14)
    vgq(rf(18.24, 27.3), ef(18.24, 27.3), wf(18.24, 27.3), -1.0, 1.0,
        100, atol=1e-13)
    ...
    vgq(rf(47.1, -0.2), ef(47.1, -0.2), wf(47.1, -0.2), -1.0, 1.0,
        100, atol=1e-11)
    ...
    vgq(rf(511.0, 511.0), ef(511.0, 511.0), wf(511.0, 511.0), -1.0, 1.0, 5,
        atol=1e-12)
    vgq(rf(511.0, 511.0), ef(511.0, 511.0), wf(511.0, 511.0), -1.0, 1.0, 25,
        atol=1e-11)
    vgq(rf(511.0, 511.0), ef(511.0, 511.0), wf(511.0, 511.0), -1.0, 1.0, 100,
        atol=1e-10)

    vgq(rf(511.0, 512.0), ef(511.0, 512.0), wf(511.0, 512.0), -1.0, 1.0, 5,
        atol=1e-12)
    vgq(rf(511.0, 512.0), ef(511.0, 512.0), wf(511.0, 512.0), -1.0, 1.0, 25,
        atol=1e-11)
    vgq(rf(511.0, 512.0), ef(511.0, 512.0), wf(511.0, 512.0), -1.0, 1.0, 100,
        atol=1e-10)

    vgq(rf(1000.0, 500.0), ef(1000.0, 500.0), wf(1000.0, 500.0), -1.0, 1.0, 5,
        atol=1e-12)
    vgq(rf(1000.0, 500.0), ef(1000.0, 500.0), wf(1000.0, 500.0), -1.0, 1.0, 25,
        atol=1e-11)
    vgq(rf(1000.0, 500.0), ef(1000.0, 500.0), wf(1000.0, 500.0), -1.0, 1.0, 100,
        atol=1e-10)

    vgq(rf(2.25, 68.9), ef(2.25, 68.9), wf(2.25, 68.9), -1.0, 1.0, 5)
    vgq(rf(2.25, 68.9), ef(2.25, 68.9), wf(2.25, 68.9), -1.0, 1.0, 25,
        atol=1e-13)
    vgq(rf(2.25, 68.9), ef(2.25, 68.9), wf(2.25, 68.9), -1.0, 1.0, 100,
        atol=1e-13)
...
def test_roots_sh_jacobi():
    ...
    vgq(rf(-0.5, 0.25), ef(-0.5, 0.25), wf(-0.5, 0.25), 0.0, 1.0,
        25, atol=1e-12)
    vgq(rf(-0.5, 0.25), ef(-0.5, 0.25), wf(-0.5, 0.25), 0.0, 1.0,
        100, atol=1e-11)
    ...
    vgq(rf(27.3, 18.24), ef(27.3, 18.24), wf(27.3, 18.24), 0.0, 1.0,
        100, atol=1e-13)
    ...
    vgq(rf(68.9, 2.25), ef(68.9, 2.25), wf(68.9, 2.25), 0.0, 1.0,
        100, atol=1e-12)
...
def test_roots_gegenbauer():
    ...
    # when alpha = 0, the gegenbauer polynomial is uniformly 0.0 but it goes
...
def test_roots_chebyt():
    ...
    verify_gauss_quad(sc.roots_chebyt, sc.eval_chebyt, weightf, -1.0, 1.0, 100,
                      atol=1e-12)
...
def test_roots_chebyc():
    ...
    verify_gauss_quad(sc.roots_chebyc, sc.eval_chebyc, weightf, -2.0, 2.0, 100,
                      atol=1e-12)
...
def test_roots_sh_chebyt():
    ...
    verify_gauss_quad(sc.roots_sh_chebyt, sc.eval_sh_chebyt, weightf, 0.0, 1.0,
                      100, atol=1e-13)
...
def test_roots_sh_chebyu():
    ...
    verify_gauss_quad(sc.roots_sh_chebyu, sc.eval_sh_chebyu, weightf, 0.0, 1.0,
                      100, atol=1e-13)
...
def test_roots_legendre():
    ...
    verify_gauss_quad(sc.roots_legendre, sc.eval_legendre, weightf, -1.0, 1.0,
                      25, atol=1e-13)
    verify_gauss_quad(sc.roots_legendre, sc.eval_legendre, weightf, -1.0, 1.0,
                      100, atol=1e-12)
...
def test_roots_sh_legendre():
    ...
    verify_gauss_quad(sc.roots_sh_legendre, sc.eval_sh_legendre, weightf, 0.0, 1.0,
                      25, atol=1e-13)
    verify_gauss_quad(sc.roots_sh_legendre, sc.eval_sh_legendre, weightf, 0.0, 1.0,
                      100, atol=1e-12)
...
def test_roots_laguerre():
    ...
    verify_gauss_quad(sc.roots_laguerre, sc.eval_laguerre, weightf, 0.0, np.inf,
                      25, atol=1e-13)
    verify_gauss_quad(sc.roots_laguerre, sc.eval_laguerre, weightf, 0.0, np.inf,
                      100, atol=1e-12)
...
def test_roots_genlaguerre():
    ...
    vgq(rootf(1), evalf(1), weightf(1), 0.0, np.inf, 100, atol=1.3e-13)
...
def test_gh_6721():
    # Regression test for gh_6721.0 This should not raise.
    sc.chebyt(65)(0.2)
