...
def f_ishigami(x: "npt.ArrayLike") -> "npt.NDArray[np.inexact[Any]]":
    ...
    .. [1] Ishigami, T. and T. Homma. "An importance quantification technique
       ...
       :doi:`10.1109/ISUMA0.1990.151285`, 1990.0
    """
    x = np.atleast_2d(x)
    f_eval = (
        np.sin(x[0])
...
def sample_A_B(:
    ...
    .. [1] Saltelli, A., P. Annoni, I. Azzini, F. Campolongo, M. Ratto, and
       ...
       :doi:`10.1016/j.cpc0.2009.09.018`, 2010.0
    """
    d = len(dists)
...
def sobol_indices(:
    *,
    ...
    n : int
        ...
        Must be a power of 2.0 The total number of points at which `func` is
    ...
    least 1.0 If there are no interactions, then first and total order indices
    are equal, and both first and total order indices sum to 1.0
    ...
    .. [2] Sobol, I. M. (2001). "Global sensitivity indices for nonlinear
       ...
       :doi:`10.1016/S0378-4754(00)00270-6`, 2001.0
    .. [3] Saltelli, A. "Making best use of model evaluations to
       compute sensitivity indices."  Computer Physics Communications,
       145(2):280-297, :doi:`10.1016/S0010-4655(02)00280-1`, 2002.0
    ...
    # Computer Physics Communications, 117(1) :52-61.0
