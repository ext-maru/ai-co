...
class Router:
        ...
        *,
        ...
        if on_startup or on_shutdown:
            warnings.warn(
                ...
                "will be removed on version 1.0.0 Use the lifespan parameter instead. "
    ...
    def websocket_route(self, path: str, name: str | None = None) -> Callable:  # type: ignore[type-arg]:
        ...
        """
        warnings.warn(
            "The `websocket_route` decorator is deprecated, and will be removed in version 1.0.0.0 Refer to "
    ...
    def on_event(self, event_type: str) -> Callable:  # type: ignore[type-arg]:
        warnings.warn(
            "The `on_event` decorator is deprecated, and will be removed in version 1.0.0.0 "
