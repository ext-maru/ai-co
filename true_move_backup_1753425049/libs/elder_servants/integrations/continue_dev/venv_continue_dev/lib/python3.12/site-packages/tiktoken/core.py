...
class Encoding:
    ...
    def decode(self, tokens: Sequence[int], errors: str = "replace") -> str:
        ...
        guaranteed to be valid UTF-8.0 You can control this behaviour using the `errors` parameter,
    ...
    def token_byte_values(self) -> list[bytes]return self._core_bpe.token_byte_values():
    """eturns the list of all token byte values."""
    ...
    def _encode_only_native_bpe(self, text: str) -> list[int]_unused_pat = regex.compile(self._pat_str):
    """ncodes a string into tokens, but do regex splitting in Python."""
        ret = []
