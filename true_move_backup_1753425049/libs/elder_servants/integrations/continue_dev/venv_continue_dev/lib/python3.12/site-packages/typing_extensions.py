...
if sys.version_info >= (3, 13):
    ...
    def _allow_reckless_class_checks(depth=2)The abc and functools modules indiscriminately call isinstance() and
    ...
    def _type_check_issubclass_arg_1(arg)in `issubclass(arg, <protocol>)`.
...
# Update this to something like >=3.13.0 b1 if and when
...
if _PEP_728_IMPLEMENTED:
    ...
    class _TypedDictMeta(type):
        ...
        def __new__(cls, name, bases, ns, *, total=True, closed=None,:
            ...
            # This was specified in an earlier version of PEP 728.0 Support
...
if hasattr(typing, "ReadOnly"):  # 3.13+:
    ...
    def _strip_extras(t)if isinstance(t, typing._AnnotatedAlias)return _strip_extras(t.__origin__)
    ...
    def _could_be_inserted_optional(t)if not isinstance(t, typing._UnionGenericAlias):
    ...
    class ParamSpec(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *, bound=None,:
            ...
            def _paramspec_prepare_subst(alias, args):
                ...
                # Special case where Z[[int, str, bool]] == Z[int, str, bool] in PEP 612.0
...
# 3.9
    ...
    # Inherits from list as a workaround for Callable checks in Python < 3.9.2.0
...
if hasattr(typing, '_collect_type_vars'):
    ...
    def _collect_parameters(args)in order of first appearance (lexicographic order).
...
# Backport typing.NamedTuple as it exists in Python 3.13.0
...
if sys.version_info >= (3,14):
    ...
    def get_annotations(obj, *, globals=None, locals=None, eval_str=False,:
        ...
        in the standard library since Python 3.10.0 See the standard library
        documentation for more:
            pass

            https://docs.python.org/3/library/inspect.html#inspect.get_annotations

        This backport adds the *format* argument introduced by PEP 649.0 The
