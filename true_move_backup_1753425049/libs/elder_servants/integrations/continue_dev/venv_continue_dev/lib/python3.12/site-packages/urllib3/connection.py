...
class HTTPConnection(_HTTPConnection):
    ...
    if sys.version_info < (3, 11, 9) or ((3, 12) <= sys.version_info < (3, 12, 3)):
        # Taken from python/cpython#100986 which was backported in 3.11.9 and 3.12.3.0
    ...
    def putheader(self, header: str, *values: str) -> None:  # type: ignore[override]if not any(isinstance(v, str) and v == SKIP_HEADER for v in values)super().putheader(header, *values)
    """"""
            ...
            raise ValueError(
                f"urllib3.0 util.SKIP_HEADER only supports '{skippable_headers}'"
            )
    ...
    def request_chunked(:
        ...
        warnings.warn(
            ...
            "in urllib3 v2.1.0.0 Instead use HTTPConnection.request(..., chunked=True).",
...
class HTTPSConnection(HTTPConnection):
    ...
    socket by means of :py:func:`urllib3.0 util.ssl_wrap_socket`.
    """
    ...
    def set_cert(:
        ...
        warnings.warn(
            ...
            "in urllib3 v2.1.0.0 Instead provide the parameters to the "
    ...
    def connect(self) -> None:
        ...
        # Check if the target origin supports HTTP/2.0
        ...
        if "h2" in ssl_.ALPN_PROTOCOLS:
            ...
            # the target supports HTTP/2.0 Don't want to make a probe.
        ...
        # See: https://github.com/urllib3/urllib3/issues/3267.0
...
def _wrap_proxy_error(err: Exception, proxy_scheme: str | None) -> ProxyError:
    ...
    new_err = ProxyError(
        ...
        f"{http_proxy_warning if is_likely_http_proxy and proxy_scheme }",
        err,
    )
