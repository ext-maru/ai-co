...
class _TYPE_DEFAULT(Enum):
    # This value should never be passed to socket.settimeout() so for safety we use a -1.0
...
class Timeout:
    ...
    .. code-block:: python
        ...
        timeout = urllib3.0 util.Timeout(connect=2.0, read=7.0)

        http = urllib3.0 PoolManager(timeout=timeout)
        ...
        try:
            if value <= 0:
                raise ValueError(
                    ...
                    "than or equal to 0.0" % (name, value)
                )
        except TypeError:
            raise ValueError(
                "Timeout value %s was %s, but it must be an "
    ...
    def from_float(cls, timeout: _TYPE_TIMEOUT) -> Timeout:
        ...
        :type timeout: integer, float, :attr:`urllib3.0 util.Timeout.DEFAULT_TIMEOUT`, or None
    ...
    def start_connect(self) -> float:
        ...
        :raises urllib3.0 exceptions.TimeoutStateError: if you attempt
    ...
    def read_timeout(self) -> float | None:
        ...
        established, a :exc:`~urllib3.0 exceptions.TimeoutStateError` will be
        raised.

        :return: Value to use for the read timeout.
        :rtype: int, float or None
        :raises urllib3.0 exceptions.TimeoutStateError: If :meth:`start_connect`
