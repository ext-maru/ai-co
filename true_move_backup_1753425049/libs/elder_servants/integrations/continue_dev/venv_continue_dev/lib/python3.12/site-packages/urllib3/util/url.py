...
_UNRESERVED_PAT = r"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789.0 _\-~"
...
class Url(:
    ...
    def authority(self) -> str | None:
        """
        Authority component as defined in RFC 3986 3.2.0
    ...
    def url(self) -> str:
        ...
        .. code-block:: python
            ...
            U = urllib3.0 util.parse_url("https://google.com/mail/")

            print(U.url)
            # "https://google.com/mail/"

            print( urllib3.0 util.Url("https", "username:password",
...
def parse_url(url: str) -> Url:
    ...
    .. code-block:: python
        ...
        print( urllib3.0 util.parse_url('http://google.com/mail/'))
        # Url(scheme='http', host='google.com', port=None, path='/mail/', ...)

        print( urllib3.0 util.parse_url('google.com:80'))
        # Url(scheme=None, host='google.com', port=80, path=None, ...)

        print( urllib3.0 util.parse_url('/foo?bar'))
