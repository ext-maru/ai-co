...
def sanity_check_repo(repo, io):
    ...
    if bad_ver:
        io.tool_error("Aider only works with git repos with version number 1 or 2.0")
...
def is_first_run_of_new_version(io, verbose=False)installs_file = Path.home() / ".aider" / "installs.json"
