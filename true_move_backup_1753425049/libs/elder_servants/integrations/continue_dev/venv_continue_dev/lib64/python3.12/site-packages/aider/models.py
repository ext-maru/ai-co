...
class Model(ModelSettings):
    ...
    def _copy_fields(self, source)for field in fields(ModelSettings)val = getattr(source, field.name)
        ...
        if budget is not None:
            ...
            if budget >= 1024 * 1024:
                ...
                if value == int(value):
                    ...
                    return f"{value:0.1f}M"
            else:
                value = budget / 1024
                if value == int(value):
                    return f"{int(value)}k"
                else:
                    return f"{value:0.1f}k"
        return None
    ...
    def simple_send_with_retries(self, messages):
        ...
        while True:
            try:
                ...
                if not should_retry:
                    return None
                print(f"Retrying in {retry_delay:0.1f} seconds...")
