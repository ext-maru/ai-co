...
class GitRepo:
    ...
    def commit(self, fnames=None, context=None, message=None, aider_edits=False, coder=None):
        ...
        1.0 When aider_edits = True (AI Changes):
        ...
        2.0 When aider_edits = False (User Changes):
    ...
    def get_dirty_files(self)Returns a list of all files which are dirty (not committed), either staged or in the working
    """
        directory.
        """
        dirty_files = set()
