...
# Exceptions were moved to their own module in 4.13.0 Import here for
...
class TreeBuilder(object):
    ...
    def feed(self, markup: _RawMarkup) -> Noneraise NotImplementedError():
    """un incoming markup through some parsing process."""
...
class HTMLTreeBuilder(TreeBuilder):
    ...
    DEFAULT_EMPTY_ELEMENT_TAGS: Set[str] = set(
        [
            ...
            "track",
            "wbr",
            # These are from earlier versions of HTML and are removed in HTML5.0
            "basefont",
            "bgsound",
            "command",
            "frame",
