...
class SoupTest(object):
    ...
    def soup(self, markup: _IncomingMarkup, **kwargs: Any) -> BeautifulSoupbuilder = kwargs.pop("builder", self.default_builder)return BeautifulSoup(markup, builder=builder, **kwargs)
    """uild a Beautiful Soup object from markup."""
...
"""
    ...
    def assertDoctypeHandled(self, doctype_fragment: str) -> Nonedoctype_str, soup = self._document_with_doctype(doctype_fragment):
    """ssert that a given doctype string is handled correctly."""
    ...
    def test_normal_doctypes(self)self.assertDoctypeHandled("html")
...
"""
    ...
    def test_nested_block_level_elements(self)soup = self.soup("<blockquote><p><b>Foo</b></p></blockquote>")
...
"""
    ...
    def test_attribute_values_with_nested_quotes_are_left_alone(self)self.assert_soup(text)
    text = """<foo attr='bar "brawls" happen'>a</foo>"""

    def test_attribute_values_with_double_nested_quotes_get_quoted(self)soup = self.soup(text)
    text = """<foo attr='bar "brawls" happen'>a</foo>"""
    ...
    def test_real_iso_8859_document(self):
        ...
        # Here it is in Unicode. Note that it claims to be in ISO-8859-1.0
        ...
        # Encode it to UTF-8.0
        result = soup.encode("utf-8")

        # What do we expect the result to look like? Well, it would
        # look like unicode_html, except that the META tag would say
        # UTF-8 instead of ISO-8859-1.0
    ...
    def test_real_hebrew_document(self):
        ...
        # Hebrew encoding) to UTF-8.0
        hebrew_document = b"<html><head><title>Hebrew (ISO 8859-8) in Visual Directionality</title></head><body><h1>Hebrew (ISO 8859-8) in Visual Directionality</h1>\xed\xe5\xec\xf9</body></html>"
        soup = self.soup(hebrew_document, from_encoding="iso8859-8")
        # Some tree builders call it iso8859-8, others call it iso-8859-9.0
...
class XMLTreeBuilderSmokeTest(TreeBuilderSmokeTest):
    ...
    def test_xml_declaration(self)soup = self.soup(markup)
    ...
    def test_processing_instruction(self)soup = self.soup(markup)
    markup = b"""<?xml version="1.0" encoding="utf8"?>\n<?PITarget PIContent?>"""
        assert markup == soup.encode("utf8")
...
class HTML5TreeBuilderSmokeTest(HTMLTreeBuilderSmokeTest):
    """Smoke test for a tree builder that supports HTML5.0"""
