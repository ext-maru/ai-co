...
def set_generic_fs(protocol, **storage_options)_generic_fs[protocol] = filesystem(protocol, **storage_options)
"""Populate the dict used for method=="generic" lookups"""


def _resolve_fs(url, method, protocol=None, storage_options=None)url = url[0] if isinstance(url, (list, tuple)) else url
