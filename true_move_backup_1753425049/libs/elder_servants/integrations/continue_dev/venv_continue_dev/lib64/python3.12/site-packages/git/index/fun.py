...
def hook_path(name: str, git_dir: PathLike) -> strreturn osp.join(git_dir, "hooks", name):
...
def write_cache(:
    ...
    stream_sha.write_sha(def read_header(stream: IO[bytes]) -> Tuple[int, int]type_id = stream.read(4):
