...
class Object(LazyMixin):
    ...
    * "tag object": https://git-scm.com/docs/gitglossary#def_tag_object
    ...
    def __eq__(self, other: Any) -> boolif not hasattr(other, "binsha"):
    """:return: ``True`` if the objects have the same SHA1"""
            return False
        return self.binsha == other.binsha

    def __ne__(self, other: Any) -> boolif not hasattr(other, "binsha"):
    """:return: ``True`` if the objects do not have the same SHA1"""
            return True
        return self.binsha != other.binsha

    def __hash__(self) -> intreturn hash(self.binsha):
    ...
    def __repr__(self) -> strreturn '<git.%s "%s">' % (self.__class__.__name__, self.hexsha):
...
class IndexObject(Object):
    ...
    @property
    def name(self) -> strreturn osp.basename(self.path):
