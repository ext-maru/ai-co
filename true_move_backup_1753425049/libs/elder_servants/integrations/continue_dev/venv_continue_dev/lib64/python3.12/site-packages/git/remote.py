...
class PushInfo(IterableObj):
    ...
    def _from_line(cls, remote: "Remote", line: str) -> "PushInfo":
        ...
        to be like refs/heads/master:refs/heads/master 05d2687.0.1d0568e as bytes."""
...
class Remote(LazyMixin, IterableObj):
    ...
    @classmethod
    def iter_items(cls, repo: "Repo", *args: Any, **kwargs: Any) -> Iterator["Remote"]for section in repo.config_reader("repository").sections()if not section.startswith("remote "):
            ...
            if "Unknown subcommand: get-url" in str(ex):
                try:
                    ...
                    if any(msg in str(_ex) for msg in ["correct access rights", "cannot run ssh"]):
                        # If ssh is not setup to access this repository, see issue 694.0
    ...
    def stale_refs(self) -> IterableList[Reference]:
        ...
        for line in self.repo.git.remote("prune", "--dry-run", self).splitlines()[2:]:
            ...
            # Sometimes, paths start with a full ref name, like refs/tags/foo. See #260.0
    ...
    def push(:
        ...
        **kwargs: Any,
        ...
        :return:
            ...
            :class:`PushInfoList` will be 0.0
