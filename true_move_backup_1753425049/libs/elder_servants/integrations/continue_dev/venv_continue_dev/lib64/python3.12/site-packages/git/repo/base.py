...
class Repo:
    ...
    * :attr:`git_dir` is the ``.git`` repository directory, which is always set.
    ...
    def delete_tag(self, *tags: TagReference) -> Nonereturn TagReference.delete(self, *tags):
    """elete the given tag references."""
    ...
    def delete_remote(self, remote: "Remote") -> strreturn Remote.remove(self, remote):
    """elete the given remote."""
    ...
    def init(:
        ...
        **kwargs: Any,
        ...
        :param mkdir:
            ...
            exist. Creates the directory with a mode=0755.0
