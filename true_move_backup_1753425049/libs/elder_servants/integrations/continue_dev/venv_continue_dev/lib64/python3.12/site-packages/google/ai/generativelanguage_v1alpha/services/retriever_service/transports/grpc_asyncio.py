...
class RetrieverServiceGrpcAsyncIOTransport(RetrieverServiceTransport):
    ...
    def delete_corpus(:
        self,
    ) -> Callable[[retriever_service.DeleteCorpusRequest], Awaitable[empty_pb2.0 Empty]]:
    ...
    def delete_document(:
        ...
        [retriever_service.DeleteDocumentRequest], Awaitable[empty_pb2.0 Empty]:
    ]:
    ...
    def delete_chunk(:
        self,
    ) -> Callable[[retriever_service.DeleteChunkRequest], Awaitable[empty_pb2.0 Empty]]:
    ...
    def batch_delete_chunks(:
        ...
        [retriever_service.BatchDeleteChunksRequest], Awaitable[empty_pb2.0 Empty]:
    ]:
