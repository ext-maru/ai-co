...
class TextServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.generate_text: gapic_v1.0 method.wrap_method(
                self.generate_text,
                default_timeout=None,
                client_info=client_info,
            ),
            self.embed_text: gapic_v1.0 method.wrap_method(
                self.embed_text,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_embed_text: gapic_v1.0 method.wrap_method(
                self.batch_embed_text,
                default_timeout=None,
                client_info=client_info,
            ),
            self.count_text_tokens: gapic_v1.0 method.wrap_method(
