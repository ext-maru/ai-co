...
class CacheServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_cached_contents: gapic_v1.0 method.wrap_method(
                self.list_cached_contents,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_cached_content: gapic_v1.0 method.wrap_method(
                self.create_cached_content,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_cached_content: gapic_v1.0 method.wrap_method(
                self.get_cached_content,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_cached_content: gapic_v1.0 method.wrap_method(
                self.update_cached_content,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_cached_content: gapic_v1.0 method.wrap_method(
