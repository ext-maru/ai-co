...
from google.ai.generativelanguage_v1beta2.0 types import discuss_service
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta2.0 DiscussServiceClient.CountMessageTokens",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 DiscussService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1beta2.0 DiscussServiceClient.count_message_tokens",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 DiscussService",
                        "rpcName": "CountMessageTokens",
        ...
        def __call__(:
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta2.0 DiscussServiceClient.GenerateMessage",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 DiscussService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(:
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1beta2.0 DiscussServiceClient.generate_message",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta2.0 DiscussService",
                        "rpcName": "GenerateMessage",
                        "metadata": http_response["headers"],
