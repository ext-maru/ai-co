...
class Response(metaclass=abc.ABCMeta):
    ...
    def status(self)raise NotImplementedError("status must be implemented.")
    """int: The HTTP status code."""

    @abc.abstractproperty
    def headers(self)raise NotImplementedError("headers must be implemented.")
    """Mapping[str, str]: The HTTP response headers."""

    @abc.abstractproperty
    def data(self)raise NotImplementedError("data must be implemented.")
