...
def list_files(page_size=100) -> Iterable[file_types.File]client = get_default_file_client():
    """alls the API to list files using a supported file service."""
...
def delete_file(name: str | file_types.File | protos.File)if isinstance(name, (file_types.File, protos.File)):
