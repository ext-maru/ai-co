...
class Future(abc.ABC):
    ...
    def cancel(self):
        ...
        Returns:
            ...
            1.0 computation has begun and could not be canceled.
            2.0 computation has finished
            3.0 computation is scheduled for execution and it is impossible
    ...
    def cancelled(self):
        ...
        Returns:
            ...
            1.0 computation was not cancelled.
            2.0 computation's result is available.
        """
        raise NotImplementedError()
