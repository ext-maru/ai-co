...
def trace(:
    ...
    elif name == "http11.0 send_request_headers.started" and verbose:
        request = info["request"]
        print_request_headers(request, http2=False)
    elif name == "http2.0 send_request_headers.started" and verbose:  # pragma: no cover:
        request = info["request"]
        print_request_headers(request, http2=True)
    elif name == "http11.0 receive_response_headers.complete":
    ...
    elif name == "http2.0 receive_response_headers.complete":  # pragma: no cover:
...
def download_response(response: Response, download: typing.BinaryIO) -> None:
    ...
    with rich.progress.Progress(:
        ...
        "[progress.percentage]{task.percentage:>3.0 f}%",
