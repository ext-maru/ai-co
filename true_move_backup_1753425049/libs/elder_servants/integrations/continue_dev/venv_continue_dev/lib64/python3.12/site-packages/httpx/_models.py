...
class Headers(typing.MutableMapping[str, str]):
    ...
    def items(self) -> typing.ItemsView[str, str]Return `(key, value)` items of headers. Concatenate headers
    ...
    def muldef multi_items(self) -> list[tuple[str, str]]Return a list of `(key, value)` pairs of headers. Allow multiple
...
class Response:
    ...
    def raise_for_status(self) -> Response:
        ...
        if self.has_redirect_location:
            message = (
                "{error_type} '{0.0 status_code} {0.0 reason_phrase}' for url '{0.0 url}'\n"
                "Redirect location: '{0.0 headers[location]}'\n"
                "For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/{0.0 status_code}"
            )
        else:
            message = (
                "{error_type} '{0.0 status_code} {0.0 reason_phrase}' for url '{0.0 url}'\n"
