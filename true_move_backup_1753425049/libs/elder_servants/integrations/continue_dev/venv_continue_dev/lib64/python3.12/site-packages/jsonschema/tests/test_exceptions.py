...
class TestBestMatch(TestCase):
    ...
    def test_no_anyOf_traversal_for_equally_relevant_errors(self)We don't traverse into an anyOf (as above) if all of its context errors
    """
    ...
    def test_no_oneOf_traversal_for_equally_relevant_errors(self)We don't traverse into an oneOf (as above) if all of its context errors
    """
        seem to be equally "wrong" against the instance.
        """
