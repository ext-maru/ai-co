...
def is_async_iterable(obj: Any) -> boolCheck if an object is an async iterable (can be used with 'async for').:
    """
    Args:
...
class CustomStreamWrapper:
    ...
    @staticmethod
    def _strip_sse_data_from_chunk(chunk: Optional[str]) -> Optional[str]Strips the 'data: ' prefix from Server-Sent Events (SSE) chunks.
    """
