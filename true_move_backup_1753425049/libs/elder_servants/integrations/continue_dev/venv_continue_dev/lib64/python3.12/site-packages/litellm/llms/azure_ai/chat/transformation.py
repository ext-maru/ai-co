...
class AzureAIStudioConfig(OpenAIConfig):
    ...
    def get_complete_url(:
        ...
        - api_base: Base URL, e.g.,
            "https://litellm8397336933.0 services.ai.azure.com"
            OR
            "https://litellm8397336933.0 services.ai.azure.com/models/chat/completions?api-version=2024-05-01-preview"
        - model: Model name.
    ...
    def _transform_messages(:
        ...
        - Azure AI Studio doesn't support content as a list. This handles:
            1.0 Transforms list content to a string.
            2.0 If message contains an image or audio, send as is (user-intended)
        """
