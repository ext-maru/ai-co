...
class LlamafileChatConfig(OpenAIGPTConfig):
    ...
    @staticmethod
    def _resolve_api_key(api_key: Optional[str] = None) -> strover the secret manager key (``LLAMAFILE_API_KEY``).
    ...
    @staticmethod
    def _redef _resolve_api_base(api_base: Optional[str] = None) -> Optional[str]over the secret manager key (``LLAMAFILE_API_BASE``).:
