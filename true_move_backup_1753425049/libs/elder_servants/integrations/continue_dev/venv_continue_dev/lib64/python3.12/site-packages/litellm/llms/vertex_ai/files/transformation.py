...
class VertexAIFilesConfig(VertexBase, BaseFilesConfig):
    ...
    def get_object_name(:
        ...
        if purpose == "batch":
            ## 1.0 If jsonl, check if there's a model name
        ...
        ## 2.0 If not jsonl, return the filename
        filename = extracted_file_data.get("filename")
        if filename:
            return filename
        ## 3.0 If no file name, return timestamp
    ...
    def transform_create_file_request(:
        ...
        """
        2 Cases:
        1.0 Handle basic file upload
        2.0 Handle batch file upload (.jsonl)
        """
