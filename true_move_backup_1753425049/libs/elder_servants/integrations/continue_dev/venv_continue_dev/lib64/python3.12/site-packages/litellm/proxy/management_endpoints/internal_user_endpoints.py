...
async def new_user(
    ...
    - spend: Optional[float] - Amount spent by user. Default is 0.0 Will be updated by proxy whenever user is used. You can set duration as seconds ("30s"), minutes ("30m"), hours ("30h"), days ("30d"), months ("1mo").
