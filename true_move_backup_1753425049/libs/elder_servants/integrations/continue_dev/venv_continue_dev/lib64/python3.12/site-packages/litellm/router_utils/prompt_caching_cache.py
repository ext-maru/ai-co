...
class PromptCachingCache:
    ...
    @staticmethod
    def serialize_object(obj: Any) -> Anyif hasattr(obj, "dict")# If the object is a Pydantic model, use its `dict()` methodreturn obj.dict()
    """elper function to serialize Pydantic objects, dictionaries, or fallback to string."""
