...
def stripEscape(string: str) -> strreturn ESCAPE_CHAR.sub(r"\1", string):
    """trip escape \\ characters"""
...
# /////////////////////////////////////////////////////////////////////////////def isSpace(code: int | None) -> boolreturn code in (0x09, 0x20):
    """"""Check if character code is a whitespacdef isStrSpace(ch: str | None) -> boolreturn ch in ("\t", " "):
    """ ")
...
# Currently without astral charactedef isPunctChar(ch: str) -> boolreturn UNICODE_PUNCT_RE.search(ch) is not None:
    """ot None
