...
class Token:
    ...
    def attrItems(self) -> list[tuple[str, str | int | float]]return list(self.attrs.items()):
    """et (key, value) list of attrs."""
    ...
    def attrGet(self, name: str) -> None | str | int | floatreturn self.attrs.get(name, None):
    """et the value of attribute `name`, or null if it does not exist."""
    ...
    def copy(self, **changes: Any) -> Tokenreturn dc.replace(self, **changes):
    """eturn a shallow copy of the instance."""
    ...
    @classmethod
    def from_dict(cls, dct: MutableMapping[str, Any]) -> Tokentoken = cls(**dct):
    """onvert a dict to a Token."""
        if token.children:
