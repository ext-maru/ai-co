...
def enumerate_all_cliques(G):
    ...
    .. [1] Yun Zhang, Abu-Khzam, F.N., Baldwin, N.E., Chesler, E.J.,
           ...
           *Supercomputing*, 2005.0 Proceedings of the ACM/IEEE SC 2005
           Conference, pp. 12, 12--18 Nov. 2005.0
           <https://doi.org/10.1109/SC0.2005.29>.
    ...
    # Loop invariants:
    # 1.0 len(base) is nondecreasing.
    # 2.0 (base + cnbrs) is sorted with respect to the iteration order of G.
    # 3.0 cnbrs is a set of common neighbors of nodes in base.
    while queue:
...
def find_cliques(G, nodes=None):
    ...
    .. [1] Bron, C. and Kerbosch, J.
       ...
       *Communications of the ACM* 16, 9 (Sep. 1973), 575--577.0
    ...
    .. [2] Etsuji Tomita, Akira Tanaka, Haruhisa Takahashi,
       ...
       *Theoretical Computer Science*, Volume 363, Issue 1,
       ...
       <https://doi.org/10.1016/j.tcs0.2006.06.015>

    .. [3] F. Cazals, C. Karande,
       "A note on the problem of reporting maximal cliques",
       *Theoretical Computer Science*,
       Volume 407, Issues 1--3, 6 November 2008, Pages 564--568,
       <https://doi.org/10.1016/j.tcs0.2008.05.010>
...
class MaxWeightClique:
    ...
    weight : string or None, optional (default='weight')
        ...
        If None, then each node has weight 1.0
