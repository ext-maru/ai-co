...
def _triangles_and_degree_iter(G, nodes=None):
    ...
    This double counts triangles so you may want to divide by 2.0
...
def _weighted_triangles_and_degree_iter(G, nodes=None, weight="weight"):
    ...
    So you may want to divide by 2.0
...
@not_implemented_for("multigraph")
def _directed_triangles_and_degree_iter(G, nodes=None)(node, total_degree, reciprocal_degree, directed_triangles).
...
@not_implemented_for("multigraph")
def _directed_weighted_triangles_and_degree_iter(G, nodes=None, weight="weight")(node, total_degree, reciprocal_degree, directed_weighted_triangles).
"""Return an iterator of
...
def average_clustering(G, nodes=None, weight=None, count_zeros=True):
    ...
    .. [1] Generalizations of the clustering coefficient to weighted
       ...
       http://jponnela.com/web_documents/a9.0 pdf
...
def square_clustering(G, nodes=None):
    ...
    .. [1] Pedro G. Lind, Marta C. González, and Hans J. Herrmann. 2005
        ...
        Physical Review E (72) 056127.0
    .. [2] Zhang, Peng et al. Clustering Coefficient and Community Structure of
        Bipartite Networks. Physica A: Statistical Mechanics and its Applications 387.27 (2008): 6869–6875.0
...
def generalized_degree(G, nodes=None):
    ...
    >>> sum([k * v for k, v in k1.0 items()]) / 2 == nx.triangles(G, 0)
    True
