...
def preflow_push_impl(G, s, t, capacity, residual, global_relabel_freq, value_only):
    ...
    def relabel(u)grt.add_work(len(R_succ[u]))
    ...
    def discharge(u, is_phase1)below), its height reaches at least n. The node is known to have the
        ...
        while True:
            ...
            try:
                ...
                if is_phase1 and height >= n - 1:
                    ...
                    # s-t cut. Stop processing it until phase 2.0
    ...
    def gap_heuristic(height)# Move all nodes at levels (height + 1) to max_height to level n + 1.0
