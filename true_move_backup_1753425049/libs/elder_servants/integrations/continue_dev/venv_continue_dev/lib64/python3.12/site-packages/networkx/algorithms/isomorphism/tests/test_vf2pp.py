...
class TestMultiGraphISOVF2pp:
    ...
    def test_custom_multigraph3_same_labels(self):
        ...
        # We connected the new node to opposite sides, so G1 must be symmetrical to G2.0 Re-structure them to be so
    ...
    def test_custom_multigraph4_different_labels(self):
        ...
        # Compose H1 with the disconnected sub-graph of G1.0 Same for H2
