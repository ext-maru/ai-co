...
class TestDistance:
    ...
    def test_harmonic_diameter(self):
        assert abs(nx.harmonic_diameter(self.G) - 2.477815699658715) < 1e-12
...
class TestBarycenter:
    ...
    def test_sp_kwarg(self):
        # Complete graph K_5.0 Normally it works...
    ...
    def test_this_one_specific_tree(self):
        """Test the tree pictured at the bottom of [West01]_, p. 78.0"""
        g = nx.Graph(
            {
                "a": ["b"],
                "b": ["a", "x"],
