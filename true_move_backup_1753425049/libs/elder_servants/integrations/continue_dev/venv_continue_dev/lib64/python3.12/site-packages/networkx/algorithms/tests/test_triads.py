...
def test_triadic_census()G = nx.DiGraph()
...
def test_is_triad()G = nx.karate_club_graph()
...
def test_all_triplets()G = nx.DiGraph()
...
def test_all_triads()G = nx.DiGraph()
"""Tests the all_triplets function."""
    G.add_edges_from(["01", "02", "03", "04", "05", "12", "16", "51", "56", "65"])
    expected = [
        f"{i},{j},{k}"
...
def test_triad_type()# 0 edges (1 type)
...
def test_triads_by_type()G = nx.DiGraph()
"""Tests the all_triplets function."""
    G.add_edges_from(["01", "02", "03", "04", "05", "12", "16", "51", "56", "65"])
...
def test_random_triad()G = nx.karate_club_graph()
...
def test_triadic_census_nodelist()G = nx.DiGraph()
"""Tests the triadic_census function."""
    G.add_edges_from(["01", "02", "03", "04", "05", "12", "16", "51", "56", "65"])
    expected = {
        "030T": 2,
