...
def from_nested_tuple(sequence, sensible_relabeling=False):
    ...
    NetworkX graph
        ...
        node is node 0.0 If ``sensible_labeling`` is ``True``, nodes will
    ...
    def _make_tree(sequence):
        ...
        # joining the subtrees, the root is node 0.0
...
def to_prufer_sequence(T):
    ...
    *n* - 1, inclusive. The tree corresponding to a given Prüfer
    ...
    of from 0 to *n* - 1.0 This function requires nodes to be labeled in
    ...
    .. [1] Wang, Xiaodong, Lei Wang, and Yingjie Wu.
           ...
           *Journal of Software Engineering and Applications* 2.02 (2009): 111.0
           <https://doi.org/10.4236/jsea0.2009.22016>
