...
def LCF_graph(n, shift_list, repeats, create_using=None):
    ...
    n : int
       ...
       The null graph is returned if `n` < 1.0
...
def hoffman_singleton_graph():
    ...
    It is the only regular graph of vertex degree 7, diameter 2, and girth 5.0
...
def krackhardt_kite_graph(create_using=None):
    ...
    Ed=5, Fernando=6, Garth=7, Heather=8, Ike=9, Jane=10.0
    ...
    .. [1] Krackhardt, David. "Assessing the Political Landscape: Structure,
       ...
       35 (2): 342–369.0 doi:10.2307/2393394.0 JSTOR 2393394.0 June 1990.0
...
def tetrahedral_graph(create_using=None):
    ...
    special case of the complete graph, K4, and wheel graph, W4.0
