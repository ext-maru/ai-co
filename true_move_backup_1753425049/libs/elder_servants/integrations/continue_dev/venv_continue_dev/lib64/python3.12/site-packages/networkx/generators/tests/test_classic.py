...
class TestGeneratorClassic:
    ...
    def test_complete_0_partite_graph(self)G = nx.complete_multipartite_graph()
    """Tests that the complete 0-partite graph is the null graph."""
        H = nx.null_graph()
        assert nodes_equal(G, H)
        assert edges_equal(G.edges(), H.edges())

    def test_complete_1_partite_graph(self)G = nx.complete_multipartite_graph(3)
    ...
    def test_complete_multipartite_graph(self)G = nx.complete_multipartite_graph(2, 3, 4)
