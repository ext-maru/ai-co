...
class TestTriangularLatticeGraph:
    ...
    def test_lattice_points(self)for m, n in [(2, 3), (2, 2), (2, 1), (3, 3), (3, 2), (3, 4)]G = nx.triangular_lattice_graph(m, n)
    ...
    def test_directed(self)G = nx.triangular_lattice_graph(3, 4, create_using=nx.Graph())
    ...
    def test_multigraph(self)G = nx.triangular_lattice_graph(3, 4, create_using=nx.Graph())
...
class TestHexagonalLatticeGraph:
    ...
    def test_lattice_points(self)for m, n in [(4, 5), (4, 4), (4, 3), (3, 2), (3, 3), (3, 5)]G = nx.hexagonal_lattice_graph(m, n)
    ...
    def test_directed(self)G = nx.hexagonal_lattice_graph(3, 5, create_using=nx.Graph())
    ...
    def test_multigraph(self)G = nx.hexagonal_lattice_graph(3, 5, create_using=nx.Graph())
