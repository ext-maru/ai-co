...
class TestArrayEqual(_GenericTest):
    ...
    def test_subclass_that_overrides_eq(self):
        ...
        # (which, e.g., astropy Quantity cannot usefully do). See gh-8452.0
...
class TestBuildErrorMessage:
    ...
    def test_build_err_msg_defaults(self):
        x = np.array([1.0001, 2.0002, 3.0003])
        y = np.array([1.0002, 2.0003, 3.0004])
        err_msg = 'There is a mismatch'

        a = build_err_msg([x, y], err_msg)
        b = ('\nItems are not equal: There is a mismatch\n ACTUAL: array(['
             '1.0001, 2.0002, 3.0003])\n DESIRED: array([1.0002, '
             '2.0003, 3.0004])')
        assert_equal(a, b)
    ...
    def test_build_err_msg_custom_names(self):
        ...
        b = ('\nItems are not equal: There is a mismatch\n FOO: array(['
             '1.0001, 2.0002, 3.0003])\n BAR: array([1.0002, 2.0003, '
             '3.0004])')
        assert_equal(a, b)

    def test_build_err_msg_custom_precision(self):
        x = np.array([1.00000001, 2.0002, 3.0003])
        y = np.array([1.00000002, 2.0003, 3.0004])
        err_msg = 'There is a mismatch'

        a = build_err_msg([x, y], err_msg, precision=10)
        b = ('\nItems are not equal: There is a mismatch\n ACTUAL: array(['
             '1.00000001, 2.0002    , 3.0003    ])\n DESIRED: array(['
             '1.00000002, 2.0003    , 3.0004    ])')
        assert_equal(a, b)
...
class TestArrayAlmostEqual(_GenericTest):
    ...
    def test_subclass(self):
        a = np.array([[1.0, 2.0], [3.0, 4.0]])
        b = np.ma.masked_array([[1.0, 2.0], [0.0, 4.0]],
...
class TestAlmostEqual(_GenericTest):
    ...
    def test_error_message(self):
        ...
        assert_equal(msgs[4], 'Max absolute difference: 1.e-05')
        assert_equal(msgs[5], 'Max relative difference: 3.33328889e-06')
        assert_equal(msgs[6], ' x: array([1.0     , 2.0     , 3.0003])')
        assert_equal(msgs[7], ' y: array([1.0     , 2.0     , 3.0004])')
        ...
        assert_equal(msgs[4], 'Max absolute difference: 1.0')
        assert_equal(msgs[5], 'Max relative difference: 1.0')
        assert_equal(msgs[6], ' x: array([inf,  0.0])')
        assert_equal(msgs[7], ' y: array([inf,  1.0])')
...
class TestULP:
    ...
    def test_single(self):
        ...
        x += 0.1 * np.random.randn(10).astype(np.float32)
    ...
    def test_double(self):
        ...
        x += 0.1 * np.random.randn(10).astype(np.float64)
