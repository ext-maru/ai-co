...
class TextArea:
    ...
    def __init__(:
        ...
        # If no height was given, guarantee height of at least 1.0
        if height is None:
            height = D(min=1)
    ...
    @property
    def document(self) -> DocumentThe `Buffer` document (text + cursor position).:
...
class Box:
    ...
    :param char: Character to be used for filling the space around the body.
        (This is supposed to be a character with a terminal width of 1.0)
    """
...
class VerticalLine:
    """
    A simple vertical line with a width of 1.0
    """
...
class HorizontalLine:
    """
    A simple horizontal line with a height of 1.0
    """
