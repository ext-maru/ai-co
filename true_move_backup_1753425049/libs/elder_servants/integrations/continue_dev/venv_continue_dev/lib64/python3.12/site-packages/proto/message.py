...
class Message(metaclass=MessageMeta):
    ...
    def __bool__(self)return any(k in self and getattr(self, k) for k in self._meta.fields.keys())
    ...
    def __getstate__(self)return self._pb.SerializeToString()
    """Serialize for pickling."""

    def __setstate__(self, value)new_pb = self._meta.pb().FromString(value)
