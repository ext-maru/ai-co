...
class BooleanPayloadDecoder(decoder.AbstractSimplePayloadDecoder):
    ...
    def valueDecoder(self, substrate, asn1Spec,:
        ...
        # BER allows any non-zero value as TRUE; cf. sections 8.2.2.0 and 11.1 
        # in https://www.itu.int/ITU-T/studygroups/com17/languages/X0.690-0207.pdf
        if byte == 0xff:
            value = 1
...
#: Turns CER octet stream into an ASN0.1 object.
#:
#: Takes CER octet-stream and decode it into an ASN0.1 object
...
#: Examples
#: --------
#: Decode CER serialisation without ASN0.1 schema
#:
#: .. code-block:: pycon
#:
...
#:     1 2 3
#:
#: Decode CER serialisation with ASN0.1 schema
#:
#: .. code-block:: pycon
#:
