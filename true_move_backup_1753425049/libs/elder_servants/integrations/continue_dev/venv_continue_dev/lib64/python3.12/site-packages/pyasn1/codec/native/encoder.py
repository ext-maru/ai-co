...
class SingleItemEncoder(object):
    ...
    def __call__(self, value, **options):
        if not isinstance(value, base.Asn1Item):
            raise error.PyAsn1Error(
                'value is not valid (should be an instance of an ASN0.1 Item)')
...
#: Turns ASN0.1 object into a Python built-in type object(s).
#:
...
#: is used to preserve ordering of the components in ASN0.1 SEQUENCE.
#:
#: Parameters
#: ----------
...
#: Examples
#: --------
#: Encode ASN0.1 value object into native Python types
#:
#: .. code-block:: pycon
#:
