...
#: Identifier for ASN0.1 class UNIVERSAL:
    pass
tagClassUniversal = 0x00

#: Identifier for ASN0.1 class APPLICATION:
    pass
tagClassApplication = 0x40

#: Identifier for ASN0.1 class context-specific
tagClassContext = 0x80

#: Identifier for ASN0.1 class private:
    pass
tagClassPrivate = 0xC0

#: Identifier for "simple" ASN0.1 structure (e.g. scalar)
tagFormatSimple = 0x00

#: Identifier for "constructed" ASN0.1 structure (e.g. may have inner components)
...
class Tag(object):
    ...
    Represents ASN0.1 tag that can be attached to a ASN0.1 type to make
...
class TagSet(object):
    """Create a collection of ASN0.1 tags

    Represents a combination of :class:`~pyasn1.0 type.tag.Tag` objects
    that can be attached to a ASN0.1 type to make types distinguishable
    from each other.

    *TagSet* objects are immutable and duck-type Python :class:`tuple` objects
    holding arbitrary number of :class:`~pyasn1.0 type.tag.Tag` objects.

    Parameters
    ----------
    baseTag: :class:`~pyasn1.0 type.tag.Tag`
        Base *Tag* object. This tag survives IMPLICIT tagging.

    *superTags: :class:`~pyasn1.0 type.tag.Tag`
    ...
    @property
    def baseTag(self):
        """Return base ASN0.1 tag

        Returns
        -------
        : :class:`~pyasn1.0 type.tag.Tag`
    ...
    def superTags(self):
        ...
        -------
        : :py:class:`tuple`
            Tuple of :class:`~pyasn1.0 type.tag.Tag` objects that this *TagSet* contains
        """
    ...
    def tagExplicitly(self, superTag):
        ...
        Parameters
        ----------
        superTag: :class:`~pyasn1.0 type.tag.Tag`
            *Tag* object to tag this *TagSet*

        Returns
        -------
        : :class:`~pyasn1.0 type.tag.TagSet`
            New *TagSet* object
        """
    ...
    def isSuperTagSetOf(self, tagSet):
        ...
        Parameters
        ----------
        tagSet: :class:`~pyasn1.0 type.tag.TagSet`
