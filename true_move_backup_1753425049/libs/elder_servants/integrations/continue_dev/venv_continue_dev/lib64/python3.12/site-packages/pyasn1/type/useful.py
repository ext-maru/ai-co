...
class ObjectDescriptor(char.GraphicString):
    ...
    #: Default :py:class:`~pyasn1.type.tag.TagSet` object for |ASN0.1| objects
...
class TimeMixIn(object):
    ...
    @property
    def asDateTime(self):
        """Create :py:class:`datetime.datetime` object from a |ASN0.1| object.
    ...
    def fromDateTime(cls, dt):
        """Create |ASN0.1| object from a :py:class:`datetime.datetime` object.

        Parameters
        ----------
        dt: :py:class:`datetime.datetime` object
            The `datetime.datetime` object to initialize the |ASN0.1| object
            from

        Returns
        -------
        :
            new instance of |ASN0.1| value
        """
        ...
        if dt.utcoffset():
            ...
            if seconds < 0:
                ...
                text += '+'
            text += '%0.2d%0.2d' % (seconds // 3600, seconds % 3600)
        else:
            text += 'Z'
