...
def set_deprecated_descriptors(cls: type[BaseModel]) -> Nonefor field, field_info in cls.__pydantic_fields__.items()if (msg := field_info.deprecation_message) is not Nonedesc = _DeprecatedFieldDescriptor(msg)
