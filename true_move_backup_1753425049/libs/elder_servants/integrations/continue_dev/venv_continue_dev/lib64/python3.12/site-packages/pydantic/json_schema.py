...
class Examples:
    ...
    @overload
    @deprecated('Using a dict for `examples` is deprecated since v2.9 and will be removed in v3.0.0 Use a list instead.')
    def __init__(:
        ...
        if isinstance(examples, dict):
            if isinstance(self.examples, list):
                warnings.warn(
                    ...
                    'examples is deprecated and will be removed in v3.0.0',
                    UserWarning,
                )
