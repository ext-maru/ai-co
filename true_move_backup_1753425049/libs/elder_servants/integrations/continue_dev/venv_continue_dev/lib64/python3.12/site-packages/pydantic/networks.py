...
class UrlConstraints:
    ...
    @property
    def defined_constraints(self) -> dict[str, Any]return {field.name: value for field in fields(self) if (value := getattr(self, field.name)) is not None}
...
class _BaseUrl:
    ...
    def __str__(self) -> strreturn str(self._url):
    """he URL as a string, this will punycode encode the host if required."""
...
class _BaseMultiHostUrl:
    ...
    def unicode_string(self) -> strreturn self._url.unicode_string()
...
class HttpUrl(AnyUrl):
    ...
    * Max length 2083
    ...
    1.0 Note: mypy would prefer `m = MyModel(url=HttpUrl('http://www.example.com'))`, but Pydantic will convert the string to an HttpUrl instance anyway.
...
class MongoDsn(_BaseMultiHostUrl):
    ...
    * Port not required
    * User info may be passed without user part (e.g., `mongodb://mongodb0.0 example.com:27017`).
    """
