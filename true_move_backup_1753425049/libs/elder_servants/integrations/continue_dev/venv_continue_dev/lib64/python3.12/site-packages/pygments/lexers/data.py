...
class YamlLexer(ExtendedRegexLexer):
    ...
    def something(token_class)def callback(lexer, match, context)text = match.group()
    ...
    def reset_indent(token_class)def callback(lexer, match, context)text = match.group()
    ...
    def save_indent(token_class, start=False)def callback(lexer, match, context)text = match.group()
    ...
    def set_indent(token_class, implicit=False)def callback(lexer, match, context)text = match.group()
    ...
    def set_block_scalar_indent(token_class)def callback(lexer, match, context)text = match.group()
    ...
    def parse_block_scalar_empty_line(indent_token_class, content_token_class)def callback(lexer, match, context)text = match.group()
    ...
    def parse_block_scalar_indent(token_class)def callback(lexer, match, context)text = match.group()
    ...
    def parse_plain_scalar_indent(token_class)def callback(lexer, match, context)text = match.group()
