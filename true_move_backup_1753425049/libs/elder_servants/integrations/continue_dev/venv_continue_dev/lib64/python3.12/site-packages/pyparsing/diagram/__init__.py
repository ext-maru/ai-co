...
def _make_bookmark(s: str) -> strConverts a string into a valid HTML bookmark (ID or anchor name).:
...
def _apply_diagram_item_enhancements(fn)decorator to ensure enhancements to a diagram item (such as results name annotations)
"""
