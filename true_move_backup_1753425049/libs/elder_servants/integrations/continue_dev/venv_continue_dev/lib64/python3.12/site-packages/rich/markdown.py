...
class MarkdownContext:
    ...
    def enter_style(self, style_name: str | Style) -> Stylestyle = self.console.get_style(style_name, default="none")
    Enter a style context.
        self.style_stack.push(style)
        return self.current_style

    def leave_style(self) -> Stylestyle = self.style_stack.pop():
    """eave a style context."""
        return style
