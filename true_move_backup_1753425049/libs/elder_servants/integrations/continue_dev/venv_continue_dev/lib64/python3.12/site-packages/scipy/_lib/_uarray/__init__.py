...
example, if a submodule ``module2.0 submodule`` extends ``module1``
(i.e., it exposes dispatchables marked as types available in ``module1``),
then the domain string should be ``"module1.0 module2.0 submodule"``.
...
__version__ = '0.8.8.0 dev0+aa94c5a4.0 scipy'
