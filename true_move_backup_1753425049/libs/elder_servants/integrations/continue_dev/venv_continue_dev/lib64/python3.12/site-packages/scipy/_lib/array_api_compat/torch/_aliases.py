...
def prod(x: array,:
    ...
    # https://github.com/pytorch/pytorch/issues/29137.0 Separate from the logic
...
def sum(x: array,:
    ...
    # https://github.com/pytorch/pytorch/issues/29137.0
...
def std(x: array,:
    ...
    # https://github.com/pytorch/pytorch/issues/61492.0 We don't try to
...
# https://github.com/pytorch/pytorch/issues/70924.0 Support for tuple dim was
# added at https://github.com/pytorch/pytorch/pull/89017.0
def squeeze(x: array, /, axis: Union[int, Tuple[int, ...]]) -> array:
    ...
    axes = _normalize_axes(axis, x.ndim)
    # Remove this once pytorch 1.14 is released with the above PR #89017.0
...
# https://github.com/pytorch/pytorch/issues/71210.0 Also torch.flip() doesn't
# accept axis=None
...
def unique_all(x: array) -> UniqueAllResult:
    ...
    # https://github.com/pytorch/pytorch/issues/36748.0 The workaround
