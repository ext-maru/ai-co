...
class TestConvertTemperature:
    def test_convert_temperature(self, xp):
        xp_assert_equal(sc.convert_temperature(xp.asarray(32.0), 'f', 'Celsius'),
                        xp.asarray(0.0))
        xp_assert_equal(sc.convert_temperature(xp.asarray([0.0, 0.0]),
                                               'celsius', 'Kelvin'),
                        xp.asarray([273.15, 273.15]))
        xp_assert_equal(sc.convert_temperature(xp.asarray([0.0, 0.0]), 'kelvin', 'c'),
                        xp.asarray([-273.15, -273.15]))
        xp_assert_equal(sc.convert_temperature(xp.asarray([32.0, 32.0]), 'f', 'k'),
                        xp.asarray([273.15, 273.15]))
        xp_assert_equal(sc.convert_temperature(xp.asarray([273.15, 273.15]),
                                               'kelvin', 'F'),
                        xp.asarray([32.0, 32.0]))
        xp_assert_equal(sc.convert_temperature(xp.asarray([0.0, 0.0]), 'C', 'fahrenheit'),
                        xp.asarray([32.0, 32.0]))
        xp_assert_close(sc.convert_temperature(xp.asarray([0.0, 0.0], dtype=xp.float64),
                                               'c', 'r'),
        ...
        xp_assert_close(sc.convert_temperature(xp.asarray([32.0, 32.0], dtype=xp.float64),
                                               'fahrenheit', 'R'),
                        xp.asarray([491.67, 491.67], dtype=xp.float64),
                        rtol=0.0, atol=1e-13)
        xp_assert_close(sc.convert_temperature(xp.asarray([273.15, 273.15],
                        ...
                        xp.asarray([491.67, 491.67], dtype=xp.float64),
                        rtol=0.0, atol=1e-13)
        xp_assert_close(sc.convert_temperature(xp.asarray([491.67, 0.0],
                                                          dtype=xp.float64),
                                               'rankine', 'kelvin'),
    ...
    def test_convert_temperature_array_like(self):
        assert_allclose(sc.convert_temperature([491.67, 0.0], 'rankine', 'kelvin'),
