...
def test_clear_cache(tmp_path):
    ...
    assert not os.path.exists(dummy_basepath/"data0.0 dat")
    ...
    _clear_cache(datasets=[data1, data2], cache_dir=dummy_basepath,
                 method_map=dummy_method_map)
    assert not os.path.exists(dummy_basepath/"data1.0 dat")
    assert not os.path.exists(dummy_basepath/"data2.0 dat")

    # clear multiple dataset files "data3_0.0 dat" and "data3_1.0 dat"
    # associated with dataset method "data3"
    def data4():
        pass
    # create files
    (dummy_basepath / "data4_0.0 dat").write_text("")
    (dummy_basepath / "data4_1.0 dat").write_text("")

    dummy_method_map["data4"] = ["data4_0.0 dat", "data4_1.0 dat"]
    _clear_cache(datasets=[data4], cache_dir=dummy_basepath,
                 method_map=dummy_method_map)
    assert not os.path.exists(dummy_basepath/"data4_0.0 dat")
    assert not os.path.exists(dummy_basepath/"data4_1.0 dat")
