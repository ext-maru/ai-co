...
class TestWfuncPointers:
    ...
    in fblas_l1.0 pyf.src. """

    def test_complex_args(self):
        pass

        cx = np.array([0.5 + 1.0 j, 0.25 - 0.375j, 12.5 - 4.0 j], np.complex64)
        cy = np.array([0.8 + 2.0 j, 0.875 - 0.625j, -1.0 + 2.0 j], np.complex64)
    ...
    def test_double_complex_args(self):
        ...
        cx = np.array([0.5 + 1.0 j, 0.25 - 0.375j, 13.0 - 4.0 j], np.complex128)
        cy = np.array([0.875 + 2.0 j, 0.875 - 0.625j, -1.0 + 2.0 j], np.complex128)
