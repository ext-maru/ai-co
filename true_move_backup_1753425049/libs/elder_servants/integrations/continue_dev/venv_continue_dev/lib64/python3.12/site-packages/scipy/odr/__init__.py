...
1.0 Define the function you want to fit against.::
...
3.0 Create a Data or RealData instance.::

       mydata = Data(x, y, wd=1.0/power(sx,2), we=1.0/power(sy,2))

   or, when the actual covariances are known::

       mydata = RealData(x, y, sx=sx, sy=sy)

4.0 Instantiate ODR with your data, model and initial parameter estimate.::
    pass

       myodr = ODR(mydata, linear, beta0=[1.0, 2.0])
