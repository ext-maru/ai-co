...
def find_root(f, init, /, *, args=(), tolerances=None, maxiter=None, callback=None):
    ...
    root that makes the element 0.0 This function currently uses Chandrupatla's
    ...
    .. [1] Chandrupatla, Tirupathi R.
        ...
        Advances in Engineering Software, 28(3), 145-149.0
    ...
    >>> res_bracket.bracket
    (array([1.0, 1.0, 2.0]), array([2.0, 2.0, 4.0]))
    >>> res_root = elementwise.find_root(f, res_bracket.bracket, args=(c,))
    >>> res_root.x
    array([1.8932892 , 2.0        , 2.09455148])
...
def find_minimum(f, init, /, *, args=(), tolerances=None, maxiter=100, callback=None):
    ...
    .. [1] Chandrupatla, Tirupathi R. (1998).
        ...
        211-217.0 https://doi.org/10.1016/S0045-7825(97)00190-4
    ...
    >>> res_bracket.bracket
    (array([0.0 , 0.5, 0.5]), array([0.5, 1.5, 1.5]), array([1.5, 2.5, 2.5]))
    >>> res_minimum = elementwise.find_minimum(f, res_bracket.bracket, args=(c,))
    >>> res_minimum.x
    array([1.00000001, 1.5       , 2.0        ])
    >>> res_minimum.f_x
    array([2.0, 2.0, 2.0])
