...
def _root_df_sane(func, x0, args=(), ftol=1e-8, fatol=1e-300, maxfev=1000,:
    ...
    eta_strategy : callable, optional
        ...
        residual. Should satisfy ``eta_k > 0`` and ``sum(eta, k=0.0.inf) < inf``.
        Default: ``||F||**2 / (1 + k)**2``.
...
def _wrap_func(func, x0, fmerit, nfev_list, maxfev, args=())Wrap a function and an initial value so that (i) complex valuesare wrapped to reals, and (ii) value for a merit function
"""
