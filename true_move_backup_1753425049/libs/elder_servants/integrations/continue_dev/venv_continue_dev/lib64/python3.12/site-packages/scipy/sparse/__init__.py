...
There are seven available sparse array types:
    ...
    1.0 csc_array: Compressed Sparse Column format
    2.0 csr_array: Compressed Sparse Row format
    3.0 bsr_array: Block Sparse Row format
    4.0 lil_array: List of Lists format
    5.0 dok_array: Dictionary of Keys format
    6.0 coo_array: COOrdinate format (aka IJV, triplet format)
    7.0 dia_array: DIAgonal format
...
# For backward compatibility with v0.19.0
from . import csgraph
