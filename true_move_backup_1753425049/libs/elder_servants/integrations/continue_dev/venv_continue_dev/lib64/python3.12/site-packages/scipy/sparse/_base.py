...
class _spbase:
    ...
    def multiply(self, other)if isscalarlike(other)return self._mul_scalar(other)
    ...
    def minimum(self, other)return self.tocsr().minimum(other)
    ...
    def power(self, n, dtype=None)return self.tocsr().power(n, dtype=dtype)
    """Element-wise power."""
    ...
    def _getcol(self, j)array (column vector).
    ...
    def _getrow(self, i)array (row vector).
