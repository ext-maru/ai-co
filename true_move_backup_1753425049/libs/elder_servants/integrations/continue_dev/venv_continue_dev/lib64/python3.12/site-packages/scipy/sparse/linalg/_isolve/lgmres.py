...
def lgmres(A, b, x0=None, *, rtol=1e-5, atol=0.0, maxiter=1000, M=None, callback=None,:
    ...
    outer_k : int, optional
        ...
        According to [1]_, good values are in the range of 1.0.0.3.0
