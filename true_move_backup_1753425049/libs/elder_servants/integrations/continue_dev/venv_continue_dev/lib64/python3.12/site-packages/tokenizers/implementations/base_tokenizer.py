...
class BaseTokenizer:
    ...
    def enable_padding(:
        ...
        Args:
            ...
            pad_to_multiple_of: (`optional`) unsigned int:
                ...
                `pad_to_multiple_of=8` then we will pad to 256.0
    ...
    def no_padding(self)return self._tokenizer.no_padding()
    """Disable padding"""
    ...
    def no_truncation(self)return self._tokenizer.no_truncation()
    """Disable truncation"""
    ...
    def post_process(:
        ...
        The various steps are:
            1.0 Truncate according to global params (provided to `enable_truncation`)
            2.0 Apply the PostProcessor
            3.0 Pad according to global params. (provided to `enable_padding`)
