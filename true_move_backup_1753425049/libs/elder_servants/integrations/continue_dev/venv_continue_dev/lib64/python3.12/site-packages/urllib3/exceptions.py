...
class MaxRetryError(RequestError):
    ...
    :type pool: :class:`~urllib3.0 connectionpool.HTTPConnectionPool`
...
class NewConnectionError(ConnectTimeoutError, HTTPError):
    ...
    def pool(self) -> HTTPConnection:
        warnings.warn(
            ...
            "in urllib3 v2.1.0.0 Use 'conn' instead.",
            DeprecationWarning,
            stacklevel=2,
        )
...
class ProxySchemeUnknown(AssertionError, URLSchemeUnknown):
    ...
    # TODO(t-8ch): Stop inheriting from AssertionError in v2.0.0
