...
class UnifiedQualityPipeline:
    ...
    def _create_error_comprehensive_result(self, error: Exception):
        """エラー時包括結果生成"""
        from libs.quality.comprehensive_quality_engine import ComprehensiveQualityResult
    ...
    def _create_error_quality_judgment(self, error: Exception):
        """エラー時品質判定生成"""
        from libs.elder_servants.quality_watcher_judgment import QualityJudgmentResult
    ...
    def _create_error_test_judgment(self, error: Exception):
        """エラー時テスト判定生成"""
        from libs.elder_servants.test_forge_judgment import TestQualityJudgmentResult
