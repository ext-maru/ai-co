...
class TaskSageMonitor:
    ...
    def check_github_flow_compliance(self) -> Dict:
        ...
        try:
            ...
            if current_branch not in ["main"] and not any(
                current_branch.startswith(prefix) for prefix in valid_prefixes
            ):
...
class IncidentSageMonitor:
    ...
    def check_security_risks(self) -> Dict:
        ...
        try:
            ...
            return {"risk_level": min(risk_level, 1.0), "risks": risks}

        except Exception as e:
            return {"risk_level": 1.0, "risks": [f"セキュリティチェックエラー: {e}"]}
...
class KnowledgeSageMonitor:
    ...
    def check_learning_consistency(self) -> Dict:
        """学習データ整合性チェック"""
        return {"consistent": True, "inconsistencies": [], "last_check": datetime.now()}
    ...
    def check_knowledge_updates(self) -> Dict:
        ...
        try:
            ...
            if latest_mtime > 0:
                ...
                return {"days_since_update": days_since, "last_update": last_update}
...
class FourSagesMonitoringSystem:
    ...
    def load_config(self) -> Dict:
        ...
        default_config = {
            ...
            "alert_thresholds": {"CRITICAL": 0, "HIGH": 2, "MEDIUM": 5, "LOW": 10},
    ...
    def get_monitoring_status(self) -> Dict:
        ...
        try:
            ...
            return {"monitoring_active": self.monitoring_active, "error": str(e)}
