...
class EnhancedTaskWorker(BaseWorker, PromptTemplateMixin):
    ...
    def __init__(self, worker_id=None):
        ...
        self.logger.info(
            f"{EMOJI['start']} Enhanced TaskWorker initialized with prompt templates"
        )
    ...
    def get_status(self):
        ...
        enhanced_status = {
            **base_status,
            ...
            if hasattr(self, "list_available_templates")
            else 0,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Enhanced TaskWorker with Prompt Templates"
    )
    ...
    if args.test:
        ...
        for template in worker.list_available_templates():
            print(
                f"  - {template['template_name']} v{template['version']}: {template['description']}"
            )
        ...
        print(
            f"{EMOJI['start']} Enhanced TaskWorker starting with prompt template support..."
        )
